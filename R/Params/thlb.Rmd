...
require (fasterize)
require (here)
source (paste0 (here::here(), "/caribou/clus_repo/clus/R/functions/R_Postgres.R"))
...
```{r output data}
writeRaster (ras.thlb, filename = file.path (here::here(), "/caribou/clus_repo/clus/R/Params/", "thlb.tif"), format = "GTiff", overwrite = TRUE)
