...
```{r, nonliner}
#NULL
start.null<-nls(pop_estimate  ~ pop.0*exp(r*time) ,start=list(r=-0.01), data=model.data)
expo.null.1 <- nlme(pop_estimate  ~ pop.0*exp(r*time), fixed =list(r~1), random= r~1|herd_name, weights=varExp(form=~herd.size), start =list(fixed=coef(start.null)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
```{r}
#Total Road 50
start.total.road50<-nls(pop_estimate  ~ pop.0*exp((b*total.road50.per)*time) ,start=list(b=-0.001), data=model.data)
expo.total.road50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.road50.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.road50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.road50.1) #AIC:877 PHI:0.884
report(expo.total.road50.1)
#Core and Matrix road 50
start.road50<-nls(pop_estimate  ~ pop.0*exp((b*core.road50.per+c*matrix.road50.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.road50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.road50.per+c*matrix.road50.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.road50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
#Total Road 500
start.total.road500<-nls(pop_estimate  ~ pop.0*exp((b*total.road500.per)*time) ,start=list( b=-0.001), data=model.data)
expo.total.road500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.road500.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.road500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.road500.1) #AIC:877 PHI:0.884
report(expo.total.road500.1)
#Core and Matrix road 500
start.road500<-nls(pop_estimate  ~ pop.0*exp((b*core.road500.per+c*matrix.road500.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.road500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.road500.per+c*matrix.road500.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.road500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
```{r}
#Total cut10-40
start.total.cut10_40<-nls(pop_estimate  ~ pop.0*exp((b*total.cut10_40.per)*time) ,start=list(b=0.001), data=model.data)
expo.total.cut10_40.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut10_40.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut10_40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40.1) #AIC:877 PHI:0.884
report(expo.total.cut10_40.1)
#Core and Matrix cut10_40
start.cut10_40<-nls(pop_estimate  ~ pop.0*exp((b*core.cut10_40.per+c*matrix.cut10_40.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut10_40.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut10_40.per+c*matrix.cut10_40.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut10_40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut10_40.1) #AIC:877 PHI:0.884
report(expo.cut10_40.1)

#Cut40
start.total.cut40<-nls(pop_estimate  ~ pop.0*exp((b*total.cut40.per)*time) ,start=list(b=-0.001), data=model.data)
expo.total.cut40.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut40.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40.1) #AIC:877 PHI:0.884
report(expo.total.cut40.1)
#Core and Matrix cut40
start.cut40<-nls(pop_estimate  ~ pop.0*exp((b*core.cut40.per+c*matrix.cut40.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut40.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut40.per+c*matrix.cut40.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40.1) #AIC:877 PHI:0.884
report(expo.cut40.1)

#Cut80
start.total.cut80<-nls(pop_estimate  ~ pop.0*exp((b*total.cut80.per)*time) ,start=list(b=-0.001), data=model.data)
expo.total.cut80.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut80.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut80)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80.1) #AIC:877 PHI:0.884
report(expo.total.cut80.1)
#Core and Matrix cut80
start.cut80<-nls(pop_estimate  ~ pop.0*exp((b*core.cut80.per+c*matrix.cut80.per)*time) ,start=list( b=-0.01, c=-0.01), data=model.data)
expo.cut80.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut80.per+c*matrix.cut80.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut80)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
```{r}
#Cut10_40r50
start.total.cut10_40r50<-nls(pop_estimate  ~ pop.0*exp((b*total.cut10_40r50.per)*time) ,start=list(b=0.001), data=model.data)
expo.total.cut10_40r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut10_40r50.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut10_40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40r50.1) #AIC:877 PHI:0.884
report(expo.total.cut10_40r50.1)
#Core and Matrix cut10_40r50
start.cut10_40r50<-nls(pop_estimate  ~ pop.0*exp((b*core.c10_40r50.per+c*matrix.c10_40r50.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut10_40r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.c10_40r50.per+c*matrix.c10_40r50.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut10_40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut10_40r50.1) #AIC:877 PHI:0.884
report(expo.cut10_40r50.1)

#Cut10_40r500
start.total.cut10_40r500<-nls(pop_estimate  ~ pop.0*exp((b*total.cut10_40r500.per)*time) ,start=list(b=0.001), data=model.data)
expo.total.cut10_40r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut10_40r500.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut10_40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40r500.1) #AIC:877 PHI:0.884
report(expo.total.cut10_40r500.1)
#Core and Matrix cut10_40r500
start.cut10_40r500<-nls(pop_estimate  ~ pop.0*exp((b*core.c10_40r500.per+c*matrix.c10_40r500.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut10_40r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.c10_40r500.per+c*matrix.c10_40r500.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut10_40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut10_40r500.1) #AIC:877 PHI:0.884
report(expo.cut10_40r500.1)

#Cut40r50
start.total.cut40r50<-nls(pop_estimate  ~ pop.0*exp((b*total.cut40r50.per)*time) ,start=list(b=0.001), data=model.data)
expo.total.cut40r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut40r50.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40r50.1) #AIC:877 PHI:0.884
report(expo.total.cut40r50.1)
#Core and Matrix cut40r50
start.cut40r50<-nls(pop_estimate  ~ pop.0*exp((b*core.cut40r50.per+c*matrix.cut40r50.per)*time) ,start=list( b=-0.001, c=-0.001), data=model.data)
expo.cut40r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut40r50.per+c*matrix.cut40r50.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40r50.1) #AIC:877 PHI:0.884
report(expo.cut40r50.1)

#Cut40r500
start.total.cut40r500<-nls(pop_estimate  ~ pop.0*exp((b*total.cut40r500.per)*time) ,start=list( b=0.001), data=model.data)
expo.total.cut40r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut40r500.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40r500.1) #AIC:877 PHI:0.884
report(expo.total.cut40r500.1)
#Core and Matrix cut40r500
start.cut40r500<-nls(pop_estimate  ~ pop.0*exp((b*core.cut40r500.per+c*matrix.cut40r500.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut40r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut40r500.per+c*matrix.cut40r500.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40r500.1) #AIC:877 PHI:0.884
report(expo.cut40r500.1)

#Cut80r50
start.total.cut80r50<-nls(pop_estimate  ~ pop.0*exp((b*total.cut80r50.per)*time) ,start=list(b=-0.001), data=model.data)
expo.total.cut80r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut80r50.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut80r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80r50.1) #AIC:877 PHI:0.884
report(expo.total.cut80r50.1)
#Core and Matrix cut80r50
start.cut80r50<-nls(pop_estimate  ~ pop.0*exp((b*core.cut80r50.per+c*matrix.cut80r50.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut80r50.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut80r50.per+c*matrix.cut80r50.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut80r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut80r50.1) #AIC:877 PHI:0.884
report(expo.cut80r50.1)

#Cut80r500
start.total.cut80r500<-nls(pop_estimate  ~ pop.0*exp((b*total.cut80r500.per)*time) ,start=list(b=0.001), data=model.data)
expo.total.cut80r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*total.cut80r500.per)*time), fixed =list(b~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.total.cut80r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80r500.1) #AIC:877 PHI:0.884
report(expo.total.cut80r500.1)
#Core and Matrix cut80r500
start.cut80r500<-nls(pop_estimate  ~ pop.0*exp((b*core.cut80r500.per+c*matrix.cut80r500.per)*time) ,start=list(b=-0.001, c=-0.001), data=model.data)
expo.cut80r500.1 <- nlme(pop_estimate  ~ pop.0*exp((b*core.cut80r500.per+c*matrix.cut80r500.per)*time), fixed =list(b~1,c~1), weights=varExp(form=~herd.size), random= b~1|herd_name, start =list(fixed=coef(start.cut80r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut80r500.1) #AIC:877 PHI:0.884
report(expo.cut80r500.1)
anova(expo.total.cut80r500.1,expo.cut80r500.1)
