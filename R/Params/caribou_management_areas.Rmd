...
#                         user = keyring::key_get('dbuser', keyring = 'postgreSQL'),
#                         password = keyring::key_get('dbpass', keyring = 'postgreSQL'))
# reve_area <- getSpatialQuery("SELECT * from public.old_recruit_buff_matrix_fin;")

# NEEDS TO BE ADDED TO PGDB; COULD NOT CONNECT TO DB, SO LAODED FROAM LOCAL FILE 
