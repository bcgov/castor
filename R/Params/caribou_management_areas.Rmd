...
DBI::dbWriteTable(conn, c("public", "zone_scenario_central_grp_proposed_luo_feb2021"), value = zone_luo, 
                          row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_scenario_central_grp_proposed_luo_feb2021 INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_du9_scenarios"), value = zone_du9_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_du9_scenarios INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_gh_scenarios"), value = zone_gh_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_gh_scenarios INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_barkerville_groundhog_scenario"), value = zone_du9_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_barkerville_groundhog_scenario INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_du7_scenarios_20210305"), value = zone_du7_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_du7_scenarios_20210305 INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_cond_du9_scenarios"), value = zone_du9_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_cond_du9_scenarios INHERIT zone_constraints"))
dbDisconnect(conn)
...
DBI::dbWriteTable(conn, c("public", "zone_cond_du7_scenarios_20210330"), value = zone_du7_scenarios, row.names = FALSE, overwrite = TRUE)
dbExecute(conn, paste0("ALTER TABLE zone_cond_du7_scenarios_20210330 INHERIT zone_constraints"))
dbDisconnect(conn)
