...
yc_vdyp<-getTableQuery("SELECT * FROM yc_vdyp_all WHERE ycid = -105439 order by age ")
yc_tipsy<-getTableQuery("SELECT * FROM yc_tipsy WHERE ycid = 9717282 order by age")
