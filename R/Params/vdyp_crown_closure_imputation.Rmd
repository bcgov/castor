...
SELECT t.feature_id, t.crown_closure,
    ...
    ON t.feature_id = y.ycid AND CAST(t.age/10 AS INT)*10 = y.age
    LEFT JOIN yc_vdyp_2020_adj k 
    ON t.feature_id = k.ycid AND round(t.age/10+0.5)*10 = k.age WHERE t.age > 0 ;")))
