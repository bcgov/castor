...
denning<-getSpatialQuery("select shape, 
                          CASE WHEN (SPECIES_CD_1 LIKE 'AC%'  or SPECIES_CD_2 LIKE 'AC%' or  SPECIES_CD_3 LIKE 'AC%' or (SPECIES_CD_1 LIKE 'S%' and SPECIES_CD_2 IS NULL)) and (bec_zone_code = 'SBS' and bec_subzone in('wk','mk','mm','mw')) THEN 1
                               ...
                               WHEN (SPECIES_CD_1 LIKE 'A%'  or SPECIES_CD_2 LIKE 'A%' or (SPECIES_CD_1 LIKE 'F%' and SPECIES_CD_2  IS NULL)) and ((bec_zone_code = 'SBPS' and bec_subzone in('xc','mc','dc','mk')) or (bec_zone_code = 'IDF' and bec_subzone in('dk','dc','mw','dw','ww')) or (bec_zone_code = 'MS' and bec_subzone in('xc','xk','dv','dm', 'dk', 'dc'))) THEN 3
                               WHEN (SPECIES_CD_1 LIKE 'AC%'  or SPECIES_CD_2 LIKE 'AC%' or  SPECIES_CD_3 LIKE 'AC%') and ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 4
                               WHEN (SPECIES_CD_1 LIKE 'AT%'  or SPECIES_CD_2 LIKE 'AT%' or  SPECIES_CD_3 LIKE 'AT%')  and ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 5
                               ELSE 0
...
rust<-getSpatialQuery("select shape, 
                          CASE WHEN (SPECIES_CD_1 LIKE 'S%'  or SPECIES_CD_2 LIKE 'S%' or SPECIES_CD_3 LIKE 'S%') and (bec_zone_code = 'SBS' and bec_subzone in('wk','mk','mm','mw')) THEN 1
                               ...
                               WHEN  (SPECIES_CD_1 LIKE 'S%'  or SPECIES_CD_2 LIKE 'S%' or  SPECIES_CD_3 LIKE 'S%') and ((bec_zone_code = 'SBPS' and bec_subzone in('xc','mc','dc','mk')) or (bec_zone_code = 'IDF' and bec_subzone in('dk','dc','mw','dw','ww')) or (bec_zone_code = 'MS' and bec_subzone in('xc','xk','dv','dm', 'dk', 'dc'))) THEN 3
                               WHEN  (SPECIES_CD_1 LIKE 'SW%'  or SPECIES_CD_2 LIKE 'SW%' or  SPECIES_CD_3 LIKE 'SW%') and ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 4
                               WHEN  (SPECIES_CD_1 LIKE 'SB%'  or SPECIES_CD_2 LIKE 'SB%' or  SPECIES_CD_3 LIKE 'SB%')  and ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 5
                               ELSE 0
                               END as region from public.veg_comp_lyr_r1_poly2020 where bec_zone_code in ('SBS', 'IDF', 'MS', 'SBPS', 'BWBS')")
...
mov<-getSpatialQuery("select shape, 
                          CASE WHEN (bec_zone_code = 'SBS' and bec_subzone in('wk','mk','mm','mw')) THEN 1
                               WHEN (bec_zone_code = 'SBS' and bec_subzone in ('dw','dh','dk')) THEN 2
                               WHEN ((bec_zone_code = 'SBPS' and bec_subzone in('xc','mc','dc','mk')) or (bec_zone_code = 'IDF' and bec_subzone in('dk','dc','mw','dw','ww')) or (bec_zone_code = 'MS' and bec_subzone in('xc','xk','dv','dm', 'dk', 'dc'))) THEN 3
                               WHEN ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 4
                               WHEN ((bec_zone_code = 'BWBS' and bec_subzone in ('dk', 'mw', 'mk', 'wk')) or (bec_zone_code ='SBS' and bec_subzone = 'wk' and bec_variant ='2')) THEN 5
                               ELSE 0
                               END as region from public.veg_comp_lyr_r1_poly2020 where bec_zone_code in ('SBS', 'IDF', 'MS', 'SBPS', 'BWBS')")

mov.ras<-fasterize::fasterize(sf= mov, raster = ProvRast , field = "region")
writeRaster(mov.ras, "mov.tif", overwrite = T)
```
