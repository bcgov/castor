...
#set all to 0 in the raster as nor harvest
...
### 6-333 Caribou
Primary forestry activties will focus in-block retention to include key cariobu features and provide sufficient forest retention to proviode visual screening. Within the Bulkley TSA: >60% of the SBSmc > 80 years,  < 28% of SBSmc < 40 year, > 45 % of SBSdk > 80 years, < 39% of SBSdk < 40 years. Within the Morice TSA: > 17% of SBSmc > 140 years, < 48 SBSmc < 40 years, > 8 % of SBSdk > 140 years, < 64% of SBSdk < 40 years  see http://www.env.gov.bc.ca/wld/documents/wha/RATA_6-333_ord_replaced_2018.pdf and http://www.env.gov.bc.ca/wld/documents/wha/RATA_6-333_amend_2018.pdf
```{r, w6333}
wha_tags<-c('6-333')
...
#9-073, 9-144 and 9-145 operational constraints --assumed by the model
...
system("cmd.exe", input = paste0('raster2pgsql -s 3005 -d -I -C -M -N 2147483648  ', here(), '/wha.tif -t 100x100 rast.zone_wha | psql -d clus'), show.output.on.console = FALSE, invisible = TRUE)
