...
dbExecute(conn, "ALTER TABLE public.zone_nharv_gbr INHERIT zone_constraints_gbr")
...
dbExecute(conn, "ALTER TABLE zone_cond_art INHERIT zone_constraints_gbr")#Note from uwr_cond_harvest.rmd
dbDisconnect(conn)
```
