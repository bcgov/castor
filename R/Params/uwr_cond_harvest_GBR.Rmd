...
zone_uwr<-data.table(zoneid=0, type='nh', variable='', threshold=0, reference_zone='rast.zone_cond_uwr_gbr', percentage=0, ndt=0, label = 'uwr no harvest')
...
u3003_table<-data.table(zoneid =zoneid_new, reference_zone ='rast.zone_cond_uwr_gbr', variable ='crownclosure', type = 'ge', percentage = 33, threshold = 46, ndt = 0, label = 'u-3-003')
...
u3004_table[feat_notes == "Corridor", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 33, threshold = 40, ndt =0, label = 'u-3-004')]
...
u3004_table[feat_notes == "Modified Harvest", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 33, threshold = 140, ndt =0, label = 'u-3-004')]
...
u3006_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 66, threshold = 30, ndt =0, label = 'u-3-006')]
...
u4001_table[feat_notes == "Elk; ICHdw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 81, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Elk; ICHmw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 101, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Foraging area", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 81, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Moose; moderate snow", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 61, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Mule Deer; ICHdw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 81, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Mule Deer; ICHmw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 40, threshold = 101, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Mule Deer; ICHwk", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 40, threshold = 101, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "Mule Deer; ICHxw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 81, ndt =0, label = 'u-4-001')]

u4001_table[feat_notes == "White-tailed Deer; ICHdw", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 40, threshold = 81, ndt =0, label = 'u-4-001')]
...
u4006_table[feat_notes == "MANAGED FOREST DRY", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 99, ndt =0, label = 'u-4-006')]

u4006_table[feat_notes == "MANAGED FOREST MESIC", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 60, ndt =0, label = 'u-4-006')] # if want to be more restrictive use 20% >100 years

u4006_table[feat_notes == "MANAGED FOREST MOIST", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 60, ndt =0, label = 'u-4-006')] 

u4006_table[feat_notes == "MANAGED FOREST TRANSITION", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 60, ndt =0, label = 'u-4-006')] # if want to be more restrictive use >100 years

u4006_table[feat_notes == "MANAGED FOREST WET", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 60, ndt =0, label = 'u-4-006')] 
...
u4008_table[feat_notes == "MANAGED FOREST DRY", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 99, ndt =0, label = 'u-4-008')]

u4008_table[feat_notes == "MANAGED FOREST MESIC", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 60, ndt =0, label = 'u-4-008')] # if want to be more restrictive use 20% >100 years

u4008_table[feat_notes == "MANAGED FOREST MOIST", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 60, ndt =0, label = 'u-4-008')] 

u4008_table[feat_notes == "MANAGED FOREST TRANSITION", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 10, threshold = 60, ndt =0, label = 'u-4-008')] # if want to be more restrictive use >100 years

u4008_table[feat_notes == "MANAGED FOREST WET", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 60, ndt =0, label = 'u-4-008')] 

#Remove these planning cells
#u4008_table[feat_notes == "OPEN FOREST", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-4-008')] # no constraint
#u4008_table[feat_notes == "OPEN RANGE", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-4-008')] # no constraint
uwr_cond_harvest<-uwr_cond_harvest[!(uwr_cond_harvest$feat_notes %in% c('OPEN RANGE','OPEN FOREST' )),]
...
#u4010_table[feat_notes == "Caribou Management Zone 1", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-4-010')] # no harvest

u4010_table[feat_notes %in% c("Caribou Management Zone 5","Caribou Management Zone 6"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 70, threshold = 80, ndt =0, label = 'u-4-010')]

u4010_table[feat_notes == "Caribou Management Zone 7", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 40, threshold = 80, ndt =0, label = 'u-4-010')]

u4010_table[feat_notes == "Caribou Management Zone 8", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 80, ndt =0, label = 'u-4-010')]
...
u6009_table [feat_notes %in% c(NA, "Island Habitat"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-009')]
...
u6014_table [, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-014')]
...
u6018_table [, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-018')]
...
u7001_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 50, threshold = 50, ndt =0, label = 'u-7-001')]
...
u7002_table[unit_no %in% c("1","2","3","4","5","11","12","14"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 56, ndt =0, label = 'u-7-002')]
#assign the 66%threshold
u7002_table[unit_no %in% c("9","10","15","16","17","18"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 50, threshold = 66, ndt =0, label = 'u-7-002')]
...
u7003_table[manage == "Medium", `:=`(variable = 'height', type = 'ge', reference_zone = 'rast.zone_cond_uwr_gbr', percentage =70, threshold = 5, ndt = 0, label = 'u-7-003' )]
...
u7003_table[manage == "Corridor", `:=`(variable = 'age', type = 'ge', reference_zone = 'rast.zone_cond_uwr_gbr', percentage =20, threshold = 100, ndt = 0, label = 'u-7-003' )]
...
u7005_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 40, ndt =0, label = 'u-7-005')]
...
u7007_table<-data.table(zoneid =zoneid_new2, reference_zone ='rast.zone_cond_uwr_gbr', variable ='age', type = 'ge', percentage =50 , threshold = 70, ndt = 0, label = 'u-7-007')
...
u7008_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 40, ndt =0, label = 'u-7-008')]
...
u7009_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 80, threshold = 3, ndt =0, label = 'u-7-009')]
...
u7010_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 50, threshold = 66, ndt =0, label = 'u-7-010')]
...
#assign all
u7011_table[unit_no %in% c("VD-004","VD-003","VD-007"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 56, ndt =0, label = 'u-7-011')]
#assign the 66%threshold
u7011_table[unit_no %in% c("VD-005","VD-006","VD-001","VD-002"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 66, ndt =0, label = 'u-7-011')]
...
u7012_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 50, threshold = 140, ndt =0, label = 'u-7-012')]
...
#assign all
u7013_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 56, ndt =0, label = 'u-7-015')]
#assign the 66%threshold
u7013_table[unit_no %in% c("PGD-001","PGD-002","PGD-012","PGD-014","PGD-019","PGD-020",
                           "PGD-021","PGD-022","PGD-035","PGD-054","PGD-066"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 40, threshold = 66, ndt =0, label = 'u-7-013')]
...
#SPC-009 - Primary forestry activites will all for 33% of area less than 3 meters
u7015_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 50, threshold = 140, ndt =0, label = 'u-7-015')]
...
u7017_table[, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'crownclosure', type = 'ge', percentage = 45, threshold = 40, ndt =0, label = 'u-7-017')]
...
u8001_table[,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 33, threshold = 140, ndt =0, label = 'u-8-001')]
...
u8005_table[,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 50, threshold = 100, ndt =0, label = 'u-8-005')]
...
u8006_table[,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 33, threshold = 16, ndt =0, label = 'u-8-006')]
...
u8007_table[,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 33, threshold = 16, ndt =0, label = 'u-8-007')]
...
u8008_table [feat_notes %in% c("pcell#6", "pcell#8", "pcell#10", "pcell#17", "pcell#30", "pcell#50", "pcell#53", "pcell#66"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 15, threshold = 101, ndt =0, label = 'u-8-008')]
setnames (u8008_table, "ogc_fid", "zoneid")

u8008_table [feat_notes %in% c("pcell#1", "pcell#2", "pcell#3", "pcell#4", "pcell#5", "pcell#7", "pcell#9", "pcell#11", "pcell#12", "pcell#13", "pcell#14", "pcell#15", "pcell#16", "pcell#20", "pcell#21", "pcell#22", "pcell#23", "pcell#24", "pcell#25", "pcell#26", "pcell#27", "pcell#28", "pcell#29", "pcell#31", "pcell#32", "pcell#33", "pcell#34", "pcell#35", "pcell#36", "pcell#37", "pcell#38", "pcell#39", "pcell#40", "pcell#41", "pcell#42", "pcell#43", "pcell#44", "pcell#46", "pcell#47", "pcell#48", "pcell#49", "pcell#52", "pcell#54", "pcell#60", "pcell#61", "pcell#63", "pcell#64", "pcell#65", "pcell#68", "pcell#70", "pcell#73", "pcell#74", "pcell#80", "pcell#81", "pcell#87", "pcell#88"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 101, ndt =0, label = 'u-8-008')]

u8008_table [feat_notes %in% c("pcell#18", "pcell#56", "pcell#57", "pcell#58", "pcell#59", "pcell#62", "pcell#67", "pcell#72", "pcell#77", "pcell#78", "pcell#79", "pcell#84", "pcell#85", "pcell#86"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 25, threshold = 101, ndt =0, label = 'u-8-008')]

u8008_table [feat_notes %in% c("pcell#19", "pcell#55", "pcell#69", "pcell#71"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 30, threshold = 101, ndt =0, label = 'u-8-008')]

u8008_table [feat_notes %in% c("pcell#51", "pcell#82", "pcell#83"), `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 40, threshold = 101, ndt =0, label = 'u-8-008')]
...
u8009_table [ ,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 50, threshold = 16, ndt =0, label = 'u-8-009')]
...
u8012_table [, `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 70, threshold = 100, ndt =0, label = 'u-8-012')] # no harvest
...
u9001_table [ ,`:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 20, threshold = 110, ndt =0, label = 'u-9-001')]
...
#SPC-009 - Primary forestry activites will all for 33% of area less than 3 meters
u9002_table[unit_no == "SPC-009", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'height', type = 'ge', percentage = 33, threshold = 3, ndt =0, label = 'u-9-002')]

#SPC-018 - Retain 60% of pine stands > 60 years. Making this equalvent to keep 60% of the zone > 60 years
u9002_table[unit_no == "SPC-018", `:=`(reference_zone = 'rast.zone_cond_uwr_gbr', variable = 'age', type = 'ge', percentage = 60, threshold = 60, ndt =0, label = 'u-9-002')]
