...
#upload to db
system("cmd.exe", input = paste0('raster2pgsql -s 3005 -d -I -C -M -N 2147483648  ', here(), '/R/params/criticalhabitat.tif -t 100x100 rast.crithabitat | psql -d clus'), show.output.on.console = FALSE, invisible = TRUE)
```
