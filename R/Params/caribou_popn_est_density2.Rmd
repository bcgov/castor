...
#Final
data.all<-data.set[, c("herd_name", "year", "core.cut80r50.per","matrix.cut80r50.per", "core.area", "matrix.road50.per","core.road50.per", "pop_estimate")]
...
expo.null.1 <- nlme(pop_estimate~exp(N0), fixed =list(N0~1), random= N0~1|herd_name,   weights = varExp(form=~pop.0), start =list(fixed=c(N0=4.5)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.null.1) 
report(expo.null.1)
...
expo.total.road50.1 <- nlme(pop_estimate~ exp(a+b*total.road50.per), fixed =list(a~1, b~1), random= a+b~1|herd_name,weights = varExp(form=~herd.size), start =list(fixed=c(a=6, b=-0.4)), data = model.data, method = 'REML', control = c(maxIter = 100000))
summary(expo.total.road50.1) 
report(expo.total.road50.1)
cor(predict(expo.total.road50.1, level=0), model.data$pop_estimate)

expo.total.road50.1 <- nlme(pop_estimate~ exp(a+b*herd.size + c*total.road50.per), fixed =list(a~1, b~1, c~1), random= c~1|herd_name,weights = varExp(form=~herd.size),correlation= corAR1(form=~time|herd_name), start =list(fixed=c(a=6, b=0.4, c=-0.4)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.road50.1)
report(expo.total.road50.1)

expo.road50.0 <- nlme(pop_estimate~ exp(a+b*herd.size + c*core.road50.per + d*matrix.road50.per), fixed =list(a~1, b~1,c~1, d~1), random= c~1|herd_name, correlation = corAR1(form=~time|herd_name), weights = varExp(form=~herd.size), start =list(fixed=c(a=6, b=0.4, c=-0.04, d=-0.04)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.road50.0)
report(expo.road50.0)
anova(expo.road50.0 ,expo.total.road50.1)
...
expo.road50.s <- nlme(pop_estimate~ exp(a+b*herd.size + c*s.core.road50.per + d*s.matrix.road50.per), fixed =list(a~1, b~1,c~1, d~1), random= c~1|herd_name, correlation = corAR1(form=~time|herd_name), weights = varExp(form=~herd.size), start =list(fixed=c(a=6, b=0.4, c=-0.04, d=-0.04)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.road50.s) 
report(expo.road50.s)

#Total Road 500
start.total.road500<-nls(pop_estimate  ~ exp(a+b*herd.size + c*total.road500.per), start=list(a=4, b=1.2, c= -0.04), data=model.data, nls.control(maxiter = 1000))
expo.total.road500.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*total.road500.per),fixed =list(a~1,b~1,c~1), weights= varExp(form=~herd.size), correlation = corAR1(form=~time|herd_name), random= c~1|herd_name, start =list(fixed=coef(start.total.road500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
start.road500<-nlsLM(pop_estimate~exp(a+b*herd.size + c*core.road500.per+d*matrix.road500.per) ,start=list(a=3.5, b=1.2, c= -0.009,d=-0.005), data=model.data)
expo.road500.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*core.road500.per+d*matrix.road500.per), fixed =list(a~1,b~1,c~1,d~1), weights= varExp(form=~herd.size), correlation = corAR1(form=~time|herd_name), random= d~1|herd_name, start =list(fixed=c(a=2.4, b=1.2, c=-0.002, c=-0.002)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.road500.1) 
report(expo.road500.1)

AICc(expo.null.1, expo.road500.1, expo.total.road500.1,expo.road50.0, expo.total.road50.1)
...
```{r}
#Total cut10-40
start.total.cut10_40<-nlsLM(pop_estimate~exp(a+b*herd.size+ c*total.cut10_40.per) ,start=list(a=4,b=1.3, c=-0.002), data=model.data, control = nls.lm.control(maxiter=100))
expo.total.cut10_40.1 <- nlme(pop_estimate~exp(a+b*herd.size+ c*total.cut10_40.per), fixed =list(a~1, b~1,c~1),  random= c~1|herd_name, weights=varExp(form=~herd.size), correlation = corAR1(form=~time),start =list(fixed=coef(start.total.cut10_40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40.1) 
report(expo.total.cut10_40.1)

#Core and Matrix cut10_40
start.cut10_40<-nlsLM(pop_estimate  ~ exp(a+b*herd.size + c*core.cut10_40.per+d*matrix.cut10_40.per) ,start=list(a=4, b=1.2, c=-0.001, d =-0.001), data=model.data)
expo.cut10_40.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*core.cut10_40.per+d*matrix.cut10_40.per), fixed =list(a~1, b~1,c~1,d~1),  random= c~1|herd_name,weights=varExp(form=~herd.size), correlation = corAR1(form=~time),  start =list(fixed=coef(start.cut10_40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut10_40.1) 
report(expo.cut10_40.1)

#Cut40
start.total.cut40<-nlsLM(pop_estimate  ~ exp(a+b*herd.size + c*total.cut40.per) ,start=list(a=5, b=1.5, c=-0.001), data=model.data)
expo.total.cut40.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*total.cut40.per), fixed =list(a~1,b~1,c~1), weights=varExp(form=~herd.size), correlation = corAR1(form = ~time), random= c~1|herd_name, start =list(fixed=coef(start.total.cut40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40.1) 
report(expo.total.cut40.1)

#Core and Matrix cut40
start.cut40<-nls(pop_estimate~exp(a+b*herd.size + c*core.cut40.per+d*matrix.cut40.per) ,start=list(a=4, b=1.5, c=-0.001, d=-0.0001), data=model.data)
expo.cut40.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*core.cut40.per+d*matrix.cut40.per), fixed =list(a~1,b~1,c~1,d~1), weights=varExp(form=~herd.size), random=c~1|herd_name, correlation = corAR1(form = ~time), start =list(fixed=coef(start.cut40)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40.1) 
report(expo.cut40.1)

#Cut80
start.total.cut80<-nls(pop_estimate~exp(a+b*herd.size+c*total.cut80.per) ,start=list(a=5, b=1.7, c=-0.001), data=model.data)
expo.total.cut80.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*total.cut80.per), fixed =list(a~1,b~1,c~1),  weights=varExp(form=~herd.size), random= c~1|herd_name, correlation = corAR1(form=~time), start =list(fixed=coef(start.total.cut80)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80.1)
report(expo.total.cut80.1)

#Core and Matrix cut80
start.cut80<-nls(pop_estimate~exp(a+b*herd.size + c*core.cut80.per+d*matrix.cut80.per) ,start=list( a=6, b= 1.3, c=-0.01, d=-0.009), data=model.data)
expo.cut80.1 <- nlme(pop_estimate~exp(a+b*herd.size + c*core.cut80.per+d*matrix.cut80.per), fixed =list(a~1,b~1,c~1,d~1), weights=varExp(form=~herd.size), correlation = corCAR1(form=~time), random= d~1|herd_name, start =list(fixed=coef(start.cut80)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
expo.cut80.s <- nlme(pop_estimate~exp(a+b*herd.size + c*s.core.cut80.per+d*s.matrix.cut80.per), fixed =list(a~1,b~1,c~1,d~1), weights=varExp(form=~herd.size), random= c~1|herd_name, start =list(fixed=coef(start.cut80)), data = model.data, method = 'REML', control = c(maxIter = 100000))
...
```{r}
#Cut10_40r50
start.total.cut10_40r50<-nls(pop_estimate ~ exp(a+b*herd.size + c*total.cut10_40r50.per)  ,start=list(a=3, b=1.2, c=-0.004), data=model.data)
expo.total.cut10_40r50.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*total.cut10_40r50.per), fixed =list(a~1,b~1,c~1), weights= varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.total.cut10_40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40r50.1) 
report(expo.total.cut10_40r50.1)

#Core and Matrix cut10_40r50
start.cut10_40r50<-nls(pop_estimate~exp(a+b*herd.size + c*core.c10_40r50.per+d*matrix.c10_40r50.per) ,start=list(a=4, b=1.2, c=-0.001,d=-0.001), data=model.data)
expo.cut10_40r50.1 <- nlme(pop_estimate  ~ exp(a+b*herd.size + c*core.c10_40r50.per+d*matrix.c10_40r50.per), fixed =list(a~1,b~1,c~1,d~1), weights= varExp(form=~herd.size), random= d~1|herd_name, correlation = corAR1(form=~time), start =list(fixed=coef(start.cut10_40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
#Total Cut10_40r500
start.total.cut10_40r500<-nls(pop_estimate~exp(a+b*herd.size + c*total.cut10_40r500.per),start=list(a=4, b=1.2, c=-0.0002), data=model.data)
expo.total.cut10_40r500.1 <- nlme(pop_estimate~exp(a+b*herd.size + c*total.cut10_40r500.per), fixed =list(a~1,b~1,c~1), weights= varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.total.cut10_40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut10_40r500.1) 
report(expo.total.cut10_40r500.1)

#Core and Matrix cut10_40r500
start.cut10_40r500<-nls(pop_estimate~exp(a+b*herd.size + c*core.c10_40r500.per+d*matrix.c10_40r500.per), start=list(a=3, b=1.2, c=-0.001, d=-0.0097), data=model.data)
expo.cut10_40r500.1 <- nlme(pop_estimate~exp(a+b*herd.size + c*core.c10_40r500.per+d*matrix.c10_40r500.per), fixed =list(a~1,b~1, c~1,d~1),  weights= varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.cut10_40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut10_40r500.1) 
report(expo.cut10_40r500.1)

#Total Cut40r50
start.total.cut40r50<-nls(pop_estimate~exp(a+b*herd.size+c*total.cut40r50.per) ,start=list(a=4,b=1.2, c=-0.002), data=model.data)
expo.total.cut40r50.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*total.cut40r50.per), fixed =list(a~1,b~1,c~1), weights= varExp(form=~herd.size),correlation = corAR1(form=~time),random= c~1|herd_name, start =list(fixed=coef(start.total.cut40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40r50.1) 
report(expo.total.cut40r50.1)

#Core and Matrix cut40r50
start.cut40r50<-nls(pop_estimate  ~exp(a+b*herd.size+c*core.cut40r50.per+d*matrix.cut40r50.per) ,start=list( a=4, b=1.5, c=-0.001, d=-0.001), data=model.data)
expo.cut40r50.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*core.cut40r50.per+d*matrix.cut40r50.per), fixed =list(a~1,b~1,c~1,d~1), weights=varExp(form=~herd.size), correlation = corAR1(form=~time),random= c~1|herd_name, start =list(fixed=coef(start.cut40r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40r50.1) 
report(expo.cut40r50.1)

#Total Cut40r500
start.total.cut40r500<-nls(pop_estimate~exp(a+b*herd.size+c*total.cut40r500.per) ,start=list( a=4, b=1.3, c=-0.002), data=model.data)
expo.total.cut40r500.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*total.cut40r500.per), fixed =list(a~1,b~1,c~1), weights=varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.total.cut40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut40r500.1) 
report(expo.total.cut40r500.1)
#Core and Matrix cut40r500
start.cut40r500<-nls(pop_estimate~exp(a+b*herd.size+c*core.cut40r500.per+d*matrix.cut40r500.per), start=list(a=4, b=1.2, c=-0.001, d=-0.002), data=model.data)
expo.cut40r500.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*core.cut40r500.per+d*matrix.cut40r500.per), fixed =list(a~1,b~1,c~1,d~1),weights=varExp(form=~herd.size), random= c~1|herd_name, correlation = corAR1(form=~time),start =list(fixed=coef(start.cut40r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut40r500.1) 
report(expo.cut40r500.1)


#Cut80r50
start.total.cut80r50<-nls(pop_estimate~exp(a+b*herd.size+c*total.cut80r50.per) ,start=list(a=3, b=1.2, c=-0.002), data=model.data)
expo.total.cut80r50.1 <- nlme(pop_estimate~exp(a+b*herd.size+c*total.cut80r50.per), fixed =list(a~1, b~1,c~1), weights=varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.total.cut80r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80r50.1) 
report(expo.total.cut80r50.1)

#Core and Matrix cut80r50
start.cut80r50<-nls(pop_estimate~exp(a+b*herd.size + c*core.cut80r50.per+d*matrix.cut80r50.per),start=list(a=5, b=1.2, c=-0.001, d=-0.002), data=model.data)
expo.cut80r50.1 <- nlme(pop_estimate~exp(a+b*herd.size + c*core.cut80r50.per+d*matrix.cut80r50.per), fixed =list(a~1,b~1,c~1,d~1), weights=varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.cut80r50)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.cut80r50.1) 
report(expo.cut80r50.1)


#Cut80r500
start.total.cut80r500<-nls(pop_estimate~exp(a+b*herd.size+ c*total.cut80r500.per) ,start=list(a=5,b=1.2, c=-0.002), data=model.data)
expo.total.cut80r500.1 <- nlme(pop_estimate~exp(a+b*herd.size+ c*total.cut80r500.per), fixed =list(a~1,b~1,c~1), weights=varExp(form=~herd.size),correlation = corAR1(form=~time),random= c~1|herd_name, start =list(fixed=coef(start.total.cut80r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
summary(expo.total.cut80r500.1) 
report(expo.total.cut80r500.1)

#Core and Matrix cut80r500
start.cut80r500<-nls(pop_estimate~exp(a+b*herd.size + c*core.cut80r500.per+d*matrix.cut80r500.per), start=list(a=5, b=1.2,c=-0.001, d=-0.0002), data=model.data)
expo.cut80r500.1 <- nlme(pop_estimate~exp(a+b*herd.size + c*core.cut80r500.per+d*matrix.cut80r500.per), fixed =list(a~1,b~1,c~1,d~1),  weights= varExp(form=~herd.size), correlation = corAR1(form=~time), random= c~1|herd_name, start =list(fixed=coef(start.cut80r500)), data = model.data, method = 'ML', control = c(maxIter = 100000))
...
#Summary
```{r}
AICc(expo.null.1, expo.road50.0, expo.total.road50.1,expo.road500.1, expo.total.road500.1,expo.cut10_40.1, expo.total.cut10_40.1, expo.cut40.1, expo.total.cut40.1,expo.cut80.1, expo.total.cut80.1, expo.total.cut10_40r50.1,expo.cut10_40r50.1,expo.total.cut10_40r500.1,expo.cut10_40r500.1,expo.total.cut40r50.1,expo.cut40r50.1,
     expo.total.cut40r500.1,expo.cut40r500.1,expo.total.cut80r50.1,expo.cut80r50.1,expo.total.cut80r500.1,expo.cut80r500.1)
...
summary(update(expo.road50.0, method = 'REML'))
...
```{r, obs_pred}
par(mfrow=c(2,2))
plot(predict(expo.road50.0, level =1), model.data$pop_estimate, title= '', ylab = 'Observed', xlab = 'Predicted')
abline(0,1, col = 'red')
plot(predict(expo.road50.0, level =1), residuals(expo.road50.0, type= 'normalized'), title= '', ylab = 'Normalized Residuals', xlab = 'Predicted')
abline(0,0, col = 'red')
acf(residuals(expo.road50.0,  type= 'normalized'), main = '')
hist(residuals(expo.road50.0,  type= 'normalized') , freq = FALSE,main = '', xlab = 'Normalized Residuals')
curve(dnorm(x,0, sd(residuals(expo.road50.0,  type= 'normalized'))), add=T)
...
mean.matrix$pop.pred<- predict(expo.road50.0, newdata = mean.matrix, level =0) 
...
mean.core$pop.pred<- predict(expo.road50.0, newdata = mean.core, level =0) 
...
raw.data<-model.data[, c("core.road50.per","matrix.road50.per", "pop_estimate", "herd_name", "herd.size")]
raw.data$pop.pred<-predict(expo.road50.0)
raw.data1<-raw.data[, c("core.road50.per", "pop_estimate", "herd_name", "pop.pred", "herd.size")]
raw.data1$type = 'Core'
setnames(raw.data1, "core.road50.per", "R50")
raw.data2<-raw.data[, c("matrix.road50.per", "pop_estimate", "herd_name","pop.pred", "herd.size")]
raw.data2$type = 'Matrix'
setnames(raw.data2, "matrix.road50.per", "R50")
fig.data2<-rbind(fig.data, raw.data1,raw.data2 )
ggplotly(ggplot(data = fig.data2, aes(x = R50, y = pop_estimate, colour = factor(herd_name))) +
...
data.threshold[,herd.size:=0]
data.threshold[core.area> 224000,herd.size:=1]
data.threshold$pred<-predict(expo.road50.1, data.threshold,level=1)
data.threshold<-data.threshold[!is.na(pred),]
ggplotly(ggplot(data=data.threshold[,c("herd_name", "pred", "year", "pop_estimate")], aes(x=year, y= pred, group = herd_name, color = herd_name)) + 
           scale_y_continuous(limits=c(0,500))+
  geom_line() +
  geom_point(aes(y=pop_estimate)))
sum(data.threshold[year==2020 , ]$pred)
```
