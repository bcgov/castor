...
```{r, ras_current}
current<- getSpatialQuery("select shape, feature_id*-1 as feature_id from veg_comp_lyr_r1_poly2019 where feature_id in (select distinct(feature_id) from tipsy_current_prov_2020);")
