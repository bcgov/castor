...
bh_herds2[core.dist500.rate == -0.1, core:='Core = -0.1']
bh_herds2[core.dist500.rate == 0, core:='Core = 0']
bh_herds2[core.dist500.rate == 0.1, core:='Core = 0.1']
bh_herds2[core.dist500.rate == 0.3, core:='Core = 0.3']
...
fig4<-ggplot(data = bh_herds2,aes(x = matrix.dist500.rate, y = pred, color = herd_name)) +
  ...
  theme_bw() +
  labs(y = expression(paste("Population trend ", italic("r"))), x = "Matrix")+
  guides(color=guide_legend(title = "Herd"))
fig4
