...
m0.d <- lme(lambda.dif ~ 1 , random=~ 1|herd_name, correlation = corAR1(value = 0.8, form = ∼1|herd_name), data = model.data, method = 'ML', control = con1)
...
#---PERCENTAGE---
burn.per <- lme(lambda.dif ~ 1 + core.burn40.per*matrix.burn40.per, random=~ 1|herd_name, correlation = corAR1(0.8, form = ~1|herd_name), data = model.data, method = 'ML', control = con1)
##Diagnostics
...
#---RATE----
burn.rate <- lme(lambda.dif ~ 1 + core.burn40.rate*matrix.burn40.rate, random=~ 1|herd_name,  correlation = corAR1(0.8, form = ~1|herd_name), data = model.data, method = 'ML', control = con1)
##Diagnostics
...
```{r, eary_seral}
#---Percentage---
early.seral.per<- lme(lambda.dif ~ core.early.seral.per*matrix.early.seral.per, random=~ 1|herd_name, method = 'ML', correlation = corAR1(0.3, form =~1|herd_name), data = model.data, control = con1)
##Diagnostics
...
#---Rate---
early.seral.rate<- lme(lambda.dif ~  core.early.seral.rate*matrix.early.seral.rate, random=~ 1|herd_name, method = 'ML', correlation = corAR1(0.3, form =~1|herd_name), data = model.data, control = con1)
##Diagnostics
...
```{r, dist}
#---Percentage---
dist.per<- lme(lambda.dif ~ core.dist.per*matrix.dist.per, random=~ 1|herd_name, method = 'ML', correlation = corAR1(0.3, form =~1|herd_name), data = model.data, control = con1)
...
abline(0,0, col = 'red')
cor(fitted(dist.per, level =1),model.data$lambda.dif) #0.809
plot(model.data$lambda.dif~fitted(dist.per))
abline(0,1, col = "red")
abline(0,0, col = "yellow")
summary(dist.per)

#---Rate---
dist.rate<- lme(lambda.dif ~ core.dist.rate*matrix.dist.rate, random=~ 1|herd_name,method = 'ML', correlation = corAR1(0.3, form =~1|herd_name), data = model.data, control = con1)
...
abline(0,0, col = 'red')
cor(fitted(dist.rate, level =1),model.data$lambda.dif) #0.876
plot(model.data$lambda.dif~fitted(dist.rate))
abline(0,1, col = "red")
abline(0,0, col = "yellow")
summary(dist.rate)
...
```{r, dist500}
#---Percentage---
dist500.per<- lme(lambda.dif ~ core.dist500.per*matrix.dist500.per, random=~ 1|herd_name, method = 'ML', correlation = corAR1(0.3, form =~1|herd_name),data = model.data, control = con1)
...
#---Rate---
dist500.rate<- lme(lambda.dif ~ core.dist500.rate*matrix.dist500.rate,random=~ 1|herd_name, method = 'ML', correlation = corAR1(0.3, form =~1|herd_name), data = model.data, control = con1)
...
rsf.rate<- lme(lambda.dif~ core.rsf.rate*matrix.rsf.rate,random=~ 1|herd_name, 
