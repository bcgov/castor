...
#Corridor - maintain 33% of suitable cariobu habitat. Equating to 33% of the area greater than 40 %canopy closure for incercepting snow
...
u4006_table[feat_notes == "OPEN FOREST", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-4-006')] # no constraint

u4006_table[feat_notes == "OPEN RANGE", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-4-006')] # no constraint
...
u4012_table[feat_notes == "Restricted Harvest - amended November 2010", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-4-012')] #  no harvest

u4012_table[,feat_notes:=NULL]
setnames(u4012_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u4012_table)

rm(u4012_table,u4012)
gc()
```
...
u4013_table[feat_notes == "Restricted Harvest - amended November 2010", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-4-013')] #  no harvest

u4013_table[,feat_notes:=NULL]
setnames(u4013_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u4013_table)

rm(u4013_table,u4013)
gc()
```
...
u4014_table[feat_notes == "Restricted Harvest - amended November 2010", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-4-014')] #  no harvest

u4014_table[,feat_notes:=NULL]
setnames(u4014_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u4014_table)

rm(u4014_table,u4014)
gc()
```
...
u5_table<-data.table(u3004)[,c("ogc_fid", "feat_notes")]
...
u5_table[feat_notes == "Modified Harvest", `:=`(reference_zone = 'rast.zone_uwr', variable = 'basalarea125', type = 'ge', percentage = 100, threshold = 22, ndt =0, label = 'u-5-001, u-5-002, u-5-003')] # NOTE: Basal area constraint allowed?; if not, then let's classify this one as "can't be modeled"; I think as long as in the model thsat Doug Fir is replanted where it was harvested then we are meetign the intent of the order
...
u6009_table <- data.table (u6009) [,c("ogc_fid")]

u6009_table [feat_notes %in% c("", "Island Habitat"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-01')]
...
u6014_table [feat_notes %in% c("", "Island Habitat"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-01')]
...
u6018_table [feat_notes == "Ungulate Winter Range", `:=`(reference_zone = 'rast.zone_uwr', variable = 'crownclosure', type = 'ge', percentage = 30, threshold = 51, ndt =0, label = 'u-6-01')]
...
u8004_table[`:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-8-004')]

u8004_table[,unit_no := NULL]
setnames(u8004_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u8004_table)
rm(u8004_table, u8004)
gc()
```
...
u8008_table<-data.table(u8008)[,c("ogc_fid", "unit_no")]
...
u8008_table [feat_notes %in% c("pcell#6", "pcell#8", "pcell#10", "pcell#17", "pcell#30", "pcell#50", "pcell#53", "pcell#66"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 15, threshold = 101, ndt =0, label = 'u-6-01')]
setnames (u8008_table, "ogc_fid", "zoneid")

u8008_table [feat_notes %in% c("pcell#1", "pcell#2", "pcell#3", "pcell#4", "pcell#5", "pcell#7", "pcell#9", "pcell#11", "pcell#12", "pcell#13", "pcell#14", "pcell#15", "pcell#16", "pcell#20", "pcell#21", "pcell#22", "pcell#23", "pcell#24", "pcell#25", "pcell#26", "pcell#27", "pcell#28", "pcell#29", "pcell#31", "pcell#32", "pcell#33", "pcell#34", "pcell#35", "pcell#36", "pcell#37", "pcell#38", "pcell#39", "pcell#40", "pcell#41", "pcell#42", "pcell#43", "pcell#44", "pcell#46", "pcell#47", "pcell#48", "pcell#49", "pcell#52", "pcell#54", "pcell#60", "pcell#61", "pcell#63", "pcell#64", "pcell#65", "pcell#68", "pcell#70", "pcell#73", "pcell#74", "pcell#80", "pcell#81", "pcell#87", "pcell#88"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 20, threshold = 101, ndt =0, label = 'u-6-01')]
setnames (u8008_table, "ogc_fid", "zoneid")

u8008_table [feat_notes %in% c("pcell#18", "pcell#56", "pcell#57", "pcell#58", "pcell#59", "pcell#62", "pcell#67", "pcell#72", "pcell#77", "pcell#78", "pcell#79", "pcell#84", "pcell#85", "pcell#86"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 25, threshold = 101, ndt =0, label = 'u-6-01')]
setnames (u8008_table, "ogc_fid", "zoneid")

u8008_table [feat_notes %in% c("pcell#19", "pcell#55", "pcell#69", "pcell#71"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 30, threshold = 101, ndt =0, label = 'u-6-01')]
setnames (u8008_table, "ogc_fid", "zoneid")

u8008_table [feat_notes %in% c("pcell#51", "pcell#82", "pcell#83"), `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 40, threshold = 101, ndt =0, label = 'u-6-01')]
setnames (u8008_table, "ogc_fid", "zoneid")
...
u8009_table<-data.table(u8009)[,c("ogc_fid", "unit_no")]

# >50% of at least 16 metres in height
u8009_table [ `:=`(reference_zone = 'rast.zone_uwr', variable = 'height', type = 'ge', percentage = 50, threshold = 16, ndt =0, label = 'u-6-01')]
setnames (u8009_table, "ogc_fid", "zoneid")

u8009_table[,feat_notes := NULL]
setnames(u8009_table, "ogc_fid", "zoneid")
...
u8010_table<-data.table(u8010)[,c("ogc_fid", "unit_no")]

# constraint is no road developemt, so set harvest to zero, unless timber accessed another way?
u8010_table [ `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-6-01')]
setnames (u8010_table, "ogc_fid", "zoneid")

u8010_table[,feat_notes := NULL]
setnames(u8010_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u8010_table)
rm(u8010_table, u8010)
gc()
```
...
u8012_table<-data.table(u8012)[,c("ogc_fid", "unit_no")]
...
# Here I used 100% retention

u8012_table [ `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-6-01')] # no harvest
setnames (u8012_table, "ogc_fid", "zoneid")

u8012_table[,feat_notes := NULL]
setnames(u8012_table, "ogc_fid", "zoneid")
...
u9001_table<-data.table(u9001)[,c("ogc_fid", "unit_no")]

# >=20% mature/old conifer-leading >=40% CC
# mature/old = 100 in BWBS and 120 in ESSF
# here I split the differnce and used 110 

u9001_table [ `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 20, threshold = 110, ndt =0, label = 'u-6-01')]

u9001_table[,unit_no := NULL]
...
u9004_table<-data.table(u9004)[,c("ogc_fid", "unit_no")]

# No real significant harvest contraints here
u9004_table[unit_no == "SPC-018", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-9-004')] # harvest allowed

u9004_table[,unit_no := NULL]
setnames(u9004_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u9004_table)
rm(u9004_table, u9004)
gc()
```
...
u9009_table<-data.table(u9009)[,c("ogc_fid", "unit_no")]

# No real significant harvest contraints here
u9009_table[unit_no == "SPC-018", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-9-009')] # harvest allowed

u9009_table[,unit_no := NULL]
setnames(u9009_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u9009_table)
rm(u9009_table, u9009)
gc()
```
...
u9010_table<-data.table(u9010)[,c("ogc_fid", "unit_no")]

# No real significant harvest contraints here
u9010_table[unit_no == "SPC-018", `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 0, ndt =0, label = 'u-9-010')] # harvest allowed

u9010_table[,unit_no := NULL]
setnames(u9010_table, "ogc_fid", "zoneid")

zone_uwr<-rbind(zone_uwr, u9010_table)
rm(u9010_table, u9010)
gc()
```
