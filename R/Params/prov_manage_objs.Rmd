...
system("cmd.exe", input = paste0('raster2pgsql -s 3005 -d -I -C -M ', here(), '/nharv.tif -t 100x100 rast.zone_c_nharv | psql -d clus'), show.output.on.console = FALSE, invisible = TRUE)
