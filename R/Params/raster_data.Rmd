...
## VEG COMP 2019 feature id 

This id links to polygon level attribution. 
```{r, veg_comp2019, echo = FALSE}
#Harvest locations year
layer<-getSpatialQuery("SELECT feature_id, shape FROM public.veg_comp_lyr_r1_poly2019")

layer.ras <-fasterize::fasterize(sf= layer, raster = ProvRast , field = "feature_id")
rm(layer)
gc()

writeRaster(layer.ras, file="tipsy2019_id.tif", format="GTiff", overwrite=TRUE)

system("cmd.exe", input = "raster2pgsql -s 3005 -d -I -C -M  C:/Users/KLOCHHEA/clus/R/Params/tipsy2019_id.tif -t 100x100 rast.vri2019_id | psql -d clus")
```
