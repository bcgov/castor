...
system("cmd.exe", input = "raster2pgsql -s 3005 -d -I -C -M  C:/Users/KLOCHHEA/clus/R/params/forest_tenure.tif -t 100x100 rast.forest_tenure | psql -d clus",invisible = TRUE, show.output.on.console = FALSE)
```