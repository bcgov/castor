...
data.table(layer=c('bc timber harvesting landbase', 'Coast timber harvesting landbase',
           ...
           public = c('bc_thlb'
                    , 'thlb_data_rco', 'thlb_data_sir', 'thlb_data_nir', 'f_own_polygon', 'cns_cut_bl_polygon' ,'veg_comp_lyr_r1_poly_final_spatialv2_2003', 'trim_ebm_waterbodies','trim_ebm_watercourses', 'caribou_boreal_study_area','du8_herds_buff25km','bec_zone'),
           rast = c('bc_thlb', 'thlb_rco_lyr2018','thlb_sir_lyr2018','thlb_nir_lyr2018', 'f_own', 'cns_cut_bl','veg_comp2003_id','waterbodies','watercourses', 'du6_bounds','du8_bounds', 'bec_zone'),
...
conn<-DBI::dbConnect(dbDriver("PostgreSQL"), host='localhost', dbname = 'clus', port='5432' ,user='app_user')
...
system("cmd.exe", input = "raster2pgsql -s 3005 -d -I -C -M  C:/Users/KLOCHHEA/clus/R/params/bec.tif -t 100x100 rast.bec_current | psql -d clus",invisible = TRUE, show.output.on.console = FALSE)
