...
```{r chilcotin study area}

studyarea <- getSpatialQuery ("SELECT tsa_name, wkb_geometry FROM study_area_chilcotin WHERE tsa_name IN ('Quesnel_TSA_Matrix', 'Quesnel_TSA_HEWSR', 'Quesnel_TSA_LESR', 'Quesnel_TSA_LEWR', 'Quesnel_TSA_out', 'Williams_Lake_TSA_HEWSR', 'Williams_Lake_TSA_LESR', 'Williams_Lake_TSA_LEWR', 'Williams_Lake_TSA_Matrix', 'Williams_Lake_TSA_out');")
