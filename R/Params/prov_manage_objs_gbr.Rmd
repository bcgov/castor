...
df_gbr1$reference_zone<-'rast.zone_cond_fsw'
...
df_gbr2$threshold<-0
df_gbr2$reference_zone<-'rast.zone_cond_fsw'
...
df_other$reference_zone<-'rast.zone_cond_fsw'
...
3. Biodiversity, Mining and Tourism areas 
...
df<-data.frame(type='nh', variable= '', threshold=0, reference_zone='rast.zone_nharv_grb',
