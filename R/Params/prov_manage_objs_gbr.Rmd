...
dbExecute(conn, "ALTER TABLE zone_nharv_grb INHERIT zone_constraints_gbr")
...
dbExecute(conn, "ALTER TABLE zone_art INHERIT zone_constraints_gbr") # defined in UBC_gbr_constraints.Rmd Its constraints for a small portion of GBR and related to a separate study.
dbDisconnect(conn)
```
