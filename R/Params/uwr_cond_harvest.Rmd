...
u8010_table [, `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-8-010')]
...
u8012_table [, `:=`(reference_zone = 'rast.zone_uwr', variable = 'age', type = 'ge', percentage = 100, threshold = 1, ndt =0, label = 'u-8-012')] # no harvest
...
writeRaster(uwr.ras, file="zone_uwr.tif", format="GTiff", overwrite=TRUE)

system("cmd.exe", input = paste0('raster2pgsql -s 3005 -d -I -C -M ', here(), '/R/params/zone_uwr.tif -t 100x100 rast.zone_uwr | psql -d clus'), show.output.on.console = FALSE, invisible = TRUE)
```
