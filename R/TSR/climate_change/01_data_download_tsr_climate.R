...
pgWriteRast (conn, c ("climate", "bec_2020s"), bec.2020, overwrite = TRUE)
bec.2050 <- raster ("bec\\BEC_zone_2050s.tif")
pgWriteRast (conn, c ("climate", "bec_2050s"), bec.2050, overwrite = TRUE)
bec.2080 <- raster ("bec\\BEC_zone_2080s.tif")
pgWriteRast (conn, c ("climate", "bec_2080s"), bec.2080, overwrite = TRUE)

# 'Currrent' climate data
ahm <- raster ("climate\\annual\\1981_2010\\ahm")
pgWriteRast (conn, c ("climate", "annual_heat_moisture_index_1981_2010"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\1981_2010\\dd_0")
pgWriteRast (conn, c ("climate", "degree_days_below_0_1981_2010"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\1981_2010\\dd5")
pgWriteRast (conn, c ("climate", "degree_days_above_5C_1981_2010"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\1981_2010\\emt")
pgWriteRast (conn, c ("climate", "extreme_min_temp_30_years_1981_2010"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\1981_2010\\ext")
pgWriteRast (conn, c ("climate", "extreme_max_temp_30_years_1981_2010"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\1981_2010\\map")
pgWriteRast (conn, c ("climate", "mean_annual_precip_mm_1981_2010"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\1981_2010\\mat")
pgWriteRast (conn, c ("climate", "mean_annual_temp_C_1981_2010"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\1981_2010\\mcmt")
pgWriteRast (conn, c ("climate", "mean_coldest_month_temp_1981_2010"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\1981_2010\\msp")
pgWriteRast (conn, c ("climate", "mean_may_to_sept_precip_mm_1981_2010"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\1981_2010\\mwmt")
pgWriteRast (conn, c ("climate", "mean_warmest_month_temp_1981_2010"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\1981_2010\\nffd")
pgWriteRast (conn, c ("climate", "number_frost_free_days_1981_2010"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\1981_2010\\pas")
pgWriteRast (conn, c ("climate", "precip_as_snow_Aug_to_July_1981_2010"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\1981_2010\\rh")
pgWriteRast (conn, c ("climate", "relative_humidity_1981_2010"), rh, overwrite = TRUE)

# CanESM2 model 'future' climate data
# 2011-2040
ahm <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\ahm")
pgWriteRast (conn, c ("climate", "annual_heat_moisture_index_canesm2_2011_2040"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\dd_0")
pgWriteRast (conn, c ("climate", "degree_days_below_0_canesm2_2011_2040"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\dd5")
pgWriteRast (conn, c ("climate", "degree_days_above_5C_canesm2_2011_2040"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\emt")
pgWriteRast (conn, c ("climate", "extreme_min_temp_30_years_canesm2_2011_2040"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_canesm2_2011_2040"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\map")
pgWriteRast (conn, c ("climate", "mean_annual_precip_mm_canesm2_2011_2040"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\mat")
pgWriteRast (conn, c ("climate", "mean_annual_temp_C_canesm2_2011_2040"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\mcmt")
pgWriteRast (conn, c ("climate", "mean_coldest_month_temp_canesm2_2011_2040"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\msp")
pgWriteRast (conn, c ("climate", "mean_may_to_sept_precip_mm_canesm2_2011_2040"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\mwmt")
pgWriteRast (conn, c ("climate", "mean_warmest_month_temp_canesm2_2011_2040"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\nffd")
pgWriteRast (conn, c ("climate", "number_frost_free_days_canesm2_2011_2040"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\pas")
pgWriteRast (conn, c ("climate", "precip_as_snow_Aug_to_July_canesm2_2011_2040"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2011_2040\\RCP45\\CanESM2\\rh")
pgWriteRast (conn, c ("climate", "relative_humidity_canesm2_2011_2040"), rh, overwrite = TRUE)

# 2041-2070
ahm <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_canesm2_2041_2070"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_canesm2_2041_2070"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_canesm2_2041_2070"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_canesm2_2041_2070"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_canesm2_2041_2070"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_canesm2_2041_2070"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\mat")
pgWriteRast (conn, c ("climate", "mean_annual_temp_C_canesm2_2041_2070"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\mcmt")
pgWriteRast (conn, c ("climate", "mean_coldest_month_temp_canesm2_2041_2070"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\msp")
pgWriteRast (conn, c ("climate", "mean_may_to_sept_precip_mm_canesm2_2041_2070"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\mwmt")
pgWriteRast (conn, c ("climate", "mean_warmest_month_temp_canesm2_2041_2070"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\nffd")
pgWriteRast (conn, c ("climate", "number_frost_free_days_canesm2_2041_2070"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_canesm2_2041_2070"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2041_2070\\RCP45\\CanESM2\\rh")
pgWriteRast (conn, c ("climate", "relative_humidity_canesm2_2041_2070"), rh, overwrite = TRUE)

# 2071-2100
ahm <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\ahm")
pgWriteRast (conn, c ("climate", "annual_heat_moisture_index_canesm2_2071_2100"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\dd_0")
pgWriteRast (conn, c ("climate", "degree_days_below_0_canesm2_2071_2100"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\dd5")
pgWriteRast (conn, c ("climate", "degree_days_above_5C_canesm2_2071_2100"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\emt")
pgWriteRast (conn, c ("climate", "extreme_min_temp_30_years_canesm2_2071_2100"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_canesm2_2071_2100"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_canesm2_2071_2100"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_canesm2_2071_2100"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_canesm2_2071_2100"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_canesm2_2071_2100"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_canesm2_2071_2100"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_canesm2_2071_2100"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_canesm2_2071_2100"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2071_2100\\RCP45\\CanESM2\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_canesm2_2071_2100"), rh, overwrite = TRUE)


# CCSM4 model 'future' climate data
# 2011-2040
ahm <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_CCSM4_2011_2040"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_CCSM4_2011_2040"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_CCSM4_2011_2040"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_CCSM4_2011_2040"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_CCSM4_2011_2040"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_CCSM4_2011_2040"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_CCSM4_2011_2040"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_CCSM4_2011_2040"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_CCSM4_2011_2040"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_CCSM4_2011_2040"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_CCSM4_2011_2040"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_CCSM4_2011_2040"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2011_2040\\RCP45\\CCSM4\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_CCSM4_2011_2040"), rh, overwrite = TRUE)

# 2041-2070
ahm <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_CCSM4_2041_2070"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_CCSM4_2041_2070"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_CCSM4_2041_2070"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_CCSM4_2041_2070"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_CCSM4_2041_2070"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_CCSM4_2041_2070"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_CCSM4_2041_2070"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_CCSM4_2041_2070"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_CCSM4_2041_2070"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_CCSM4_2041_2070"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_CCSM4_2041_2070"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_CCSM4_2041_2070"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2041_2070\\RCP45\\CCSM4\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_CCSM4_2041_2070"), rh, overwrite = TRUE)

# 2071-2100
ahm <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_CCSM4_2071_2100"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_CCSM4_2071_2100"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_CCSM4_2071_2100"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_CCSM4_2071_2100"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_CCSM4_2071_2100"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_CCSM4_2071_2100"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_CCSM4_2071_2100"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_CCSM4_2071_2100"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_CCSM4_2071_2100"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_CCSM4_2071_2100"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_CCSM4_2071_2100"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_CCSM4_2071_2100"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2071_2100\\RCP45\\CCSM4\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_CCSM4_2071_2100"), rh, overwrite = TRUE)

# HadGEM2-ES model 'future' climate data
# 2011-2040
ahm <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\ahm")
pgWriteRast (conn, c ("climate", "annual_heat_moisture_index_HadGEM2ES_2011_2040"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_HadGEM2ES_2011_2040"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_HadGEM2ES_2011_2040"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_HadGEM2ES_2011_2040"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_HadGEM2ES_2011_2040"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_HadGEM2ES_2011_2040"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_HadGEM2ES_2011_2040"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_HadGEM2ES_2011_2040"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_HadGEM2ES_2011_2040"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_HadGEM2ES_2011_2040"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_HadGEM2ES_2011_2040"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_HadGEM2ES_2011_2040"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2011_2040\\RCP45\\HadGEM2-ES\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_HadGEM2ES_2011_2040"), rh, overwrite = TRUE)

# 2041-2070
ahm <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_HadGEM2ES_2041_2070"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_HadGEM2ES_2041_2070"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_HadGEM2ES_2041_2070"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_HadGEM2ES_2041_2070"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_HadGEM2ES_2041_2070"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_HadGEM2ES_2041_2070"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_HadGEM2ES_2041_2070"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_HadGEM2ES_2041_2070"), mcmt, overwrite = TRUE)
...
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_HadGEM2ES_2041_2070"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_HadGEM2ES_2041_2070"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_HadGEM2ES_2041_2070"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2041_2070\\RCP45\\HadGEM2-ES\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_HadGEM2ES_2041_2070"), rh, overwrite = TRUE)

# 2071-2100
ahm <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\ahm")
pgWriteRast (conn, c ("climate","annual_heat_moisture_index_HadGEM2ES_2071_2100"), ahm, overwrite = TRUE)
dd0 <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\dd_0")
pgWriteRast (conn, c ("climate","degree_days_below_0_HadGEM2ES_2071_2100"), dd0, overwrite = TRUE)
dd5 <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\dd5")
pgWriteRast (conn, c ("climate","degree_days_above_5C_HadGEM2ES_2071_2100"), dd5, overwrite = TRUE)
emt <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\emt")
pgWriteRast (conn, c ("climate","extreme_min_temp_30_years_HadGEM2ES_2071_2100"), emt, overwrite = TRUE)
ext <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\ext")
pgWriteRast (conn, c ("climate","extreme_max_temp_30_years_HadGEM2ES_2071_2100"), ext, overwrite = TRUE)
map <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\map")
pgWriteRast (conn, c ("climate","mean_annual_precip_mm_HadGEM2ES_2071_2100"), map, overwrite = TRUE)
mat <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\mat")
pgWriteRast (conn, c ("climate","mean_annual_temp_C_HadGEM2ES_2071_2100"), mat, overwrite = TRUE)
mcmt <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\mcmt")
pgWriteRast (conn, c ("climate","mean_coldest_month_temp_HadGEM2ES_2071_2100"), mcmt, overwrite = TRUE)
msp <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\msp")
pgWriteRast (conn, c ("climate","mean_may_to_sept_precip_mm_HadGEM2ES_2071_2100"), msp, overwrite = TRUE)
mwmt <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\mwmt")
pgWriteRast (conn, c ("climate","mean_warmest_month_temp_HadGEM2ES_2071_2100"), mwmt, overwrite = TRUE)
nffd <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\nffd")
pgWriteRast (conn, c ("climate","number_frost_free_days_HadGEM2ES_2071_2100"), nffd, overwrite = TRUE)
pas <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\pas")
pgWriteRast (conn, c ("climate","precip_as_snow_Aug_to_July_HadGEM2ES_2071_2100"), pas, overwrite = TRUE)
rh <- raster ("climate\\annual\\2071_2100\\RCP45\\HadGEM2-ES\\rh")
pgWriteRast (conn, c ("climate","relative_humidity_HadGEM2ES_2071_2100"), rh, overwrite = TRUE)
