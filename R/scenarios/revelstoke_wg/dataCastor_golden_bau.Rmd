...
---
title: "Database creation for Golden TSA bau Analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "golden_bau_20231205", 
...
scenario = data.table (name = "load_data_golden_bau", description = "dataCastor output for Golden TSA")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/golden_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) # 141,530 hectares
