...
---
title: "Database creation for TFL 56 BAU analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "tfl56_bau_20231205", 
...
scenario = data.table (name = "load_data_tfl56_bau", description = "dataCastor output for TFL56 BAU")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/tfl56_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) #  22,000 hectares
