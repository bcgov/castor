...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = FALSE,
                          sqlite_dbname = "rev_complex", 
                          nameBoundaryFile = "public.tsa_aac_bounds", 
                          nameBoundaryColumn = "tsa_name", 
                          nameBoundary = c ("Arrow_TSA","Revelstoke_TSA", "Cascadia_TKO_TSA", "Golden_TSA", "Kamloops_TSA", "Robson_Valley_TSA","Kootenay_Lake_TSA", "Okanagan_TSA", "TFL14", "TFL23", "TFL55", "TFL56"), 
...
```{r, create blocks}
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/backCastor_revelstoke_complex_pre_status_52.tif")
...
writeRaster(in.block, "C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/inblock_revelstoke_complex.tif")

#Over write the inblock roads
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/backCastor_revelstoke_complex_pre_status_52.tif")
in.block<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/inblock_revelstoke_complex.tif")
rd.stat[rd.stat[] == -52] <- 0
in.block[is.na(in.block[])]<-0
rd.stat<-rd.stat + in.block
writeRaster(rd.stat, "C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/est_roadstatus_revelstoke_complex.tif")

castordb <- dbConnect(RSQLite::SQLite(), dbname ="C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/revelstoke_complex_castordb.sqlite")
