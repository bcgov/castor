...
scenario = data.table (name = "backCastor_arrow", description = "dataCastor output")
...
```{r, create blocks}
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/backCastor_arrow_Arrow_TSA_pre_status_52.tif")
...
writeRaster(in.block, "C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/inblock_arrow.tif")

#Over write the inblock roads
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/backCastor_arrow_Arrow_TSA_pre_status_52.tif")
in.block<-rast("C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/inblock_arrow.tif")
rd.stat[rd.stat[] == -52] <- 0
in.block[is.na(in.block[])]<-0
rd.stat<-rd.stat + in.block
writeRaster(rd.stat, "C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/outputs/est_roadstatus_arrow.tif")

castordb <- dbConnect(RSQLite::SQLite(), dbname ="C:/Users/klochhea/castor/R/scenarios/revelstoke_wg/arrow_bau_20231205_castordb.sqlite")
