...
---
title: "Database creation for Kootenay Lake TSA bau Analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "kootenay_bau_20231205", 
...
scenario = data.table (name = "load_data_kootenay_bau", description = "dataCastor output for Kootenay Lake TSA")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/kootenay_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) # ~219,325  hectares
