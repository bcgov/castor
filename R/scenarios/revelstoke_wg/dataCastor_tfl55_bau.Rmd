...
---
title: "Database creation for TFL 55 BAU analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "tfl55_bau_20231205", 
...
scenario = data.table (name = "load_data_tfl55_bau", description = "dataCastor output for TFL55 BAU")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/tfl55_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) #  16,000 hectares
