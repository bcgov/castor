...
---
title: "Database creation for Cascadia-Okanagan BAU analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "cascadia_tko_bau_20231205", 
...
scenario = data.table (name = "load_data_cascadia_bau", description = "dataCastor output for Cascadia TKO TSA BAU")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/cascadia_tko_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) # 25,000 hectares
