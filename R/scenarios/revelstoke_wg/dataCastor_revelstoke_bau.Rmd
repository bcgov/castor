...
---
title: "Database creation for Revelstoke TSA BAU analysis"
author: "Tyler Muhly"
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "revelstoke_bau_20231205", 
...
scenario = data.table (name = "load_data_revelstoke_bau", description = "dataCastor output for Revelstoke TSA BAU")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/revelstoke_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) #  57,908 hectares
