...
---
title: "Database creation for TFL 14 BAU analysis"
author: "Tyler Muhly"
...
scenario = data.table (name = "load_data_tfl14_bau", description = "dataCastor output for TFL14 BAU")
...
db <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/revelstoke_complex/tfl14_bau_20230203_castordb.sqlite"))

pixels <- data.table (dbGetQuery(db, "SELECT * FROM pixels;"))
thlb.area <- sum(pixels$thlb, na.rm = T) #  46,000 hectares
