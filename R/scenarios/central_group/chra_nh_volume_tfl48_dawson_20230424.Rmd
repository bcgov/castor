...
scenario = data.table (name = "central_group_chra_no_harvest_tfl48_dawsonck_april2023",
                       description = "No Harvest in caribou Habitat Recovery Areas (CHRA) scenario. Max. non-declining harvest flow; TFL 48 = 395,000 m3/yr; Dawson Creek TSA = 1.08 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years). Partnership areas included (A2, B2, B3, B4 = no harvest; A1, B1, B5 = 90% > 40 years old).")
