---
title: "Business-as-usual Simulation for Resoration Area of Central Group Caribou Recovery Planning"
author: ""
...
Here we use forestryCLUS to assess the potential impact of a hypothetical land use orders and deferral areas on timber supply within a restoration area-of-interest for central group caribou (east-central B.C.).
...
dbExecute (clusdb, "UPDATE zoneconstraints SET type = '' WHERE reference_zone = 'rast.central_grp_partner_areas_072022' AND zoneid = 3") 
...
### harvestFlow
First set at 1,000,000 m3/year, 750,000, 700,000, 675,000, 665,000, 660,000



target of  m3/year provided a non-declining maximum harvest flow over a 200 year period.
...
parameters <- list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         useCLUSdb = paste0(here::here(), "/R/scenarios/central_group/inputs/central_group_restore_nov2022_clusdb.sqlite"),
...
scenario = data.table (name = "central_group_restore_bau_nov2022",
                       description = "Business-as-usual (BAU) scenario. Max. non-declining harvest flow = 660,000 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
