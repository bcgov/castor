...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "central_group", 
                          nameBoundaryFile = "public.tsa_aac_bounds", 
                          nameBoundaryColumn = "tsa_name", 
                          nameBoundary = c ("MacKenzie_TSA", "MacKenzie_SW_TSA", "Dawson_Creek_TSA", "TFL48", "Prince_George_TSA"), 
                          ...
                          nameYieldsRaster = "rast.ycid_vdyp_2020", # 2021 ready?
