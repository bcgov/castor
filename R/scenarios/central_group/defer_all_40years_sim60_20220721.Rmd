...
scenario = data.table (name = "central_group_defer_all_40_sim60_july2022",
                       description = "No harvest in all five deferral areas for the first 40 years of the simulation scenario. Max. non-declining harvest flow = 1.6 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years). Simulation length = 60 years.")
