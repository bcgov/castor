...
dbExecute (clusdb, "UPDATE zoneconstraints SET type = 'nh' WHERE reference_zone = 'rast.central_grp_deferral_072022' AND zoneid IN (1, 2, 3, 4, 5)") 
dbExecute (clusdb, "UPDATE zoneconstraints SET stop = 39 WHERE reference_zone = 'rast.central_grp_deferral_072022' AND zoneid IN (1, 2, 3, 4, 5)") 
