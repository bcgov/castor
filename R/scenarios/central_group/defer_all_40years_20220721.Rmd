...
# check tables
check <- dbGetQuery (clusdb, "SELECT * from zoneconstraints WHERE reference_zone = 'rast.central_grp_partner_areas_072022'") # rast.central_grp_deferral_072022
...
dbExecute (clusdb, "UPDATE zoneconstraints SET stop = 40 WHERE reference_zone = 'rast.central_grp_deferral_072022' AND (zoneid = 1) OR (zoneid = 2) OR (zoneid = 3) OR (zoneid = 4) OR (zoneid = 5)") 
