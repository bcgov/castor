...
dbExecute (castordb, "UPDATE zoneconstraints SET type = 'ge' WHERE reference_zone = 'rast.central_grp_partner_areas_072022' AND (zoneid = 1) OR (zoneid = 3) OR (zoneid = 9)") 
dbExecute (castordb, "UPDATE zoneconstraints SET variable = 'age' WHERE reference_zone = 'rast.central_grp_partner_areas_072022' AND (zoneid = 1) OR (zoneid = 3) OR (zoneid = 9)") 
dbExecute (castordb, "UPDATE zoneconstraints SET threshold = 41 WHERE reference_zone = 'rast.central_grp_partner_areas_072022' AND (zoneid = 1) OR (zoneid = 3) OR (zoneid = 9)")
dbExecute (castordb, "UPDATE zoneconstraints SET percentage = 90 WHERE reference_zone = 'rast.central_grp_partner_areas_072022' AND (zoneid = 1) OR (zoneid = 3) OR (zoneid = 9)")
