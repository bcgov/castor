...
check <- dbGetQuery (castordb, "SELECT * from zoneconstraints WHERE reference_zone = 'rast.zone_cond_bc_burnt_pine_crithab' OR reference_zone = 'rast.zone_cond_bc_kennedy_siding_crithab' OR reference_zone = 'rast.zone_cond_bc_moberly_crithab' OR reference_zone = 'rast.zone_cond_bc_quintette_crithab' OR reference_zone = 'rast.zone_cond_bc_narraway_crithab' OR reference_zone = 'rast.central_grp_partner_areas_072022'")
...
scenario = data.table (name = "central_group_canada_order_tfl48_dawsonck_may2023",
                       description = "Scenario where Canada places a no harvest emergency order over critical habitat for Burnt Pine, Kennedy Siding, Klinse-Za (Moberly and Scott East), Quintette and Narraway herds.. Max. non-declining harvest flow; TFL 48 = 165,000 m3/yr; Dawson Creek TSA = 890,000 m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years). Partnership areas included (A2, B2, B3, B4 = no harvest; A1, B1, B5 = 90% > 40 years old).")
