...
VALUES 
(1201,1,'rast.central_grp_deferral_072022','zone20',0,'age',40,'le',10,NULL,NULL,12372,41,250),
(1202,2,'rast.central_grp_deferral_072022','zone20',0,'age',40,'le',10,NULL,NULL,267425,41,250),
(1203,3,'rast.central_grp_deferral_072022','zone20',0,'age',40,'le',10,NULL,NULL,247416,41,250),
(1204,4,'rast.central_grp_deferral_072022','zone20',0,'age',40,'le',10,NULL,NULL,354352,41,250),
(1205,5,'rast.central_grp_deferral_072022','zone20',0,'age',40,'le',10,NULL,NULL,302453,41,250);")
dbCommit(clusdb)
...
scenario = data.table (name = "defer_all_nh1to40y_10ple40yo_41to200y_oct2022",
                       description = "No harvest in all five deferral areas for the first 40 years of the simulation scenario, then maximum 10% less than or equal to 40 year old forest from years 41 to 200 of the scenario. Max. non-declining harvest flow = 1.275 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
