...
Here we simautle the 'business-as-usual' (BAU) case, where we only apply existing legal constraints, caribou or otherwise. This scenario is used to establish the current 'baseline' or benchmark to evaluate the potential impact of 'new' actions in caribou habitat.

We identify the non-declining maximum annual harvest volume that can be achieved as the baseline level of forestry that could occur in the region, given existing legal contraints. 
## Model Paramters
### BAU Zones 
...
### harvestFlow
First set at 1,000,000 m3/year, then 2M, 1.75 M, 1.5 M, 1.65 M, 1.6M, 1.55M; 1.5 M final.
