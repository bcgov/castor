...
### harvestFlow
First set at 1,500,000 m3/year, then 1.6M, 2M;  final.
...
scenario = data.table (name = "central_group_bau_july2022",
                       description = "Business-as-usual (BAU) scenario. Max. non-declining harvest flow = 2.0 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
...
harvestFlow <- rbindlist(list(data.table(compartment ="central_group",
                                     ...
                                     period = rep( seq (from = 1,
                                                      ...
                                                      by = 1),
                                                1), 
                                     flow = 10000000, #2,000,000m3/year 
                                     partition_type = 'live') 
))
