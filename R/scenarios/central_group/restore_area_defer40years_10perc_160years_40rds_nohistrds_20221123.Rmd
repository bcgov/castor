...
# UPDATE ROADS TO YEAR 0
dbExecute (clusdb, "UPDATE pixels SET roadstatus = 0 WHERE roadstatus IS NOT NULL;") 
dbCommit(clusdb)
...
scenario = data.table (name = "restore40_defer_nh1to40y_10ple40yo_41to200y_initroad0_nov2022",
                       description = "No harvest in all five deferral areas for the first 40 years of the simulation scenario, then maximum 10% less than or equal to 40 year old forest from years 41 to 200 of the scenario. Road restored after 40 years of no use, but all roads start at year 0. Max. non-declining harvest flow = 265,000 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
