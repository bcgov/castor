...
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/scenarios/fisher_cclup/wlms_lk/williams_lake_castordb.sqlite"))
...
VALUES 
(5,'rast.zone_chilcotin_scenario2','zone13',0,'age',141,'ge',25,NULL,NULL,626115,0,250),
(5,'rast.zone_chilcotin_scenario2','zone13',0,'age',121,'ge',30,NULL,NULL,626115,0,250),
(5,'rast.zone_chilcotin_scenario2','zone13',0,'age',101,'ge',37,NULL,NULL,626115,0,250),
(5,'rast.zone_chilcotin_scenario2','zone13',0,'age',81,'ge',45,NULL,NULL,626115,0,250),
(6,'rast.zone_chilcotin_scenario2','zone13',0,'age',141,'ge',25,NULL,NULL,618070,0,250),
(6,'rast.zone_chilcotin_scenario2','zone13',0,'age',121,'ge',30,NULL,NULL,618070,0,250),
(6,'rast.zone_chilcotin_scenario2','zone13',0,'age',101,'ge',37,NULL,NULL,618070,0,250),
(6,'rast.zone_chilcotin_scenario2','zone13',0,'age',81,'ge',45,NULL,NULL,618070,0,250);")
}
...
params[, reference_zone:= 'rast.zone_cond_beo_pg_cclup'][, zone_column:= 'zone10'][,variable :='age'][,threshold :=40][,type:='le'][,start:=0][,stop:=250]
dbBegin(clusdb)
...
setPaths(modulePath = here::here("R/SpaDES-modules"),
         outputPath = here::here("R/scenarios/fisher_cclup/wlms_lk"))
...
parameters <-  list(
  ...
  dataCastor = list (dbName = 'clus', # name of the postgres database
                         #saveCastorDB = TRUE,
                         useCastorDB = paste0(here::here(), "/R/scenarios/fisher_cclup/wlms_lk/williams_lake_castordb.sqlite"),
                         sqlite_dbname = "williams_lake",
...
scenario = data.table(name="upgrade_low_beo", description = "Upgrading the low BEO to intermediate and making early seral constraints legal with a business as usual plus cariboo and old growth deferrals harvesting flow")
