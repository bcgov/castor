...
scenario = data.table(name="bau", description = "business as usual - with cariboo and old growth deferrals")
...
harvestFlow <- data.table(compartment ="Williams_Lake_TSA",
                                         ...
                                         period = rep( seq (from = 1, # run the 
                                                      ...
                                                      by = 1),
                                                    1), 
                                         flow = 12400000, #12300000 #1250000 too high
                                         partition_type = 'live')
objects <- list(scenario = scenario, harvestFlow = harvestFlow)
inputs <- list()
mySim <- simInit(times = times, params = parameters, modules = modules,
                 objects = objects)
outputs(mySim) <- data.frame (objectName = c("harvestReport","growingStockReport","zoneManagement"))
