...
parameters <-  list(
  ...
  dataCastor = list (dbName = 'clus', # name of the postgres database
                         #saveCastorDB = TRUE,
                         useCastorDB = paste0(here::here(), "/R/scenarios/fisher_cclup/hundred_mile/hundred_mile_castordb_old.sqlite"),
...
scenario = data.table(name="bau", description = "business as usual - existing legal constraints")
...
harvestFlow <- data.table(compartment ="Onehundred_Mile_House_TSA",
                                         ...
                                         period = rep( seq (from = 1, # run the 
                                                      ...
                                                      by = 1),
                                                    1),
                                         flow =  5995000, #5795000 low 5895000 high #bau harvest 7295000
                                         partition_type = 'live')
...
mySim <- simInit(times = times, params = parameters, modules = modules,
                 objects = objects)
outputs(mySim) <- data.frame (objectName = c("harvestReport","zoneManagement", "growingStockReport"))
