...
scenario = data.table(name="esr_bau_pri_og_caribou_adj", description = "business as usual: existing legal constraints and no harvesting in priority old growth deferral areas (TAP) and caribou scenario 2a (no harvest in core, conditional harvest in matrix)")
