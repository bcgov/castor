...
setPaths(modulePath = here::here("R/SpaDES-modules"),
         outputPath = here::here("R/scenarios/fisher_cclup/non_adj/"))
...
parameters <-  list(
  ...
  dataCastor = list (dbName = 'clus', # name of the postgres database
                         #saveCastorDB = TRUE,
                         useCastorDB = paste0(here::here(), "/R/scenarios/fisher_cclup/non_adj/rcb_castordb_old.sqlite"),
                         sqlite_dbname = "rcb",
...
scenario = data.table(name="esr_no_harvest", description = "no disturbance")
