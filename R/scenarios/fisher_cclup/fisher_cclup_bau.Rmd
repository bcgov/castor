...
scenario = data.table(name="esr_bau_adj", description = "business as usual: existing legal constraints with yields adjusted for second structure")
...
harvestFlow <- rbindlist(list( data.table(compartment ="Williams_Lake_TSA",
                              ...
                              data.table(compartment ="Onehundred_Mile_House_TSA",
                                         ...
                                         period = rep( seq (from = 1, # run the 
                                                      ...
                                                      by = 1),
                                                    1),
                                         flow =  7295000, #bau harvest 7195000
                                         partition_type = 'live'),
