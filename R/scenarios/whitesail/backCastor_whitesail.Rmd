...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          ...
                          nameBoundaryFile = "public.whitesail_wha_aoi", 
                          nameBoundaryColumn = "aoi", 
                          nameBoundary = "whitesail", 
...
objects <- list (scenario = scenario, roadSourceID = 63066
                 )
...
```{r, create blocks}
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/whitesail/whitesail_backrds_whitesail_pre_status_52.tif")
...
writeRaster(in.block, "C:/Users/klochhea/castor/R/scenarios/whitesail/inblock_whitesail.tif")

#Over write the inblock roads
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/whitesail/whitesail_backrds_whitesail_pre_status_52.tif")
in.block<-rast("C:/Users/klochhea/castor/R/scenarios/whitesail/inblock_whitesail.tif")
rd.stat[rd.stat[] == -52] <- 0
in.block[is.na(in.block[])]<-0
rd.stat<-rd.stat + in.block
writeRaster(rd.stat, "C:/Users/klochhea/castor/R/scenarios/whitesail/est_roadstatus_whitesail.tif")
