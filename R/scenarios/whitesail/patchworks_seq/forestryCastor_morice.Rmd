...
scenario = data.table (name = "alternative_smz_rr21",
                       description = "alternative_smz. morice land use regional plan. recovery 21 years")
harvestSchedule <- rast("alternative_smz_hsq.tif")
