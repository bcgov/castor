...
library(sf)
library(terra)
spatial.hsq<-"C:/Users/klochhea/castor/R/scenarios/whitesail/data_raw/scenario50yrs/steventon_observed_mod.gpkg"
...
out<-rast(ras.hseq)
writeRaster(out, "steventon_observed_mod_hsq.tif")
```
