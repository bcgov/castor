...
Sys.setenv(JAVA_HOME = 'C:\\Program Files\\Java\\jdk-23.0.1') #throws an error if pointing to different version of java (i.e., 32 vs 64 bit)
...
parameters <-  list (
        ...
        dataCastor = list(dbHost=keyring::key_get('dbhost', keyring = 'postgreSQL'),
                    ...
                    dbPass= keyring::key_get('dbpass', keyring = 'postgreSQL'),
                         saveCastorDB = TRUE,
                          sqlite_dbname = "boundary_fire_r2", 
