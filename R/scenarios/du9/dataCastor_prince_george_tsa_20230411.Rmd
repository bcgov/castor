...
outputDir <- file.path (paste0 (here::here (), "/R/scenarios/du9/outputs")) %>% reproducible::checkPath (create = TRUE)
cacheDir <- file.path (paste0 (here::here (), "/R/scenarios/du9"))
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          ...
                          nameZoneRasters = c ("rast.zone_cond_beo", 
                                               ...
                                               "rast.zone_smc_zones_20210315", # DU9 proposal
                                               # central group proposal
