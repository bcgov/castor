...
scenario = data.table (name = "golden_bau_sustain",
                       description = "Business as usual (BAU) sustainable. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. Even live harvest flow: 250,000 m3/year. Growing stock sustainable (flat) at year 100-200, or similar growing stock value at start and end of sim. No road recovery (300 years).")
