...
parameters <- list(
  ...
  dataCastor = list( dbName = 'castor',
                          saveCastorDB = FALSE,
                          sqlite_dbname = "cascadia_tko_bau_20230203", 
                          useCastorDB = paste0(here::here(), "/R/scenarios/revelstoke_complex/cascadia_tko_bau_20230203_castordb.sqlite"),
...
scenario = data.table (name = "cascadia_tko_bau_max",
                       description = "Business as usual (BAU) max non-declining harvest flow. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. No road recovery. Max non-declining live harvest flow: 72,500 m3/year. No growing stock constraint. No road recovery (300 years).")
