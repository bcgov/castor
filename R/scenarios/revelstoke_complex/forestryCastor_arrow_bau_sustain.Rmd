...
parameters <- list(
  ...
  dataCastor = list( dbName = 'castor',
                          ...
                          useCastorDB = paste0(here::here(), "/R/scenarios/revelstoke_complex/arrow_bau_20230203_castordb.sqlite"),
...
scenario = data.table (name = "arrow_bau_sustain",
                       description = "Business as usual (BAU) sustainable. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. No road recovery. Even live harvest flow: 225,000 m3/year. Growing stock sustainable (flat) at year 100-200. No road recovery (300 years).")
