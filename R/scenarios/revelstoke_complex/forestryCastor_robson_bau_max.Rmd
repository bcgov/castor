...
scenario = data.table (name = "robson_bau_max",
                       description = "Business as usual (BAU) max non-declining harvest flow. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year.Maximum non-declining live harvest flow: 235,000 m3/year. No growing stock constraint. No road recovery (300 years).")
