...
scenario = data.table (name = "arrow_bau_max",
                       description = "Business as usual (BAU) sustainable max non-declining harvest flow. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. No road recovery. Even live max. non-declining harvest flow: 325,000 m3/year. No growing stock constraint. No road recovery (300 years).")
