...
parameters <- list(
  ...
  dataCastor = list( dbName = 'castor',
                          saveCastorDB = FALSE,
                          sqlite_dbname = "tfl56_bau_20230203",
                      useCastorDB = paste0(here::here(), "/R/scenarios/revelstoke_complex/tfl56_bau_20230203_castordb.sqlite"),
...
scenario = data.table (name = "tfl56_bau_max",
                       description = "Business as usual (BAU) max non-declining harvest flow. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. No road recovery. Max non-declining live harvest flow: 32,500 m3/year. No growing stock constraint. No road recovery (300 years).")
