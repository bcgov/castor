...
parameters <- list(
  ...
  dataCastor = list( dbName = 'castor',
                          saveCastorDB = FALSE,
                          sqlite_dbname = "kootenay_bau_20230203",
                          useCastorDB = paste0(here::here(), "/R/scenarios/revelstoke_complex/kootenay_bau_20230203_castordb.sqlite"),
...
scenario = data.table (name = "kootenay_lake_bau_max",
                       description = "Business as usual (BAU) sustainable max non-declining harvest flow. Adjacency = 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/year. Even live max. non-declining harvest flow: 450,000 m3/year. No growing stock constraint. No road recovery (300 years).")
