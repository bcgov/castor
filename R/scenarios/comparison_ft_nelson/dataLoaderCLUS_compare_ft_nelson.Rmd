...
parameters <-  list(
  ...
  dataCastor = list(dbName = 'castor',
                        ...
                        nameZoneRasters = c("comparison_nass.rast_zone_uwr",
                                             "compaon_nass.rast_zone_beo_prod",
                        ...
                        # nameZonePriorityRaster = "rast.zone_cond_beo",
                         ...
                         nameYieldTable ="yc_vdyp", # fort_nelson_tsa.yc_table
  ...
  uploaderCastor = list(aoiName = 'morice_tsa',
