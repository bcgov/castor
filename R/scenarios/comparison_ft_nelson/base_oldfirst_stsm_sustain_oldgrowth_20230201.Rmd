...
# Scenario
This is scenario where replicates the 'sustainble' even flow over a 200 year period where the growing stock does not decline after 100 years. The harvest priority queue is 'oldest first' and neither blocking or roading is implemented in the model. There is an old growth constraint. 

# Parameters 
## Zone Constraints
There is a an old growth constraint for 5 'zones' across the TSA, where a proportion (0.17 to 0.44) of each zone must consist of older (100 to 140 year old) forest stands. 
...
scenario = data.table (name = "oldest_stsm_sustain_oldgrowth_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum live harvest flow: 2,450,000 m3/year, which assumes growing stock is non-declining after 100 years, replicating the SELES-STSM run. Minimum harvest age = 50. Old growth constraints included.")
