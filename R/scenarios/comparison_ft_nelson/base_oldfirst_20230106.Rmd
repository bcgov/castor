...
scenario = data.table (name = "oldest_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 3,500,000m3/year. Minimum harvest age = 50")
...
harvestFlow <- rbindlist(list(data.table(compartment ="Fort_Nelson_TSA",
                                     ...
                                     period = rep( seq (from = 1,
                                                      ...
                                                      by = 1),
                                                1), 
                                     flow = 17500000, # 3,500,000m3/year 
                                     partition_type = 'live') 
))
