...
scenario = data.table (name = "oldest_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 3,150,000 m3/year. Minimum harvest age = 50")
