...
scenario = data.table (name = "oldest_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 2,500,000m3/year. Minimum harvest volume = xxxx")
