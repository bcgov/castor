...
# Scenario
This is a simple scenario where the harvest flow target is the maximum even flow over a 200 year period. The harvest priority queue is 'highest volume first' and no constraints, blocking or roading is implemented in the model. 
...
parameters <- list(
  ...
  forestryCastor = list(harvestBlockPriority = " vol DESC ", 
...
scenario = data.table (name = "highestvolume_noroads_noblocks",
                       description = "Priority queue = highest volume first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 2,700,000m3/year. Minimum harvest age = 50")
...
harvestFlow <- rbindlist(list(data.table(compartment ="Fort_Nelson_TSA",
                                     ...
                                     period = rep( seq (from = 1,
                                                      ...
                                                      by = 1),
                                                1), 
                                     flow = 27000000, # 2,700,000m3/year 
                                     partition_type = 'live') 
))
