...
scenario = data.table (name = "oldest_stsm_sustain_oldgrowth_extreme",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum live harvest flow: 2,450,000 m3/year, which assumes growing stock is non-declining after 100 years, replicating the SELES-STSM run. Minimum harvest age = 50. Old growth constraints included with 75% threshold.")
