...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          ...
                          sqlite_dbname = "boundary_climate_canesm_ssp245_r1_2023", 
...
scenario = data.table (name = "CanESM5_ssp245_run_1", description = "10000 reps of firescastor for year 2023. climate data from gcm model CanESM5 with ssp245 and run r1i1p1f1")
