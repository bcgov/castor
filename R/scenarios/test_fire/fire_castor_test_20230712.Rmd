...
outputDir <- file.path(paste0(here::here(), "/R/scenarios/test_fire/outputs"))
cacheDir <- file.path(paste0(here::here(), "/R/SpaDES-modules/test_fire"))
...
parameters <- list(
  ...
  fireCastor = list(#updateInterval =1,
                    ...
                    futureClimateProjection = "8GCMs_ensemble_ssp370",
                    nameForestInventoryRaster = "rast.vri2020_id",
