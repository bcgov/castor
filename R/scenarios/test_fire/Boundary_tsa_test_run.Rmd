...
---
title: "Model runs using the experiment function in SpadES for Boundary TSA to test if fireCastor is working"
...
outputDir <- file.path (paste0 (here::here (), "/R/scenarios/test_fire/outputs")) %>% reproducible::checkPath (create = TRUE)
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          useCastorDB = "C:/Work/caribou/castor/boundary_tsa_fire_test_20june24_castordb.sqlite",
                          sqlite_dbname = "boundary_tsa_fire_test_20june24", 
                          nameBoundaryFile = "boundary_tsa_buff_50km", 
                          nameBoundaryColumn = "tsa_name", 
                          nameBoundary = 'Boundary TSA', 
                          nameBoundaryGeom = 'wkb_geometry',
                          nameCompartmentRaster = "rast.boundary_tsa_buff_50km", 
                          nameCompartmentTable = "vat.vat_boundary_tsa_buff_50km", 
...
outputs(mySim) <- data.frame (objectName = "growingStockReport",
                                      "disturbanceReport",
                                      "perFireReport",
...
system.time({
  sims <- experiment(mySim, replicates = 1, saveExperiment = FALSE, clearSimEnv = TRUE, .plotInitialTime = NA) # no plotting
