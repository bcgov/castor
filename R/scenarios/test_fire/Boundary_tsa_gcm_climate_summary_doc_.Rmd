---
title: Comparison between fireCastor results from actual and predicted climate and actual number of fires in the Boundary TSA for the year 2023
...
ggplot(dat1, aes(x=numberstarts,y = ..density.., color=gcm, fill=gcm)) +
...
total_area_burned<- fireReportForReps_test[ ,list(sum=sum(areaburned_estimated)), by=rep]
