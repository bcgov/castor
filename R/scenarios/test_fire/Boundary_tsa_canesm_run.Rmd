...
outputDir <- file.path (paste0 (here::here (), "/R/scenarios/test_fire/CanESM_ssp245_boundaryTSA/outputs")) %>% reproducible::checkPath (create = TRUE)
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          #useCastorDB = "C:/Work/caribou/castor/R/scenarios/test_fire/boundary_climate_canesm_ssp245_r2_2023_castordb.sqlite",
                          sqlite_dbname = "boundary_climate_canesm_ssp245_r3_2023", 
        ...
        climateCastor = list(calculateInterval = 1,
                    ...
                    gcm = c("CanESM5"), # for observed data put "none",
                    gcmname = c("CanESM"), # for observed data put "climatena",
                    ssp = c("ssp245"), # for observed data put "none","ssp245","ssp370"
                    run = c("r3i1p1f1"), #, "r2i1p1f1", "r3i1p1f1"
...
scenario = data.table (name = "CanESM5_ssp245_run_3", description = "10000 reps of firescastor for year 2023. climate data from gcm model CanESM5 with ssp245 and run r3i1p1f1")
