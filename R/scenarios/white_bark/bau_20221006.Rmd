---
title: "Business-as-usual Simulation for Whitebark pine recovery planning"
author: ""
date: "6 October 2022"
output:
  html_document: 
...
Here we use forestryCLUS to assess the potential impact of hypothetical protections for whitebark pine habitat. Here we simulate the 'business-as-usual' (BAU) scenario, where we only apply existing legal constraints. This scenario is used to establish the current 'baseline' or benchmark to evaluate the potential impact of 'new' actions in  whitebark pine habitat.
...
### harvestFlow
First set at 1,000,000 m3/year, 750k, 650k, 625k m3/yr; target of 620,000 m3/year provided a non-declining maximum harvest flow over a 200 year period.
...
scenario = data.table (name = "whitebark_bau_oct2022",
                       description = "Business-as-usual (BAU) scenario. Max. non-declining harvest flow = 620,000 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
