---
title: "Protection of core whitebark pine habitat simulation for Whitebark pine recovery planning"
author: ""
date: "6 October 2022"
output:
  html_document: 
...
Here we use forestryCLUS to assess the potential impact of hypothetical protections for whitebark pine habitat. Here we simulate a scenario where we apply existing legal constraints and no harvest in "core" whitebark pine habitat areas, as defined by the B.C. government. This scenario can be used to assess the potential impact of protecting these areas on timber supply.
...
zone_whitebark_bc_core_habitat = whitebark pine core habitat areas
...
# check tables
check <- dbGetQuery (clusdb, "SELECT * from zoneconstraints WHERE reference_zone = 'rast.zone_whitebark_bc_core_habitat'") 
```
...
### harvestFlow
620,000 m3/year provided a non-declining maximum harvest flow over a 200 year period.
...
scenario = data.table (name = "whitebark_bc_core_habitat_oct2022",
                       description = "Scenario with no harvest in core whitebark pine habitat as defined by the government of B.C. Max. non-declining harvest flow = 620,000 M m3/yr. Adjacency was set to 0m. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 150 m3/ha. No road recovery (300 years).")
