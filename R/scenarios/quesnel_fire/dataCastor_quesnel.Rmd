...
parameters <-  list (
        ...
        fireCastor = list(calculateInterval =1,
                    ...
                    numberFireReps = 1),
        climateCastor= list(gcm= 'CanESM5',#'MPI-ESM1-2-HR'"ACCESS_ESM1_5", "CanESM5", "MPI_ESM1_2_HR" Note that MPI_ESM1_2HR seems to only have r1i1p1f1 and r2i1p1f1 for ssp 126 and ssp245. 
                            gcmname='CanESM5', 
...
scenario = data.table (name = "load_data_2024Nov10", description = "dataCastor output")
...
#connect to castordb
castordb <- dbConnect(RSQLite::SQLite(), dbname ="quesnel_fire_castordb.sqlite")
...
con = dbConnect(RSQLite::SQLite(), dbname = "quesnel_fire_castordb.sqlite")
...
out<-rast(ras.hseq)
writeRaster(out, "quesnel_fire_hsq.tif", overwrite = TRUE)
