...
parameters <-  list (
        ...
        dataCastor = list(dbHost=keyring::key_get('dbhost', keyring = 'postgreSQL'),
                    ...
                    dbPass= keyring::key_get('dbpass', keyring = 'postgreSQL'),
                         saveCastorDB = FALSE,
                          dbName = 'castor',
                          useCastorDB = "boundary_fire_castordb.sqlite",
...
scenario = data.table (name = "harv_castor_MPI_ESM1_2_HR_ssp370_r1i1p1f1", description = "dataCastor output")
...
harvestFlow <- rbindlist(list(
                              data.table (compartment ="Boundary_TSA",
...
mysimout<-simInitAndExperiment(times = times, 
                 ...
                 modules = modules,
                 objects = objects,
                 paths = paths, replicates = 16, clearSimEnv = TRUE)
