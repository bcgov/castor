...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          useCastorDB = "C:/Users/klochhea/castor/R/scenarios/wolverine/mackenzie_castordb.sqlite",
                          sqlite_dbname = "mackenzie", 
        ...
        forestryCastor = list(harvestBlockPriority = " dist, age DESC ", 
                        ...
                        activeZoneConstraint = c("rast.wolverine_he",
                                                 "rast.zone_cond_nharv",
                                                 "rast.zone_wha_2021", 
                                                 "rast.zone_uwr_2021", 
                                                 "rast.zone_cond_beo", 
...
harvestFlow <- rbindlist(list(
                              data.table (compartment ="MacKenzie_TSA",
                                          ...
                                          period = rep( seq (from = 1,
                                                     ...
                                                     1),
                                          partition_type = 'live',
                                          flow = 12000000 ) # 12000000 LRSY;  bau;
                              ))
