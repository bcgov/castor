...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          useCastorDB = "C:/Users/klochhea/castor/R/scenarios/wolverine/pg_north_castordb.sqlite",
                          sqlite_dbname = "pg_north", 
        ...
        forestryCastor = list(harvestBlockPriority = " dist, age DESC ", 
                        ...
                        activeZoneConstraint = c("rast.zone_cond_nharv",                                              "rast.wolverine_he",
                                                 "rast.wolverine_cpa",
                                                 "rast.zone_cond_beo", 
                                                 "rast.zone_cond_vqo", 
                                                 "rast.zone_wha_2021", 
...
scenario = data.table (name = "cpa_no_harvesting",
                       description = "No harvesting in high or low elevation habitat. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 140 m3/year. Even live harvest flow: 1,170,000 m3/year. Growing stock sustainable (flat) at year 100-200, or similar growing stock value at start and end of sim. Road recovery (30 years).")
...
harvestFlow <- rbindlist(list(
                              data.table (compartment ="Prince_George_North_TSA",
                                          partition = ' vol > 140 and age >=60  ', 
                                          period = rep( seq (from = 1,
                                                           to = 20,
                                                           by = 1),
                                                     1),
                                          partition_type = 'live',
                                          flow =10900000 ) # 12000000 LRSY;  11700000 bau; 9850000 le
                              ))
