...
inputDir <- file.path (paste0 (here::here (), "/R/scenarios/wolverine/inputs/tsa")) %>% reproducible::checkPath (create = TRUE)
outputDir <- file.path (paste0 (here::here (), "/R/scenarios/wolverine/outputs/tsa")) %>% reproducible::checkPath (create = TRUE)
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          useCastorDB = "C:/Users/klochhea/castor/R/scenarios/wolverine/mackenzie_sw_castordb.sqlite",
                          sqlite_dbname = "mackenzie_sw", 
                          nameBoundaryFile = "public.tsa_aac_bounds", 
                          nameBoundaryColumn = "tsa_name", 
                          nameBoundary = "MacKenzie_SW_TSA", 
                          nameBoundaryGeom = 'wkb_geometry',
                          nameCompartmentRaster = "rast.tsa_aac_boundary", 
                          nameCompartmentTable = "vat.tsa_aac_boundary", 
        ...
        uploadCastor = list(aoiName = 'wolverine_5scen_tsa',
...
scenario = data.table (name = "le_he_no_harvesting",
                       description = "No harvesting in high elevation habitat or low elevation. Priority queue = Closest to disturbance first, oldest second. Minimum volume: 125 m3/year. Even live harvest flow: 936,000 m3/year. Growing stock sustainable (flat) at year 100-200, or similar growing stock value at start and end of sim. Road recovery (30 years).")
...
harvestFlow <- rbindlist(list(
                              data.table (compartment ="MacKenzie_SW_TSA",
                                          ...
                                          period = rep( seq (from = 1,
                                                     ...
                                                     1),
                                          partition_type = 'live',
                                          flow = 9360000 ) # 12000000 LRSY; 10600000 bau; 9360000 no harv he+le
                              ))
