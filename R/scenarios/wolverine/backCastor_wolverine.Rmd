...
```{r, create blocks}
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/load_data_May2024_Wolverine_pre_status_52.tif")
...
writeRaster(in.block, "C:/Users/klochhea/castor/R/scenarios/wolverine/inblock_wolverine.tif")

#Over write the inblock roads
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/load_data_May2024_Wolverine_pre_status_52.tif")
in.block<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/inblock_wolverine.tif")
rd.stat[rd.stat[] == -52] <- 0
in.block[is.na(in.block[])]<-0
rd.stat<-rd.stat + in.block
writeRaster(rd.stat, "C:/Users/klochhea/castor/R/scenarios/wolverine/est_roadstatus_wolverine.tif")
