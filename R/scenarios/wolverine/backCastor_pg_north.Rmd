...
scenario = data.table (name = "load_pg_n_tsa", description = "dataCastor output")
...
```{r, create blocks}
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/load_pg_n_tsa_Prince_George_North_TSA_pre_status_52.tif")
...
writeRaster(in.block, "C:/Users/klochhea/castor/R/scenarios/wolverine/pg_inblock_wolverine.tif")

#Over write the inblock roads
rd.stat<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/load_pg_n_tsa_Prince_George_North_TSA_pre_status_52.tif")
in.block<-rast("C:/Users/klochhea/castor/R/scenarios/wolverine/pg_inblock_wolverine.tif")
rd.stat[rd.stat[] == -52] <- 0
in.block[is.na(in.block[])]<-0
rd.stat<-rd.stat + in.block
writeRaster(rd.stat, "C:/Users/klochhea/castor/R/scenarios/wolverine/pg_est_roadstatus_wolverine.tif")

castordb <- dbConnect(RSQLite::SQLite(), dbname ="C:/Users/klochhea/castor/R/scenarios/wolverine/pg_north_castordb.sqlite")
