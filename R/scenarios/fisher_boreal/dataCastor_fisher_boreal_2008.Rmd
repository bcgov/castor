...
---
title: "Database creation for Boreal Fisher Habitat Calibration"
author: "Tyler Muhly"
...
# Overview
Creating a sqlite db of a boreal landscape in 2008 to 'calibrate' the fisher agent-based model. Here we assume a static landscape (no harvesting, no forest stand growth and yield) to test for the effect of the specific landscape configuration on fisher abundance estimated from an agent-based model (ABM). The ABM  territory locations (and population estimates) can be compared to field-data derived home ranges (and population estimates?) to assess the ABM's accuracy.
...
parameters <-  list (
        ...
        dataCastor = list(dbName = 'castor',
                          saveCastorDB = TRUE,
                          sqlite_dbname = "fisher_boreal_2008",
                          nameBoundaryFile = "fisher_boreal.bounds_fisher_boreal_sa", 
                          nameBoundaryColumn = "tsa_name", 
                          nameBoundary = "study_area", 
                          nameBoundaryGeom = 'wkb_geometry',
                          nameCompartmentRaster = "fisher_boreal.rast_bounds", 
                          nameCompartmentTable = "fisher_boreal.vat_bounds", 
                          # nameMaskHarvestLandbaseRaster = 'rast.thlb_2020', # won't be used 
                          # nameZoneRasters = "fort_nelson_tsa.rast_oldgrw_prod", # no mgt zones
                          # nameZoneTable = "fort_nelson_tsa.constraints", # no constraints
                          # natural and managed stands yield curves are the same    
                          # nameYieldsRaster = "fort_nelson_tsa.rast_ycid_fort_nelson_tsa", # not dynamic
