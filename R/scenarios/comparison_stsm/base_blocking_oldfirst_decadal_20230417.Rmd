...
scenario = data.table (name = "oldest_decadal_noroads_blocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 130,000 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
