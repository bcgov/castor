...
parameters <- list(
  ...
  dataCastor = list (dbName='castor',
                     ...
                     useCastorDB = paste0(here::here(), "/R/scenarios/comparison_stsm/stsm_compare_blocks_noroads_castordb.sqlite"),
...
scenario = data.table (name = "oldest_decadal_noroads_blocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 124,500 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
