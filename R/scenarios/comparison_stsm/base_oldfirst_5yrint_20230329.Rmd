...
times <- list(start = 0, end = 50) # 5 year interval; 250 years = 50 intervals
parameters <- list(
  ...
  dataCastor = list (dbName='castor',
                     ...
                     useCastorDB = paste0(here::here(), "/R/scenarios/comparison_stsm/stsm_compare_noroads_noblocks_castordb.sqlite"),
...
scenario = data.table (name = "oldest_5yr_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 127,500 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
