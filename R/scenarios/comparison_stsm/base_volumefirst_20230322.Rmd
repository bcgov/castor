...
scenario = data.table (name = "volume_noroads_noblocks",
                       description = "Priority queue = highest volume first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 115,000 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
