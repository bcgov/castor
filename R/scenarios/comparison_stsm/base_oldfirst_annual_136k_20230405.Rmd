...
scenario = data.table (name = "oldest_annual_noroads_noblocks_136000",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Maximum even live harvest flow: 136,000 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
