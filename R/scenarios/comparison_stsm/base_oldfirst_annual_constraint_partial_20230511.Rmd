...
scenario = data.table (name = "oldest_annual_noroads_noblocks_constraint_modified_aflb",
                       description = "Priority queue = oldest first. Adjacency constraint = None. Constraint zone: 75% >= 175 years old. No roads or blocks. Maximum even live harvest flow: 118,500 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
