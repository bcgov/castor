...
scenario = data.table (name = "oldest_133k_noroads_noblocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. No roads or blocks. Harvest flow: 133,598 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
