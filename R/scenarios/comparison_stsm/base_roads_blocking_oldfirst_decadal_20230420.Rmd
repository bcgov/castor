...
scenario = data.table (name = "oldest_decadal_roads_blocks",
                       description = "Priority queue = oldest first. Adjacency constraint = None. Includes roads (mst) and blocks (pre). Maximum even live harvest flow: 124,500 m3/year. Minimum harvest age = 80 and minimum harvest volume = 150")
