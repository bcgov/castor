...
parameters <- list(
  ...
  growingStockCLUS = list (periodLength = 10),
...
scenario = data.table (name = "bau_beo", description = "bau with only the beo")

harvestFlow <- rbindlist(list(data.table(compartment ="Quesnel_TSA",
                                     partition = ' vol > 150 and manage_type = 1 ', 
                                     year = rep( seq (from = 1, 
                                                      to = 40, 
                                                      by = 1),
                                                1), 
                                     flow = 35000000, type = 'live')
))
