...
dbExecute(clusdb, "UPDATE zoneconstraints SET type= 'nh' where reference_zone = 'rast.zone_smc_zones_20210315' and zoneid in(18,19,20)")
...
# scenario = data.table (name = "tfl14_bau", description = "Business as usual (BAU). Harvest flow = 140,000 m3/yr. Adjacency = 3m. Oldest first.")
...
# scenario = data.table (name = "tfl14_centselk_ch_he0d_m12d",
 #                      description = "No harvest in Central Selkirks high elevation critical habitat, maximum 12%  disturbance  in Central Selkirks matrix critical habitat. Harvest flow = 140,000 m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "tfl14_centselk_scen3a",description = "No harvest in old forest, recruitment forest and buffered Central Selkirks core critical habitat areas, as defined by Bevan Ernst, maximum 15% disturbance (unbuffered) in Central Selkirks matrix habitat areas. Harvest flow = 140,000 m3/yr. Adjacency = 3m. Oldest first.")
 
scenario = data.table (name = "tfl14_centselk_scen3b",
                      description = "No harvest in old forest and recruitment forest Central Selkirks core critical habitat areas, as defined by Bevan Ernst, maximum 15% disturbance (unbuffered) in Central Selkirks matrix habitat areas. Harvest flow = 140,000 m3/yr. Adjacency = 3m. Oldest first.")
...
harvestFlow <- rbindlist(list(data.table(compartment ="TFL14",
                                     ...
                                     period = rep( seq (from = 1, # run the 
                                                ...
                                                1), 
                                     flow = 700000,
                                     partition_type = 'live')  # 140,000 m3/yr
))
