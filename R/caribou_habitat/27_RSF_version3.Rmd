...
## Introduction
Here I develop statistical models to quantify the effect of forestry disturbance on caribou distribution. The intent is to use the models to indicate the influence of current and potential future forestry development on caribou use of habitat. Tne model will be implemented as a module (i.e., rsfCLUS) in the caribou and land use simulator (CLUS). Models were fit for the four caribou designatable units (DUs) in British Columbia (BC): DU6, boreal; DU7, northern moutain; DU8, central mountain; DU9, southern moutnain, as defined by the [Committee on the Status of Endangered Wildlife in Canada (COSEWIC)](https://www.registrelep-sararegistry.gc.ca/default.asp?lang=En&n=E6271D78-1&offset=2#_01_4). DUs were modeled independently, as they are intended to represent groups of caribou with unique ecological characteristics, and potentially different responses to forestry disturbance. 
...
```{r du6 fxn response image, echo = F, message = F, eval = T, fig.cap = "DU6 Caribou Functional Response to Road"}
...
```{r, du7 model road fxn response, echo = T, message = F, eval = F}
data.road.test <- read.csv (here ("R/caribou_habitat/data", "rd_fxn_test_data.csv"))
plot3d(x = data.road.test$distance_to_resource_road, 
       y = data.road.test$dist_res_road_E,
...
```{r, du7 fxn response image, echo = F, message = F, eval = T, fig.cap = "DU7 Caribou Functional Response to Road"}
...
```{r, du8 model road fxn response, echo = T, message = F, eval = F}
data.road.test <- read.csv (here ("R/caribou_habitat/data", "rd_fxn_test_data.csv"))
plot3d(x = data.road.test$distance_to_resource_road, 
       y = data.road.test$dist_res_road_E,
...
```{r, du8 fxn response image, echo = F, message = F, eval = T, fig.cap = "DU8 Caribou Functional Response to Road"}
knitr::include_graphics( here ("R/caribou_habitat/images", "du8_fxn.jpg"))
```
...
```{r, du9 fxn response image, echo = F, message = F, eval = T, fig.cap = "DU9 Caribou Functional Response to Road"}
