...
locs.caribou.ecotype.herd.C307T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C307T", ] 
locs.caribou.ecotype.herd.C306T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C306T", ] 
locs.caribou.ecotype.herd.C305T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C305T", ] 
locs.caribou.ecotype.herd.C303T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C303T", ] 
locs.caribou.ecotype.herd.C302T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C302T", ] 
locs.caribou.ecotype.herd.C301T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C301T", ] 
locs.caribou.ecotype.herd.C296T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C296T", ] 
locs.caribou.ecotype.herd.C295T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C295T", ] 
locs.caribou.ecotype.herd.C298T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C298T", ] 
locs.caribou.ecotype.herd.C297T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C297T", ] 
locs.caribou.ecotype.herd.C294T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C294T", ]
locs.caribou.ecotype.herd.C293T <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "C293T", ]
locs.caribou.ecotype.herd.40 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "40", ]
locs.caribou.ecotype.herd.39 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "39", ]
locs.caribou.ecotype.herd.37 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "37", ]
locs.caribou.ecotype.herd.49 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "49", ]
locs.caribou.ecotype.herd.46 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "46", ]
locs.caribou.ecotype.herd.42 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "42", ]
locs.caribou.ecotype.herd.162 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "162", ] # deleted
locs.caribou.ecotype.herd.CS1 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "CS1", ]
locs.caribou.ecotype.herd.CS3 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "CS3", ]
locs.caribou.ecotype.herd.CS7 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "CS7", ]
locs.caribou.ecotype.herd.34 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "34", ]
locs.caribou.ecotype.herd.CS4 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "CS4", ]
locs.caribou.ecotype.herd.CS5 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "CS5", ]
locs.caribou.ecotype.herd.81 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "81", ]
locs.caribou.ecotype.herd.SS1 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SS 1", ]
locs.caribou.ecotype.herd.SS4 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SS 4", ]
locs.caribou.ecotype.herd.SL26 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SL26", ]
locs.caribou.ecotype.herd.HSCEK077 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "HSCEK077", ]
locs.caribou.ecotype.herd.SCEK002 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK002", ]
locs.caribou.ecotype.herd.SCEK003 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK003", ]
locs.caribou.ecotype.herd.SCEK007 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK007", ]
locs.caribou.ecotype.herd.SCEK007b <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK007b", ]
locs.caribou.ecotype.herd.SCEK009 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK009", ]
locs.caribou.ecotype.herd.SCEK009b <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK009b", ]
locs.caribou.ecotype.herd.SCEK026 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK026", ]
locs.caribou.ecotype.herd.SCEK044 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK044", ]
locs.caribou.ecotype.herd.SCEK050 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK050", ]
locs.caribou.ecotype.herd.SCEK066b <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK066b", ]
locs.caribou.ecotype.herd.SCEK079 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK079", ]
locs.caribou.ecotype.herd.SCEK133 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK133", ]
locs.caribou.ecotype.herd.SCEK136 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK136", ]
locs.caribou.ecotype.herd.SCEK136b <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK136b", ]
locs.caribou.ecotype.herd.SCEK143 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK143", ]
locs.caribou.ecotype.herd.SCEK161 <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK161", ]
locs.caribou.ecotype.herd.SCEK161b <- locs.caribou.ecotype.herd [locs.caribou.ecotype.herd$animal_id == "SCEK161b", ]
...
head (locs.caribou.ecotype.herd.SCEK143)

rm (locs.caribou.ecotype.herd.c234c, locs.caribou.ecotype.herd.C310T, locs.caribou.ecotype.herd.C307T,
    locs.caribou.ecotype.herd.C306T, locs.caribou.ecotype.herd.C305T, locs.caribou.ecotype.herd.C303T,
    locs.caribou.ecotype.herd.C302T, locs.caribou.ecotype.herd.C301T, locs.caribou.ecotype.herd.C296T,
    locs.caribou.ecotype.herd.C295T, locs.caribou.ecotype.herd.C298T, locs.caribou.ecotype.herd.C297T,
    locs.caribou.ecotype.herd.C294T, locs.caribou.ecotype.herd.C293T, locs.caribou.ecotype.herd.40,
    locs.caribou.ecotype.herd.39, locs.caribou.ecotype.herd.37, locs.caribou.ecotype.herd.49,
    locs.caribou.ecotype.herd.46, locs.caribou.ecotype.herd.42, locs.caribou.ecotype.herd.162,
    locs.caribou.ecotype.herd.CS1, locs.caribou.ecotype.herd.CS3, locs.caribou.ecotype.herd.CS7,
    locs.caribou.ecotype.herd.34, locs.caribou.ecotype.herd.CS4, locs.caribou.ecotype.herd.CS5,
    locs.caribou.ecotype.herd.81, locs.caribou.ecotype.herd.SS1, locs.caribou.ecotype.herd.SS4,
    locs.caribou.ecotype.herd.SL26, locs.caribou.ecotype.herd.HSCEK077, 
    locs.caribou.ecotype.herd.SCEK002, locs.caribou.ecotype.herd.SCEK003, 
    locs.caribou.ecotype.herd.SCEK007, locs.caribou.ecotype.herd.SCEK007b,
    locs.caribou.ecotype.herd.SCEK009, locs.caribou.ecotype.herd.SCEK009b,
    locs.caribou.ecotype.herd.SCEK026, locs.caribou.ecotype.herd.SCEK044, 
    locs.caribou.ecotype.herd.SCEK050, locs.caribou.ecotype.herd.SCEK066b,
    locs.caribou.ecotype.herd.SCEK079, locs.caribou.ecotype.herd.SCEK133, 
    locs.caribou.ecotype.herd.SCEK136, locs.caribou.ecotype.herd.SCEK143,
    locs.caribou.ecotype.herd.SCEK161, )
gc ()


# check if is.na again......



plot (st_geometry (prov.bnd))
plot (st_geometry (locs.caribou.bc), add = T)



caribou.range$diss <- 1  # add field in data frame for 'dissolving' data
caribou.range.boreal <- subset (caribou.range, caribou.range$ECOTYPE == "Boreal")
caribou.range.mtn <- subset (caribou.range, caribou.range$ECOTYPE == "Mountain")
caribou.range.north <- subset (caribou.range, caribou.range$ECOTYPE == "Northern")
# dissolve
caribou.range.boreal.diss <- caribou.range.boreal %>% 
                              group_by (diss) %>% 
                              summarise ()
caribou.range.mtn.diss <- caribou.range.mtn %>% 
                              group_by (diss) %>% 
                              summarise ()
caribou.range.north.diss <- caribou.range.north %>% 
                              group_by (diss) %>% 
                              summarise ()
...
caribou.range.boreal.buff.25km <- st_buffer (caribou.range.boreal.diss, dist = 25000) # buffer ecotype ranges by 25km, a reasonable distance based on wolf territory size (Mech et al. 2003, pg 174) 
caribou.range.mtn.diss.buff.25km <- st_buffer (caribou.range.mtn.diss, dist = 25000) 
caribou.range.north.diss.buff.25km <- st_buffer (caribou.range.north.diss, dist = 25000) 


plot (st_geometry (caribou.range.boreal.buff.25km))
plot (st_geometry (caribou.range.mtn.diss.buff.25km), add = T)
plot (st_geometry (caribou.range.north.diss.buff.25km), add = T)
plot (st_geometry (locs.caribou.new), add = T)





caribou.range.north.buff.25km <- gBuffer (, width = 25000) 
