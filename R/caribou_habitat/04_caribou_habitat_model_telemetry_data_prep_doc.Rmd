...
locs.caribou.hr.ewinter.mtn <- locs.caribou.hr [locs.caribou.hr@data$season == "EarlyWinter" & locs.caribou.hr@data$du == "du6", ]
locs.caribou.hr.ewinter.mtn@data$uniqueID <- factor (locs.caribou.hr.ewinter.mtn@data$uniqueID)

locs.caribou.hr.lwinter.mtn <- locs.caribou.hr [locs.caribou.hr@data$season == "LateWinter" & locs.caribou.hr@data$du == "du6", ]
locs.caribou.hr.lwinter.mtn@data$uniqueID <- factor (locs.caribou.hr.lwinter.mtn@data$uniqueID)




# hr's with h = 500
locs.caribou.hr.summer.du6.h500 <- kernelUD (locs.caribou.hr.summer.mtn [, 13], # column of unique ID
                                          h = 500, # smoothing parameter (h) tried different h values 
                                          grid = 1000, # grid 1km x 1km
                                          extent = 2)  # extent is 2x the 'normal' size
homerange.summer.mtn.h500 <- getverticeshr (locs.caribou.hr.summer.du6.h500, percent = 95)
# save data 
writeOGR (homerange.summer.mtn.h500, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_summer_du6_h500.shp", 
          layer = "hr_summer_du6_h500.shp", driver = "ESRI Shapefile")




locs.caribou.hr.ewinter.mtn.h500 <- kernelUD (locs.caribou.hr.ewinter.mtn [, 13], 
                                          h = 500, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.ewinter.mtn.h500 <- getverticeshr (locs.caribou.hr.ewinter.mtn.h500, percent = 95)
writeOGR (homerange.ewinter.mtn.h500, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_ewinter_mtn_h500.shp", 
          layer = "hr_ewinter_mtn_h500.shp", driver = "ESRI Shapefile")

locs.caribou.hr.lwinter.mtn.h500 <- kernelUD (locs.caribou.hr.lwinter.mtn [, 13], 
                                          h = 500, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.lwinter.mtn.h500 <- getverticeshr (locs.caribou.hr.lwinter.mtn.h500, percent = 95)
writeOGR (homerange.lwinter.mtn.h500, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_lwinter_mtn_h500.shp", 
          layer = "hr_lwinter_mtn_h500.shp", driver = "ESRI Shapefile")

locs.caribou.hr.summer.boreal.h500 <- kernelUD (locs.caribou.hr.summer.boreal [, 13], 
                                          h = 500, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.summer.boreal.h500 <- getverticeshr (locs.caribou.hr.summer.boreal.h500, percent = 95)
writeOGR (homerange.summer.boreal.h500, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_summer_boreal_h500.shp", 
          layer = "hr_summer_boreal_h500.shp", driver = "ESRI Shapefile")



# hr's with h = 250
locs.caribou.hr.summer.mtn.h250 <- kernelUD (locs.caribou.hr.summer.mtn [, 13], 
                                          h = 250, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.summer.mtn.h250 <- getverticeshr (locs.caribou.hr.summer.mtn.h250, percent = 95)
writeOGR (homerange.summer.mtn.h250, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_summer_mtn_h250.shp", 
          layer = "hr_summer_mtn_h250.shp", driver = "ESRI Shapefile")

locs.caribou.hr.ewinter.mtn.h250 <- kernelUD (locs.caribou.hr.ewinter.mtn [, 13], 
                                          h = 250, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.ewinter.mtn.h250 <- getverticeshr (locs.caribou.hr.ewinter.mtn.h250, percent = 95)
writeOGR (homerange.ewinter.mtn.h250, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_ewinter_mtn_h250.shp", 
          layer = "hr_ewinter_mtn_h250.shp", driver = "ESRI Shapefile")

locs.caribou.hr.lwinter.mtn.h250 <- kernelUD (locs.caribou.hr.lwinter.mtn [, 13], 
                                          h = 250, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.lwinter.mtn.h250 <- getverticeshr (locs.caribou.hr.lwinter.mtn.h250, percent = 95)
writeOGR (homerange.lwinter.mtn.h250, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_lwinter_mtn_h250.shp", 
          layer = "hr_lwinter_mtn_h250.shp", driver = "ESRI Shapefile")

locs.caribou.hr.summer.boreal.h250 <- kernelUD (locs.caribou.hr.summer.boreal [, 13], 
                                          h = 250, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.summer.boreal.h250 <- getverticeshr (locs.caribou.hr.summer.boreal.h250, percent = 95)
writeOGR (homerange.summer.boreal.h250, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_summer_boreal_h250.shp", 
          layer = "hr_summer_boreal_h250.shp", driver = "ESRI Shapefile")
...
# hr's with h = 100
locs.caribou.hr.summer.mtn.h100 <- kernelUD (locs.caribou.hr.summer.mtn [, 13],
                                          h = 100, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.summer.mtn.h100 <- getverticeshr (locs.caribou.hr.summer.mtn.h100, percent = 95)
writeOGR (homerange.summer.mtn.h100, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_summer_mtn_h100.shp", 
          layer = "hr_summer_mtn_h100.shp", driver = "ESRI Shapefile")

locs.caribou.hr.ewinter.mtn.h100 <- kernelUD (locs.caribou.hr.ewinter.mtn [, 13],
                                          h = 100, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.ewinter.mtn.h100 <- getverticeshr (locs.caribou.hr.ewinter.mtn.h100, percent = 95)
writeOGR (homerange.ewinter.mtn.h100, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_ewinter_mtn_h100.shp", 
          layer = "hr_ewinter_mtn_h100.shp", driver = "ESRI Shapefile")

locs.caribou.hr.lwinter.mtn.h100 <- kernelUD (locs.caribou.hr.lwinter.mtn [, 13],
                                          h = 100, 
                                          grid = 1000, 
                                          extent = 2)  
homerange.lwinter.mtn.h100 <- getverticeshr (locs.caribou.hr.lwinter.mtn.h100, percent = 95)
writeOGR (homerange.lwinter.mtn.h100, dsn = "C:\\Work\\caribou\\clus_data\\caribou\\telemetry_habitat_model_20180904\\homeranges\\hr_lwinter_mtn_h100.shp", 
          layer = "hr_lwinter_mtn_h100.shp", driver = "ESRI Shapefile")
...
resoltuion of data: smallest size (h=100) is ~200 m from point locations to egde of hr, leaving littel room for avriability in habitat between used and avalable for analysis @1ha resoltuion 
...
Mountain_Summer_car078_2008
Boreal_Summer_SCEK43_2013
