...
st_write (obj = locs.caribou.ecotype.herd, 
          dsn = conn, 
          layer = c ("caribou", "telemetry_caribou_bc_ecotype_herd_all_id"))
dbDisconnect (conn)
...
head (locs.caribou.ecotype.herd)

plot (st_geometry (prov.bnd))
plot (st_geometry (locs.caribou.bc), add = T)


# create unique ID by ecotype, animal ID, year, and season
locs.caribou.ecotype.herd <- mutate (locs.caribou.ecotype.herd, 
                                     uniqueID = paste (locs.caribou.ecotype.herd$ecotype,
                                                     locs.caribou.ecotype.herd$ANIMAL_ID,
                                                      locs.caribou.ecotype.herd$OBSERVATION_YEAR,
