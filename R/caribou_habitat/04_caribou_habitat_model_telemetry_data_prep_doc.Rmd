...
rsf.locations <- raster::extract (cut.1976, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [31] <- "cutblocks_1976"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (9, 31)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1976)
gc ()
...
rsf.locations <- raster::extract (cut.1977, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [32] <- "cutblocks_1977"
...
rsf.locations <- raster::extract (cut.1978, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [33] <- "cutblocks_1978"
...
rsf.locations <- raster::extract (cut.1979, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [34] <- "cutblocks_1979"
...
rsf.locations <- raster::extract (cut.1980, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [35] <- "cutblocks_1980"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (35)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1980)
gc ()
...
rsf.locations <- raster::extract (cut.1981, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [36] <- "cutblocks_1981"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (36)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1981)
gc ()
...
rsf.locations <- raster::extract (cut.1982, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [37] <- "cutblocks_1982"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (37)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1982)
gc ()
...
rsf.locations <- raster::extract (cut.1983, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [38] <- "cutblocks_1983"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (38)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1983)
gc ()
...
rsf.locations <- raster::extract (cut.1984, rsf.locations, method = 'simple',
                                  factors = T, df = T, sp = T) 
names (rsf.locations) [39] <- "cutblocks_1984"
rsf.data <- dplyr::full_join (rsf.data, rsf.locations@data [c (39)], 
                              by = c ("ptID" = "ptID")) 
rm (cut.1984)
gc ()
...
write.table (rsf.data, "C:\\Work\\caribou\\clus_data\\caribou_habitat_model\\rsf_data.csv",
             sep = ",")
...
rsf.locations.cut.2017 <- raster::extract (cut.2017, rsf.locations, method = 'simple',
                                              factors = T, df = T) 
rsf.locations.cut.2017$ptID <- 1:2671047
rsf.locations <- dplyr::full_join (rsf.locations, rsf.locations.cut.2017, 
                                   by = c ("ptID" = "ptID")) 
rm (rsf.locations.cut.2017, cut.2017)
gc ()
