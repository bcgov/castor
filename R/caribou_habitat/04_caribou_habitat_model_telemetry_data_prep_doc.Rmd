...
names (locs.caribou.ogris.slim) [8] <- "GEOMETRY" # give the 'geometry' column the same name as SPI
st_geometry (locs.caribou.ogris.slim) <- "GEOMETRY"
...
names (locs.caribou.spi.slim)
names (locs.caribou.ogris.slim)
...
locs.caribou.all <- rbind (locs.caribou.spi.slim, locs.caribou.ogris.slim)
...
rm (locs.caribou.spi, locs.caribou.spi.slim, locs.caribou.ogris,locs.caribou.ogris.slim, 
    locs.caribou.nexen, locs.caribou.bp2010 )
gc ()
