...
Justification for this study comes from the consencus that future climate will in general make the environment more conducive to fire. Here, the authors use General Circulation Models and carbon emission pathways to generate future fire environment scenarios. They specifically assess how potential for crown fire occurrence and active growth of fire changes with changing climate. Overall, they find that the proportion of days in fire seasons with the potential for ummanageable fire will increase, nearly doubling in some regions.
