...
Range_scale_data1<- Range_scale_data1 %>% mutate(distance_category_road = 
                if_else(distance_to_road <= 0.25,"<0.25km",
                if_else(distance_to_road > 0.25 & distance_to_road <=0.5, "0.25-0.5km",
                if_else(distance_to_road > 0.5 & distance_to_road <= 1, "0.5-1km",
                if_else(distance_to_road >1 & distance_to_road<=3, "1-3km",
                if_else(distance_to_road >3 & distance_to_road <= 6, "3-6km",">6km"))))))

Range_scale_data1<- Range_scale_data1 %>% mutate(distance_category_1to5_cut = 
                if_else(distance_to_cut_1to5yo <= 0.25,"<0.25km",
                if_else(distance_to_cut_1to5yo > 0.25 & distance_to_cut_1to5yo <=0.5, "0.25-0.5km",
                if_else(distance_to_cut_1to5yo > 0.5 & distance_to_cut_1to5yo <= 1, "0.5-1km",
                if_else(distance_to_cut_1to5yo >1 & distance_to_cut_1to5yo<=3, "1-3km",
                if_else(distance_to_cut_1to5yo >3 & distance_to_cut_1to5yo <= 6, "3-6km",">6km"))))))

Range_scale_data1<- Range_scale_data1 %>% mutate(distance_category_6to10_cut = 
                if_else(distance_to_cut_6to10yo <= 0.25,"<0.25km",
                if_else(distance_to_cut_6to10yo > 0.25 & distance_to_cut_6to10yo <=0.5, "0.25-0.5km",
                if_else(distance_to_cut_6to10yo > 0.5 & distance_to_cut_6to10yo <= 1, "0.5-1km",
                if_else(distance_to_cut_6to10yo >1 & distance_to_cut_6to10yo<=3, "1-3km",
                if_else(distance_to_cut_6to10yo >3 & distance_to_cut_6to10yo <= 6, "3-6km",">6km"))))))

Range_scale_data1<- Range_scale_data1 %>% mutate(distance_category_11to40_cut = 
                if_else(distance_to_cut_11to40yo <= 0.25,"<0.25km",
                if_else(distance_to_cut_11to40yo > 0.25 & distance_to_cut_11to40yo <=0.5, "0.25-0.5km",
                if_else(distance_to_cut_11to40yo > 0.5 & distance_to_cut_11to40yo <= 1, "0.5-1km",
                if_else(distance_to_cut_11to40yo >1 & distance_to_cut_11to40yo<=3, "1-3km",
                if_else(distance_to_cut_11to40yo >3 & distance_to_cut_11to40yo <= 6, "3-6km",">6km"))))))

Range_scale_data1$distance_category_road<-factor(Range_scale_data1$distance_category_road, ordered=T, levels=c("<0.25km", "0.25-0.5km", "0.5-1km", "1-3km",">6km"))
Range_scale_data1$distance_category_1to5_cut<-factor(Range_scale_data1$distance_category_1to5_cut, ordered=T, levels=c("<0.25km", "0.25-0.5km", "0.5-1km", "1-3km",">6km"))
Range_scale_data1$distance_category_6to10_cut<-factor(Range_scale_data1$distance_category_6to10_cut, ordered=T, levels=c("<0.25km", "0.25-0.5km", "0.5-1km", "1-3km",">6km"))
Range_scale_data1$distance_category_11to40_cut<-factor(Range_scale_data1$distance_category_11to40_cut, ordered=T, levels=c("<0.25km", "0.25-0.5km", "0.5-1km", "1-3km",">6km"))

#Checking correlation by du but this does not seem to work since everything is signficanct
du6<- Range_scale_data1 %>% filter(du=="du6")
table(du6$distance_category_road, du6$distance_category_1to5_cut)
chisq.test(du6$distance_category_road, du6$distance_category_1to5_cut, correct=FALSE)

table(du6$distance_category_road, du6$distance_category_6to10_cut)
chisq.test(du6$distance_category_road, du6$distance_category_6to10_cut, correct=FALSE)

table(du6$distance_category_road, du6$distance_category_11to40_cut)
chisq.test(du6$distance_category_road, du6$distance_category_1to5_cut, correct=FALSE)
...
# du7 has high correlation see below
...
# Distance to cutblock variables are highly correlated no matter how I chop it up e.g. 1-5 nd 6-40 OR 1-5 and 6-40 OR 1-10 and 11-40 OR 1-14 and 15-40 or 1-15 and 16-40. None of these options help. So Ill lump all cutblock data and have 1-40 for du7
du7 <- dplyr::mutate (du7, distance_to_cut_1to40yo = pmin (distance_to_cut_1yo, distance_to_cut_2yo, distance_to_cut_3yo, distance_to_cut_4yo, distance_to_cut_5yo,distance_to_cut_6yo, distance_to_cut_7yo,distance_to_cut_8yo, distance_to_cut_9yo, distance_to_cut_10yo,distance_to_cut_11yo, distance_to_cut_12yo, distance_to_cut_13yo, distance_to_cut_14yo, distance_to_cut_15yo, distance_to_cut_16yo, distance_to_cut_17yo, distance_to_cut_18yo, distance_to_cut_19yo,distance_to_cut_20yo,distance_to_cut_21yo, distance_to_cut_22yo, distance_to_cut_23yo, distance_to_cut_24yo, distance_to_cut_25yo, distance_to_cut_26yo, distance_to_cut_27yo, distance_to_cut_28yo, distance_to_cut_2yo, distance_to_cut_30yo,distance_to_cut_31yo, distance_to_cut_32yo, distance_to_cut_33yo, distance_to_cut_34yo, distance_to_cut_35yo, distance_to_cut_36yo, distance_to_cut_37yo,distance_to_cut_38yo, distance_to_cut_39yo, distance_to_cut_40yo))

dist.cut.corr <- (du7 [c ("distance_to_road", "distance_to_cut_1to40yo")])
corr <- round (cor (dist.cut.corr), 3)
p.mat <- round (cor_pmat (dist.cut.corr), 2)
ggcorrplot (corr, type = "lower", lab = TRUE, tl.cex = 10,  lab_size = 3,
            title = "DU7 Distance to Cutblock Correlation")
...
# the above is too correlated so Ill do this below
du8 <- dplyr::mutate (du8, distance_to_cut_1to4yo = pmin (distance_to_cut_1yo, distance_to_cut_2yo, distance_to_cut_3yo, distance_to_cut_4yo))
                                                            
du8 <- dplyr::mutate (du8, distance_to_cut_5to40yo = pmin (distance_to_cut_5yo,distance_to_cut_6yo, distance_to_cut_7yo,distance_to_cut_8yo, distance_to_cut_9yo, distance_to_cut_10yo,distance_to_cut_11yo, distance_to_cut_12yo, distance_to_cut_13yo, distance_to_cut_14yo, distance_to_cut_15yo, distance_to_cut_16yo, distance_to_cut_17yo, distance_to_cut_18yo, distance_to_cut_19yo,distance_to_cut_20yo,distance_to_cut_21yo, distance_to_cut_22yo, distance_to_cut_23yo, distance_to_cut_24yo, distance_to_cut_25yo, distance_to_cut_26yo, distance_to_cut_27yo, distance_to_cut_28yo, distance_to_cut_2yo, distance_to_cut_30yo,distance_to_cut_31yo, distance_to_cut_32yo, distance_to_cut_33yo, distance_to_cut_34yo, distance_to_cut_35yo, distance_to_cut_36yo, distance_to_cut_37yo,distance_to_cut_38yo, distance_to_cut_39yo, distance_to_cut_40yo))

dist.cut.corr <- (du8 [c ("distance_to_road", "distance_to_cut_1to4yo","distance_to_cut_5to40yo")])
corr <- round (cor (dist.cut.corr), 3)
p.mat <- round (cor_pmat (dist.cut.corr), 2)
ggcorrplot (corr, type = "lower", lab = TRUE, tl.cex = 10,  lab_size = 3,
            title = "DU8 Distance to Cutblock Correlation")
...
# in du9 roads and old cutblocks are correlated so Ill remove roads
...
ggplot (du6) +
  geom_col ( aes (x = as.factor(pttype), fill= distance_category_road)) +
