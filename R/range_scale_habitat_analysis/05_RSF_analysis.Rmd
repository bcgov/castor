...
Caribou tended to avoid cutblocks 1 to 5 years old across herds in DU8 (Fig. \@ref(fig:du8-Herd-cutblock-1-to-5)). For example, all herds except Narraway tended to use areas further from to 1 to 5 year old cutblocks than what was available. A random effect for distance to cutblock 1 to 5 years old was included in the GLMM to account for this variability.
...
Caribou tended to avoid cutblocks 6 to 10 years of age across herds in DU8 (Fig. \@ref(du8-Herd-cutblock-5-to-10)). For example, all herds except Narraway used areas further from to 6 to 10 year old cutblocks than what was available. A random effect for distance to cutblock 6 to 10 years old was included in the GLMM to account for this variability.

```{r du8-Herd-cutblock-5-to-10, fig.cap="Distance to 6 to 10 year old cutblock at available (0) and used (1) locations by caribou herds in DU8", echo = F, message = F, eval = T}
...
Caribou tended to avoid cutblocks 11 to 40 years of age across herds in DU8 (Fig. \@ref(fig:du8-Herd-cutblock-11-to-40)). For example, all herds except Narraway used areas further from to 11 to 40 year old cutblocks than what was available. A random effect for distance to cutblock 11 to 40 years old was included in the GLMM to account for this variability.
...
#### Caribou-Forestry Disturbance Model
Caribou in DU8 avoided 1 to 5 year old cutblocks (P<<0.0001) and weakly avoided roads (P = 0.116) and 6 to 10 year old cutblocks (P = 0.125). However, there was essentially no effect of 11 to 40 year old cutblocks on caribou distribution (P = 0.58) (Table \@ref(tab:du8-fix-eff-coef), Figure \@ref(fig:random-fixed-effects-du8)).
...
du8$distance_to_cut_11to40yo_scale<-scale(du8$distance_to_cut_11to40yo)
...
model.lme4.du8.cut.rd.yr2 <- glmer (pttype ~ distance_to_road_scale +
                                        ...
                                        (distance_to_road_scale +
                                         distance_to_cut_1to5yo_scale +
                                         distance_to_cut_6to10yo_scale +
                                         distance_to_cut_11to40yo_scale||HERD_NAME) +
                                        (1|year),
                                      data = du8, 
                                      family = binomial (link = "logit"),
                                      verbose = T)  
