...
Range_scale_data <- dplyr::mutate (Range_scale_data, distance_to_cut_11to30yo = pmin (distance_to_cut_11yo, distance_to_cut_12yo, distance_to_cut_13yo, distance_to_cut_14yo,distance_to_cut_15yo,distance_to_cut_16yo, distance_to_cut_17yo, distance_to_cut_18yo, distance_to_cut_19yo, distance_to_cut_20yo,distance_to_cut_21yo, distance_to_cut_22yo, distance_to_cut_23yo, distance_to_cut_24yo, distance_to_cut_25yo, distance_to_cut_26yo, distance_to_cut_27yo, distance_to_cut_28yo, distance_to_cut_2yo, distance_to_cut_30yo))

Range_scale_data <- dplyr::mutate (Range_scale_data, distance_to_cut_31to50 = pmin (distance_to_cut_31yo, distance_to_cut_32yo, distance_to_cut_33yo, distance_to_cut_34yo, distance_to_cut_35yo, distance_to_cut_36yo, distance_to_cut_37yo,distance_to_cut_38yo, distance_to_cut_39yo, distance_to_cut_40yo, distance_to_cut_41yo, distance_to_cut_42yo, distance_to_cut_43yo, distance_to_cut_44yo, distance_to_cut_45yo, distance_to_cut_46yo, distance_to_cut_47yo, distance_to_cut_48yo, distance_to_cut_49yo, distance_to_cut_50yo))



# convert m to km
Range_scale_data$distance_to_cut_1to5yo <- Range_scale_data$distance_to_cut_1to5yo/1000
Range_scale_data$distance_to_cut_6to10yo <- Range_scale_data$distance_to_cut_6to10yo/1000
Range_scale_data$distance_to_cut_11to30yo <- Range_scale_data$distance_to_cut_11to30yo/1000
Range_scale_data$distance_to_cut_31to50 <- Range_scale_data$distance_to_cut_31to50/1000
...
count.animals.herd <- du6  %>%
  group_by(HERD_NAME) %>%
  summarise(count = n_distinct(year))
count.animals.herd<- count.animals.herd %>%  rename(Herd.years=count)

count.locs.herd <- du6  %>%
  group_by(HERD_NAME) %>%
  filter (pttype == 1) %>%
  summarise(count = n()) %>%
  rename(Herd.count=count)

count.locs.range <- du6  %>%
  group_by(HERD_NAME) %>%
  filter (pttype == 0) %>%
  summarise(count = n()) %>%
  rename(Range.count=count)



table <- full_join(count.animals.herd, count.locs.herd,count.locs.range, by = "HERD_NAME")
table <- full_join(table,count.locs.range, by = "HERD_NAME")
