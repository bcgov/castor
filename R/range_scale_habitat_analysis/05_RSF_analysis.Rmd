...
Range_scale_data <- read.csv ("C:/Work/caribou/clus/R/range_scale_habitat_analysis/data/Range_scale_data.csv")
...
Range_scale_data <- dplyr::mutate (Range_scale_data, distance_to_cut_11to50yo = pmin (distance_to_cut_11yo, distance_to_cut_12yo, distance_to_cut_13yo, distance_to_cut_14yo,distance_to_cut_15yo,distance_to_cut_16yo, distance_to_cut_17yo, distance_to_cut_18yo, distance_to_cut_19yo,distance_to_cut_20yo,distance_to_cut_21yo, distance_to_cut_22yo, distance_to_cut_23yo, distance_to_cut_24yo, distance_to_cut_25yo, distance_to_cut_26yo, distance_to_cut_27yo, distance_to_cut_28yo, distance_to_cut_2yo, distance_to_cut_30yo, distance_to_cut_31yo, distance_to_cut_32yo, distance_to_cut_33yo, distance_to_cut_34yo, distance_to_cut_35yo, distance_to_cut_36yo, distance_to_cut_37yo,distance_to_cut_38yo, distance_to_cut_39yo, distance_to_cut_40yo, distance_to_cut_41yo, distance_to_cut_42yo, distance_to_cut_43yo, distance_to_cut_44yo, distance_to_cut_45yo, distance_to_cut_46yo, distance_to_cut_47yo, distance_to_cut_48yo, distance_to_cut_49yo, distance_to_cut_50yo))

Range_scale_data <- dplyr::mutate (Range_scale_data, distance_to_road = pmin (dist_crds_resource, dist_crds_paved,  dist_crds_petroleum, dist_crds_loose, dist_crds_rough, dist_crds_unknown))
...
There was variability in the caribou response to 1 to 5 year old cutblocks in DU6 (Fig. 3). For example, caribou in the Chinchaga, Maxhamish and Snake_Sahtaneh herds were slightly further from 1 to 5 year old cutblocks than what was available on average in their home range. Whereas, caribou in the Calendar and Parker herds showed no preference and Caribou in the Prophet herd were slightly closer to 1 to 5 year old cutblocks than what was available. A random effect for distance to 1 to 5 year old cutblocks was included in the GLMM to account for this variability.
...
ggplot (du6, aes (x = as.factor(pttype), y = distance_to_cut_11to50yo)) +
  geom_boxplot (outlier.colour = "red") +
...
du6$distance_to_road_scale<-scale(du6$distance_to_road,center=TRUE,scale = FALSE)
du6$distance_to_cut_1to5yo_scale<-scale(du6$distance_to_cut_1to5yo,center = TRUE,scale=FALSE)
du6$distance_to_cut_6to10yo_scale<-scale(du6$distance_to_cut_6to10yo,center = TRUE, scale = FALSE)
du6$distance_to_cut_11to50yo_scale<-scale(du6$distance_to_cut_11to50yo,center = TRUE, scale=FALSE)

model.lme4.du6.cut.rd.yr2 <- glmer (pttype ~ distance_to_road_scale +
                                      ...
                                      verbose = T) 
VarCorr(model.lme4.du6.cut.rd)
# check residuals
binnedplot (fitted (model.lme4.du6.cut.rd.yr2), 
...
binnedplot (du6$distance_to_road_scale, 
             residuals(model.lme4.du6.cut.rd.yr2, type = "response"), 
             nclass = NULL, 
...
binnedplot (du6$distance_to_cut_6to10yo_scale, 
             residuals(model.lme4.du6.cut.rd.yr2, type = "response"), 
             nclass = NULL, 
...
binnedplot (du6$distance_to_cut_11to50yo_scale, 
             residuals(model.lme4.du6.cut.rd.yr2, type = "response"), 
             nclass = NULL, 
...
summary(model.lme4.du6.cut.rd.yr2)
Anova(model.lme4.du6.cut.rd.yr2,type="III")
