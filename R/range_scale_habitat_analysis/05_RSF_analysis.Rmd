...
model.lme4.du6.cut.rd.yr <- glmer (pttype ~ distance_to_road_c +
                                         distance_to_cut_1to5yo_c +
                                         distance_to_cut_6to10yo_c +
                                         distance_to_cut_11to40yo_c +
                                        (distance_to_road_c|HERD_NAME) +
                                        (distance_to_cut_1to5yo_c|HERD_NAME) +
                                        (distance_to_cut_6to10yo_c|HERD_NAME) +
                                        (distance_to_cut_11to40yo_c|HERD_NAME) +
                                        (distance_to_road_c|year) +
                                        (distance_to_cut_1to5yo_c|year) +
                                        (distance_to_cut_6to10yo_c|year) +
                                        (distance_to_cut_11to40yo_c|year),
                                      data = du6, 
