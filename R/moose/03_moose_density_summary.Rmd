...
```{r, estimated wolf densites from recovery of disturbed habitat, warning = F, message = F, eval = T, echo = F, fig.align = "left", fig.cap = "Figure 4. Estimated Wolf Density in Wildlife Management Units (WMUs) as a Function of Habitat Disturbance at Current and Undisturbed (i.e, no roads or cutblocks) and Minimally Disturbed (15% of the WMU was cutblocks aged 1 to 30 years old)"}
