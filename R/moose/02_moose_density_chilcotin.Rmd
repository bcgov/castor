...
table.avg.coeff.est <- data.table ("Coefficient Name" = c ("Intercept", 
                                                           
                                                           
                                                           
                                                           "Proportion Burnt 16 to 30 years old", "Density Paved Roads", "Density Unpaved Roads",  "Proportion Pine spp.", "Proportion Poplar spp.",  "Proportion Douglas Fir", "Proportion Spruce spp.", "Proportion Cutblocks 1 to 10 years old", "Proportion Cutblocks 11 to 30 years old"),
                                   "Coefficient Estimate" = c (0.15, 
                                                               
                                                               18.58, -5.94, -3.59, 0.14,
                                                               3.10, 0.02, -0.03, 0.76, -0.31),
                                   "Adjusted Std. Error" = c (0.06, 
...
qqnorm (data.lme.final$lme.residuals) # some deviation in upper quantile; 5-04 1994 could be hte problem
