...
scenario = data.table (name = "morice_bau_no_fire",
                       description = "Business-as-usual case. Harvest flow = 950,000m3/yr. Adjacency = 3m. Oldest first. With no fire")
...
Make some maps
```{r}
castordb <- dbConnect(sqlite,"C:/Work/caribou/castor/fire_test_Lakes_tsa_castordb.sqlite")
...
areaBurned[]<-mySim$probFireRasts$prob_ignition_escape
plot(areaBurned)
