...
forestryCastor = list(harvestBlockPriority = " age DESC ", 
  ...
  fireCastor = list(calculateInterval =1,
                    ...
                    nameForestInventorybclcs_level_2 = "bclcs_lv_2",
                    nameForestInventorybclcs_level_3 = "bclcs_lv_3",
                    nameForestInventorybclcs_level_5 = "bclcs_lv_5",
                    nameForestInventoryinventory_standard_cd = "inv_std_cd",
                    nameForestInventorynon_productive_cd = "np_code",
                    nameForestInventorycoast_interior_cd ="c_i_code",
                    nameForestInventoryland_cover_class_cd_1 = "land_cd_1",
                    nameForestInventoryearliest_nonlogging_dist_type = "n_log_dist",
                    nameForestInventoryearliest_nonlogging_dist_date = "n_log_date",
                    nameForestInventoryvri_live_stems_per_ha = "live_stems",
                    nameForestInventoryvri_dead_stems_per_ha = "dead_stems",
