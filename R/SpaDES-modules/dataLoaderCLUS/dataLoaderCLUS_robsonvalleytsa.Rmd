...
---
title: "Database creation for Robson Valley TSA Analyses Version 1.0"
author: "Tyler Muhly"
date: "25 June 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for the [Robson Valley timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/robson-valley-tsa)). The TSA is located in eastern British Columbia, encompasses approximately 1.46 million hectares of land. It overlaps with the Columbia North (DU9), Wells Gray South (DU9), Hart Ranges (DU9), North Cariboo (DU9) and Redrock-Prairie Creek (DU8) caribou herds. 

On March 1, 2016, the allowable annual cut was set at 363,559 cubic metres.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Robson_Valley_TSA", # the boudnary (TSA) name
  ...
  uploaderCLUS = list(aoiName = 'robsonvalley_tsa',
