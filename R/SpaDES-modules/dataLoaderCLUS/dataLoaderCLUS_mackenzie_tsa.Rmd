...
Here I set the parameters to create a database for the [Mackenzie timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/mackenzie-tsa). The TSA is British Columbia’s fourth largest, covering 6.41 million hectares in B.C.’s northeast. The Mackenzie TSA’s allowable annual cut (AAC) is 4.5 million cubic metres as of November 14, 2014. A maximum of 2 M m3 is attributable to live uninfested timber and of this 500 000 can be taken from the south west portion of the TSA. 

The Sw portion overlaps with Moberly, Scott, and Wolverine, caribou herds. While the remainder of the TSA overlaps with the Gataga, Rabbit, Frog, Quintette, Chase, Wolverine, Finlay, Graham, Moberly, Kennedy Siding, caribou herds. 

# SW portion of Mackenzie
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", # rasters of the zone constraints to include
                                             ...
                                             "rast.zone_cond_cw",                                           "rast.zone_cond_noharvest_moberly_crithab_or_herd",
"rast.zone_cond_noharvest_scott_crithab_or_herd",
"rast.zone_cond_noharvest_wolverine_crithab_or_herd",                              "rast.zone_cond_eccc_moberly_crithab_or_herd",
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundaryFile = "tsa_aac_bounds", # name of the TSA boundary data in postgres
                         nameBoundaryColumn = "tsa_name", # name of the column in the boundary (TSA) data with the boundary (TSA) name
                         nameBoundary = "MacKenzie_TSA", # the boudnary (TSA) name
                         nameBoundaryGeom = 'wkb_geometry', # geometry column name in the boundary file
                         nameCompartmentRaster = "rast.tsa_aac_boundary", # name of the raster with boundaries (TSAs) id's (integers); note the 'raster' schema in postgres
                         nameCompartmentTable = "tsa_aac_bounds_vat", # boundary (TSA) names corresponding to raster id's
                         nameMaskHarvestLandbaseRaster = 'rast.bc_thlb2018', # THLB raster in postgres
...
"rast.zone_cond_noharvest_wolverine_crithab_or_herd",                             "rast.zone_cond_noharvest_chase_crithab_or_herd",                                "rast.zone_cond_noharvest_finlay_crithab_or_herd",
"rast.zone_cond_noharvest_kennedy_siding_crithab_or_herd",                        "rast.zone_cond_noharvest_graham_crithab_or_herd",           "rast.zone_cond_noharvest_rabbit_crithab_or_herd",
"rast.zone_cond_noharvest_quintette_crithab_or_herd",                             "rast.zone_cond_noharvest_frog_crithab_or_herd",
                                             "rast.zone_cond_eccc_moberly_crithab_or_herd",
"rast.zone_cond_eccc_gataga_crithab_or_herd",
"rast.zone_cond_eccc_wolverine_crithab_or_herd",                             "rast.zone_cond_eccc_chase_crithab_or_herd",                                "rast.zone_cond_eccc_finlay_crithab_or_herd",
"rast.zone_cond_eccc_kennedy_siding_crithab_or_herd",                        "rast.zone_cond_eccc_graham_crithab_or_herd",           "rast.zone_cond_eccc_rabbit_crithab_or_herd",
"rast.zone_cond_eccc_quintette_crithab_or_herd",                             "rast.zone_cond_eccc_frog_crithab_or_herd"
                                          ), 
                         nameZoneTable = "zone_constraints", # table that defines the constraints in the rasters
                         nameYieldsRaster = "rast.ycid_vdyp", # raster of stand id for VDYP ("natural origin") yields
                         nameYieldTable = "yc_vdyp", # VDYP yield  table
