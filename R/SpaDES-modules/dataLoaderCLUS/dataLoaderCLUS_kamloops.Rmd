...
---
title: "Database creation for Kamloops TSA Analyses Version 1.0"
...
Here I set the parameters to create a database for the [Kamloops timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/kamloops-tsa). The Kamloops TSA is located in south central British Columbia and ranges between Logan Lake in the south and Wells Gray Provincial Park in the north-west. In the east it is bounded by the Columbia Mountains and the Cariboo Regional District to the west. Overall the TSA covers approximately 2.77 million hectares of land. On June 1, 2008 the allowable annual cut was set at 4.0 million cubic metres. However, actual harvest levels billed between 2009-2013 have averaged 2.7 million cubic meters per year.

Four herds overlap with the Kamloops TSA - Columbia North, Groundhog, Wells Gray North and Wells Gray South. Thus for building the database only information on these herds were included
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameBoundary = "Kamloops_TSA", # change this name
  ...
  uploaderCLUS = list(aoiName = 'kamloops_tsa',
