...
---
title: "Database creation for 100 Mile TSA Analyses Version 1.0"
author: "Tyler Muhly"
...
Here I set the parameters to create a database for the [100 Mile timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/100-mile-house-tsa). 

The TSA is located in central British Columbia, encompasses approximately 1.24 Million hectares of land. It overlaps with the Wells Gray North	and Wells Gray South caribou herds (all in DU9). 

On November 7, 2013, the allowable annual cut was set at 2,000,000 cubic metres, of which no more than 500,000 cubic metres are attributable to live trees. However, from November 7, 2018 until the next determination, the AAC was set at 1,000,000 cubic metres, of which no more than 500,000 cubic metres are attributable to live trees
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', 
                         ...
                         nameBoundary = "Onehundred_Mile_House_TSA", # I updated '100' to 'Onehundred'; '100' wasn't working in the rasterclip2 fxn
  ...
  uploaderCLUS = list(aoiName = 'onehundred_mile_tsa',
