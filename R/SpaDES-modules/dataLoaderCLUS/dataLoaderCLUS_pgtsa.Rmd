...
---
title: "Database creation for Prince George TSA Analyses Version 1.0"
...
Here I set the parameters to create a database for the [Prince George timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/prince-george-tsa). The TSA isin British Columbia’s north-central interior and covers about 7.97 million hectares. The current AAC (October 11, 2017) is set at 8,350,000 cubic metres per year for the first five years, and
...
metres per year is attributed to deciduous-leading stands. A maximum of 750,000 cubic metres per year is attributed to bioenergy stands. Given the spatial partitions *** the Prince George TSA will have two seperate databases called pg and pg_north (representing supply blocks A&B)***.

For pg the TSA overlaps with the George Mountain, Narrow Lake, Hart Ranges, Tweedsmuir, Itchas-Ilgachuz, Kennedy Siding, North Cariboo, Red Rock Praire Creek, caribou herds (a combination of DU9, 8 and 7). While for pg_north the TSA overlaps with Takla, Wolverine, Chase, Thutade, and Spatsizi, caribou herds.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Prince_George_TSA", # the boudnary (TSA) name
 ...
 "rast.zone_cond_noharvest_george_mountain_crithab_or_herd",                                           "rast.zone_cond_noharvest_narrow_lake_crithab_or_herd",
 ...
 "rast.zone_cond_noharvest_redrock_prairie_creek_crithab_or_herd",
                                           "rast.zone_cond_eccc_george_mountain_crithab_or_herd",                                           "rast.zone_cond_eccc_narrow_lake_crithab_or_herd",
 ...
 "rast.zone_cond_eccc_redrock_prairie_creek_crithab_or_herd"
  ...
  uploaderCLUS = list(aoiName = 'prince_george_tsa',
...
# Prince George North (Supply blocks A&B)
For pg_north the TSA overlaps with Takla, Wolverine, Chase, Thutade, and Spatsizi, caribou herds.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundaryFile = "tsa_aac_bounds", # name of the TSA boundary data in postgres
                         nameBoundaryColumn = "tsa_name", # name of the column in the boundary (TSA) data with the boundary (TSA) name
                         nameBoundary = "Prince_George_North_TSA", # the boudnary (TSA) name
                         nameBoundaryGeom = 'wkb_geometry', # geometry column name in the boundary file
                         nameCompartmentRaster = "rast.tsa_aac_boundary", # name of the raster with boundaries (TSAs) id's (integers); note the 'raster' schema in postgres
                         nameCompartmentTable = "tsa_aac_bounds_vat", # boundary (TSA) names corresponding to raster id's
                         nameMaskHarvestLandbaseRaster = 'rast.bc_thlb2018', # THLB raster in postgres
 ...
 "rast.zone_cond_noharvest_chase_crithab_or_herd",                                           "rast.zone_cond_noharvest_wolverine_crithab_or_herd",
 ...
 "rast.zone_cond_eccc_chase_crithab_or_herd",                                           "rast.zone_cond_eccc_wolverine_crithab_or_herd",
                                          "rast.zone_cond_eccc_takla_crithab_or_herd",
                                          "rast.zone_cond_eccc_thutade_crithab_or_herd",
 "rast.zone_cond_eccc_spatsizi_crithab_or_herd"
                                          ), 
                         nameZoneTable = "zone_constraints", # table that defines the constraints in the rasters
                         nameYieldsRaster = "rast.ycid_vdyp", # raster of stand id for VDYP ("natural origin") yields
                         nameYieldTable = "yc_vdyp", # VDYP yield  table
