...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus',
                         ...
                         nameBoundary = "Cascadia_TKO_TSA", # "Cascadia_TKO_TSA" = Cascadia Kootenay area
  ...
  uploaderCLUS = list(aoiName = 'cascadia_kootenay_block',
...
scenario = data.table(name="load_data_kootenay", 
                      description = "dataloader Kootenay Block area")
