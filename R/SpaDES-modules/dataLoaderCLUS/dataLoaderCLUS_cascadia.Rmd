...
---
title: "Database creation for Cascadia TSA Kootenay Block Analyses Version 1.0"
author: "Tyler Muhly"
date: "8 June 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for the [Cascadia timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/cascadia-tsa). 

The TSA is divided into 11 blocks,divided into 4 business areas: Kootenay, Okanagan-Columbia, Cariboo-Chilcotin, and Skeena.  BC timber sales (BCTS) holds all of the AAC in this unit, and the allowable annual cut (AAC) is set for each of those areas.

The Skeena business area overlaps with the Telkwa caribou herd. The Cariboo-Chilcotin business area overlaps with the Narrow Lake and Barkerville caribou herds. The Okanagan-Columbia business area overlaps with the Monashee caribou herd, and the Kootenay business area overlaps with the Central Selkiks caribou herd.

On January 23, 2020, the allowable annual cut (AAC) in the Kootenay business area was set at 101,420 cubic metres, the AAC for Okanagan-Columbia business area was set at 63,000 cubic metres, the AAC for the Cariboo-Chilcotin business area was set at 65,740 cubic metres, and  the AAC for the Skeena business area was set at 126,070 cubic metres. 
...
parameters <-  list(
  ...
  uploaderCLUS = list(aoiName = 'cascadia_okanagan_columbia', # cascadia_okanagan_columbia  cascadia_kootenay_block
...
scenario = data.table(name="load_data_ok",  # load_data_kootenay  load_data_ok
                      description = "dataloader Okanagan area")  # Kootenay Block Okanagan
