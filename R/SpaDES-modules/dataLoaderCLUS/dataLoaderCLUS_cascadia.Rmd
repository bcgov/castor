...
Here I set the parameters to create a database for the [Cascadia timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/cascadia-tsa). The TSA is divided into 11 blocks, of which only block 3 occurs within caribou range. BC timber sales (BCTS) holds all of the AAC in this unit. The unit is divided into 4 business areas, adn AAC is set for each of those areas. Block 3 occurs within the "Kootenay" busniess area, which is the focus of the analysis here.  It overlaps with the Central Selkirks caribou herds (all in DU9).

On Januaury 23, 2020, the allowable annual cut in teh Kooenay block was set at 101,420 cubic metres,
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Cascadia_TKO_TSA", # Cascadia Kootenay block name
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", # rasters of the zone constraints to include
                                             ...
                                             "rast.zone_cond_cw", 
                                             "rast.zone_cond_noharvest_central_selkirks_crithab_or_herd",                                                           "rast.zone_cond_eccc_central_selkirks_crithab_or_herd"
                                          ), 
