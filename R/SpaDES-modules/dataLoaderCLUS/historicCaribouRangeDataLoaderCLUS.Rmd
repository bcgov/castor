...
aoi_herds<-c("Barkerville", "Central_Selkirks", "Columbia_North", "Columbia_South", "Groundhog", "Narrow_Lake", "North_Cariboo", "Purcells_South","Purcell_Central", "South_Selkirks","Wells_Gray_North", "Wells_Gray_South","Frisby_Boulder") #DU9
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
    ...
    #                    tableCaribouHerd = "public.criticalhabitat_gen_bc_vat"),
     uploaderCLUS = list(aoiName = 'disturbance_measures2',
...
modules <- list("dataLoaderCLUS", "roadCLUS", "cutblockSeqPrepCLUS", "uploaderCLUS", "disturbanceCalcCLUS")
