...
---
title: "Database creation for Arrow TSA Analyses Version 1.0"
author: "Tyler Muhly"
date: "8 June 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for the [Arrow timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/arrow-tsa). The TSA is located in south-eastern British Columbia, encompasses approximately 1.3 million hectares of land. It overlaps with the Central Selkirks, Columbia South, Monashee and South Selkirks caribou herds (all in DU9). On November 16, 2017, the allowable annual cut was set at 500,000 cubic metres,
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Arrow_TSA", # the boudnary (TSA) name
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", # rasters of the zone constraints to include
                                             ...
                                             "rast.zone_cond_cw", 
                                          "rast.zone_cond_noharvest_central_selkirks_crithab_or_herd",                                                              "rast.zone_cond_noharvest_columbia_south_crithab_or_herd",
  ...
  uploaderCLUS = list(aoiName = 'arrow_tsa',
