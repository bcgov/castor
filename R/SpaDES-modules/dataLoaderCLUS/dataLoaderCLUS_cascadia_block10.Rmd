...
---
title: "Database creation for Cascadia TSA Block 10 Analyses Version 1.0"
author: "Tyler Muhly"
date: "10 June 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for the [Cascadia timber supply area (TSA), Block 10 only](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/cascadia-tsa). The TSA is located in northern-west British Columbia. 
On January 23, 2020 the allowable annual cut for teh Skeena portion of the Cascadia TSA, which includes blocks 9 to 11, was set at 126,070 cubic metres/year. The Telkwa herd overlap with block 10 of the Cascadia TSA, block 10.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameBoundaryFile="tsa_nw_coast_no_tfl", # note coastal TSA
                         nameBoundaryColumn="tsa_name",
                         nameBoundary = "Cascadia_TSA_Block10", # change this name
  ...
  uploaderCLUS = list(aoiName = 'cascadia_blk10_tsa',
