...
---
title: "Database creation for TFL 18 Analyses Version 1.0"
...
Here I set the parameters to create a database for the [Tree Farm Licence 18 (TFL18)](https://www2.gov.bc.ca/gov/content/industry/forestry/forest-tenures/timber-harvesting-rights/tfl/tfl-18). TFL14 covers a total area of 74 266 hectares and is situated northwest of Clearwater, BC in undulating terrain with an elevation range of 516 to 1989 meters. The TFL is within the Kamloops Timber Supply Area.  In January 2017 Canfor requested a harvest rate of 201 000 cubic meters. It is unclear what the actual AAC was set at.

One caribou herd overlap with TFL18 - Wells Gray South. 
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameBoundary = "TFL18", # change this name
  ...
  uploaderCLUS = list(aoiName = 'tfl18',
