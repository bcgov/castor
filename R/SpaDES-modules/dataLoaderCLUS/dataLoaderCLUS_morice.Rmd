...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameZoneRasters=c("rast.zone_cond_beo", "rast.zone_cond_vqo", "rast.zone_cond_wha", "rast.zone_cond_uwr", "rast.zone_cond_nharv","rast.zone_cond_fsw", "rast.zone_cond_cw", "rast.zone_cond_"),# add all zone rasters I need but first 7 always stay
...
scenario = data.table(name="morice_bau", description = "Simple flow")
