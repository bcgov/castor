...
#Sys.setenv(JAVA_HOME = 'C:\\Program Files\\Java\\jre1.8.0_241') # this is what Kyle had before
...
# its weird though because my inputPath and OutputPath are something like: "D:\\temp\\Rtmpglw3bx/SpaDES/outputs"
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameZoneRasters=c("rast.zone_cond_beo", "rast.zone_cond_vqo", "rast.zone_cond_wha", "rast.zone_cond_uwr", "rast.zone_cond_nharv","rast.zone_cond_fsw", "rast.zone_cond_cw", "rast.zone_cond_bc_telkwa_crithab", "rast.zone_cond_eccc_telkwa_crithab", "rast.zone_cond_nh_crit_telkwa_crithab", "rast.zone_cond_bc_charlotte_alplands_crithab", "rast.zone_cond_bc_itcha_ilgachuz_crithab", "rast.zone_cond_bc_rainbows_crithab", "rast.zone_cond_eccc_charlotte_alplands_crithab", "rast.zone_cond_eccc_itcha_ilgachuz_crithab", "rast.zone_cond_eccc_rainbows_crithab", "rast.zone_cond_nh_crit_charlotte_alplands_crithab", "rast.zone_cond_nh_crit_itcha_ilgachuz_crithab", "rast.zone_cond_nh_crit_rainbows_crithab"),# add all zone rasters I need but first 7 always stay
                         nameZoneTable="zone_constraints", # this is a parent table so other tables inherit it
...
scenario = data.table(name="morice_all_data", description = "Populated database with relevant data to run scenarios")
