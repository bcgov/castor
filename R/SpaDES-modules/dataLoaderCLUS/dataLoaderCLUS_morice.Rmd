...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameZoneRasters=c("rast.zone_cond_beo", # rasters of the zone constraints to include. Add all zone rasters that might be needed here. First 7 always stay.
                                           ...
                                           "rast.zone_cond_fsw", 
                                           "rast.zone_cond_cw",
                                           "rast.zone_bc_bounds_chase_noharvest",
                                           "rast.zone_bc_bounds_takla_noharvest",
                                           "rast.zone_bc_bounds_wolverine_noharvest",
                                           "rast.zone_bc_bounds_tweedsmuir_noharvest",
                                           "rast.zone_bc_bounds_rainbows_noharvest",
                                           "rast.zone_bc_bounds_itcha_ilgachuz_noharvest",
                                           "rast.zone_bc_bounds_charlotte_alplands_noharvest",
                                           ...
                                           "rast.zone_cond_eccc_telkwa_crithab",
                                           "rast.zone_cond_eccc_charlotte_alplands_crithab",
                                           "rast.zone_cond_eccc_itcha_ilgachuz_crithab",
                                           "rast.zone_cond_eccc_rainbows_crithab",
                                           "rast.zone_cond_nh_crit_telkwa_crithab",
                                           "rast.zone_cond_nh_crit_charlotte_alplands_crithab",
                                           "rast.zone_cond_nh_crit_itcha_ilgachuz_crithab",
