...
Here I set the parameters to create a database for the [Okanagan timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/okanagan-tsa). The TSA stretches from the Canada-United States border in the south to the Seymour River and Shuswap Lake in the north, and from the Monashee Mountains in the east to the Okanagan Mountains in the west. The Okanagan TSA encompasses approximately 2.25 million hectares of land. On January 1, 2013 the allowable annual cut was set at 3,078,405 cubic metres. Since 1980 to present the AAC has varied quite a bit, with the lowest level set from 1980 to 1986 with an AAC of 2 700 000 cubic meters, and the highest level set at 3 375 000 cubic meters between 2006 and 2013 to facilitate the harvest of timber affected by mountain pine beetle.

Several caribou herds overlap with the Okanagan TSA - Columbia North, Frisbee-Boulder and Monashee. 
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameBoundary = "Okanagan_TSA", # change this name
  ...
  uploaderCLUS = list(aoiName = 'okanagan_tsa',
...
scenario = data.table(name="okanagan_dataloader", 
