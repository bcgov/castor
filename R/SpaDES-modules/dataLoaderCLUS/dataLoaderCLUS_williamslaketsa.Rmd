...
---
title: "Database creation for Williams Lake TSA Analyses Version 1.0"
...
Here I set the parameters to create a database for the [Williams Lake timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/williams-lake-tsa) which lies in the central Cariboo Region, straddling the Fraser Basin and the Interior Plateau between the Coast Mountains on the west and the Cariboo Mountains on the east. It is bounded by the Quesnel TSA to the north and 100 Mile House and Lillooet TSAs to the south. The allowable annual cut (AAC) for the Williams Lake TSA is 3 million cubic metres as of February 25, 2015. This includes a partition of a maximum of 1 500 000 cubic metres per year for live
volume which means the remainder of the AAC is for salvaging dead trees.This TSA overlaps with the Itcha-Ilgachuz, Charlotte Alplands, Rainbows, Wells gray North, and Barkerville, caribou herds. 
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Williams_Lake_TSA", # the boudnary (TSA) name
  ...
  uploaderCLUS = list(aoiName = 'williams_lake_tsa',
