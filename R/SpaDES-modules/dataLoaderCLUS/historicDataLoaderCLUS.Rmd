...
rsf_model_coeff <- data.table(getTableQuery("SELECT * FROM caribou_avoid_coeff WHERE population = 'DU7' and  species = 'caribou' and season IN ('A')"))


scenario = data.table(name="testing", description = "historical disturbances")
modules <- list("dataLoaderCLUS", "cutblockSeqPrepCLUS", "roadCLUS", "survivalCLUS", "rsfCLUS")
