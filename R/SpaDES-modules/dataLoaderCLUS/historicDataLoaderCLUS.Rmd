...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
    ...
    uploaderCLUS = list(aoiName = 'dm_all_1040',
...
#scenario = data.table(name='Hart_Ranges_South', description = "historical disturbances")
scenario = data.table(name=herd, description = "historical disturbances")
modules <- list("dataLoaderCLUS", "roadCLUS", "cutblockSeqPrepCLUS", "survivalCLUS", "disturbanceCalcCLUS", "uploaderCLUS")
