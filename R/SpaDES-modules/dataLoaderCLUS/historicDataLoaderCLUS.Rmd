...
#aoi_herds<-c("Barkerville", "Central_Selkirks", "Central_Rockies", "Columbia_North", "Columbia_South", "Frisby_Boulder", "Groundhog", "Hart_Ranges", "Narrow_Lake", "North_Cariboo", "Purcells_South","Purcells_Central", "South_Selkirks","Wells_Gray_North", "Wells_Gray_South") #DU9
#aoi_herds<-c("Kennedy_Siding", "Moberly", "Narraway") #DU8
#aoi_herds<-c("Graham") #DU7
aoi_herds<-c("Purcell_Central")
