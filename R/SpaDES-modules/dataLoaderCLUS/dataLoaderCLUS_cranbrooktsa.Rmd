...
---
title: "Database creation for Cranbrook TSA Analyses Version 1.0"
author: "Tyler Muhly"
...
Here I set the parameters to create a database for the [Cranbrook timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/cranbrook-tsa). 

The TSA is located in south-eastern corner of British Columbia, encompasses approximately 1.2 million hectares of land. It overlaps with the Purcell Central and Purcells South caribou herds (all in DU9). On August 24, 2017, the allowable annual cut was set at 808,000 cubic metres.
...
parameters <-  list(
  ...
  uploaderCLUS = list(aoiName = 'cranbrook_tsa',
