...
---
title: "Database creation for TFL 52 Analyses Version 1.0"
author: "Tyler Muhly"
...
Here I set the parameters to create a database for [Tree Farm Licence (TFL) 52](https://www2.gov.bc.ca/assets/gov/farming-natural-resources-and-industry/forestry/stewardship/forest-analysis-inventory/tsr-annual-allowable-cut/tree-farm-license/52tfra_2019.pdf)). TFL 52 is located east of Quesnel, in the Cariboo region. The TFL occupies a total area of 261,468 hectares, of which 171,884 hectares is within the THLB. 

On June 17, 2019, the  AAC for TFL 52 was set at 592,500 cubic metres, of which 570,000 cubic metres was partitioned for conifer.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", 
                                             ...
                                             "rast.zone_cond_cw", 
                                        "rast.zone_cond_noharvest_north_cariboo_crithab_or_herd",                                                     "rast.zone_cond_eccc_north_cariboo_crithab_or_herd",
                                        "rast.zone_cond_noharvest_narrow_lake_crithab_or_herd",                                                       "rast.zone_cond_eccc_narrow_lake_crithab_or_herd",
                                        "rast.zone_cond_noharvest_barkerville_crithab_or_herd",                                                       "rast.zone_cond_eccc_barkerville_crithab_or_herd",
  ...
  uploaderCLUS = list(aoiName = 'tfl52',
