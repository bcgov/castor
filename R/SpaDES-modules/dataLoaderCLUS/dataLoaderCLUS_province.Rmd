...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameYieldsRaster = "rast.yc_vdyp",
                         nameYieldsTransitionRaster = "rast.yc_tipsy",
...
scenario<-data.table(name="bau", description = "buisness as usual-projecting current trends")#NOTE: do not use special characters (.,/+=;'!@#$%^&*)
