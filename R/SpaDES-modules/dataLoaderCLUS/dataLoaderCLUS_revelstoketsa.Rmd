...
Here I set the parameters to create a database for the [Revelstoke timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/revelstoke-tsa). The TSA is located in south-eastern British Columbia, encompasses approximately 527,000 hectares of land. It overlaps with the Monashee, Frisby Boulder, Columbia South, Central Rockies and Columbia North caribou herds (all in DU9). 
