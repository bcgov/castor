...
Here I set the parameters to create a database for the [Kalum timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/kalum-tsa). 

The TSA is located in west-central British Columbia, encompasses approximately 2.3 Million hectares of land. It overlaps with the Tweedsmuir	and Twlkwa caribou herds. 

The Kalum TSA’s allowable annual cut (AAC) is 424,000 cubic metres, effective February 16, 2011
...
parameters <-  list(
  ...
  uploaderCLUS = list(aoiName = 'kalum_tsa',
