...
---
title: "Database creation for TFL 55 Analyses Version 1.0"
author: "Tyler Muhly"
date: "10 July 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for [Tree Farm Licence (TFL) 55](https://www2.gov.bc.ca/assets/gov/farming-natural-resources-and-industry/forestry/stewardship/forest-analysis-inventory/tsr-annual-allowable-cut/tree-farm-license/55tfra_2017.pdf). TFL 55 is located in the Selkirk Mountains, north of Revelstoke. The TFL occupies a total area of 92,700 hectares. 

On March 24, 2017, the  AAC for TFL 55 was set at 83,000 cubic metres.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", 
                                             ...
                                             "rast.zone_cond_noharvest_central_rockies_crithab_or_herd",                                                                     "rast.zone_cond_eccc_central_rockies_crithab_or_herd",
  ...
  uploaderCLUS = list(aoiName = 'tfl55',
