...
nameYieldRaster<-a provincial raster of id's that support a look up to yield tables. Deflauts to 1 yeild table
...
nameMaskHarvestLandbaseRaster<- a provincial raster of the timber harvesting landbase (THLB) that delinates area feasible to harvest timber. Defaluts to all of the area of interest being eligible for harvesting.
