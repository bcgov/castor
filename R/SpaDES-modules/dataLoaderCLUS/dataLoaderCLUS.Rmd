...
<<<<<<< HEAD
                         nameZoneRasters=c("rast.beo_const", "rast.vqo_const",  "rast.uwr_const", "rast.fsw_const", "rast.nharv_const"),
                         ...
                         nameZoneRasters=c("rast.beo_const", "rast.vqo_const",  "rast.uwr_const", "rast.fsw_const", "rast.nharv_const"), # scenario rasters needs to be specified here too, e.g., rast.zone_crit_habitat_chilcotin
                         nameZoneTable="zone_constraints", # scenario table needs to be specified here too, e.g., zone_crit_habitat_chilcotin
                         #nameForestInventoryRaster ="rast.vri2002_id",
                         #nameForestInventoryKey = "feature_id",
