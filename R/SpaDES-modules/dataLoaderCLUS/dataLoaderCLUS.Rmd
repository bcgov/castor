...
setPaths(modulePath = file.path(paste0(here::here(), "/R/SpaDES-modules")), cachePath =paste0(here::here(), "/R/SpaDES-modules"), rasterPath = paste0(here::here(), "/R/SpaDES-modules") )
