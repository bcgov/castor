...
parameters <-  list(
  ...
  roadCLUS = list(roadMethod = 'pre', # 'pre' creates the road network usign a a minimum spanning tree to all potential 'ladndings (created in blockingCLUS)
...
patchSizeDist<- data.table(ndt= c(1,1,1,1,1,1,
                           ...
                           freq = c(0.3,0.3,0.1,0.1,0.1, 0.1,
                                    ...
                                    0.3,0.3,0.1,0.1,0.1, 0.1))
modules <- list("dataLoaderCLUS", "blockingCLUS", "roadCLUS", "rsfCLUS", "survivalCLUS", "uploaderCLUS", "disturbanceCalcCLUS")
