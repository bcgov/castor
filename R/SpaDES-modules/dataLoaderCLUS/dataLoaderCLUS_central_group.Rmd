...
---
title: "Database creation for Central Group of Caribou Analyses Version 2.0"
...
Here I set the parameters to create a database for the central group of caribou


central grouop inlcudes: Moberly, Kennedy Siding, 

TSAs

[Mackenzie timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/mackenzie-tsa). The TSA is British Columbia’s fourth largest, covering 6.41 million hectares in B.C.’s northeast.
...
combined these TSAs into a singel 'caribou_area' in tsa_bounds called 'central_group' 
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundaryColumn = "caribou_area", # new caribou area column
                         nameBoundary = "central_group", # tsa/tfl that overlaps caribou area
