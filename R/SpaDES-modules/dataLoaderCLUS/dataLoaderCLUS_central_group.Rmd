...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameBoundaryFile ="", # study_area_chilcotin; chilcotin_area_of_interest_habitat
                         nameBoundaryColumn = "tsa_name", # tsa_name
                         nameBoundary = c (), # c ('Quesnel_TSA_Matrix', 'Quesnel_TSA_HEWSR', 'Quesnel_TSA_LESR', 'Quesnel_TSA_LEWR', 'Quesnel_TSA_out', 'Williams_Lake_TSA_HEWSR', 'Williams_Lake_TSA_LESR', 'Williams_Lake_TSA_LEWR', 'Williams_Lake_TSA_Matrix', Williams_Lake_TSA_out')  
                        # c ('Matrix', 'HEWSR', 'LESR', 'LEWR', 'out')
                         nameBoundaryGeom = 'wkb_geometry',
                         nameCompartmentRaster = "rast.", #rast.study_area_chilcotin
                         nameCompartmentTable = "vat.",
