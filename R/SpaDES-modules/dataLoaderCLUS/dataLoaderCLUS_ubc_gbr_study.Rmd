...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameZoneTable = "zone_constraints", # wonder if this should be zone_constraints_gbr? table that defines the constraints in the rasters. Its a parent table so other tables inherit it
