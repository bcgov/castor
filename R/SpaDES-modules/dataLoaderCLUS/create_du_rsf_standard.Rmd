...
#aoi_herds<-c("Purcells_South","Barkerville", "Central_Selkirks", "Central_Rockies", "Columbia_North", "Columbia_South", "Frisby_Boulder", "Groundhog", "Hart_Ranges", "Narrow_Lake", "North_Cariboo",  "South_Selkirks","Wells_Gray_North", "Wells_Gray_South") #DU9
#aoi_herds<-c("Kennedy_Siding", "Moberly", "Narraway") #DU8
#aoi_herds<-c("Graham") #DU7
aoi_herds<-c("Narraway") #DU8
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
    ...
    uploaderCLUS = list(aoiName = 'rsf_current',
...
rsf_model_coeff <- data.table(getTableQuery("SELECT * FROM rsf_model_coeff WHERE population = 'DU8' and  species = 'caribou' and season IN ('A')"))
rsf_model_coeff[, population:= aoi_herds]
rsf_model_coeff[, bounds:= 'rast.bc_crithab']

scenario = data.table(name="all_dus", description = "current disturbances")
