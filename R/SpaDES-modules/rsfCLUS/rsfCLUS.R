...
defineModule(sim, list(
  ...
  parameters = rbind(
    ...
    defineParameter("rsfCalcInterval", "numeric", 1, NA, NA, "This describes the simulation time at which resource selection function should be calculated"),
...
getDistanceToLayers<-function(){ #this function takes a sql statement and returns the distance to the result set generated by the sql
