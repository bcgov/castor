...
rsf_model_coeff <- data.table(getTableQuery("SELECT * FROM rsf_model_coeff WHERE species = 'caribou' AND population = 'DU8' AND season = 'LW'"))
...
#rsf_model_coeff<-rsf_model_coeff[!(sql== 'rast.dist_to_ag'), ]
rsf_model_coeff<-rsf_model_coeff[!(sql== 'rast.tave_wt'), ]
#rsf_model_coeff<-rsf_model_coeff[!(sql== 'rast.ppt_snow_winter'), ]
