...
rsf_model_coeff<-data.table(population = c("DU6", "DU6","DU6","DU6","DU6","DU6",
                                           ...
                                           "DU6","DU6"),
                            season =c("EW","EW","EW","EW","EW","EW","EW","EW","EW","EW","EW",
                            ...
                            beta = c(-2.562923161, -0.017756076, -0.018701324, 
                                     ...
                                     -2.07466903, -0.041530085),
                            layer=c('int', "rast.bc_ha_slope", "rast.dt_waterbodies",
                                    "rast.dt_watercourses",'du6_cut_1_4','du6_cut_5_10','du6_cut_gt_10',
                                    'age','height','crownclosure', 'rast.crds_paved',
                                    
                                    'int','du6_cut_5_10'),
                            type =c('','','','','DT', 'DT','DT','UP','UP','UP', 'DT', 
                                    '', 'DT'),
                            sql=c('','','','', 'blockid > 0 AND age BETWEEN 1 AND 4',
                                  'blockid > 0 AND age BETWEEN 5 AND 10', 
                                  'blockid > 0 AND age BETWEEN 11 AND 60','','','', '> 0',
