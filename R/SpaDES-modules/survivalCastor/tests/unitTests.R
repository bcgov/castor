...
test_dir("C:/Work/caribou/clus_github/R/SpaDES-modules/survivalCLUS/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Work/caribou/clus_github/R/SpaDES-modules/survivalCLUS/tests/testthat/test-template.R")
