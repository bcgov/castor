...
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/MacKenzie_SW_TSA_clusdb.sqlite")) # MacKenzie_SW_TSA_clusdb.sqlite   Mackenzie_TSA_clusdb.sqlite
...
parameters <- list(
  ...
  dataLoaderCLUS = list( 
                           dbName='clus',
                           save_clusdb = FALSE,
                           useCLUSdb = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/MacKenzie_SW_TSA_clusdb.sqlite"), # MacKenzie_TSA_clusdb.sqlite  MacKenzie_SW_TSA_clusdb.sqlite  
                           #Study Area
                           nameBoundaryFile = "tsa_aac_bounds",
                           nameBoundaryColumn = "tsa_name",
                           nameBoundary = "MacKenzie_SW_TSA", # MacKenzie_TSA   MacKenzie_SW_TSA
...
harvestFlow <- rbindlist(list(data.table(compartment ="MacKenzie_SW_TSA",
                                     ...
                                     year = rep( seq (from = 2019, # run the 
                                                      to = 2219, 
                                                      by = 5),
                                                1), 
                                     flow = 6500000) # 1,300,000m3/yr
))
