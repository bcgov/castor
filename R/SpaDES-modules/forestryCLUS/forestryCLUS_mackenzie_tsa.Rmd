...
- In the main portion of the TSA, first, I tested a harvest flow of 1,500,000m^3^/year (7,500,000m^3^/5-year); was acheivle, so tried 1.75 M m3, 1.65 M, 1.70 M n3
...
- in TSR, the annual average was 200, allowign for <200, but I used 150 m3/ha as minimum harvest volume, and assesed what the average was *a priori* to make sure I was at ~200; foudn that with a 1.5 Mm3 flow, for 21 of 200 years average <200 and 16 of 200 years average less than 195, and 4 of 200 years less than 185; so I am overesriamtign use of low voluem stands 8-10% of the time, but on average typiecally not mode than by 15m3/ha; lowest average was 180 m3; so I kept as is (any) major concerns with this?)
