...
# Below makes the Moberly(Klinse-za) and Kennedy Siding critical habitat with early seral constraints
## Kennedy Siding
...
harvestFlow <- rbindlist(list(data.table(compartment ="MacKenzie_TSA", # # MacKenzie_TSA   MacKenzie_SW_TSA
                                     ...
                                     year = rep( seq (from = 2019, # run the 
                                                      ...
                                                      by = 5),
                                                1), 
                                     flow = 9750000) # southwest: 6500000 / 1,300,000m3/yr //north: 9750000 / 1,950,000m3/yr 
))
