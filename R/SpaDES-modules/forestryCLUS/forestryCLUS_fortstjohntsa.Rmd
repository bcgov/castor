...
zoneconstraints<-dbGetQuery(clusdb, "SELECT * from zoneconstraints where reference_zone = 'rast.brfn_areas_fsj'") 
...
scenario = data.table (name = "fsj_nocore_multi_plan_low",
