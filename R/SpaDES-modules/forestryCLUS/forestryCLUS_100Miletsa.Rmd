...
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/Onehundred_Mile_House_TSA_clusdb.sqlite")) # connext to clusdb -- set the locations of the sqlite
...
harvestFlow <- rbindlist(list(data.table(compartment ="Onehundred_Mile_House_TSA",
                                         ...
                                         year = rep(seq (from = 2018, 
                                                         ...
                                                         by = 5),
                                                    1), 
                                         flow = 8250000) # 1,650,000m^3^/year
))
