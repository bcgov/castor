...
- First, I tested a harvest flow of 808,000m^3^/year (2,375,000m^3^/5-year), 750,000, 700,000, 650,000, 675,000, 665,000, 670,000

- 670,000m^3^/year was used; coudl be maitnained except last time step (years 195-200)
...
=======
                                           ...
                                           # "rast.zone_cond_noharvest_purcells_south_crithab_or_herd" 
                                           # "rast.zone_cond_eccc_purcells_south_crithab_or_herd"
>>>>>>> d3c0af3aa91f4d929a8dd443511aab8c1415b9bb
                                               ),
...
#                        description = "Business-as-usual case; sustainable flow = 670,000m3/yr. Adjacency was set to 3m.")
# scenario = data.table (name = "cranbrook_purcell_central_nh",
# description = "No harvest in Purcell Central critical habitat. Adjacency was set to 3m. Harvest flow = 670,000m3/yr.")
...
# description = "No harvest in Purcells South critical habitat. Adjacency was set to 3m. Harvest flow = 670,000m3/yr.")


scenario = data.table (name = "cranbrook_purcells_south_ch_he0d_m15d",
                       description = "No harvest in Purcells South high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Purcells South matrix critical habitat. Adjacency was set to 3m. Harvest flow = 670,000m3/yr.")
=======
scenario = data.table (name = "cranbrook_bau",
                       description = "Business-as-usual case; sustainable flow = 750,000m3/yr. Adjacency was set to 3m.")

# scenario = data.table (name = "icranbrook_purcell_central_nh",
...
harvestFlow <- rbindlist(list(data.table(compartment ="Cranbrook_TSA",
                                     ...
                                     year = rep( seq (from = 2018, 
                                                ...
                                                1), 
<<<<<<< HEAD
                                     flow = 3350000) #670,000m3/yr 
=======
                                     flow = 3750000) #750,000m3/yr 
>>>>>>> d3c0af3aa91f4d929a8dd443511aab8c1415b9bb
))
