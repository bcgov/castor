...
parameters <- list(
  ...
  dataLoaderCLUS = list(   dbName='clus',
                           ...
                           nameZoneRasters=c(#"rast.zone_cond_beo", # leave out beo for the UBC study because I think similar info is comming from the art
                                           "rast.zone_cond_vqo",
...
harvestFlow <- rbindlist(list(data.table(compartment ="UBC_study_boundary",
                                     ...
                                     flow = 2000000))) #2500000, 2400000, 2300000, 2200000 dont work. # 1780000 works  with vol >150
