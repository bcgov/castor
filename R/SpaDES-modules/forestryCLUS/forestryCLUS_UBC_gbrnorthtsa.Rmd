...
times <- list(start = 0, end = 40) # 3 year interval; 30 years = 10 intervals # this was originally increased by 5 years and 40 intervals i.e. to get a 200 year simulation
parameters <- list(
  ...
  disturbanceCalcCLUS = list(calculateInterval = 5, # was 5 
                             criticalHabitatTable = "public.vat_bc_crithab_and_herd",
                             criticalHabRaster = "rast.bc_crithab_and_herd",
                             permDisturbanceRaster = "rast.mine_ag_wind_rail",
                             recovery = 40),
  uploaderCLUS = list(aoiName = 'ubc_gbr_study', # name of the schema that gets uploaded to postgres
...
harvestFlow <- rbindlist(list(data.table(compartment ="UBC_study_boundary",
                                     ...
                                     flow = 1800000))) # try 1 3300000, try 2 3000000,3.) 2900000, 4.) 2500000 5.) 2100000 (worked), 2200000 (did not),
