...
parameters <- list(
  ...
  forestryCLUS = list(harvestBlockPriority = "age DESC", # "dist, age DESC, vol DESC"
                      ...
                      reportHarvestConstraints = TRUE, # This should spit out a report of harvest constraints in the global environment so I can see which constraints occured where.
...
harvestFlow <- rbindlist(list(data.table(compartment ="UBC_study_boundary",
                                     ...
                                     flow = 2050000,
                                     partition_type = 'live'))) #2000000 = yes, 2100000=no, 2500000=no, 3500000=no(I think), 4000000=no,
