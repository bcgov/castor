...
zoneconstraints<-dbGetQuery(clusdb, "SELECT * from zoneConstraints WHERE reference_zone = 'rast.zone_du7_scenario_20210330'") # rast.zone_cond_bc_telkwa_crithab  rast.zone_cond_bc_tweedsmuir_crithab


# Whitesail scenarios
# Below makes everythign a no harvest zone
