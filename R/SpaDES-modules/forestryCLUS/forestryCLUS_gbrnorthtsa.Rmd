...
parameters <- list(
  ...
  dataLoaderCLUS = list(   dbName='clus',
                           save_clusdb = FALSE,
                           sqlite_dbname = "Great_Bear_Rainforest_North_TSA",
...
harvestFlow <- rbindlist(list(data.table(compartment ="Great_Bear_Rainforest_North_TSA",
                                     ...
                                     flow = 4800000,
                                     partition_type = 'live'))) # 1.) try 5000000 did not worked, 2.) 4500 000 worked, 3.) 4 600 000 worked, 4 700 000 worked, 4900000 did not work, 4800000 worked but 4 850 000 did not.
