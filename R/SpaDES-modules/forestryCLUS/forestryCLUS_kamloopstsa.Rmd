...
#                        description = "No harvest in Groundhog high elevation critical habitat; harvest allowed in matrix critical habitat yp to 12% disturbance (no buffer). Harvest flow 1,500,000 m3/yr. Adjacency = 3m. Oldest first.")

scenario = data.table (name = "kamloops_groundhog_high_med_low_priority",
                       description = "No harvest in Groundhog high priority stands in all high elevation critical habitat; harvest allowed in all matrix critical habitat up to 15% disturbance (no buffer). Harvest flow 1,500,000 m3/yr. Adjacency = 3m. Oldest first.")
