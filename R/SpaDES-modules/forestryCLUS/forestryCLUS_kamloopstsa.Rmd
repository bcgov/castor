...
# GROUNDHOG
# View the constraints available to a zone
zoneconstraints<-dbGetQuery(clusdb, "SELECT * from zoneConstraints WHERE reference_zone = 'rast.zone_gh_scenarios'") 

#Below will set Grounhog old and recruit forest as no harvest and matrix as 35% disturbance (no buffer)
