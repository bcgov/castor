...
dbExecute(clusdb, "UPDATE zoneconstraints set percentage = 85 where (reference_zone = 'rast.zone_cond_eccc_narrow_lake_crithab_or_herd') AND (variable = 'dist')") 
...
## 'harvestFlow'
- based on interpretation of analysis report, I tested a harvest flow of 350,000m^3^/year (1,750,000m^3^/5-year); 250,000, 200,000, 175,000, 185,000, 190,000, 195,000

not cear from pdp or detemiantion what the priority queue, adjacency or min harvest criteria were
...
#                        description = "Business-as-usual case; sustainable flow = 195,000m^3^/year. Adjacency was set to 3m.")
...
#                        description = "No harvest in North Cariboo critical habitat of all herds that overlap with the TSA. Adjacency was set to 3m.")
# scenario = data.table (name = "robson_north_cariboo_he0d_m15d",
#                        description = "No harvest in North Cariboo high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in North Cariboo matrix critical habitat. Adjacency was set to 3m.")
# scenario = data.table (name = "robson_columbia_north_nh",
#                        description = "No harvest in Columbia North critical habitat o. Adjacency was set to 3m.")
...
#                        description = "No harvest in Wells Gray South critical habitat. Adjacency was set to 3m.")
