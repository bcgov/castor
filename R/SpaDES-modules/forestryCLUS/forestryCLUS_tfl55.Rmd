...
- First, I tested a harvest flow of 80,000m^3^/year (400,000m^3^/5-year); too high, dropped to 50,000m^3^/year, 45,000, 40,000; used 40,000; slight drop in final two intervals
...
#                        description = "Business-as-usual (BAU); harvest flow 40,000 m3/yr. Adjacency was set to 3m.")
...
scenario = data.table (name = "tfl55_columbia_north_ch_he0d_m15d",
                       description = "No harvest in Columbia North HEWSR, maximum 35% buffered disturbance (15% harvest) in Columbia North matrix critical habitat that overlap with the harvest unit; harvest flow 40,000 m3/yr. Adjacency was set to 3m.")
