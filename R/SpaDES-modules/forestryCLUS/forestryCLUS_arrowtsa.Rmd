...
- First, I tested a harvest flow of 540,000m^3^/year (2,780,000m^3^/5-year); dropped to 450,000
...
scenario = data.table (name = "arrow_bau",
                       description = "Business-as-usual case. Harvest flow = 450,000m3/yr.Adjacency = 3m. Oldest first.")
