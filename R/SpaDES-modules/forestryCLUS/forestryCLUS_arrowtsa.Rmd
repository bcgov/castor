...
## 'harvestFlow'
from 2017 determination: base case set harvest at 506,000m^3^/year for 60 years, and then increases to 680,000m^3^/year for the next 40 years; averages to 576,000m^3^/yea

- I tested a harvest flow of 576,000m^3^/year (2,880,000m^3^/5-year) initially, foudn it was sustainbale, then worked my way back from 1,000,000m^3^/year down to  760,000m^3^/year (765,000m^3^/year was not sustainable); this seems consistent with 2019 TSR model, as if you weight the average of the base case it = 750,000m3/yr
