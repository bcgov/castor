...
scenario = data.table (name = "fsj_core_multi_plan",
                       description = "No harvest in multiple planning areas, including: old growth, Chinchaga caribou zones A and B, Pink Mtn caribou core habitat, Graham caribou core habitat, First Nations AOIs, and RSEA/Blueberry River First Nations protection and restoration areas. Harvest flow = 1,700,000m3/yr. Adjacency = 3m. Oldest first.")
