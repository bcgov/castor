...
# Below sets proposed LUO for critical habitat overlappign this unit 
## Kennedy Siding
...
scenario = data.table (name = "dawson_creek_bau_newpark_conif",
                       description = "Business-as-usual case with Klinse-za/Twin Sisters park (B2 and B3 areas) from parntership agreement added as no harvest. Conifer leading stands (deciduous percentage < 50) only. Harvest flow = 1,000,000m3/yr. Adjacency = 3m. Oldest first.")
...
harvestFlow <- rbindlist(list(data.table(compartment ="Dawson_Creek_TSA",
                                     partition = ' vol > 120 AND dec_pcnt < 50 ', # 
                                     year = rep( seq (from = 2018, 
                                                      to = 2222, 
                                                      by = 5),
                                                1), 
                                     flow = 5000000) #1,000,000m3/yr / conifer leading part only / BAU with new protected area
                        ))
