...
- havrest flow: first tried 2,000,000 m^3^/yr
...
scenario = data.table (name = "dawson_creek_bau",
                       description = "Business-as-usual case. Harvest flow = 2,000,000m3/yr .Adjacency = 3m. Oldest first.")
