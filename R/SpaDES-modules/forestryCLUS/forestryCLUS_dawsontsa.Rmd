...
reference_zone = 'rast.zone_cond_bc_narraway_crithab'") 
...
count <- dbGetQuery(clusdb, "SELECT count() from pixels where zone28 = 5") 

## update to the total area in the constraint table for the zone
dbExecute(clusdb, paste0("UPDATE zoneConstraints SET t_area = ", count, " where reference_zone = 'rast.zone_cond_bc_narraway_crithab' AND (zoneid = 5)")) 

# to check it
zoneconstraints<-dbGetQuery(clusdb, "SELECT * from zoneconstraints where reference_zone = 'rast.zone_cond_bc_narraway_crithab'")                  
...
scenario = data.table (name = "dawson_creek_bau_no_constraints",
                       description = "Business-as-usual case with no constraints. Harvest flow = 2,500,000m3/yr. No adjacency. Oldest first.")
...
harvestFlow <- rbindlist(list(data.table(compartment ="Dawson_Creek_TSA",
                                     ...
                                     year = rep( seq (from = 2018,
                                                      ...
                                                      by = 5),
                                                1),
                                     flow = 12500000) #1,750,000m3/yr / BAU with new protected area
))
# 
