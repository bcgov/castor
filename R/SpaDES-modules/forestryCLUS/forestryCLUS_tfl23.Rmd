...
- started at 523,000m^3/year; this was too high so I dropped gradually setting on l40,000 m^3/yr
...
parameters <- list(
  ...
  forestryCLUS = listharvestBlockPriority = "age DESC", # "dist, age DESC, vol DESC"
...
# rsf_model_coeff[, bounds := 'rast.bc_crithab_and_herd']
 ...
 #                        description = "No harvest in all Central Selkirks critical habitat. Adjacency was set to 3m.")
