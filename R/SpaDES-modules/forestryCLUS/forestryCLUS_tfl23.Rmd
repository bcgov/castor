...
# rsf_model_coeff[, bounds := 'rast.bc_crithab_and_herd']
 ...
 #                        description = "Business as usual (BAU). Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
 # scenario = data.table (name = "tfl23_columbia_south_nh",
 #                        description = "No harvest in all Columbia South critical habitat. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
...
# scenario = data.table (name = "tfl23_monashee_nh",
#                         description = "No harvest in all Monashee critical habitat. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "tfl23_monashee_ch_he0d_m15d",
#                         description = "No harvest in Monashee high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Monashee matrix critical habitat. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
...
# scenario = data.table (name = "tfl23_centselk_nh",
#                         description = "No harvest in all Central Selkirks critical habitat. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "tfl23_centselk_ch_he0d_m15d",
#                         description = "No harvest in Central Selkirks high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Central Selkirks matrix critical habitat.  Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "tfl23_centselk_scen3a",
#                        description = "No harvest in old forest, recruitment forest and buffered Central Selkirks core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Central Selkirks matrix habitat areas. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")

scenario = data.table (name = "tfl23_centselk_scen3b",
                       description = "No harvest in old forest and recruitment forest Central Selkirks core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Central Selkirks matrix habitat areas. Harvest flow 495,000 m3/yr. Adjacency = 3m. Oldest first.")
...
# scenario = data.table (name = "tfl23_columbia_south_ch_he10d_m15d",
