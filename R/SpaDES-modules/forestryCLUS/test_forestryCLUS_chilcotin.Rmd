...
harvestFlow <- rbindlist(list(data.table (compartment ="Quesnel_TSA_HEWSR",
                                          partition = '  vol > 150 and vol/(salvage_vol+vol) > 0.5 ', #  AND age > 139, 119, 99
                              ...
                              data.table (compartment ="Quesnel_TSA_LESR",
                                          partition = ' vol > 150 and vol/(salvage_vol+vol) > 0.5 ', # AND age > 139, 119
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1),
                              ...
                              data.table (compartment ="Quesnel_TSA_LESR",
                                          partition = ' salvage_vol > 150  and vol/(salvage_vol+vol) <= 0.5  ', # AND age > 139, 119
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                     1),
                              ...
                              data.table (compartment ="Quesnel_TSA_out",
                                          partition = '  vol > 150 and vol/(salvage_vol+vol) > 0.5 ', 
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1), 
                              ...
                              data.table (compartment ="Quesnel_TSA_out",
                                          partition = ' salvage_vol > 150  and vol/(salvage_vol+vol) <= 0.5 ', 
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                     1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_HEWSR",
                                          partition = '  vol > 110 and vol/(salvage_vol+vol) > 0.5  ', # AND age > 139
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_HEWSR",
                                          partition = ' salvage_vol > 110  and vol/(salvage_vol+vol) <= 0.5  ', # AND age > 139
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                     1), 
                                          flow = 37500,
                                          partition_type = 'dead'), # 7,500 m3/yr 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_LESR",
                                          ...
                                          period = rep( seq (from = 1, 
                                                     ...
                                                     1), 
                                          flow = 175000,
                                          partition_type = 'dead'), # 35,000 m3/yr 
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = '  vol > 110 and vol/(salvage_vol+vol) > 0.5 ', # AND age > 139, 119 
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                      1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = ' salvage_vol > 110  and vol/(salvage_vol+vol) <= 0.5 ', # AND age > 139, 119 
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                      1), 
                                          flow = 350000,
                                          partition_type = 'dead'), # 70,000 m3/yr 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_out",
                                          partition = '  vol > 110 and vol/(salvage_vol+vol) > 0.5 ', 
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                      1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_out",
                                          partition = ' salvage_vol > 110  and vol/(salvage_vol+vol) <= 0.5 ', 
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                      1), 
                                          flow = 4125000,
                                          partition_type = 'dead') # 825,000 m3/yr 
))
harvestFlow <- rbindlist(list(data.table (compartment ="Quesnel_TSA_HEWSR",
                                          partition = '  vol > 150  ', #  AND age > 139, 119, 99
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1), 
                                          ...
                                          partition_type = 'live'), # 0 m3/yr 
                              data.table (compartment ="Quesnel_TSA_LESR",
                                          partition = ' vol > 150  ', # AND age > 139, 119
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1),
                              ...
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = '  vol > 110 ', # AND age > 139, 119 
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                      1), 
