...
dbExecute(clusdb, "UPDATE zoneconstraints set type = 'nh' where reference_zone = 'rast.zone_cond_partnership_agreement'") #
...
dbExecute(clusdb, "UPDATE zoneconstraints set variable = 'age' where reference_zone = 'rast.central_grp_proposed_luo_feb2021'") # height
dbExecute(clusdb, "UPDATE zoneconstraints set threshold = '25' where reference_zone = 'rast.central_grp_proposed_luo_feb2021'") # 2.5
