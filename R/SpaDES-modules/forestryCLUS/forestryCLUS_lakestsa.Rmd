...
- i tested a harvest flow of 750,000m^3^/year (3,750,000m^3^/5-year) initially 
...
parameters <- list(
  ...
  disturbanceCalcCLUS = list(calculateInterval = 5, 
                             ...
                             recovery = 40),
  uploaderCLUS = list(aoiName = 'lakes_tsa_bau',
...
scenario = data.table (name = "test", 
                       description = "testing harvest flow")

# scenario = data.table (name = "lakes_bau", 
#                        description = "Lakes TSA business-as-usual scenario. Adjacency was set to 3m.")

harvestFlow <- rbindlist(list(data.table(compartment ="Lakes_TSA",
                                     partition = ' vol > 100 ', # from Lakes 2019 dtermination
...
# outputs to keep; these are tables that get used in the uploader; comment out when running 'tests'
