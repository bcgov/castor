...
The allowable annual cut (AAC) for the Williams Lake TSA is 3 million cubic metres as of February 25, 2015. This includes a partition of a maximum of 1 500 000 cubic metres per year for live
volume which means the remainder of the AAC is for salvaging dead trees
...
parameters <- list(
  ...
  dataLoaderCLUS = list( 
                           ...
                           nameZoneRasters = c("rast.zone_cond_beo", 
                                               ...
                                               "rast.zone_cond_cw",
 "rast.zone_cond_eccc_itcha_ilgachuz_crithab_or_herd",                                      "rast.zone_cond_eccc_charlotte_alplands_crithab_or_herd",
...
scenario = data.table (name = "willake_all_ch_hele0d_m15d",
                       description = "No harvest in high and low elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in matrix critical habitat of all herds that overlap with the harvest unit (e.g., TSA or TFL)")
