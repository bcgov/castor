...
## 'harvestFlow'
from 2010 determination:  even-flow forecast indicates a harvest level of 546 000 cubic metres per year 
- First, I tested a harvest flow of 550,000m^3^/year (2,750,000m^3^/5-year); was not able to achieve this after  years, so dropped to 425,000, 435,000, 445,000, 450,000; 445,000 was max

from detemiantion: used 'oldest first' priority queue


From 2010 pdp, varied th minmum age constraint, but never decclareed what minimum age used

- I used 150 m3/ha as minimum harvest volume instead

For cutblock adjacency, I used 3 m adjacncey; no real mention fo this in PDP; 
...
#                        description = "Business-as-usual case; sustainable flow = 445,000m^3^/year. Adjacency was set to 3m.")
...
#                        description = "No harvest in Purcell Central critical habitat. Adjacency was set to 3m.")
...
#                        description = "No harvest in Purcells South critical habitat. Adjacency was set to 3m.")
# scenario = data.table (name = "kootenaylake_purcells_south_ch_he0d_m15d",
#                        description = "No harvest in Purcells South high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Purcells South matrix critical habitat of all herds that overlap the TSA. Adjacency was set to 3m.")
# scenario = data.table (name = "kootenaylake_south_selkirks_nh",
#                        description = "No harvest in South Selkirks critical habitat. Adjacency was set to 3m.")


scenario = data.table (name = "kootenaylake_south_selkirks_ch_he0d_m15d",
                       description = "No harvest in South Selkirks high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in South Selkirks matrix critical habitat of all herds that overlap the TSA. Adjacency was set to 3m.")
