...
Note: for GBR I created new spatial layers for wha, uwr, fsw, and parks and protected areas. This is because the original layers were missing some details relevant for GBR.
...
No information on the even flow harvest could be found for GBR south, except in the data packages for Kingcome and Strathcona TSA's. However, since GBR south is only a portion of these old TSA's it difficult to work out how to add the harvest flows and so I started with the value for the ACC as the even flow value i.e. 830,500 m^3/year. This value was too high so I dropped it to 700,000m^3/yr but this too was still to high. I then tried 600,000, this worked so I tried 615,000 and 610,000. 615,000 was too high and 610,000 resulted in an even harvest flow so this is the value I settled on.

Interestingly, I found by adjusting the volume to 90 cubic meteres per hectare and stand age to 60 I could incease the harvest flow from 610,000m^3/year to 620,000m^3/year, but for the final run and scenarios I decided to use 150 m3/ha as minimum harvest volume as this is what was done in most of the other TSA's. We could discuss this...

For cutblock adjacency, in data package, allowed maximum 33% height ≤ 2.5 m THLB by landscape unit; I used 3 m adjacncey; this is a bit conservative
