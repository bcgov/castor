...
#scenario = data.table (name = "revelstoke_columbia_north_he0d_m15d", description = "No harvest in Columbia North high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Columbia North matrix critical habitat. Adjacency was set to 3m. Flow = 210,000m^3^/year.")
...
#scenario = data.table (name = "revelstoke_frisby_boulder_he10d_m15d", description = "No harvest in Frisby Boulder high elevation critical habitat areas as defined by Bevan Ernst, maximum 35% buffered disturbance (15% harvest) in Frisby Boulder martix habitat areas as defined by Bevan Ernst. Adjacency was set to 3m. Flow = 210,000m^3^/year.")
