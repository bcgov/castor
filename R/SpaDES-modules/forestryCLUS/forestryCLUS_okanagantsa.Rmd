...
# rsf_model_coeff[, bounds := 'rast.bc_crithab_and_herd']
 ...
 # scenario = data.table (name = "okanagan_bau",
 #                        description = "Business as usual (BAU). Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_columbia_north_nh",
#                         description = "No harvest in all Columbia North critical habitat. Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_columbia_north_ch_he0d_m15d",
#                         description = "No harvest in Columbia North high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Columbia North matrix critical habitat. Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_columbia_north_scen3a",
#                        description = "No harvest in old forest, recruitment forest and buffered Columbia North core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Columbia North matrix habitat areas. Harvest flow = 1,400,000m^3^/year.  Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_columbia_north_scen3b",
#                        description = "No harvest in old forest and recruitment forest Columbia North core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Columbia North matrix habitat areas. Harvest flow = 1,400,000m^3^/year.  Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_monashee_nh",
#                         description = "No harvest in all Monashee critical habitat. Harvest flow = 1,400,000m^3^/year.  Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_monashee_ch_he0d_m15d",
#                         description = "No harvest in Monashee high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Monashee matrix critical habitat. Harvest flow = 1,400,000m^3^/year.  Adjacency = 3m. Oldest first.")
...
# scenario = data.table (name = "okanagan_frisby_boulder_nh",
#                         description = "No harvest in all Frisby Boulder critical habitat. Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_frisby_boulder_ch_he0d_m15d",
#                         description = "No harvest in Frisby Boulder high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Frisby Boulder matrix critical habitat. Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "okanagan_frisby_boulder_scen3a",
#                         description = "No harvest in old forest, recruitment forest and buffered Frisby Boulder core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Frisby Boulder matrix habitat areas. Harvest flow = 1,400,000m^3^/year.  Adjacency = 3m. Oldest first.")
...
scenario = data.table (name = "okanagan_columbia_north_he0d",
                       description = "No harvest in Columbia North high elevation critical habitat; harvest allowed in matrix critical habitat. Harvest flow = 1,400,000m^3^/year. Adjacency = 3m. Oldest first.")
