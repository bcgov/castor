...
## 'harvestFlow'
from 2010 analysis report:  maximum even flow harvest was 513,000m^3^/year; from detemrination, June 3, 2010, the  AAC was set at 485 000 cubic metres 

- First, I tested a harvest flow of 513,000m^3^/year (2,565,000m^3^/5-year); was not able to achieve this after 70 years, so dropped to 450,000, then 400,000, 375,000, 385,000, and 382,500



why was this model max even flow at 75% or previosu model? maybe adjacney?, maybe min. volume? or maybe harvest queue? no indications in TSR documentation of signficant inventory or yeidl probelms 
...
#                        description = "Business-as-usual case; sustainable flow = 382,500m^3^/year. Adjacency was set to 3m.")
...
#                        description = "No harvest in Columbia South critical habitat. Adjacency was set to 3m.")
# scenario = data.table (name = "golden_columbia_south_ch_he0d_m15d",
#                        description = "No harvest in Columbia South high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Columbia South matrix critical habitat in the TSA. Adjacency was set to 3m.")
# scenario = data.table (name = "golden_columbia_north_nh",
#                        description = "No harvest in Columbia North critical habitat. Adjacency was set to 3m.")
# scenario = data.table (name = "golden_columbia_north_ch_he0d_m15d",
#                        description = "No harvest in Columbia North high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Columbia North matrix critical habitat in the TSA. Adjacency was set to 3m.")
# scenario = data.table (name = "golden_central_rockies_nh",
#                        description = "No harvest in Central Rockies critical habitat. Adjacency was set to 3m.")
# scenario = data.table (name = "golden_central_rockies_ch_he0d_m15d",
#                        description = "No harvest in Central Rockies high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Central Rockies matrix critical habitat in the TSA. Adjacency was set to 3m.")
