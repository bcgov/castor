...
-in TSR base case, minimum harvest age when stadns reached 300m3 was used; here I used 300m3 as min volume for harvest

- I started with 75,000

#UPDATE SCENARIO
```{r, zone_update}
#STEP 1: Connect to the clusdb.sqlite database for the AOI
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/Pacific TSA_clusdb.sqlite")) # connect to clusdb -- set the locations of the sqlite
...
scenario = data.table (name = "pacific_bau",
                       description = "Business-as-usual case. Harvest flow = 75,000m3/yr. Adjacency = 3m. Oldest first.")
