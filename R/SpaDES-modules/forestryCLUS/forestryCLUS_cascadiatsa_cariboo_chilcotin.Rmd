...
# Below makes priority stands in all priority zones no harvest, core outside of priority stands available, and  matrix high priority zones max 15% disturbance (note there are no medium and low core or medium priority matrix overlapping the TSA)
dbExecute(clusdb, "UPDATE zoneconstraints SET type = 'nh' where reference_zone = 'rast.zone_barkerville_groundhog_zones_20210303' AND zoneid = 2") 
...
# scenario = data.table (name = "cascadia_cariboo_chilcotin_barkerville_he0d_m12d",
#                        description = "No harvest in Barkerville high elevation critical habitat; harvest allowed in matrix critical habitat up to 12% disturbance (no buffer). Oldest first. Adjacency = 3m. Even harvest flow = 55,000m3/year.")
# scenario = data.table (name = "cascadia_cariboo_chilcotin_barkerville_high_med_low_priority",
#                        description = "No harvest in Barkerville high priority stands in all high elevation critical habitat; harvest allowed in all matrix critical habitat up to 15% disturbance (no buffer). Oldest first. Adjacency = 3m. Even harvest flow = 55,000m3/year.")

scenario = data.table (name = "cascadia_cariboo_chilcotin_barkerville_high_priority",
                       description = "No harvest in Barkerville high priority stands in high priority high elevation critical habitat; no constraint in low and medium priority high elevation or matrix critical habitat; up to 15% disturbance (no buffer) allowed in high priority matrix critical habitat. Oldest first. Adjacency = 3m. Even harvest flow = 55,000m3/year.")
