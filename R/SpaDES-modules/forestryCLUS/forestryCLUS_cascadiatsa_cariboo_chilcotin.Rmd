...
- First, I tested a harvest flow of 65,740m^3^/year (328,700m^3^/5-year); 60,000, 50,000, 40,000, 45,000, 47,250
...
#                        description = "Business-as-usual (BAU) for Cariboo Chilcotin area. Adjacency was set to 3m. Harvest flow = 47,250m3/yr")
# scenario = data.table (name = "cascadia_cariboo_chilcotin_narrow_lake_noharvest",
#                        description = "No harvest in all Narrow Lake critical habitat. Adjacency was set to 3m. Harvest flow = 47,250m3/yr")
# scenario = data.table (name = "cascadia_cariboo_chilcotin_narrow_lake_ch_he0d_m15d",
#                        description = "No harvest in Narrow Lake high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Narrow Lake matrix critical habitat. Adjacency was set to 3m. Harvest flow = 47,250m3/yr")
# scenario = data.table (name = "cascadia_cariboo_chilcotin_barkerville_noharvest",
#                        description = "No harvest in all Barkerville critical habitat. Adjacency was set to 3m. Harvest flow = 47,250m3/yr")


scenario = data.table (name = "cascadia_cariboo_chilcotin_barkerville_ch_he0d_m15d",
                       description = "No harvest in Barkerville high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Barkerville matrix critical habitat. Adjacency was set to 3m. Harvest flow = 47,250m3/yr")
