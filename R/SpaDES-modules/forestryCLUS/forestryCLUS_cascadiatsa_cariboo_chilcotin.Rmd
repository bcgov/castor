...
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 1) OR (zoneid = 2) OR (zoneid = 3) OR (zoneid = 26) OR (zoneid = 27) OR (zoneid = 78)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET type = 'le' where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 78)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET threshold = 0 where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 78) ") 
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 15 where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 78)")
...
dbExecute(clusdb, "UPDATE zoneconstraints SET type = 'le' where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 26) OR (zoneid = 27)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET threshold = 0 where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 26) OR (zoneid = 27)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 15 where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 26) OR (zoneid = 27)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_smc_zones_20210315' AND zoneid = 78") 
# Below makes priority stands in high priority zones no harvest, core outside of priority stands and zones available, and  matrix high priority zones max 15% disturbance (note there are no medium and low core or medium priority matrix overlapping the TSA)
dbExecute(clusdb, "UPDATE zoneconstraints SET type = 'nh' where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 1) OR (zoneid = 2) OR (zoneid = 3)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_smc_zones_20210315' AND (zoneid = 78) OR (zoneid = 27)") 
...
parameters <- list(
  ...
  dataLoaderCLUS = list(   dbName='clus',
                           save_clusdb = TRUE,
                           sqlite_dbname = "Cascadia_TCC_TSA",
...
# scenario = data.table (name = "cascadia_cc_narrow_lake_noharv",
...
# scenario = data.table (name = "cascadia_cc_narrow_lk_he0d_m12d",
#                        description = "No harvest in Narrow Lake high elevation critical habitat; harvest allowed in matrix critical habitat up to 12% disturbance (no buffer) in forested area. Oldest first. Adjacency = 3m. Even harvest flow = 55,000m3/year.")
# scenario = data.table (name = "cascadia_cc_narrow_lk_hi_m_lo_priority",
#                        description = "No harvest in Narrow Lake high priority stands in all priority high elevation critical habitat; harvest allowed in all priority matrix critical habitat up to 15% disturbance (no buffer) of forested area. Oldest first. Adjacency = 3m. Even harvest flow = 55,000m3/year.")
