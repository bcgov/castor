...
no harvest in Frisby-Boulder, Columbia North, and Columbia South caribou critical habtiat; to support  herd planning, we run a scenario with no harvest in theh HEWSR and Matrix; assesses the potential maximum impact of protecting these herds 

ECCC in Frisby-Boulder, Columbia North, and Columbia South caribou critical habitat; an alterantive to a no harvest scenario, attemps to interpret the federal recovery strategy that stipulates no harvest in high and low elevation critical habitat, and up to 35% disturabnce in matrix habtiat; this is a possible scenario if Canada were to enact an emergency order on Frisby-Boulder
...
No harvest in Columbia Norht, South and Frisby-Boulder = rast.zone_cond_noharvest_frisby_boulder_crithab_or_herd

No harvest in Columbia North, Columbia South and Frisby-Boulder high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) matrix critical habitat = rast.zone_cond_eccc_frisby_boulder_crithab_or_herd
...
25th decade."
- started at 145,000m^3/year; way too high, dropped to 5,000, 2,500
...
#scenario = data.table (name = "tfl33_colnsfb_ch_he0d_m15d", description = "No harvest in Frisby-Boulder HEWSR critical habitat, 35% buffered disturbance (15% harvest) in matrix critical habitat; harvest flow 2,500 m3/yr. Adjacency was set to 3m.")
...
harvestFlow <- rbindlist(list(data.table(compartment ="TFL33",
                                         ...
                                         period = rep( seq (from = 1, # run the 
                                                    ...
                                                    1), 
                                         flow = 12500,
                                         partition_type = 'live') # 2,500m3/yr 
))
