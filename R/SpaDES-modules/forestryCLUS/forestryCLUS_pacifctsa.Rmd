...
The TSA consists of 30 timber supply blocks (‘supply blocks’) on Vancouver Island, the Sunshine Coast, the Mainland Coast and Douglas Channel, each ranging in size from 76 hectares to over 400 000 hectares. Here we only simualte within supply blocks that overlap caribou range in northwest BC. 
...
## 'harvestFlow'
Effective August 10, 2017, the AAC for the  Pacific TSA was set at 803,300 cubic metres.
...
parameters <- list(
  ...
  uploaderCLUS = list(aoiName = 'pacific_tsa', # name of the schema that gets uplaoded to postgres
...
# scenario = data.table (name = "pacific_du7_grp1_hi_med_lo_priority",
...
# scenario = data.table (name = "pacific_du7_grp1_hi_med_priority",
...
harvestFlow <- rbindlist(list(data.table(compartment ="Pacific TSA",
                                     partition = ' vol > 100 ', 
