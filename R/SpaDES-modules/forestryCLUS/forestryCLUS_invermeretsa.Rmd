...
## 'harvestFlow'
from June 2017 determination: AAC was 496,720m^3^/year until 2022 and 424,800m^3^/year thereafte; base case maintained a harvest of 447,158m^3^/year for 100 years, amd could be sustained for a 250-year forecast

- First, I tested a harvest flow of 475,000m^3^/year (2,375,000m^3^/5-year), then 400,000m^3^/year, then 350,000m^3^/year, 325,000m^3^/year, 335,000m^3^/year, 345,000m^3^/year, 340,000m^3^/year

- 340,000m^3^/year was used; coudl be maitnained except last time step (years 195-200)

- I used 150 m3/ha as minimum harvest volume, dta package used minimum age 60 for pine, 80 for everything else
...
#                        description = "Business-as-usual case; sustainable flow = 340,000m3/yr. Adjacency was set to 3m.")
