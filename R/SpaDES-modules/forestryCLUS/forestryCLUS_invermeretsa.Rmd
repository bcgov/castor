...
# scenario = data.table (name = "invermere_bau",
#                        description = "Business-as-usual case. Harvest flow = 405,000m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "invermere_purcell_central_nh",
# description = "No harvest in Purcell Central critical habitat. Harvest flow = 405,000m3/yr. Adjacency = 3m. Oldest first.")
# scenario = data.table (name = "invermere_purcell_central_ch_he0d_m15d",
#                        description = "No harvest in Purcell Central high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Purcell Central matrix critical habitat. Harvest flow = 405,000m3/yr. Adjacency = 3m. Oldest first.")
...
scenario = data.table (name = "invermere_purcell_central_scen3b",
                       description = "No harvest in old forest and recruitment forest Purcell Central core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Purcell Central matrix habitat areas. Harvest flow = 405,000m3/yr. Adjacency = 3m. Oldest first.")
