...
harvestFlowA<- data.table(compartment = '26A',
                                   ...
                                   flow = 10000)
harvestFlowB<- data.table(compartment = '29B',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 10000)

harvestFlowC<- data.table(compartment = '29C',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 10000)
harvestFlow<-list(harvestFlowA,harvestFlowB,harvestFlowC)
harvestFlow<-rbindlist(harvestFlow)
...
outputs(mySim) <- data.frame(objectName = c("harvestReport", "growingStockReport","rsf"))
