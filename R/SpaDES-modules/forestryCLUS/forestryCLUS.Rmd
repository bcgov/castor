...
parameters <- list(
  ...
  uploaderCLUS = list(aoiName = 'boreal',
...
scenario<-data.table(name="BAU", description = "Business as usual -projecting current trends with 10 times the harvest flow")
harvestFlowA<- data.table(compartment = '08A',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlowB<- data.table(compartment = '08B',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)

harvestFlowC<- data.table(compartment = '08C',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlowD<- data.table(compartment = '08D',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlowE<- data.table(compartment = '40A',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlowF<- data.table(compartment = '40B',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlowG<- data.table(compartment = '41A',
                                   partition = 'vol > 50',
                                   year = rep(seq(from = 2018, to=2068, by = 1),1), 
                                   flow = 30000)
harvestFlow<-rbindlist(list(harvestFlowA,harvestFlowB,harvestFlowC,harvestFlowD, harvestFlowE, harvestFlowF , harvestFlowG))
