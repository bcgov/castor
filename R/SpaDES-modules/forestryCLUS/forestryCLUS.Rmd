...
parameters <- list(
  ...
  dataLoaderCLUS = list( 
                         ...
                         #Study Area
                         nameBoundaryFile="tsa_area_bounds",
                         nameBoundaryColumn="tsa_name",
                         nameBoundary = "Quesnel_TSA",
                         nameBoundaryGeom='wkb_geometry',
                         nameCompartmentRaster = "rast.tsa_area_bounds_r",
                         nameCompartmentTable = "tsa_area_bounds_vat",
                         nameMaskHarvestLandbaseRaster='rast.bc_thlb2018',
                        nameZoneRasters=c("rast.zone_cond_beo", "rast.zone_cond_vqo", "rast.zone_cond_wha", "rast.zone_cond_uwr", "rast.zone_cond_nharv", "rast.zone_cond_crithab", "rast.proposed_uwr"),
  ...
  uploaderCLUS = list(aoiName = 'tweedsmuir',
...
scenario<-data.table(name="UpprBound_ditchlines", description = "UpprBound_ditchlines - Assuming federal constraints on critical habitat")#NOTE: do not use special characters (.,/+=;'!@#$%^&*)

harvestFlow<- data.table(compartment = 'Quesnel TSA',
                                   partition = 'vol > 110',
