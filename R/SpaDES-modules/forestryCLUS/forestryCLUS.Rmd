...
parameters <- list(
  ...
  dataLoaderCLUS = list( 
                         dbName='clus',
                           #save_clusdb = TRUE,
                           useCLUSdb = paste0("C:/Users/KLOCHHEA/clus/R/SpaDES-modules/dataLoaderCLUS/Morice_TSA_clusdb.sqlite"),
                           #Study Area
  ...
  forestryCLUS = list( harvestPriority = "vol DESC, age DESC", growingStockConstraint = 1.005),
  ...
  uploaderCLUS = list(aoiName = 'morice',
...
harvestFlow<- data.table(compartment ="Morice_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 2018, to=2022, by = 1),1), 
                                     flow = 6000000)
