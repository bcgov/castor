...
harvestFlow<- rbindlist(list(data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 1, to=2, by = 1),1), 
                                     flow = 207100),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 3, to=10, by = 1),1), 
                                     flow = 186390), 
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 11, to=20, by = 1),1), 
                                     flow = 165680),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 21, to=30, by = 1),1), 
                                     flow = 144970),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 31, to=40, by = 1),1), 
                                     flow = 135900),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 41, to=50, by = 1),1), 
                                     flow = 144970),
                              data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 51, to=60, by = 1),1), 
                                     flow = 165680),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 61, to=70, by = 1),1), 
                                     flow = 186390),
                             data.table(compartment ="Revelstoke_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 71, to=80, by = 1),1), 
                                     flow = 207100)
))
