...
parameters <- list(
  ...
  dataLoaderCLUS = list(   dbName='clus',
                           ...
                           nameZoneRasters = c("rast.zone_cond_beo", 
                                               ...
                                               # "rast.zone_cond_noharvest_columbia_north_crithab_or_herd",                                                             "rast.zone_cond_noharvest_columbia_south_crithab_or_herd" 
...
scenario = data.table (name = "tfl56_colnsfb_ch_he0d_m15d",
                       description = "No harvest in Columbia North and Columbia South HEWSR critical habitat, 35% buffered disturbance (15% harvest) in matrix critical habitat; harvest flow 31,000 m3/yr. Adjacency was set to 3m.")


# No harvest in CN, CS and FB high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in CN, CS and FB matrix critical habitat	
