...
# scenario = data.table (name = "cascadia_ok_col_monashee_ch_he0d_m15d",
#                        description = "No harvest in Monashee high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Monashee matrix critical habitat. Oldest first. Adjacency = 3m. Harvest flow = 75,000m3/yr")
