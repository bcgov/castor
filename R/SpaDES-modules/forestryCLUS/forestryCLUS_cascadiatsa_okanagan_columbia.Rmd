...
## 'harvestFlow'
from 2020 determination: AAC was 63,000^3^/year 

- First, I tested a harvest flow of 63,000m^3^/year (315,000m^3^/5-year); was abel to sustain this, so used as target, even though may be abel to sustain higher with our model
...
#                        description = "Business-as-usual (BAU) for Okanagan-Columbia area. Adjacency was set to 3m. Harvest flow = 63,000m3/yr")
# scenario = data.table (name = "cascadia_okanagan_columbia_monashee_noharvest",
#                        description = "No harvest in all Monashee critical habitat. Adjacency was set to 3m. Harvest flow = 63,000m3/yr")
scenario = data.table (name = "cascadia_okanagan_columbia_monashee_ch_he0d_m15d",
