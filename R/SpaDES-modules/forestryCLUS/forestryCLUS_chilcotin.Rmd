...
VALUES 
(1465,0,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',121,'ge',30,NULL,NULL,354303,0,250),
(1466,3,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',121,'ge',30,NULL,NULL,742496,0,250),
(1467,4,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',121,'ge',30,NULL,NULL,790764,0,250),
(1468,0,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',101,'ge',37,NULL,NULL,354303,0,250),
(1469,3,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',101,'ge',37,NULL,NULL,742496,0,250),
(1470,4,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',101,'ge',37,NULL,NULL,790764,0,250),
(1471,0,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',81,'ge',45,NULL,NULL,354303,0,250),
(1472,3,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',81,'ge',45,NULL,NULL,742496,0,250),
(1473,4,'rast.zone_cond_bc_itcha_ilgachuz_crithab','zone17',0,'age',81,'ge',45,NULL,NULL,790764,0,250);")
...
dbExecute(clusdb, "INSERT INTO zoneconstraints (id, zoneid, reference_zone, zone_column, ndt, variable, threshold, type, percentage, denom, multi_condition, t_area, start, stop)
VALUES 
(1474,0,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',121,'ge',30,NULL,NULL,41182,0,250),
(1475,3,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',121,'ge',30,NULL,NULL,45116,0,250),
(1476,4,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',121,'ge',30,NULL,NULL,10929,0,250),
(1477,0,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',101,'ge',37,NULL,NULL,41182,0,250),
(1478,3,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',101,'ge',37,NULL,NULL,45116,0,250),
(1479,4,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',101,'ge',37,NULL,NULL,10929,0,250),
(1480,0,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',81,'ge',45,NULL,NULL,41182,0,250),
(1481,3,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',81,'ge',45,NULL,NULL,45116,0,250),
(1482,4,'rast.zone_cond_bc_rainbows_crithab','zone18',0,'age',81,'ge',45,NULL,NULL,10929,0,250);")
...
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 25 where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1465) OR (id = 1466)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 30 where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1468) OR (id = 1469)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 37 where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1471) OR (id = 1472)")
## Rainbows ##
...
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 25 where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND (id = 1474) OR (id = 1475)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 30 where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND (id = 1477) OR (id = 1478)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 37 where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND (id = 1480) OR (id = 1481)")
## Charlotte ##
...
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1465)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 25 where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1468)")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 30 where reference_zone = 'rast.zone_cond_bc_itcha_ilgachuz_crithab' AND (id = 1471)")
## Rainbows ##
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND zoneid = 3")
dbExecute(clusdb, "UPDATE zoneconstraints SET type = '' where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND id = 1474")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 25 where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND id = 1477")
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 30 where reference_zone = 'rast.zone_cond_bc_rainbows_crithab' AND id = 1480")
## Charlotte ##
