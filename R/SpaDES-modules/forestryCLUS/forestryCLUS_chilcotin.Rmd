...
dbExecute(clusdb, "INSERT INTO zoneconstraints (id, zoneid, reference_zone, zone_column, ndt, variable, threshold, type, percentage, denom, multi_condition, t_area, start, stop)
VALUES 
(1794,5,'rast.zone_chilcotin_scenario2','zone20',0,'age',141,'ge',25,NULL,NULL,776877,0,250),
(1795,5,'rast.zone_chilcotin_scenario2','zone20',0,'age',121,'ge',30,NULL,NULL,776877,0,250),
(1796,5,'rast.zone_chilcotin_scenario2','zone20',0,'age',101,'ge',37,NULL,NULL,776877,0,250),
(1797,5,'rast.zone_chilcotin_scenario2','zone20',0,'age',81,'ge',45,NULL,NULL,776877,0,250),
(1798,6,'rast.zone_chilcotin_scenario2','zone20',0,'age',141,'ge',25,NULL,NULL,879039,0,250),
(1799,6,'rast.zone_chilcotin_scenario2','zone20',0,'age',121,'ge',30,NULL,NULL,879039,0,250),
(1800,6,'rast.zone_chilcotin_scenario2','zone20',0,'age',101,'ge',37,NULL,NULL,879039,0,250),
(1801,6,'rast.zone_chilcotin_scenario2','zone20',0,'age',81,'ge',45,NULL,NULL,879039,0,250);")
...
dbExecute(clusdb, "INSERT INTO zoneconstraints (id, zoneid, reference_zone, zone_column, ndt, variable, threshold, type, percentage, denom, multi_condition, t_area, start, stop)
VALUES 
(1802,2,'rast.zone_chilcotin_scenario2','zone20',0,'age',141,'ge',25,NULL,NULL,14863,0,250),
(1803,2,'rast.zone_chilcotin_scenario2','zone20',0,'age',121,'ge',30,NULL,NULL,14863,0,250),
(1804,2,'rast.zone_chilcotin_scenario2','zone20',0,'age',101,'ge',37,NULL,NULL,14863,0,250),
(1805,2,'rast.zone_chilcotin_scenario2','zone20',0,'age',81,'ge',45,NULL,NULL,14863,0,250);")
...
dbExecute(clusdb, "INSERT INTO zoneconstraints (id, zoneid, reference_zone, zone_column, ndt, variable, threshold, type, percentage, denom, multi_condition, t_area, start, stop)
VALUES 
(1806,3,'rast.zone_chilcotin_scenario2','zone20',0,'age',141,'ge',25,NULL,NULL,19196,0,250),
(1807,3,'rast.zone_chilcotin_scenario2','zone20',0,'age',121,'ge',30,NULL,NULL,19196,0,250),
(1808,3,'rast.zone_chilcotin_scenario2','zone20',0,'age',101,'ge',37,NULL,NULL,19196,0,250),
(1809,3,'rast.zone_chilcotin_scenario2','zone20',0,'age',81,'ge',45,NULL,NULL,19196,0,250),
(1810,7,'rast.zone_chilcotin_scenario2','zone20',0,'age',141,'ge',25,NULL,NULL,77831,0,250),
(1811,7,'rast.zone_chilcotin_scenario2','zone20',0,'age',121,'ge',30,NULL,NULL,77831,0,250),
(1812,7,'rast.zone_chilcotin_scenario2','zone20',0,'age',101,'ge',37,NULL,NULL,77831,0,250),
(1813,7,'rast.zone_chilcotin_scenario2','zone20',0,'age',81,'ge',45,NULL,NULL,77831,0,250);")
...
scenario = data.table (name = "chilcotin_bau_live_dead",
                       description = "Business as usual (BAU). Adjacency = 0m. Priority queue = closest to disturbance first, dead volume second, oldest third (live or dead volume). Salvage dead volume in first 10 years. Minimum volume: 150 m3/year. Even live harvest flow: HEWSR = 10,000 m3/year; LESR = 10,000 m3/year; LEWR = 100,000m3/year; Matrix = 200,000m3/year; out = 2,500,000m3/year. Dead volume targets (in first 10 years only): HEWSR = 10,000 m3/year; LESR = 10,000 m3/year; LEWR = 100,000m3/year; Matrix = 100,000 m3/year; out = 1,500,000 m3/year.")
...
#                        description = "Scenario 2a, live and dead volume harvest. Adjacency = 0m. Harvest Priority: Closest to disturbance first, Salvage Violume Second, Oldest Third. Salvage harvest in first 2 interals (i.e., 10 years) only. No harvest: HEWSR, LESR, Tweedsmuir Corridor, Rainbows Corridor. Rotation age (in all habitat): 140 years. Seral stage constraints (in LEWR, Matrix): 25% > 140 y.o.; 30% >120 y.o.; 37% >100 y.o.; 45% >80 y.o.; 65% > 40 y.o. Minimum volume: 150 m3/year. Target harvest flow (live; years 10-200): HEWSR = 9,600 m3/year; LESR =  32,000 m3/year; LEWR = 225,000 m3/year; Matrix = 282,000 m3/year;  out = 420,000 m3/year. Target harvest flow (live + dead; years 1-10): HEWSR = 9,600 m3/year; LESR = 40,000 m3/year; LEWR = 311,000 m3/year; Matrix = 282,000 m3/year; out = 442,000 m3/year.")
# scenario = data.table (name = "chilcotin_scen2c_live_dead",
#                        description = "Scenario 2c, live and dead volume harvest. Adjacency = 0m. Harvest Priority: Closest to disturbance first, Salvage Violume Second, Oldest Third. Salvage harvest in first 2 interals (i.e., 10 years) only. No harvest: HEWSR, LESR (except high-low and high-moderate areas), Tweedsmuir Corridor. Rotation age (in all habitat): 140 years. Seral stage constraints (in LESR high-low areas, LEWR, Matrix, Rainbows Corridor): 25% > 140 y.o.; 30% >120 y.o.; 37% >100 y.o.; 45% >80 y.o.; 65% > 40 y.o. Minimum volume: 150 m3/year. Target harvest flow (live; years 10-200): HEWSR = 9,600 m3/year; LESR =  32,000 m3/year; LEWR = 225,000 m3/year; Matrix = 282,000 m3/year;  out = 420,000 m3/year. Target harvest flow (live + dead; years 1-10): HEWSR = 9,600 m3/year; LESR = 40,000 m3/year; LEWR = 311,000 m3/year; Matrix = 282,000 m3/year; out = 442,000 m3/year.")
# scenario = data.table (name = "chilcotin_scen2b_live_dead",
#                        description = "Scenario 2b, live and dead volume harvest. Adjacency = 0m. Harvest Priority: Closest to disturbance first, Salvage Violume Second, Oldest Third. Salvage harvest in first 2 interals (i.e., 10 years) only. No harvest: HEWSR, LESR (except high-low areas), Tweedsmuir Corridor, Rainbows Corridor. Rotation age (in all habitat): 140 years. Seral stage constraints (in LESR high-low areas, LEWR, Matrix): 25% > 140 y.o.; 30% >120 y.o.; 37% >100 y.o.; 45% >80 y.o.; 65% > 40 y.o. Minimum volume: 150 m3/year. Target harvest flow (live; years 10-200): HEWSR = 9,600 m3/year; LESR =  32,000 m3/year; LEWR = 225,000 m3/year; Matrix = 282,000 m3/year;  out = 420,000 m3/year. Target harvest flow (live + dead; years 1-10): HEWSR = 9,600 m3/year; LESR = 40,000 m3/year; LEWR = 311,000 m3/year; Matrix = 282,000 m3/year; out = 442,000 m3/year.")
...
harvestFlow <- rbindlist(list(data.table (compartment ="HEWSR",
                              ...
                              data.table (compartment ="LESR",
                                          ...
                                          partition_type = 'live'), 
                                  data.table (compartment ="LESR",
                                          partition = ' (vol > 150 and salvage_vol/(vol + salvage_vol) < 0.5) AND age > 100 ', # AND age > 139, 119
