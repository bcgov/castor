...
parameters <- list(
  ...
  forestryCLUS = list(harvestBlockPriority = "age DESC", # query to prioritize blocks within 1km of disturbance, then 2.5km, then 5km, then everything >5km, then oldest first after that =  "CASE WHEN dist < 1000 THEN 3 WHEN dist < 2500 THEN 2 WHEN dist < 5000 THEN 1 ELSE 0 END DESC, age DESC"
...
harvestFlow <- rbindlist(list(data.table (compartment ="Quesnel_TSA_HEWSR",
                              ...
                              data.table (compartment ="Quesnel_TSA_LESR",
                                          partition = ' vol > 150 AND age > 149 ', # 119
                                          year = rep( seq (from = 2018, 
                                                           to = 2218, 
                                                           by = 5),
                                                      1), 
                                          flow = 35000), # 7,000 m3/yr 
                              data.table (compartment ="Quesnel_TSA_LEWR",
                                          partition = ' vol > 150 AND age > 149 ', #  AND age > 119
                                          year = rep( seq (from = 2018, 
                                                           to = 2218, 
                                                           by = 5),
                                                      1), 
                                          flow = 425000), # 85,000 m3/yr 
                              ...
                              data.table (compartment ="Quesnel_TSA_out",
                                          ...
                                          year = rep( seq (from = 2018, 
                                                           ...
                                                           by = 5),
                                                      1), 
                                          flow = 10500000), # 2,100,000 m3/yr 
                              data.table (compartment ="Williams_Lake_TSA_HEWSR",
                                          partition = ' vol > 110 AND age > 149 ', 
                                          year = rep( seq (from = 2018, 
                                                           to = 2218, 
                                                           by = 5),
                                                      1), 
                                          flow = 75000), # 15,000 m3/yr 
                              data.table (compartment ="Williams_Lake_TSA_LESR",
                                          ...
                                          year = rep( seq (from = 2018, 
                                                           ...
                                                           by = 5),
                                                      1), 
                                          flow = 350000), # 70,000 m3/yr 
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = ' vol > 110 AND age > 149 ', # AND age > 119 
                                          year = rep( seq (from = 2018, 
                                                           to = 2218, 
                                                           by = 5),
                                                      1), 
