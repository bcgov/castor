...
times <- list(start = 0, end = 4) # 5 year interval; 200 years = 40 intervals
parameters <- list(
  ...
  forestryCLUS = list(harvestBlockPriority = "dist, age DESC", # query to prioritize blocks within 1km of disturbance, then 2.5km, then 5km, then everything >5km, then oldest first after that =  "CASE WHEN dist < 1000 THEN 3 WHEN dist < 2500 THEN 2 WHEN dist < 5000 THEN 1 ELSE 0 END DESC, age DESC"
