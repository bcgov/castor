...
harvestFlow <- rbindlist(list(data.table (compartment ="HEWSR",
                                          partition = ' (vol > 150 and salvage_vol/(vol + salvage_vol) < 0.5 AND age > 139) ', #  AND age > 139, 119, 99
                              ...
                              data.table (compartment ="LESR",
                                          partition = ' (vol > 150 and salvage_vol/(vol + salvage_vol) < 0.5) AND age > 139 ', # AND age > 139, 119
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                     1),
