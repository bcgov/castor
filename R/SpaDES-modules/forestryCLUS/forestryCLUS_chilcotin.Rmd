...
harvestFlow <- rbindlist(list(data.table (compartment ="Quesnel_TSA_HEWSR",
                              ...
                              data.table (compartment ="Williams_Lake_TSA_HEWSR",
                                          partition = ' vol > 110  and salvage_vol/(vol + salvage_vol) < 0.5', # AND age > 139
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                     1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_HEWSR",
                                          partition = ' salvage_vol > 110 and salvage_vol/(vol + salvage_vol) >= 0.5) ', # AND age > 139
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                     1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = ' vol > 110 and salvage_vol/(vol + salvage_vol) < 0.5', # AND age > 139, 119 
                                          period = rep( seq (from = 1, 
                                                           to = 40, 
                                                           by = 1),
                                                      1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_LEWR",
                                          partition = ' salvage_vol > 110 and salvage_vol/(vol + salvage_vol) >= 0.5)', # AND age > 139, 119 
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                      1), 
                              ...
                              data.table (compartment ="Williams_Lake_TSA_out",
                                          partition = ' salvage_vol > 110 and salvage_vol/(vol + salvage_vol) >= 0.5)', 
                                          period = rep( seq (from = 1, 
                                                           to = 2, 
                                                           by = 1),
                                                      1), 
