...
harvestFlow <- rbindlist(list(data.table (compartment ="HEWSR",
                              ...
                              data.table (compartment ="HEWSR",
                                          ...
                                          flow = 48000,
                                          partition_type = 'live'),
                               data.table (compartment ="HEWSR",partition = ' (salvage_vol > 150 and salvage_vol/(vol + salvage_vol) >= 0.5) ', period = rep( seq (from = 1,to = 2, by = 1),1),flow =3000,partition_type = 'dead'),
                              data.table (compartment ="LESR",
                                  ...
                                  data.table (compartment ="LESR",
                                          ...
                                          flow = 160000,#150000
                                          partition_type = 'live'), # 7,000 m3/yr 
                              data.table (compartment ="LESR",partition = ' (salvage_vol > 150 and salvage_vol/(vol + salvage_vol) >= 0.5) ', period = rep( seq (from = 1,to = 2, by = 1),1),flow =100000,partition_type = 'dead'), # 160000 m3/yr 
                              data.table (compartment ="LEWR",
                               ...
                               data.table (compartment ="LEWR",
                                          ...
                                          period = rep( seq (from = 3, 
                                                           ...
                                                           by = 1),
                                                     1), 
                                          flow = 1125000, #1125000
                                          partition_type = 'live'), 
                              data.table (compartment ="LEWR",partition = ' (salvage_vol > 150 and salvage_vol/(vol + salvage_vol) >= 0.5) ', period = rep( seq (from = 1, to = 2, by = 1),1), flow = 500000,partition_type = 'dead'), # 42,500 m3/yr 
                              ...
                              data.table (compartment ="Matrix",
                                          ...
                                          period = rep( seq (from = 2, 
                                                           ...
                                                           by = 1),
                                                     1), 
                                          flow = 1410000, #1380000
                                          partition_type = 'live'),
                              data.table (compartment ="Matrix",partition = ' (salvage_vol > 150 and salvage_vol/(vol + salvage_vol) >= 0.5) ',  period = rep( seq (from = 1, to = 2, by = 1), 1), flow = 450000,partition_type = 'dead'), #95,000 m3/yr 
                              ...
                              data.table (compartment ="out",
                                          ...
                                          period = rep( seq (from = 2, 
                                                           ...
                                                           by = 1),
                                                     1), 
                                          flow = 2100000,#1900000
                                          partition_type = 'live'),
                              data.table (compartment ="out",partition = ' (salvage_vol > 150 and salvage_vol/(vol + salvage_vol) >= 0.5) ',period = rep( seq (from = 1,  to = 2,  by = 1),1),  flow = 350000,partition_type = 'dead') # 1,050,000 m3/yr 
))
