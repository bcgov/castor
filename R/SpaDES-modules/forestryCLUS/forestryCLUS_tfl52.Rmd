...
# scenario = data.table (name = "tfl52_barkerville_high_med_low_priority",
#                        description = "No harvest in Barkerville high priority stands in all high elevation critical habitat; harvest allowed in all matrix critical habitat up to 15% disturbance (no buffer) in forested area. Harvest flow = 595,000 m3/yr. Adjacency = 3m. Oldest first.")
