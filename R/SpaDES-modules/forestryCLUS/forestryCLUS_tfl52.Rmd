...
scenario = data.table (name = "tfl52_barkerville_he0d_m12d",
                       description = "No harvest in Barkerville high elevation critical habitat; harvest allowed in matrix critical habitat up to 12% disturbance (no buffer). OHarvest flow = 595,000 m3/yr. Adjacency = 3m. Oldest first..")
