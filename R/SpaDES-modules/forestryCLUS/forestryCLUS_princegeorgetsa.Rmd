...
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/Prince_George_TSA_clusdb.sqlite")) # Prince_George_North_TSA_clusdb.sqlite
...
harvestFlow <- rbindlist(list(data.table(compartment ="Prince_George_North_TSA", # Prince_George_North_TSA   Prince_George_TSA
                                         partition = ' vol > 182 and age >= 75  ', 
                                           year = rep( seq (from = 2018, 
                                                            ...
                                                            by = 5),
                                                      1), 
                                           flow = 6000000) #6,000,000 / 30000000 //  1,200,000 / 
))
