...
scenario = data.table (name = "prince_george_bau",
                       description = "Business-as-usual case; sustainable flow = 4.8 Mm3/yr .Adjacency was set to 3m.")

harvestFlow <- rbindlist(list(data.table(compartment ="Prince_George_TSA",
                                     partition = ' vol > 180 and age >= 75  ', 
