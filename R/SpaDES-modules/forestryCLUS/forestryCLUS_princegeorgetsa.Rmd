...
scenario = data.table (name = "pg_north_cariboo_hi_priority",
                       description = "No harvest in North Cariboo high priority stands in high priority high elevation critical habitat; harvest allowed in high priority matrix critical habitat up to 15% disturbance (no buffer) in forested area. Low and Non-priority areas available for harvest. Note: only low priority HEWSR and high and low priority matrix zones here. Sustainable flow = 6,000,000m^3^/year. Oldest first priority. Adjacency = 3m.")
