...
zoneconstraints<-dbGetQuery(clusdb, "SELECT * from zoneConstraints WHERE reference_zone = 'rast.zone_cond_bc_tweedsmuir_crithab'") # "rast.zone_cond_bc_itcha_ilgachuz_crithab", "rast.zone_cond_bc_tweedsmuir_crithab"
...
dbExecute(clusdb, "UPDATE zoneconstraints SET type = 'nh' where reference_zone = 'rast.zone_barkerville_groundhog_zones_20210303' AND (zoneid = 1) OR (zoneid = 2) OR (zoneid = 5) OR (zoneid = 6)")
...
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 12 where reference_zone = 'rast.zone_barkerville_groundhog_zones_20210303' AND (zoneid = 7) OR (zoneid = 9)") 
dbExecute(clusdb, "UPDATE zoneconstraints SET dist = 0 where reference_zone = 'rast.zone_barkerville_groundhog_zones_20210303' AND (zoneid = 7) OR (zoneid = 9)") 
...
scenario = data.table (name = "quesnel_barkerville_high_med_low_priority",
