...
- First, I tested a harvest flow of 2,139,000m^3^/year, dropped to 1.9M m^3^/year, 2.0M m^3^/year, 1.95M m^3^/year was final
...
clusdb <- dbConnect(RSQLite::SQLite(), dbname = paste0(here::here(), "/R/SpaDES-modules/dataLoaderCLUS/Quesnel_TSA_clusdb.sqlite")) # connext to clusdb -- set the locations of the sqlite
...
#                        description = "Business as usual (BAU). Adjacency was set to 3m. Even harvest flow = 1,950,000m3/year")
