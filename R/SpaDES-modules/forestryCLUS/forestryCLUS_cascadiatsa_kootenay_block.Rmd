...
## 'harvestFlow'
from 2020 determination: maximum non-decliningevem-flow was 76,000m^3^/year for 20 years

- First, I tested a harvest flow of 76,000m^3^/year (380,000m^3^/5-year); increased to 100,000 m^3^/year, 90,000, 85,000, 80,000, 82,500


From 2020 analysis report, used minimum volume of 150 cubic metres for 'gounrd-based' operations and 200 cubic metres for cable operations; stands must achieve age where MAI is 95% of max, but when removed this, only lowered AAC by 3.8%
