...
# scenario = data.table (name = "cascadiakb_centselk_ch_he0d_m15d",
#                        description = "No harvest in Central Selkirks high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Central Selkirks matrix critical habitat. Adjacency = 3m. Oldest first. Harvest flow = 95,000m3/year.")
# scenario = data.table (name = "cascadiakb_centselk_scen3a",
#                        description = "NNo harvest in old forest, recruitment forest and buffered Central Selkirks core critical habitat areas, as defined by Bevan Ernst, maximum 35% buffered disturbance (unbuffered) in Central Selkirks matrix habitat areas. Adjacency = 3m. Oldest first. Harvest flow = 95,000m3/year.")
