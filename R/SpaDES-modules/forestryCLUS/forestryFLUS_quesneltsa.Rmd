...
scenario = data.table (name = "quesnel_all_terr_10per_max12yrs_test", description = "bau + maximum 10 % of the territory <= 12 years of age. Harvest flow = 1,900,000 m3/yr. Adjacency = 3m. Oldest first.")
...
harvestFlow <- rbindlist(list(data.table(compartment ="Quesnel_TSA",
                                     ...
                                     period = rep( seq (from = 1, # run the 
                                                ...
                                                1), 
                                     flow = 9500000,
                                     partition_type = 'live') # 1,900,000 m3/yr 
))
