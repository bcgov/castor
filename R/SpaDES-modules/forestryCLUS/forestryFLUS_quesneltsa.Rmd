...
scenario = data.table (name = "quesnel_all_terr_10per_max12yrs", description = "bau + maximum 10 % of the territory <= 12 years of age. Harvest flow = 1,900,000 m3/yr. Adjacency = 3m. Oldest first.")
