...
parameters <- list(
  ...
  forestryCLUS = list( harvestPriority = " dist, siteindex DESC, age DESC, vol DESC ",
...
scenario = data.table(name="cg_test", description = "Partnership Agreement - projecting no harvesting in management zones outlined in partnership agreement. Adjacency constraint > 3 m.")

harvestFlow<- data.table(compartment ="MacKenzie_TSA",
                                     partition = ' vol > 110 ',
                                     year = rep(seq(from = 2018, to=2218, by = 5),1),  flow = 8370000)
