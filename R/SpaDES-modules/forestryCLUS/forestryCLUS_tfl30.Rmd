...
dbExecute(clusdb, "UPDATE zoneconstraints SET percentage = 65 where reference_zone = 'rast.zone_du9_scenarios' AND zoneid = 68") #Below will set Hart Ranges old and recruit forest as no harvest and matrix as 35% disturbance (no buffer)
...
# rsf_model_coeff[, bounds := 'rast.bc_crithab_and_herd']
 ...
 #                        description = "Business as usual (BAU). Sustainable flow = 180,000m^3^/year. Oldest first priority. Adjacency was set to 3m.")
# scenario = data.table (name = "tfl30_hart_nh",
#                         description = "No harvest in all Hart Ranges critical habitat. Sustainable flow = 180,000m^3^/year. Oldest first priority. Adjacency = 3m.")
# scenario = data.table (name = "tfl30_hart_ch_he0d_m15d",
#                         description = "No harvest in Hart Ranges high elevation critical habitat, maximum 35% buffered disturbance (15% harvest) in Hart Ranges matrix critical habitat. Sustainable flow = 180,000m^3^/year. Oldest first priority. Adjacency = 3m.")
