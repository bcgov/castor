...
- First, I tested a harvest flow of 219,000m^3^/year; 210,000, 205,000; 

- 205,000 provided even flow
...
#                        description = "Business-as-usual (BAU); harvest flow 205,000 m3/yr. Adjacency was set to 3m.")
# scenario = data.table (name = "tfl53_narrow_lake_nh",
#                        description = "No harvest in Narrow Lake critical habitat; harvest flow 205,000 m3/yr. Adjacency was set to 3m.")


scenario = data.table (name = "tfl53_narrow_lake_ch_he0d_m15d",
                       description = "No harvest in Narrow Lake HEWSR, maximum 35% buffered disturbance (15% harvest) in Narrow Lake matrix critical habitat that overlap with the harvest unit; harvest flow 205,000 m3/yr. Adjacency was set to 3m.")
