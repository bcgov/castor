...
parameters <- list(
  ...
  dataLoaderCLUS = list( 
                         dbName='clus',
                           ...
                           nameBoundaryFile="tsa_aac_bounds",
                           nameBoundaryColumn="tsa_name",
                           nameBoundary = "Morice_TSA", # This name must match that in dataLoaderCLUS
                           nameBoundaryGeom='wkb_geometry',
                           nameCompartmentRaster = "rast.tsa_aac_boundary",
                           nameCompartmentTable = "tsa_aac_bounds_vat",
                           nameMaskHarvestLandbaseRaster='rast.bc_thlb2018',
...
scenario = data.table(name="morice_bau_test", description = "business as usual - projecting current trends")
...
harvestFlow<- data.table(compartment ="Morice",
                                     partition = ' vol > 110 ',
