...
test_dir("C:/Users/klochhea/clus/R/SpaDES-modules/test/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/klochhea/clus/R/SpaDES-modules/test/tests/testthat/test-template.R")
