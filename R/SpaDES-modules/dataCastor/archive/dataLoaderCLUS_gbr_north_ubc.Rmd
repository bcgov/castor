...
---
title: "Database creation for Great Bear Rainforest North TSA Analyses Version 1.0"
...
Here I set the parameters to create a database for an area within the [Great Bear Rainforest (GBR) North timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/great-bear-rainforest-north), (https://www.bclaws.ca/civix/document/id/complete/statreg/327_2016#section2), (https://www2.gov.bc.ca/gov/content/industry/crown-land-water/land-use-planning/regions/west-coast/great-bear-rainforest/great-bear-rainforest-legal-direction-agreements). This area was defined by a group of UBC researchers who are interested in looking at cummulative effects. They provided me with a shape file of their study area and information on the constraints in this area. Here I use this shape file to run the dataloader CLUS.

# Usage
Set parameters for creating the database in the code chunk below.

If you run into an error saying something about a Self-intersection at or near some point. Run this code in postgres to fix the problem.

update public.ubc_gbr_boundaries set wkb_geometry = st_multi(st_collectionextract(st_makevalid(wkb_geometry), 3));

It removes or corrects the self-intersection
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         save_clusdb = TRUE,
                         sqlite_dbname = "UBC_study_boundary",
                         nameBoundaryFile="ubc_gbr_boundaries",
                         nameBoundaryColumn="tsa_name",
                         nameBoundary = "UBC_study_boundary", #Great_Bear_Rainforest_North_TSA # change this name
                         ...
                         nameZoneRasters=c("rast.zone_cond_beo", # rasters of the zone constraints to include. Add all zone rasters that might be needed here. First 7 always stay.
                                           ...
                                           "rast.zone_cond_cw",
                                           "rast.zone_cond_art" # average retention targets set by UBC group
                                           ),
  ...
  uploaderCLUS = list(aoiName = 'ubc_gbr_study',
...
scenario = data.table(name="load_data_ubc", 
...
patchSizeDist<- data.table(ndt= c(1,1,1,1,1,1,
                           ...
                           freq = c(0.3,0.3,0.1,0.1,0.1, 0.1,
                                    ...
                                    0.3,0.3,0.1,0.1,0.1, 0.1))
modules <- list("dataLoaderCLUS", "blockingCLUS", "roadCLUS", "disturbanceCalcCLUS", "uploaderCLUS")
