...
---
title: "Database creation for Kootenay Lake TSA Analyses Version 1.0"
author: "Tyler Muhly"
date: "23 June 2020"
output: pdf_document
---
...
Here I set the parameters to create a database for the [Kootenay Lake timber supply area (TSA)](https://www2.gov.bc.ca/gov/content/industry/forestry/managing-our-forest-resources/timber-supply-review-and-allowable-annual-cut/allowable-annual-cut-timber-supply-areas/kootenay-lake-tsa). The TSA is located in south-eastern British Columbia, encompasses approximately 1.2 million hectares of land. It overlaps with the Central Selkirks, Purcell Central, Purcells South, and South Selkirks s caribou herds (all in DU9). 

On August 12, 2010, the allowable annual cut was set at 640,000 cubic metres.
...
parameters <-  list(
  ...
  dataLoaderCLUS = list (dbName = 'clus', # name of the postgres database
                         ...
                         nameBoundary = "Kootenay_Lake_TSA", # the boundary (TSA) name
                         ...
                         nameZoneRasters = c("rast.zone_cond_beo", 
                                             ...
                                             "rast.zone_cond_bc_purcells_south_crithab",
                                             "rast.zone_cond_bc_south_selkirks_crithab"
                                              ), 
  ...
  uploaderCLUS = list(aoiName = 'kootenaylake_tsa',
