...
Here, I set the parameters and information needed to run the itchas-ilgachuzs scenarios for herd-planning.

# Usage

```{r module_usage}

#aois_tsa<-c("Quesnel_TSA")
aois_tsa<-c("Williams_Lake_TSA")
#library(snow)
#library(parallel)
#library(doParallel)
...
Sys.setenv(JAVA_HOME='C:\\Program Files\\Java\\jre1.8.0_251') #throws an error if pointing to different version of java (i.e., 32 vs 64 bit)
...
parameters <-  list(
  ...
  dataLoaderCLUS = list(dbName='clus',
                         ...
                         nameZoneRasters=c("rast.zone_cond_beo", "rast.zone_cond_vqo", "rast.zone_cond_wha", "rast.zone_cond_uwr","rast.zone_cond_fsw","rast.zone_cond_nharv", "rast.zone_cond_eccc_barkerville_crithab","rast.zone_cond_bc_barkerville_crithab","rast.zone_cond_eccc_itcha_ilgachuz_crithab","rast.zone_cond_bc_itcha_ilgachuz_crithab","rast.zone_cond_eccc_wells_gray_north_crithab","rast.zone_cond_bc_wells_gray_north_crithab", "rast.zone_cond_nh_crit_barkerville_crithab","rast.zone_cond_nh_crit_itcha_ilgachuz_crithab","rast.zone_cond_nh_crit_wells_gray_north_crithab", "rast.zone_cond_nh_crit_charlotte_alplands_crithab", "rast.zone_cond_nh_crit_rainbows_crithab"),
...
itchas<-data.table(getTableQuery("SELECT * FROM rsf_model_coeff WHERE population = 'DU9' and  species = 'caribou' and season IN ('A')"))
itchas[, bounds := 'rast.crithabitat']
itchas[, population:= 'Itcha_Ilgachuz']
...
patchSizeDist<- data.table(ndt= c(1,1,1,1,1,1,
                           ...
                           freq = c(0.3,0.3,0.1,0.1,0.1, 0.1,
                                    ...
                                    0.3,0.3,0.1,0.1,0.1, 0.1))
modules <- list("dataLoaderCLUS", "blockingCLUS", "roadCLUS", "survivalCLUS", "disturbanceCalcCLUS","growingStockCLUS")
