...
test_dir("C:/Users/KLOCHHEA/clus/R/SpaDES-modules/dataLoaderCLUS/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/KLOCHHEA/clus/R/SpaDES-modules/dataLoaderCLUS/tests/testthat/test-template.R")
