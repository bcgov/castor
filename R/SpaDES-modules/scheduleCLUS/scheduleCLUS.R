...
defineModule(sim, list(
  ...
  inputObjects = bind_rows(
    ...
    expectsInput(objectName = "targetVolume", objectClass = "data.frame", desc = NA, sourceURL = NA),
    expectsInput(objectName ="boundaryInfo", objectClass ="character", desc = NA, sourceURL = NA),
    expectsInput(objectName = "landscape", objectClass = "RasterStack", desc = NA, sourceURL = NA)
  ),
...
doEvent.scheduleCLUS = function(sim, eventTime, eventType) {
  switch(
    eventType,
    init = {
      sim <- Init(sim)
