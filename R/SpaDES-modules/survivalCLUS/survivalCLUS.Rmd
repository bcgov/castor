...
outputs (mySim) <- data.frame (objectName = c ("tableSurvival")) # Consists of survival rate estimates for each herd in the study area at each time step. Gets saved in the 'outputs' folder of the module. 
system.time({
