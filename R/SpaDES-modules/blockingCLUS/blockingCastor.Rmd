...
parameters <- list(
  ...
  dataCastor = list( dbName='clus',
                         saveCastordb = TRUE,
                         useCastorDB = "R/SpaDES-modules/dataCastor/clusdb.sqlite",
...
A SQLite db is required as an output from dataCastor.

## Output data

A raster of block IDs, internally stored in memory in castordb
