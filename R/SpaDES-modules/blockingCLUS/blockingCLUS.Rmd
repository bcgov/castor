...
parameters <- list(
  ...
  dbName = 'clus', nameBoundary ='Muskwa', nameBoundaryGeom = 'geom', nameMaskHarvestLandbaseRaster = 'ras_bc_thlb2018'),
  blockingCLUS = list(blockMethod = 'pre', nameSimilarityRas = 'ras_similar_vri2003', useLandingsArea = TRUE, useSpreadProbRas = TRUE),
