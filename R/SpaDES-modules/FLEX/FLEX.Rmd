...
experiment(mySim, replicates = 50)
```
...
library(ggplot2)
dir_reps<-data.table(dir(paste0(here::here(),"R/scenarios/test_flex2/outputs")))[V1 %like% "rep",]
abmReport<-rbindlist(lapply(dir_reps$V1, function(x) {
  readRDS(paste0(here::here(),"/R/scenarios/test_flex2/outputs/",x,"/fisherABMReport_year4.rds"))}))
