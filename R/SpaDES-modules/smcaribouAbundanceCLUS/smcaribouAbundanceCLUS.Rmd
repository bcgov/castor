...
1. If possible, you should run the *cutblockSeqPrepCLUS* module as part of the dataLoaderCLUS module to estimate which roads are used for forest harvest. Otherwise, you will overestimate the number of roads for the abundance estimate.
