...
When you run the *keyring_create()* function you will be prompted to add a password that will be used to open the keyring. This will be the password you use at the start of an R session. You can keep this simple as you will be the primary, and likley only user on your computer.
