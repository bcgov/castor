...
dat10$FWI_veg[dat10$FWI_veg=="M-3"]<-"O-1a/b"
dat10$FWI_veg[dat10$FWI_veg=="S-2"]<-"M-1/2"
...
cor.test(dat10$climate1, dat10$elevatn)
cor.test(dat10$climate2, dat10$elevatn)
cor.test(dat10$climate1, dat10$climate2)

mod.frt.10<-glm(fire ~ climate1 +climate2 + FWI_veg + elevatn, data=dat10, family=binomial(link="logit"))

# looking at difference in link function
modclim_logit<-glm(fire ~ climate1, data=dat10, family=binomial(link="logit"))
modclim_cloglog<-glm(fire ~ climate1, data=dat10, family=binomial(link="cloglog"))
...
dat2_b<-dat10%>% dplyr::select(fire, elevatn, climate1, climate2)
...
top_mod_table_FRT10_lightningALL <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_table_FRT10_lightningALL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept",
                                                   "coef_climate_1", 
                                                   "coef_climate_2", 
                                                   "coef_FWI_veg_C-3",  
                                                   "coef_FWI_veg_C-5",  
...
top_mod_table_FRT10_lightningL <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_table_FRT10_lightningL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept",
                                                   "coef_climate_1", 
                                                   "coef_climate_2", 
                                                   "coef_FWI_veg_C-3",  
                                                   "coef_FWI_veg_C-5",  
...
top_mod_table_FRT10_lightningL[1,15]<- mod.auc
