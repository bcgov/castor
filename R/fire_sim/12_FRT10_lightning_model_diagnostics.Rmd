...
mod.frt.10<-glm(fire ~ climate1 + FWI_veg + elevatn, data=dat10_2, family=binomial(link="logit"))
...
dat2_b<-dat10_2%>% dplyr::select(fire, elevatn, climate1)
...
colnames (top_mod_table_FRT12_lightningALL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_FWI_veg_C-3",  "coef_FWI_veg_C-5",  "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_M-3", "coef_FWI_veg_N", "coef_FWI_veg_O-1a/b","coef_elevatn", "AUC")
...
colnames (top_mod_table_FRT12_lightningL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_FWI_veg_C-3",  "coef_FWI_veg_C-5",  "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_M-3", "coef_FWI_veg_N", "coef_FWI_veg_O-1a/b","coef_elevatn", "AUC")


##Add data for NDT1
top_mod_table_FRT12_lightningL[1,1]<-"lightning"
top_mod_table_FRT12_lightningL[1,2]<-"FRT14"
top_mod_table_FRT12_lightningL[1,3]<-"fire ~ climate1 + climate2 + FWI_veg + elevatn"
...
FRT12_summary_table_mean$FRT<-10
FRT12_summary_table_mean$Model_terms<-"fire ~ climate1 + FWI_veg + elevatn"
...
```{r}
write.csv(FRT12_summary_table_mean, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_FRT10_lightning.csv")
```
