...
```{r}
write.csv(top_mod_table_NDT1_spread_poly, file="D:\\Fire\\fire_data\\raw_data\\top_mod_NDT1_spread_poly_all_.csv")
```
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_NDT1_spread_poly_means_.csv")
```
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_NDT1_spread_poly_sd_.csv")
```
