...
Escape_data_lightning<-read.csv("D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_lightning.csv")
...
#Person-caused fires
Escape_data_person<-read.csv("D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_person.csv")
...
```{r}
write.csv(Escape_data_lightning, "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Lightning_data_escape_.csv")

write.csv(Escape_data_person, "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Person_data_escape_.csv")
```
...
write.csv(Escape_data_lightning_t, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_lightning_trees_NDT.csv")

write.csv(Escape_data_lightning_nt, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_lightning_notrees_NDT.csv")

write.csv(Escape_data_person_t, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_person_trees_NDT.csv")

write.csv(Escape_data_person_nt, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\escape_data_person_notrees_NDT.csv")

```

Load in the prepped data if starting from here.
...
```{r}
Escape_data_person_nt$fire_veg<-paste(Escape_data_person_nt$escape, Escape_data_person_nt$vegtype)

Escape_data_person_t$fire_veg<-paste(Escape_data_person_t$escape, Escape_data_person_t$vegtype)

Escape_data_lightning_nt$fire_veg<-paste(Escape_data_lightning_nt$escape, Escape_data_lightning_nt$vegtype)

Escape_data_lightning_t$fire_veg<-paste(Escape_data_lightning_t$escape, Escape_data_lightning_t$vegtype)

str(Escape_data_person_t$fire_veg)
str(Escape_data_person_t$fire_pres)
```

Clear R except what I want to keep.

```{r}
library(gdata)

keep(dat_lightning, dat_lightning_, dat_person, dat_person_, Escape_data_lightning_t, Escape_data_lightning_nt, Escape_data_person_nt, Escape_data_person_t, sure = TRUE) # setting sure to TRUE removes variables not in the list
...
NDT 1, 3 and 5 all have 2 climate variables, and NDT 2 and 4 have one.
...
write.csv(NDT1_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT1_lightning_escape_models.csv")
```
...
```{r}
##### TOP MODEL####
NDT1_t<-Escape_data_lightning_t %>%
  filter(ntrl_ds=="NDT1")
...
write.csv(NDT2_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT2_lightning_escape_models.csv")
```
...
```{r}
##### TOP MODEL####
NDT2_t<-Escape_data_lightning_t %>%
  filter(ntrl_ds=="NDT2")
...
write.csv(NDT3_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT3_lightning_escape_models.csv")
```
...
```{r}
##### TOP MODEL####
NDT3_t<-Escape_data_lightning_t %>%
  filter(ntrl_ds=="NDT3")
...
write.csv(NDT4_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT4_lightning_escape_models.csv")
```
...
```{r}
##### TOP MODEL####
NDT4_t<-Escape_data_lightning_t %>%
  filter(ntrl_ds=="NDT4")
...
head(Escape_data_lightning_t_NDT5)
table(Escape_data_lightning_t_NDT5$vegtype)
table(Escape_data_lightning_t_NDT5$escape)
table(Escape_data_lightning_t_NDT5$fire_veg)
...
write.csv(NDT5_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT5_lightning_escape_models.csv")
```
...
```{r}
##### TOP MODEL####
NDT5_t<-Escape_data_lightning_t %>%
  filter(ntrl_ds=="NDT5")
...
write.csv(NDT1_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT1_lightning_escape_models_notrees.csv")
```
...
```{r}
##### TOP MODEL####
NDT1_t<-Escape_data_lightning_nt %>%
  filter(ntrl_ds=="NDT1")
...
write.csv(NDT2_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT2_lightning_escape_models_notrees.csv")
```
...
```{r}
##### TOP MODEL####
NDT2_t<-Escape_data_lightning_nt %>%
  filter(ntrl_ds=="NDT2")
...
write.csv(NDT3_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT3_lightning_escape_models_notrees.csv")
```
...
```{r}
##### TOP MODEL####
NDT3_t<-Escape_data_lightning_nt %>%
  filter(ntrl_ds=="NDT3")
...
write.csv(NDT4_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT4_lightning_escape_models_notrees.csv")
```
...
```{r}
##### TOP MODEL####
NDT4_t<-Escape_data_lightning_nt %>%
  filter(ntrl_ds=="NDT4")
...
Problems because too little data.
```{r}
Escape_data_lightning_nt_NDT5<-subset(Escape_data_lightning_nt, Escape_data_lightning_nt$ntrl_ds=="NDT5")
head(Escape_data_lightning_nt_NDT5)
table(Escape_data_lightning_nt_NDT5$escape)
...
write.csv(NDT5_l_models_escape, file="D:\\Fire\\fire_data\\raw_data\\NDT5_lightning_escape_models_notrees.csv")
```
...
```{r}
##### TOP MODEL####
NDT5_t<-Escape_data_lightning_nt %>%
  filter(ntrl_ds=="NDT5")
...
############### Part 2 of 4 Model Series: person Caused Fires, No Trees ##########
