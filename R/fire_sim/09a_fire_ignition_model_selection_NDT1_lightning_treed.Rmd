...
3. slope + aspect + elevation + aspect:elevation
...
```{r}
##Create variable lists to be used in the model loop.
variables_all_NDT1<-c(climate1 = "climate1", climate2 = "climate2", vegtype2 = "vegtype2", proj_height_1 = "proj_height_1", live_stand_volume_125 = "live_stand_volume_125", proj_age_1 = "proj_age_1", slope = "slope", aspect = "aspect", elevation ="elevation", dist_mun = "dist_mun", dist_dam = "dist_dam", dist_nat = "dist_nat", dist_mine = "dist_mine", bclcs_level_5_2 = "bclcs_level_5_2")
...
#3. DEM
slope + aspect + elevation + aspect:elevation
...
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   ...
   mod.auc <- auc(roc_obj)
   mod.auc #0.7543 --> good fit!
   
Anova(model.NDT1, type=3)
Anova(model.NDT1, type=3, singular.ok = TRUE)

#Begin removing least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate1:proj_age_1 + climate2:live_stand_volume_125 + climate2:proj_age_1 + vegtype2:live_stand_volume_125 + vegtype2:proj_age_1 + proj_height_1:live_stand_volume_125 + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation + aspect:elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6111.6

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"fire_pres"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7542 --> good fit!
...
#Begin removing least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125 + vegtype2:proj_age_1 + proj_height_1:live_stand_volume_125 + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6108.2
...
#Begin removing least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125 + vegtype2:proj_age_1 + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6107.1
...
AIC(model.NDT1) #6106.5

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"fire_pres"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7546 --> good fit!
...
#Begin removing least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1  + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125  + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2  + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6103.23

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"fire_pres"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7551 --> good fit!
   
Anova(model.NDT1, type=3)
Anova(model.NDT1, type=3, singular.ok = TRUE)

#The above is the best model thus far. Are there interactions between other variables that may be of biological relevance to investigate? Maybe try climate with elevation?

#New interactions
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1  + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125  + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2  + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation + climate1:elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6101.5

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"fire_pres"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7564 --> good fit!
   
Anova(model.NDT1, type=3)
Anova(model.NDT1, type=3, singular.ok = TRUE)

#try removing one
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1  + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125  + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2  + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT1) #6100.08
...
NDT1_t_ignite<-dat_lightning_t_NDT1 %>% drop_na(climate1, climate2, proj_height_1, live_stand_volume_125, proj_age_1, dist_mun,  dist_dam, dist_nat, dist_mine, vegtype2, bclcs_level_5_2, slope, aspect, elevation)

#Run Model again with this data; but uses all data here
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1  + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125  + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2  + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation + climate2:elevation, family = binomial, data = NDT1_t_ignite)
...
#Partial Residuals
#climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:vegtype2 + climate1:proj_height_1  + climate1:proj_age_1  + climate2:proj_age_1 + vegtype2:live_stand_volume_125  + live_stand_volume_125:proj_age_1 + dist_mun + dist_dam + dist_nat + dist_mine + bclcs_level_5_2  + dist_nat:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + slope + aspect + elevation + climate2:elevation
library(visreg)
visreg(model.NDT1, "climate1", by="vegtype2", overlay=TRUE) #huge variation in disturbed
visreg(model.NDT1, "climate1", by="vegtype2", overlay=TRUE, ylim=c(-7,7))
...
visreg(model.NDT1, "aspect")
visreg(model.NDT1, "elevation", by="climate2")

visreg(model.NDT1, "live_stand_volume_125", by="vegtype2", overlay=TRUE, ylim=c(-20,20))
...
visreg(model.NDT1, "dist_mun") #look into these extreme points
visreg(model.NDT1, "dist_dam")
visreg(model.NDT1, "dist_nat", by="bclcs_level_5_2")
visreg(model.NDT1, "dist_mine", by="bclcs_level_5_2")
...
top_mod_table_NDT1_light_t_ALL <- data.frame (matrix (ncol = 42, nrow = 0))
colnames (top_mod_table_NDT1_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_climate_interaction", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_stand_height", "coef_live_stand_volume_125", "coef_stand_age",  "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_dist_mine", "coef_bclcs_level_5_2DIST", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "slope", "aspect", "elevation", "coef_climate1:vegtype2TB", "coef_climate1:vegtype2TC", "coef_climate1:vegtype2TM", "coef_climate1:proj_height_1", "coef_climate1:proj_age_1", "coef_climate2:proj_age_1", "coef_vegtype2TB:live_stand_volume_125", "coef_vegtype2TC:live_stand_volume_125", "coef_vegtype2TM:live_stand_volume_125", "coef_live_stand_volume_125:proj_age_1", "coef_dist_nat:bclcs_level_5_2DIST", "coef_dist_nat:bclcs_level_5_2OP", "coef_dist_nat:bclcs_level_5_2SP", "coef_dist_mine:bclcs_level_5_2DIST", "coef_dist_mine:bclcs_level_5_2OP", "coef_dist_mine:bclcs_level_5_2SP", "coef_climate2:elevation", "AUC")
```
...
top_mod_table_NDT1_light_t <- data.frame (matrix (ncol = 42, nrow = 0))
...
top_mod_table_NDT1_light_t[1,8]<- coef(model.NDT1)[20] #Interaction climate variables
top_mod_table_NDT1_light_t[1,9]<- coef(model.NDT1)[4] #coefficient vegtypeTB
top_mod_table_NDT1_light_t[1,10]<- coef(model.NDT1)[5] #coefficient vegtypeTC
top_mod_table_NDT1_light_t[1,11]<- coef(model.NDT1)[6] #coefficient vegtypeTM
top_mod_table_NDT1_light_t[1,12]<- coef(model.NDT1)[7] #stand_height
top_mod_table_NDT1_light_t[1,13]<- coef(model.NDT1)[8] #live stand volume
top_mod_table_NDT1_light_t[1,14]<- coef(model.NDT1)[9] #proj age
top_mod_table_NDT1_light_t[1,15]<- coef(model.NDT1)[10] #coefficient dist_mun
top_mod_table_NDT1_light_t[1,16]<- coef(model.NDT1)[11] #coefficient dist_dam
top_mod_table_NDT1_light_t[1,17]<- coef(model.NDT1)[12] #coefficient dist_nat
top_mod_table_NDT1_light_t[1,18]<- coef(model.NDT1)[13] #coefficient dist_mine
top_mod_table_NDT1_light_t[1,19]<- coef(model.NDT1)[14] #coefficient bclcs_level_5_2DIST
top_mod_table_NDT1_light_t[1,20]<- coef(model.NDT1)[15] #coefficient bclcs_level_5_2OP
top_mod_table_NDT1_light_t[1,21]<- coef(model.NDT1)[16] #coefficient bclcs_level_5_2SP
top_mod_table_NDT1_light_t[1,22]<- coef(model.NDT1)[17] #coefficient slope
top_mod_table_NDT1_light_t[1,23]<- coef(model.NDT1)[18] #coefficient aspect
top_mod_table_NDT1_light_t[1,24]<- coef(model.NDT1)[19] #coefficient elevation
top_mod_table_NDT1_light_t[1,25]<- coef(model.NDT1)[21] #coefficient climate1:vegypeTB
top_mod_table_NDT1_light_t[1,26]<- coef(model.NDT1)[22] #coefficient climate1:vegypeTC
top_mod_table_NDT1_light_t[1,27]<- coef(model.NDT1)[23] #coefficient climate1:vegypeTM
top_mod_table_NDT1_light_t[1,28]<- coef(model.NDT1)[24] #coefficient climate1*projheight
top_mod_table_NDT1_light_t[1,29]<- coef(model.NDT1)[25] #coefficient climate1*projage
top_mod_table_NDT1_light_t[1,30]<- coef(model.NDT1)[26] #coefficient climate2*projage
top_mod_table_NDT1_light_t[1,31]<- coef(model.NDT1)[27] #coefficient livestandvolume*vegtypeTB
top_mod_table_NDT1_light_t[1,32]<- coef(model.NDT1)[28] #coefficient livestandvolume*vegtypeTC
top_mod_table_NDT1_light_t[1,33]<- coef(model.NDT1)[29] #coefficient livestandvolume*vegtypeTM
top_mod_table_NDT1_light_t[1,34]<- coef(model.NDT1)[30] #coefficient livestandvolume*projage
top_mod_table_NDT1_light_t[1,35]<- coef(model.NDT1)[31] #coefficient dist_nat:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t[1,36]<- coef(model.NDT1)[32] #coefficient dist_nat:bclcs_level_5_2OP
top_mod_table_NDT1_light_t[1,37]<- coef(model.NDT1)[33] #coefficient dist_nat:bclcs_level_5_2SP 
top_mod_table_NDT1_light_t[1,38]<- coef(model.NDT1)[34] #coefficient dist_mine:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t[1,39]<- coef(model.NDT1)[35] #coefficient dist_mine:bclcs_level_5_2OP
top_mod_table_NDT1_light_t[1,40]<- coef(model.NDT1)[36] #coefficient dist_mine:bclcs_level_5_2SP
top_mod_table_NDT1_light_t[1,41]<- coef(model.NDT1)[37] #coefficient climate2:elevation 
top_mod_table_NDT1_light_t[1,42]<- mod.auc
...
mean(top_mod_table_NDT1_light_t_ALL$AUC) #0.754

# create model table (only do this once) and add the relevant data
top_mod_table_NDT1_light_t_Means <- data.frame (matrix (ncol = 42, nrow = 0))
...
top_mod_table_NDT1_light_t_Means[1,8]<- mean(top_mod_table_NDT1_light_t_ALL$coef_climate_interaction, na.rm=TRUE) #Interaction climate variables
top_mod_table_NDT1_light_t_Means[1,9]<- mean(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTB, na.rm=TRUE) #coefficient vegtypeTB
top_mod_table_NDT1_light_t_Means[1,10]<- mean(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTC, na.rm=TRUE) #coefficient vegtypeTC
top_mod_table_NDT1_light_t_Means[1,11]<- mean(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTM, na.rm=TRUE) #coefficient vegtypeTM
top_mod_table_NDT1_light_t_Means[1,12]<- mean(top_mod_table_NDT1_light_t_ALL$coef_stand_height, na.rm=TRUE) #stand_height
top_mod_table_NDT1_light_t_Means[1,13]<- mean(top_mod_table_NDT1_light_t_ALL$coef_live_stand_volume_125, na.rm=TRUE) #live stand volume
top_mod_table_NDT1_light_t_Means[1,14]<- mean(top_mod_table_NDT1_light_t_ALL$coef_stand_age, na.rm=TRUE) #proj age
top_mod_table_NDT1_light_t_Means[1,15]<- mean(top_mod_table_NDT1_light_t_ALL$coef_dist_mun, na.rm=TRUE) #coefficient dist_mun
top_mod_table_NDT1_light_t_Means[1,16]<- mean(top_mod_table_NDT1_light_t_ALL$coef_dist_dam, na.rm=TRUE)#coefficient dist_dam
top_mod_table_NDT1_light_t_Means[1,17]<- mean(top_mod_table_NDT1_light_t_ALL$coef_dist_nat, na.rm=TRUE) #coefficient dist_nat
top_mod_table_NDT1_light_t_Means[1,18]<- mean(top_mod_table_NDT1_light_t_ALL$coef_dist_mine, na.rm=TRUE) #coefficient dist_mine
top_mod_table_NDT1_light_t_Means[1,19]<- mean(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2DIST, na.rm=TRUE) #coefficient bclcs_level_5_2DIST
top_mod_table_NDT1_light_t_Means[1,20]<- mean(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2OP, na.rm=TRUE) #coefficient bclcs_level_5_2OP
top_mod_table_NDT1_light_t_Means[1,21]<- mean(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2SP, na.rm=TRUE) #coefficient bclcs_level_5_2SP
top_mod_table_NDT1_light_t_Means[1,22]<- mean(top_mod_table_NDT1_light_t_ALL$slope, na.rm=TRUE) #coefficient slope
top_mod_table_NDT1_light_t_Means[1,23]<- mean(top_mod_table_NDT1_light_t_ALL$aspect, na.rm=TRUE) #coefficient aspect
top_mod_table_NDT1_light_t_Means[1,24]<- mean(top_mod_table_NDT1_light_t_ALL$elevation, na.rm=TRUE) #coefficient elevation
top_mod_table_NDT1_light_t_Means[1,25]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TB`, na.rm=TRUE) #coefficient climate1:vegypeTB
top_mod_table_NDT1_light_t_Means[1,26]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TC`, na.rm=TRUE) #coefficient climate1:vegypeTC
top_mod_table_NDT1_light_t_Means[1,27]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TM`, na.rm=TRUE) #coefficient climate1:vegypeTM
top_mod_table_NDT1_light_t_Means[1,28]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:proj_height_1`, na.rm=TRUE) #coefficient climate1*projheight
top_mod_table_NDT1_light_t_Means[1,29]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:proj_age_1`, na.rm=TRUE) #coefficient climate1*projage
top_mod_table_NDT1_light_t_Means[1,30]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate2:proj_age_1`, na.rm=TRUE) #coefficient climate2*projage
top_mod_table_NDT1_light_t_Means[1,31]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TB:live_stand_volume_125`, na.rm=TRUE) #coefficient livestandvolume*vegtypeTB
top_mod_table_NDT1_light_t_Means[1,32]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TC:live_stand_volume_125`, na.rm=TRUE)#coefficient livestandvolume*vegtypeTC
top_mod_table_NDT1_light_t_Means[1,33]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TM:live_stand_volume_125`, na.rm=TRUE) #coefficient livestandvolume*vegtypeTM
top_mod_table_NDT1_light_t_Means[1,34]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_live_stand_volume_125:proj_age_1`, na.rm=TRUE) #coefficient livestandvolume*projage
top_mod_table_NDT1_light_t_Means[1,35]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t_Means[1,36]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2OP`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2OP
top_mod_table_NDT1_light_t_Means[1,37]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2SP`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2SP 
top_mod_table_NDT1_light_t_Means[1,38]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t_Means[1,39]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2OP`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2OP
top_mod_table_NDT1_light_t_Means[1,40]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2SP`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2SP
top_mod_table_NDT1_light_t_Means[1,41]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate2:elevation`, na.rm=TRUE) #coefficient climate2:elevation 
top_mod_table_NDT1_light_t_Means[1,42]<- mean(top_mod_table_NDT1_light_t_ALL$AUC, na.rm=TRUE)
...
```{r}
# create model table (only do this once) and add the relevant data
top_mod_table_NDT1_light_t_SD <- data.frame (matrix (ncol = 42, nrow = 0))
...
top_mod_table_NDT1_light_t_SD[1,8]<- sd(top_mod_table_NDT1_light_t_ALL$coef_climate_interaction, na.rm=TRUE) #Interaction climate variables
top_mod_table_NDT1_light_t_SD[1,9]<- sd(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTB, na.rm=TRUE) #coefficient vegtypeTB
top_mod_table_NDT1_light_t_SD[1,10]<- sd(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTC, na.rm=TRUE) #coefficient vegtypeTC
top_mod_table_NDT1_light_t_SD[1,11]<- sd(top_mod_table_NDT1_light_t_ALL$coef_vegtypeTM, na.rm=TRUE) #coefficient vegtypeTM
top_mod_table_NDT1_light_t_SD[1,12]<- sd(top_mod_table_NDT1_light_t_ALL$coef_stand_height, na.rm=TRUE) #stand_height
top_mod_table_NDT1_light_t_SD[1,13]<- sd(top_mod_table_NDT1_light_t_ALL$coef_live_stand_volume_125, na.rm=TRUE) #live stand volume
top_mod_table_NDT1_light_t_SD[1,14]<- sd(top_mod_table_NDT1_light_t_ALL$coef_stand_age, na.rm=TRUE) #proj age
top_mod_table_NDT1_light_t_SD[1,15]<- sd(top_mod_table_NDT1_light_t_ALL$coef_dist_mun, na.rm=TRUE) #coefficient dist_mun
top_mod_table_NDT1_light_t_SD[1,16]<- sd(top_mod_table_NDT1_light_t_ALL$coef_dist_dam, na.rm=TRUE)#coefficient dist_dam
top_mod_table_NDT1_light_t_SD[1,17]<- sd(top_mod_table_NDT1_light_t_ALL$coef_dist_nat, na.rm=TRUE) #coefficient dist_nat
top_mod_table_NDT1_light_t_SD[1,18]<- sd(top_mod_table_NDT1_light_t_ALL$coef_dist_mine, na.rm=TRUE) #coefficient dist_mine
top_mod_table_NDT1_light_t_SD[1,19]<- sd(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2DIST, na.rm=TRUE) #coefficient bclcs_level_5_2DIST
top_mod_table_NDT1_light_t_SD[1,20]<- sd(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2OP, na.rm=TRUE) #coefficient bclcs_level_5_2OP
top_mod_table_NDT1_light_t_SD[1,21]<- sd(top_mod_table_NDT1_light_t_ALL$coef_bclcs_level_5_2SP, na.rm=TRUE) #coefficient bclcs_level_5_2SP
top_mod_table_NDT1_light_t_SD[1,22]<- sd(top_mod_table_NDT1_light_t_ALL$slope, na.rm=TRUE) #coefficient slope
top_mod_table_NDT1_light_t_SD[1,23]<- sd(top_mod_table_NDT1_light_t_ALL$aspect, na.rm=TRUE) #coefficient aspect
top_mod_table_NDT1_light_t_SD[1,24]<- sd(top_mod_table_NDT1_light_t_ALL$elevation, na.rm=TRUE) #coefficient elevation
top_mod_table_NDT1_light_t_SD[1,25]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TB`, na.rm=TRUE) #coefficient climate1:vegypeTB
top_mod_table_NDT1_light_t_SD[1,26]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TC`, na.rm=TRUE) #coefficient climate1:vegypeTC
top_mod_table_NDT1_light_t_SD[1,27]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TM`, na.rm=TRUE) #coefficient climate1:vegypeTM
top_mod_table_NDT1_light_t_SD[1,28]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:proj_height_1`, na.rm=TRUE) #coefficient climate1*projheight
top_mod_table_NDT1_light_t_SD[1,29]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:proj_age_1`, na.rm=TRUE) #coefficient climate1*projage
top_mod_table_NDT1_light_t_SD[1,30]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate2:proj_age_1`, na.rm=TRUE) #coefficient climate2*projage
top_mod_table_NDT1_light_t_SD[1,31]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TB:live_stand_volume_125`, na.rm=TRUE) #coefficient livestandvolume*vegtypeTB
top_mod_table_NDT1_light_t_SD[1,32]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TC:live_stand_volume_125`, na.rm=TRUE)#coefficient livestandvolume*vegtypeTC
top_mod_table_NDT1_light_t_SD[1,33]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_vegtype2TM:live_stand_volume_125`, na.rm=TRUE) #coefficient livestandvolume*vegtypeTM
top_mod_table_NDT1_light_t_SD[1,34]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_live_stand_volume_125:proj_age_1`, na.rm=TRUE) #coefficient livestandvolume*projage
top_mod_table_NDT1_light_t_SD[1,35]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t_SD[1,36]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2OP`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2OP
top_mod_table_NDT1_light_t_SD[1,37]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_nat:bclcs_level_5_2SP`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2SP 
top_mod_table_NDT1_light_t_SD[1,38]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2DIST 
top_mod_table_NDT1_light_t_SD[1,39]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2OP`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2OP
top_mod_table_NDT1_light_t_SD[1,40]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_dist_mine:bclcs_level_5_2SP`, na.rm=TRUE) #coefficient dist_mine:bclcs_level_5_2SP
top_mod_table_NDT1_light_t_SD[1,41]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate2:elevation`, na.rm=TRUE) #coefficient climate2:elevation 
top_mod_table_NDT1_light_t_SD[1,42]<- sd(top_mod_table_NDT1_light_t_ALL$AUC, na.rm=TRUE)

top_mod_table_NDT1_light_t_SD

```

If colons replaced with periods, use below:
