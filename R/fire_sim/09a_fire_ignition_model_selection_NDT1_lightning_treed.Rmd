...
top_mod_table_NDT1_light_t_Means[1,35]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_ist_nat:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2DIST 
...
top_mod_table_NDT1_light_t_Means[1,42]<- mean(mod.auc, na.rm=TRUE)
...
top_mod_table_NDT1_light_t_SD[1,35]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_ist_nat:bclcs_level_5_2DIST`, na.rm=TRUE) #coefficient dist_nat:bclcs_level_5_2DIST 
...
top_mod_table_NDT1_light_t_SD[1,42]<- sd(mod.auc, na.rm=TRUE)
