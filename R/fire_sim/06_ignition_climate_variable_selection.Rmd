...
#Select the below for BEC zones that have had inconsistent results to run these ones again
#zones<- c("MH", "IDF", "SBPS", "IMA", "BG", "SBS", "SWB") #"CDF", "BAFA"
...
```{r}
write.csv(aic_bec_lightning_summary2, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\climate_AIC_results_lightning_July13.csv")
```
...
#Repeat for zones that need additional runs, or attempt the ones with fewer
zones<- c("MH", "SBPS", "SWB")
...
```{r}
write.csv(aic_bec_person_summary2, file="D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\climate_AIC_results_person_July13.csv")
