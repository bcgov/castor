...
top_mod_table_NDT3_light_t[1,17]<- coef(model.NDT3)[13] #coefficient slope
top_mod_table_NDT3_light_t[1,18]<- coef(model.NDT3)[14] #coefficient elevation 
top_mod_table_NDT3_light_t[1,19]<- coef(model.NDT3)[15] #coefficient  wind_atfire
top_mod_table_NDT3_light_t[1,20]<- coef(model.NDT3)[16] #coefficient  Tdif_atfire
top_mod_table_NDT3_light_t[1,21]<- coef(model.NDT3)[17] #coefficient climate2:vegtype2TB
top_mod_table_NDT3_light_t[1,22]<- coef(model.NDT3)[18] #coefficient climate2:vegtype2TC
top_mod_table_NDT3_light_t[1,23]<- coef(model.NDT3)[19] #coefficient climate2:vegtype2TM
top_mod_table_NDT3_light_t[1,24]<- coef(model.NDT3)[20] #coefficient live_stand_volume_125:proj_height_1
top_mod_table_NDT3_light_t[1,25]<- coef(model.NDT3)[21] #coefficient dist_dam:roads_km
top_mod_table_NDT3_light_t[1,26]<- coef(model.NDT3)[22] #coefficient dist_mun:roads_km
top_mod_table_NDT3_light_t[1,27]<- coef(model.NDT3)[23] #coefficient climate2:elevation
top_mod_table_NDT3_light_t[1,28]<- coef(model.NDT3)[24] #coefficient climate1:Tdif_atfire
top_mod_table_NDT3_light_t[1,29]<- coef(model.NDT3)[25] #coefficient climate2:Tdif_atfire 
top_mod_table_NDT3_light_t[1,30]<- coef(model.NDT3)[26] #coefficient wind_atfire:Tdif_atfire
