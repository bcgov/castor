...
12. roads_km (raod density, which may relate to ability to fight fires)
...
vars.infra<-c("dist_mun", "dist_dam", "dist_nat", "dist_pow", "dist_mine", "dist_any", "roads_km")
...
length(mods.twowayI) #2097152 - this is a problem; use just mods.meI
#mods.twowayI
