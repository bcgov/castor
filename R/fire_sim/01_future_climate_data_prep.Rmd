...
```{r Step3, echo=FALSE}
rm(dirs, gcms, dir, files, element.list, scenario.list, ripf.list, run.list, elements, runs2, runs, years, temp, ref.rast, r, delta.r, delta.r.hist, temp.delta.rast, temp.delta.rast.hist, temp2, temp3, x)
gc()
