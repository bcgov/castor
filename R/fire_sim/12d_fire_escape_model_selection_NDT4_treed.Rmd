---
title: "12d_fire_escape_model_selection_NDT4_treed"
author: "Cora Skaien"
date: "28/09/2021"
...
#=================================
#  Script Name: 12d_fire_escape_model_selection_NDT4_treed.R
#  Script Version: 1.0
...
*Interactions to include: climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire:wind_atfire + Tdif_atfire
...
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:elevation + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire:wind_atfire + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1148.3
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:elevation + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1146.3
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1144.4
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1142.6
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1140.7
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1138.95
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1137.0
...
#Remove least sig
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1136.2
...
#Last top model before Tdif
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #1141.4

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT4.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.69 --> still predicts better!
   
Anova(model.NDT4.E, type=3)
#Anova(model.NDT4.E, type=3, singular.ok = TRUE)

#Take last model but add Tdif_atfire
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4.E) #1140.2
...
Anova(model.NDT4.E, type=3)
#Anova(model.NDT4.E, type=3, singular.ok = TRUE)
##AIC not as good, but AUC much better
...
NDT4_escape_t<-escape_lightning_t_NDT4 %>% drop_na(climate1, live_stand_volume_125, aspect, elevation, wind_atfire, dist_mun, dist_nat, roads_km, Tdif_atfire)

#Run Model again with this data; but uses all data here
model.NDT4.E<-glm(escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = NDT4_escape_t)
...
# climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire
visreg(model.NDT4.E, "climate1", by="elevation")
visreg(model.NDT4.E, "Tdif_atfire")

visreg(model.NDT4.E, "live_stand_volume_125")

visreg(model.NDT4.E, "aspect")
visreg(model.NDT4.E, "elevation", by="climate1")

visreg(model.NDT4.E, "wind_atfire")

visreg(model.NDT4.E, "dist_mun")
visreg(model.NDT4.E, "dist_nat")
...
colnames (top_mod_table_NDT4_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_live_stand_volume_125", "coef_aspect", "coef_elevation", "coef_wind_atfire", "coef_dist_mun", "coef_dist_nat", "coef_roads_km", "coef_Tdif_atfire", "coef_climate1:elevation", "AUC")
```
...
colnames (top_mod_table_NDT4_light_t ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_live_stand_volume_125", "coef_aspect", "coef_elevation", "coef_wind_atfire", "coef_dist_mun", "coef_dist_nat", "coef_roads_km", "coef_Tdif_atfire", "coef_climate1:elevation", "AUC")

##Add data for NDT4
top_mod_table_NDT4_light_t[1,1]<-"lightning"
top_mod_table_NDT4_light_t[1,2]<-"NDT4"
top_mod_table_NDT4_light_t[1,3]<-"Y"
top_mod_table_NDT4_light_t[1,4]<-"escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire" 
top_mod_table_NDT4_light_t[1,5]<- coef(model.NDT4.E)[1] #Intercept
top_mod_table_NDT4_light_t[1,6]<- coef(model.NDT4.E)[2] #Climate variable 1
top_mod_table_NDT4_light_t[1,7]<- coef(model.NDT4.E)[3] #live_stand_volume_125
top_mod_table_NDT4_light_t[1,8]<- coef(model.NDT4.E)[4] #coefficient aspect
top_mod_table_NDT4_light_t[1,9]<- coef(model.NDT4.E)[5] #coefficient elevation
top_mod_table_NDT4_light_t[1,10]<- coef(model.NDT4.E)[6] #coefficient wind_atfire
top_mod_table_NDT4_light_t[1,11]<- coef(model.NDT4.E)[7] #coefficient dist_mun
top_mod_table_NDT4_light_t[1,12]<- coef(model.NDT4.E)[8] #coefficient dist_nat
top_mod_table_NDT4_light_t[1,13]<- coef(model.NDT4.E)[9] #coefficient roads_km
top_mod_table_NDT4_light_t[1,14]<- coef(model.NDT4.E)[10] #coefficient Tdif_atfire
top_mod_table_NDT4_light_t[1,15]<- coef(model.NDT4.E)[11] #coefficient climate1:elevation
...
mean(top_mod_table_NDT4_light_t_ALL$AUC) # 0.65

# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_t_Means <- data.frame (matrix (ncol = 16, nrow = 0))
colnames (top_mod_table_NDT4_light_t_Means ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_live_stand_volume_125", "coef_aspect", "coef_elevation", "coef_wind_atfire", "coef_dist_mun", "coef_dist_nat", "coef_roads_km", "coef_Tdif_atfire", "coef_climate1:elevation", "AUC")
...
top_mod_table_NDT4_light_t_Means[1,4]<-"escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire" 
...
top_mod_table_NDT4_light_t_Means[1,14]<- mean(top_mod_table_NDT4_light_t_ALL$coef_Tdif_atfire, na.rm=TRUE) #
...
colnames (top_mod_table_NDT4_light_t_SD ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_live_stand_volume_125", "coef_aspect", "coef_elevation", "coef_wind_atfire", "coef_dist_mun", "coef_dist_nat", "coef_roads_km", "coef_Tdif_atfire", "coef_climate1:elevation", "AUC")
...
top_mod_table_NDT4_light_t_SD[1,4]<-"escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire" 
...
top_mod_table_NDT4_light_t_SD[1,14]<- sd(top_mod_table_NDT4_light_t_ALL$coef_Tdif_atfire, na.rm=TRUE) #
...
top_mod_table_NDT4_light_t[1,9]<- coef(model.NDT4.E)[5] #coefficient elevation
top_mod_table_NDT4_light_t[1,10]<- coef(model.NDT4.E)[6] #coefficient wind_atfire
top_mod_table_NDT4_light_t[1,11]<- coef(model.NDT4.E)[7] #coefficient dist_dam
top_mod_table_NDT4_light_t[1,12]<- coef(model.NDT4.E)[8] #coefficient dist_mun
top_mod_table_NDT4_light_t[1,13]<- coef(model.NDT4.E)[9] #coefficient dist_nat
top_mod_table_NDT4_light_t[1,14]<- coef(model.NDT4.E)[10] #coefficient roads_km
top_mod_table_NDT4_light_t[1,15]<- coef(model.NDT4.E)[11] #coefficient climate1:elevation
top_mod_table_NDT4_light_t[1,16]<- mod.auc
