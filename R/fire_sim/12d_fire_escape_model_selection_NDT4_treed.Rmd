...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:elevation + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1146.3
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1144.4
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:live_stand_volume_125 + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1142.6
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + dist_mine + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1140.7
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + aspect + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1138.95
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire:climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1137.0
...
#Remove least sig
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:wind_atfire + dist_dam + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1136.2
...
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT4) #1140.2
...
model.NDT4<-glm(escape ~ climate1 + live_stand_volume_125 + aspect + elevation + wind_atfire  + dist_mun + dist_nat + roads_km + climate1:elevation + Tdif_atfire, family = binomial, data = NDT4_escape_t)
...
top_mod_table_NDT4_light_t[1,14]<- coef(model.NDT4)[10] #coefficient Tdif_atfire
