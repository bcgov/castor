...
mod_frt9c<-glm(fire ~ climate1 + elevatn + infr_dist, data=dat9, family=binomial(link="logit"))
...
```{r}
mod_frt9<- glm(fire ~ climate1 + elevatn + infr_dist, data=dat9, family=binomial(link="logit"))
...
#Model   
mod<-glm(fire ~ climate1 + elevatn + infr_dist, data=dat1, family=binomial(link="logit"))
...
top_mod_table_FRT5_person[1,3]<-"fire ~ climate1 + elevatn + infr_dist"
