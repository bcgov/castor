...
(SELECT feature_id, bclcs_level_2, bclcs_level_3, bclcs_level_4, bclcs_level_5,
  ...
  fire.aspct__, fire.dm_h_bc, fire.heatload, fire.shp_ln_, fire.win_sum, 
  fire.win_spg, fire.dist_any,
  ...
  (SELECT wkb_geometry, idno, fire_yr, fire_cs, fir_typ, ign_month, size_ha, fire, zone,
   ...
   mdc_09, slp_h_b, aspct__, dm_h_bc, heatload, shp_ln_, win_sum, win_spg, dist_any 
   from Data_clim_DEM_roads_wind where fire_yr = '2002') as fire where st_contains
...
(SELECT feature_id, bclcs_level_2, bclcs_level_3, bclcs_level_4, bclcs_level_5,
  ...
  fire.tave09, fire.ppt05, fire.ppt06, fire.ppt07, fire.ppt08, fire.ppt09,
  fire.mdc_05, fire.mdc_06, fire.mdc_07, fire.mdc_08, fire.mdc_09, fire. slp_h_b, 
  fire.aspct__, fire.dm_h_bc, fire.heatload, fire.shp_ln_, fire.win_sum, fire.win_spg, fire.dist_any,
  veg_comp_lyr_r1_poly2020.geometry FROM veg_comp_lyr_r1_poly2020,
  (SELECT wkb_geometry, idno, fire_yr, fire_cs, fir_typ, ign_month, size_ha, fire, zone,
   subzone, ntrl_ds, tmax05, tmax06, tmax07, tmax08, tmax09, tave05, tave06, tave07,
   tave08, tave09, ppt05, ppt06, ppt07, ppt08, ppt09, mdc_05, mdc_06, mdc_07, mdc_08,
   mdc_09, slp_h_b, aspct__,dm_h_bc, heatload, shp_ln_, win_sum, win_spg, dist_any
   from Data_clim_DEM_roads_wind where fire_yr = '2020') as fire where st_contains
...
# live_stand_volume_125 does not exist
 ...
 (SELECT feature_id, bclcs_lv_2, bclcs_lv_3, bclcs_lv_4, bclcs_lv_5,
  upd_htdate, proj_age_1, proj_ht_1, COALESCE(volsp1_125,0)+COALESCE(volsp2_125,0)+COALESCE(volsp3_125,0)+COALESCE(volsp4_125,0)+COALESCE(volsp5_125,0) AS live_stand_volume_125, stand_percentage_dead, 
  fire.idno, fire.fire_yr, fire.fire_cs, fire.fir_typ, fire.ign_month, fire.size_ha, fire.fire,
  fire.zone, fire.subzone, fire.ntrl_ds, fire.tmax05, fire.tmax06, fire.tmax07,
  fire.tmax08, fire.tmax09, fire.tave05, fire.tave06, fire.tave07, fire.tave08,
  fire.tave09, fire.ppt05, fire.ppt06, fire.ppt07, fire.ppt08, fire.ppt09,
  ...
  (SELECT wkb_geometry, idno, fire_yr, fire_cs, fir_typ, ign_month, size_ha, fire, zone,
   ...
   tave08, tave09, ppt05, ppt06, ppt07, ppt08, ppt09, mdc_05, mdc_06, mdc_07, mdc_08,
   mdc_09, slp_h_b, aspct__, dm_h_bc, heatload, shp_ln_, win_sum, win_spg, dist_any 
   from Data_clim_DEM_roads_wind where fire_yr = '2007') 
...
##############################
 ...
 (SELECT feature_id, bclcs_level_2, bclcs_level_3, bclcs_level_4, bclcs_level_5,
   ...
   +COALESCE(vol_per_ha_spp5_125,0)+COALESCE(vol_per_ha_spp6_125,0) AS live_stand_volume_125, stand_percentage_dead, 
   fire.idno, fire.fire_yr, fire.fire_cs, fire.fir_typ, fire.ign_month, fire.size_ha, fire.fire,
   fire.zone, fire.subzone, fire.ntrl_ds, fire.tmax05, fire.tmax06, fire.tmax07,
   fire.tmax08, fire.tmax09, fire.tave05, fire.tave06, fire.tave07, fire.tave08,
   fire.tave09, fire.ppt05, fire.ppt06, fire.ppt07, fire.ppt08, fire.ppt09,
   ...
   (SELECT wkb_geometry, idno, fire_yr, fire_cs, fir_typ, ign_month, size_ha, fire, zone,
    ...
    tave08, tave09, ppt05, ppt06, ppt07, ppt08, ppt09, mdc_05, mdc_06, mdc_07, mdc_08,
    mdc_09, slp_h_b, aspct__, dm_h_bc, heatload, shp_ln_, win_sum, win_spg, dist_any 
    from Data_clim_DEM_roads_wind where fire_yr = '2008') 
...
### July 2021, when ran, there already is a column for live_stand_volume_125, stand_percentage_dead,  so this may not be necessary
...
# (SELECT wkb_geometry from Data_clim_DEM_roads_wind where fire_yr = '2008') as fire where st_contains
...
```{r}
st_write(fire_veg_data_B, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\fire_ignitions_veg_climate_ALL_5x_.shp", delete_layer=TRUE)
```
