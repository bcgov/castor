---
title: "13e_fire_spread_size_model_selection_lightning_treed_NDT5"
author: "Cora Skaien"
date: "02/12/2021"
...
#=================================
#  Script Name: 13e_fire_spread_size_model_selection_lightning_treed_NDT5.R
#  Script Version: 1.0
...
```{r}
table(spread_data_lightning_t$vegtype2, spread_data_lightning_t$ntrl_ds)
#No variation in vegtype
```

#1. Climate1
Only has climate1, no climate2. No vegtype. Do not need to run anything here because we have just climate1.
...
AIC_lightning_NDT5_spread_treed_climate<-table.glm.climate.simple.spread

AIC_lightning_NDT5_spread_treed_summary_climate<- AIC_lightning_NDT5_spread_treed_climate %>%
  group_by(model) %>%
...
AIC_lightning_NDT5_spread_treed_summary_climate2<- AIC_lightning_NDT5_spread_treed_summary_climate %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_lightning_NDT5_spread_treed_summary_climate2)
```
...
AIC_lightning_NDT5_spread_treed_climate_gamma<-table.glm.climate.simple.spread.gamma

AIC_lightning_NDT5_spread_treed_summary_climate_gamma<- AIC_lightning_NDT5_spread_treed_climate_gamma %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            sdR2=sd(Model.R2, na.rm=TRUE),
...
AIC_lightning_NDT5_spread_treed_summary_climate_gamma2<- AIC_lightning_NDT5_spread_treed_summary_climate_gamma %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_lightning_NDT5_spread_treed_summary_climate_gamma2)
```
...
AIC_lightning_NDT5_spread_treed_VRI<-table.glm.VRI.simple.spread

AIC_lightning_NDT5_spread_treed_summary_VRI<- AIC_lightning_NDT5_spread_treed_VRI %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_lightning_NDT5_spread_treed_summary_VRI2<- AIC_lightning_NDT5_spread_treed_summary_VRI %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_lightning_NDT5_spread_treed_summary_VRI2)
```
...
AIC_lightning_NDT5_spread_treed_topo<-table.glm.topo.simple.spread

AIC_lightning_NDT5_spread_treed_summary_topo<- AIC_lightning_NDT5_spread_treed_topo %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_lightning_NDT5_spread_treed_summary_topo2<- AIC_lightning_NDT5_spread_treed_summary_topo %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_lightning_NDT5_spread_treed_summary_topo2)
```
...
AIC_lightning_NDT5_spread_treed_infra<-table.glm.infra.simple.spread

AIC_lightning_NDT5_spread_treed_summary_infra<- AIC_lightning_NDT5_spread_treed_infra %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_lightning_NDT5_spread_treed_summary_infra2<- AIC_lightning_NDT5_spread_treed_summary_infra %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_lightning_NDT5_spread_treed_summary_infra2)
```

Combine together
```{r}
NDT5_l_treed_spread<-rbind(AIC_lightning_NDT5_spread_treed_summary_climate2, AIC_lightning_NDT5_spread_treed_summary_infra2, AIC_lightning_NDT5_spread_treed_summary_topo2, AIC_lightning_NDT5_spread_treed_summary_VRI2)
...
Save data.
```{r}
write.csv(NDT5_l_treed_spread, file="D:\\Fire\\fire_data\\raw_data\\NDT5_lightning_models_treed_spread_Nov.csv")
```
...
```{r}
spread_lightning_t_NDT5<-subset(spread_data_lightning_t, spread_data_lightning_t$ntrl_ds=="NDT5")

prop<-0.75

#Partition data into training and validation
 trainIndex <- createDataPartition(spread_lightning_t_NDT5$escape10, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- spread_lightning_t_NDT5[ trainIndex,]
   Valid <- spread_lightning_t_NDT5[-trainIndex,]
  
#Run model using dat1
model.NDT5<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun +  roads_km + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_age_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT5) #847.4
summary(model.NDT5)$r.squared #0.31
summary(model.NDT5)$adj.r.squared #0.20
...
#Remove least sig
model.NDT5<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun +  roads_km + elevation + climate1 + vegtype2 + wind_atfire + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT5) #840.7
summary(model.NDT5)$r.squared #0.30
summary(model.NDT5)$adj.r.squared #0.22
...
#Remove least sig
model.NDT5<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun +  roads_km + elevation + climate1 + vegtype2 + wind_atfire + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT5) #836.9
summary(model.NDT5)$r.squared #0.30
summary(model.NDT5)$adj.r.squared #0.23
...
#Remove least sig
model.NDT5<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT5) #829.6
summary(model.NDT5)$r.squared #0.30
summary(model.NDT5)$adj.r.squared #0.24
...
#Remove least sig
model.NDT5<-lm(LNsize_ha ~ proj_age_1  + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT5) #865.2 -> bad increase
summary(model.NDT5)$r.squared #0.27
summary(model.NDT5)$adj.r.squared #0.21
...
model.NDT5<-lm(LNsize_ha ~  live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT5) #828.1
summary(model.NDT5)$r.squared #0.30
summary(model.NDT5)$adj.r.squared #0.25
...
NDT5_spread_size_t<-spread_lightning_t_NDT5 %>% drop_na(proj_age_1, live_stand_volume_125 , dist_mun, climate1, wind_atfire, elevation, Tdif_atfire)

#Run Model again with this data; but uses all data here
model.NDT5.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation + climate1:wind_atfire + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT5_spread_size_t)

AIC(model.NDT5.Spread) #1101.1
summary(model.NDT5.Spread)$r.squared #0.23
summary(model.NDT5.Spread)$adj.r.squared #0.19

#Anova(model.NDT5.Spread, type=3)
Anova(model.NDT5.Spread, type=3, singular.ok = TRUE)

#Compare to fewer interactions
model.NDT5.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT5_spread_size_t)

AIC(model.NDT5.Spread) #1099.4
summary(model.NDT5.Spread)$r.squared #0.23
summary(model.NDT5.Spread)$adj.r.squared #0.19
...
#Compare to fewer interactions
model.NDT5.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire + Tdif_atfire, data = NDT5_spread_size_t)

AIC(model.NDT5.Spread) #1098.4
summary(model.NDT5.Spread)$r.squared #0.23
summary(model.NDT5.Spread)$adj.r.squared #0.19
...
#
model.NDT5.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire, data = NDT5_spread_size_t)

AIC(model.NDT5.Spread) #1096.98
summary(model.NDT5.Spread)$r.squared #0.23
summary(model.NDT5.Spread)$adj.r.squared #0.19
...
#Model   
model.NDT5.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire, data = dat1) 

predictions <- model.NDT5.Spread %>% predict(Valid)

# create model table (only do this once) and add the relevant data
top_mod_table_NDT5_lightning_t <- data.frame (matrix (ncol = 21, nrow = 0))
colnames (top_mod_table_NDT5_lightning_t ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_proj_age_1", "coef_live_stand_volume_125", "coef_dist_mun", "coef_elevation", "coef_climate_1", "coef_wind_atfire", "coef_slope", "coef_elevation:climate1", "coef_wind_atfire:slope", "coef_elevation:wind_atfire", "AIC", "Model.R2", "Valid.R2", "Valid.RSME", "Valid.MAE", "Adjusted.R2")

##Add data for NDT5
top_mod_table_NDT5_lightning_t[1,1]<-"lightning"
top_mod_table_NDT5_lightning_t[1,2]<-"NDT5"
top_mod_table_NDT5_lightning_t[1,3]<-"Y"
top_mod_table_NDT5_lightning_t[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire" 
top_mod_table_NDT5_lightning_t[1,5]<- coef(model.NDT5.Spread)[1] #Intercept
top_mod_table_NDT5_lightning_t[1,6]<- coef(model.NDT5.Spread)[2] #C
top_mod_table_NDT5_lightning_t[1,7]<- coef(model.NDT5.Spread)[3] #C
top_mod_table_NDT5_lightning_t[1,8]<- coef(model.NDT5.Spread)[4] #co
top_mod_table_NDT5_lightning_t[1,9]<- coef(model.NDT5.Spread)[5] #co
top_mod_table_NDT5_lightning_t[1,10]<- coef(model.NDT5.Spread)[6] #c
top_mod_table_NDT5_lightning_t[1,11]<- coef(model.NDT5.Spread)[7] #l
top_mod_table_NDT5_lightning_t[1,12]<- coef(model.NDT5.Spread)[8] #co
top_mod_table_NDT5_lightning_t[1,13]<- coef(model.NDT5.Spread)[9] #c
top_mod_table_NDT5_lightning_t[1,14]<- coef(model.NDT5.Spread)[10] #coeff
top_mod_table_NDT5_lightning_t[1,15]<- coef(model.NDT5.Spread)[11] #co
top_mod_table_NDT5_lightning_t[1,16]<- AIC(model.NDT5.Spread)
top_mod_table_NDT5_lightning_t[1,17]<- summary(model.NDT5.Spread)$r.squared
top_mod_table_NDT5_lightning_t[1,18]<- R2(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT5_lightning_t[1,19]<- RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT5_lightning_t[1,20]<- MAE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT5_lightning_t[1,21]<- summary(model.NDT5.Spread)$adj.r.squared

top_mod_table_NDT5_lightning_t_ALL<-rbind(top_mod_table_NDT5_lightning_t_ALL, top_mod_table_NDT5_lightning_t)
...
Check.
```{r}
head(top_mod_table_NDT5_lightning_t_ALL)
...
```{r}
write.csv(top_mod_table_NDT5_lightning_t_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT5.Spread_firesize_lightning_t.csv")
```
...
```{r}
names(top_mod_table_NDT5_lightning_t_ALL)

top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means<-top_mod_table_NDT5_lightning_t_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means

top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means[1,1]<-"lightning"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means[1,2]<-"NDT5"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means[1,3]<-"Treed"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means[1,4]<- "LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire" 
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means
```
Save table.

```{r}
write.csv(top_mod_table_NDT5_model.NDT5.Spreadlightning_t_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT5.Spread_firesize_lightning_t_Means.csv")
```

Standard deviation.

```{r}
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd<-top_mod_table_NDT5_lightning_t_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd

top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd[1,1]<-"lightning"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd[1,2]<-"NDT5"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd[1,3]<-"Treed"
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + elevation + climate1 + wind_atfire + climate1:elevation  + slope + slope:wind_atfire + elevation:wind_atfire" 
top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd
```
...
```{r}
write.csv(top_mod_table_NDT5_model.NDT5.Spreadlightning_t_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT5.Spread_firesize_lightning_t_SD.csv")
```
