...
model.NDT5<-glm(escape ~ climate1 + climate2 + climate1:climate2 + slope + aspect + elevation + wind_atfire + aspect:wind_atfire + dist_dam + dist_mine + roads_km + dist_mine:roads_km, family = binomial, data = dat1)
...
model.NDT5<-glm(escape ~ climate1 + climate2 + climate1:climate2 + slope + aspect + elevation + wind_atfire + dist_dam + dist_mine + roads_km + dist_mun, family = binomial, data = dat1)
...
Anova(model.NDT5, type=3) #Still does not work; no convergence

#create logical model
model.NDT5<-glm(escape ~ climate1 + climate2 + slope + elevation + wind_atfire + dist_dam + dist_mine + roads_km + dist_mun, family = binomial, data = dat1)

AIC(model.NDT5) #236.26
...
#create logical model
model.NDT5<-glm(escape ~ climate1 + climate2 + slope + elevation + wind_atfire +  roads_km + dist_mun, family = binomial, data = dat1)
...
Anova(model.NDT5, type=3) #Converges, but too many variables

#create logical model
model.NDT5<-glm(escape ~ climate1 + climate2 + slope + elevation + wind_atfire +  roads_km, family = binomial, data = dat1)
...
#create logical model
model.NDT5<-glm(escape ~ climate1 + climate2, family = binomial, data = dat1)
...
Anova(model.NDT5, type=3) #Converges,

#create logical model
model.NDT5<-glm(escape ~ climate1, family = binomial, data = dat1)
...
#create logical model
model.NDT5<-glm(escape ~ climate1 + roads_km, family = binomial, data = dat1)
...
#create logical model
model.NDT5<-glm(escape ~ climate1 + dist_dam, family = binomial, data = dat1)
...
# Try with tdif
model.NDT5<-glm(escape ~ Tdif_atfire, family = binomial, data = dat1)
...
#
model.NDT5<-glm(escape ~ climate2, family = binomial, data = dat1)
...
#
model.NDT5<-glm(escape ~ Tdif_atfire + climate2, family = binomial, data = dat1)
...
model.NDT5<-glm(escape ~ climate1, family = binomial, data = NDT5_escape_nt)

Anova(model.NDT5, type=3) #climate1*elevation REALLY not significant here!
#Anova(model.NDT5, type=3, singular.ok = TRUE)
...
NDT5_escape_nt$resids<-resid(model.NDT5)
...
#Run Model again with this data; but uses all data here
model.NDT5<-glm(escape ~ Tdif_atfire, family = binomial, data = NDT5_escape_nt)
...
#Run Model again with this data; but uses all data here
model.NDT5<-glm(escape ~ climate1 +climate2, family = binomial, data = NDT5_escape_nt)
...
#Model   
model.NDT5<-glm(escape ~ climate1, data = dat1) 
...
#Model   
model.NDT5<-glm(escape ~ climate1 + climate2, data = dat1) 
...
top_mod_table_NDT5_light_nt[1,5]<- coef(model.NDT5)[1] #Intercept
top_mod_table_NDT5_light_nt[1,6]<- coef(model.NDT5)[2] #Climate variable 1
top_mod_table_NDT5_light_nt[1,7]<- coef(model.NDT5)[3] #Climate variable 2
