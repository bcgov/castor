...
top_mod_table_NDT5_light_nt[1,3]<-"Y"
top_mod_table_NDT5_light_nt[1,4]<-"escape ~ climate1 + climate2 + climate1:climate2 + elevation + wind_atfire + roads_km  + climate2:elevation  + wind_atfire:vegtype2 + vegtype2" 
...
top_mod_table_NDT5_light_nt_Means[1,3]<-"Y"
...
top_mod_table_NDT5_light_nt_SD[1,3]<-"Y"
