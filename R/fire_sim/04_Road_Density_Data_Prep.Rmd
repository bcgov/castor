...
```{r}
sample_locations_DEM_buf<- st_buffer(sample_locations_DEM, 564) #Set the buffer to 564 m to get a circle with a raious of 564 m and an area of 1 km2
...
#Check what the distirbution of shape length is
