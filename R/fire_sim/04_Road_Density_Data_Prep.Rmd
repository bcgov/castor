...
```{r}
sample_locations_DEM_buf<- st_buffer(sample_locations_DEM, 564) #Set the buffer to 564 m to get a circle with a radous of 564 m and an area of 1 km2
...
head(road_sums)
str(road_sums)#Check how many rows there are in the data and compare to our initial data
#181,356
...
st_write(sample_locations_DEM_roads, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Data_climate_DEM_roads.shp", delete_layer=TRUE)
