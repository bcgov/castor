...
message("getting vegetation data")
  ...
  veg2[(height < 4 | basalarea < 8 | is.na(height ) | is.na(basalarea)) & bclcs_level_4 %in% ("TC", "TM", "TB"), veg_cat:=4]
  veg2[!bclcs_level_4 %in% ("TC", "TM", "TB"), veg_cat:=5]
  veg2[bclcs_level_1 != 'V' & (is.na(basalarea) | basalarea <6)]
  rm(veg_attributes)
  gc()
