...
cor.test(dat15$road_dist_m, dat15$infr_dist)
...
mod_frt_15a<- glm(fire ~ climate1 + climate2 + FWI_veg + log(road_dist_m+1) + infr_dist, data=dat15, family=binomial(link="logit"))
Anova(mod_frt_15a, type=3)

mod_frt_15b<- glm(fire ~ elevatn + climate2 + FWI_veg + log(road_dist_m+1) + infr_dist, data=dat15, family=binomial(link="logit"))
...
mod_frt15<- glm(fire ~ 1 + climate1 + climate2 + FWI_veg + log_road_dist + infr_dist, data=dat15, family=binomial(link="logit"))
...
mod_frt15<- glm(fire ~ climate1 + climate2 + log_road_dist + infr_dist + as.factor(FWI_veg), data=dat15, family=binomial(link="logit"))
...
#Model   
mod<-glm(fire ~ climate1 + climate2 + log_road_dist + infr_dist + FWI_veg, data=dat1, family=binomial(link="logit"))
