...
#Remove least significant interaction
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125  + climate2*proj_height_1 + climate1*live_stand_volume_125 + climate2*live_stand_volume_125 + slope + aspect + elevation + dist_any + vegtype2 + elevation*climate1 + dist_mun +  dist_dam + dist_nat + dist_pow + vegtype2 + bclcs_level_5_2, family = binomial, data = dat1) 
...
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125  + climate2*proj_height_1 + climate1*live_stand_volume_125 + climate2*live_stand_volume_125 + slope + aspect + elevation + vegtype2 + elevation*climate1 + dist_mun +  dist_dam + dist_nat + dist_pow + vegtype2 + bclcs_level_5_2, family = binomial, data = dat1) 
...
top_mod_table_NDT4_light_t[1,4]<-"climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + dist_mun +  dist_dam + dist_nat + dist_pow + + vegtype2 + bclcs_level_5_2 + climate2*proj_height_1 + climate1*live_stand_volume_125 + climate2*live_stand_volume_125 + slope + aspect + elevation + vegtype2 + elevation*climate1" 
...
top_mod_table_NDT4_light_t[1,24]<- coef(model.NDT4)[19] #coefficient aspect
...
top_mod_table_NDT4_light_t_ALL <- data.frame (matrix (ncol = 30, nrow = 0))
colnames (top_mod_table_NDT4_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_climate_interaction", "coef_stand_height", "coef_live_stand_volume_125", "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_dist_pow", "coef_vegtypeOP", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_bclcs_level_5_2DE", "coef_bclcs_level_5_2DIST", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope", "coef_aspect", "coef_elevation", "coef_climate2:proj_height", "coef_climate1:live_stand_volume_125", "coef_climate2:live_stand_volume_125", "coef_climate1:elevation", "AUC")
```
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_t <- data.frame (matrix (ncol = 30, nrow = 0))
colnames (top_mod_table_NDT4_light_t ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_climate_interaction", "coef_stand_height", "coef_live_stand_volume_125", "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_dist_pow", "coef_vegtypeOP", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_bclcs_level_5_2DE", "coef_bclcs_level_5_2DIST", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope", "coef_aspect", "coef_elevation", "coef_climate2:proj_height", "coef_climate1:live_stand_volume_125", "coef_climate2:live_stand_volume_125", "coef_climate1:elevation", "AUC")
...
top_mod_table_NDT4_light_t[1,28]<- coef(model.NDT4)[24] #coefficient climate2:live_stand_volume_125
top_mod_table_NDT4_light_t[1,29]<- coef(model.NDT4)[25] #coefficient climate1:elevation
top_mod_table_NDT4_light_t[1,30]<- mod.auc
...
mean(top_mod_table_NDT4_light_t_ALL$AUC) #0.605

# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_t_Means <- data.frame (matrix (ncol = 30, nrow = 0))
...
top_mod_table_NDT4_light_t_Means[1,20]<- mean(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2DIST) #coefficient bclcs_level_5_2DIST
top_mod_table_NDT4_light_t_Means[1,21]<- mean(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2OP) #coefficient bclcs_level_5_2OP
top_mod_table_NDT4_light_t_Means[1,22]<- mean(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2SP) #coefficient bclcs_level_5_2SP
top_mod_table_NDT4_light_t_Means[1,23]<- mean(top_mod_table_NDT4_light_t_ALL$coef_slope) #coefficient slope 
top_mod_table_NDT4_light_t_Means[1,24]<- mean(top_mod_table_NDT4_light_t_ALL$coef_aspect) #coefficient aspect 
top_mod_table_NDT4_light_t_Means[1,25]<- mean(top_mod_table_NDT4_light_t_ALL$coef_elevation) #coefficient elevation 
top_mod_table_NDT4_light_t_Means[1,26]<- mean(top_mod_table_NDT4_light_t_ALL$`coef_climate2:proj_height`) #coefficient coef_climate2:proj_height
top_mod_table_NDT4_light_t_Means[1,27]<- mean(top_mod_table_NDT4_light_t_ALL$`coef_climate1:live_stand_volume_125`) #coefficient `coef_climate1:live_stand_volume_125`
top_mod_table_NDT4_light_t_Means[1,28]<- mean(top_mod_table_NDT4_light_t_ALL$`coef_climate2:live_stand_volume_125`) #coefficient `coef_climate2:live_stand_volume_125`
top_mod_table_NDT4_light_t_Means[1,29]<- mean(top_mod_table_NDT4_light_t_ALL$`coef_climate1:elevation`) #coefficient `coef_climate1:elevation`
top_mod_table_NDT4_light_t_Means[1,30]<- mean(top_mod_table_NDT4_light_t_ALL$AUC)
...
```{r}
# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_t_SD <- data.frame (matrix (ncol = 30, nrow = 0))
colnames (top_mod_table_NDT4_light_t_SD ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_climate_interaction", "coef_stand_height", "coef_live_stand_volume_125", "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_dist_pow", "coef_vegtypeOP", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_bclcs_level_5_2DE", "coef_bclcs_level_5_2DIST", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope", "coef_aspect", "coef_elevation", "coef_climate2:proj_height", "coef_climate1:live_stand_volume_125", "coef_climate2:live_stand_volume_125", "coef_climate1:elevation", "AUC")
...
top_mod_table_NDT4_light_t_SD[1,4]<-"fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + dist_mun +  dist_dam + dist_nat + dist_pow + vegtype2 + bclcs_level_5_2" 
top_mod_table_NDT4_light_t_SD[1,5]<- sd(top_mod_table_NDT4_light_t_ALL$intercept) #Intercept
top_mod_table_NDT4_light_t_SD[1,6]<- sd(top_mod_table_NDT4_light_t_ALL$coef_climate_1) #Climate variable 1
top_mod_table_NDT4_light_t_SD[1,7]<- sd(top_mod_table_NDT4_light_t_ALL$coef_climate_2) #Climate variable 2
top_mod_table_NDT4_light_t_SD[1,8]<- sd(top_mod_table_NDT4_light_t_ALL$coef_climate_interaction) #Interaction climate variables
top_mod_table_NDT4_light_t_SD[1,9]<- sd(top_mod_table_NDT4_light_t_ALL$coef_stand_height) #coef_stand_height
top_mod_table_NDT4_light_t_SD[1,10]<- sd(top_mod_table_NDT4_light_t_ALL$coef_live_stand_volume_125) #live_stand_volume_125
top_mod_table_NDT4_light_t_SD[1,11]<- sd(top_mod_table_NDT4_light_t_ALL$coef_dist_mun) #dist_mun
top_mod_table_NDT4_light_t_SD[1,12]<- sd(top_mod_table_NDT4_light_t_ALL$coef_dist_dam) #dist_dam
top_mod_table_NDT4_light_t_SD[1,13]<- sd(top_mod_table_NDT4_light_t_ALL$coef_dist_nat) #dist_nat
top_mod_table_NDT4_light_t_SD[1,14]<- sd(top_mod_table_NDT4_light_t_ALL$coef_dist_pow) #dist_pow
top_mod_table_NDT4_light_t_SD[1,15]<- sd(top_mod_table_NDT4_light_t_ALL$coef_vegtypeOP) #coefficient vegtypeOP
top_mod_table_NDT4_light_t_SD[1,16]<- sd(top_mod_table_NDT4_light_t_ALL$coef_vegtypeTB) #coefficient vegtypeTB
top_mod_table_NDT4_light_t_SD[1,17]<- sd(top_mod_table_NDT4_light_t_ALL$coef_vegtypeTC) #coefficient vegtypeTC
top_mod_table_NDT4_light_t_SD[1,18]<- sd(top_mod_table_NDT4_light_t_ALL$coef_vegtypeTM) #coefficient vegtypeTM
top_mod_table_NDT4_light_t_SD[1,19]<- sd(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2DE) #coefficient bclcs_level_5_2DE
top_mod_table_NDT4_light_t_SD[1,20]<- sd(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2DIST) #coefficient bclcs_level_5_2DIST
top_mod_table_NDT4_light_t_SD[1,21]<- sd(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2OP) #coefficient bclcs_level_5_2OP
top_mod_table_NDT4_light_t_SD[1,22]<- sd(top_mod_table_NDT4_light_t_ALL$coef_bclcs_level_5_2SP) #coefficient bclcs_level_5_2SP
top_mod_table_NDT4_light_t_SD[1,23]<- sd(top_mod_table_NDT4_light_t_ALL$coef_slope) #coefficient slope 
top_mod_table_NDT4_light_t_SD[1,24]<- sd(top_mod_table_NDT4_light_t_ALL$coef_aspect) #coefficient aspect 
top_mod_table_NDT4_light_t_SD[1,25]<- sd(top_mod_table_NDT4_light_t_ALL$coef_elevation) #coefficient elevation 
top_mod_table_NDT4_light_t_SD[1,26]<- sd(top_mod_table_NDT4_light_t_ALL$`coef_climate2:proj_height`) #coefficient coef_climate2:proj_height
top_mod_table_NDT4_light_t_SD[1,27]<- sd(top_mod_table_NDT4_light_t_ALL$`coef_climate1:live_stand_volume_125`) #coefficient `coef_climate1:live_stand_volume_125`
top_mod_table_NDT4_light_t_SD[1,28]<- sd(top_mod_table_NDT4_light_t_ALL$`coef_climate2:live_stand_volume_125`) #coefficient `coef_climate2:live_stand_volume_125`
top_mod_table_NDT4_light_t_SD[1,29]<- sd(top_mod_table_NDT4_light_t_ALL$`coef_climate1:elevation`) #coefficient `coef_climate1:elevation`
top_mod_table_NDT4_light_t_SD[1,30]<- sd(top_mod_table_NDT4_light_t_ALL$AUC)
