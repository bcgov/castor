...
#Redo with redued variables (categories)
...
#Run model using dat1
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + proj_height_1*live_stand_volume_125 + climate1*proj_height_1 + climate2*proj_height_1 + climate1*live_stand_volume_125 + climate2*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1 + elevation*climate2 + vegtype2, family = binomial, data = dat1) 
   
AIC(model.NDT4) #6524.5
Anova(model.NDT4)
...
#Remove least significant interaction
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + proj_height_1*live_stand_volume_125 + climate1*proj_height_1 + climate2*proj_height_1 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1 + vegtype2, family = binomial, data = dat1) 
   
AIC(model.NDT4) #6520.9
Anova(model.NDT4)
...
#Remove least significant interaction
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*proj_height_1 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1 + vegtype2, family = binomial, data = dat1) 
   
AIC(model.NDT4) #6517.8
Anova(model.NDT4)
...
#Remove least significant interaction
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1 + vegtype2, family = binomial, data = dat1) 
   
AIC(model.NDT4) #6516.9
Anova(model.NDT4)
...
```{r}
#Remove NAs to ensure all same data used so we can compare AICs
NDT4_t<-dat_lightning_t_NDT4 %>% drop_na(climate1, climate2, proj_height_1, live_stand_volume_125, dist_infra, slope, aspect_cos, elevation, vegtype2)

#Check vegtype categories
table(NDT4_t$vegtype2) #Only 3 disturbed, and 3 open. May wish to remove these 6 points.

NDT4_t<-subset(NDT4_t, NDT4_t$vegtype2!="D")
NDT4_t<-subset(NDT4_t, NDT4_t$vegtype2!="OP")

model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1, family = binomial, data = NDT4_t) 
...
#Residual Plots
#climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1
...
#Or create a new blank table and get AUC too
top_mod_table_NDT4_light_t_ALL <- data.frame (matrix (ncol = 20, nrow = 0))
colnames (top_mod_table_NDT4_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_proj_height_1", "coef_live_stand_volume_125", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_vegtypeTC", "coef_vegtypeTM",  "coef_climate1:climate2", "coef_climate1:live_stand_volume_125", "coef_slope:aspect_cos", "coef_climate1:elevation", "AUC")
```
...
#Model   
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1, family = binomial, data = dat1) 
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_t <- data.frame (matrix (ncol = 20, nrow = 0))
colnames (top_mod_table_NDT4_light_t ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_proj_height_1", "coef_live_stand_volume_125", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_vegtypeTC", "coef_vegtypeTM",  "coef_climate1:climate2", "coef_climate1:live_stand_volume_125", "coef_slope:aspect_cos", "coef_climate1:elevation", "AUC")
...
top_mod_table_NDT4_light_t[1,2]<-"NDT4"
top_mod_table_NDT4_light_t[1,3]<-"Y"
top_mod_table_NDT4_light_t[1,4]<-"fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1" 
top_mod_table_NDT4_light_t[1,5]<- coef(model.NDT4)[1] #
top_mod_table_NDT4_light_t[1,6]<- coef(model.NDT4)[2] #
top_mod_table_NDT4_light_t[1,7]<- coef(model.NDT4)[3] #
top_mod_table_NDT4_light_t[1,8]<- coef(model.NDT4)[4] #Int
...
top_mod_table_NDT4_light_t[1,18]<- coef(model.NDT4)[14] #coefficient
top_mod_table_NDT4_light_t[1,19]<- coef(model.NDT4)[15] #coef
top_mod_table_NDT4_light_t[1,20]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT4_light_t_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_t_ALL_Jan.csv")
```
...
top_mod_table_NDT4_light_t_Means[1,2]<-"NDT4"
top_mod_table_NDT4_light_t_Means[1,3]<-"Treed"
top_mod_table_NDT4_light_t_Means[1,4]<- "fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1" 
top_mod_table_NDT4_light_t_Means
```
Save table.

```{r}
write.csv(top_mod_table_NDT4_light_t_Means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_t_Means_Jan.csv")
```
...
top_mod_table_NDT4_light_t_SD[1,2]<-"NDT4"
top_mod_table_NDT4_light_t_SD[1,3]<-"Treed"
top_mod_table_NDT4_light_t_SD[1,4]<-"fire_pres ~ climate1 + climate2 + climate1*climate2 + proj_height_1 + live_stand_volume_125 + climate1*live_stand_volume_125 + slope + aspect_cos + elevation + slope*aspect_cos + dist_infra + vegtype2 + elevation*climate1" 
top_mod_table_NDT4_light_t_SD
```
...
```{r}
write.csv(top_mod_table_NDT4_light_t_SD, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_t_SD_Jan.csv")
```
