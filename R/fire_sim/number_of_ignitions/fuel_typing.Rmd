...
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 6 AND coast_interior_cd = 'C' then 'S-3' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 6 AND coast_interior_cd = 'I' then 'S-1' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 AND {year_vri} - EXTRACT('Year' FROM harvest_date) < 25 AND bec_zone_code in('CWH', 'MH', 'ICH') then 'D-1/2' 
when EXTRACT('Year' FROM projected_date)- EXTRACT('Year' FROM harvest_date)  > 6 AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) < 25 AND bec_zone_code not in('CWH', 'MH', 'ICH') then 'O-1a/b' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code in ('CMA', 'IMA') then 'N' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code in ('BAFA','MH') then 'D-1/2' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'CWH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') then 'M-1/2' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'CWH' and bec_subzone in ('{glue::glue_collapse(wet,  sep ='\\',\\'')}') then 'C-5'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'BWBS' then 'C-2'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'SWB' then 'M-1/2'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'SBS' then 'C-3'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND (bec_zone_code in ('SBPS', 'MS', 'ESSF') OR (bec_zone_code in('IDF', 'CDF') AND bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'C-7'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'IDF' AND bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') then 'C-3'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code in ('CDF', 'ICH') AND bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') then 'C-5'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code = 'ICH' AND bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') then 'C-3'
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 25 AND bec_zone_code in ('PP', 'BG') then 'O-1a/b'
...
case when earliest_nonlogging_dist_type in ('B','BE','BG','BW','BR','NB') and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date)  <= 3 then 'N'
when earliest_nonlogging_dist_type in ('B','BE','BG','BW','BR','NB') and {year_vri} - EXTRACT('Year' FROM earliest_nonlogging_dist_date) > 3 and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) <= 6 then 'D-1/2'
when earliest_nonlogging_dist_type in ('B','BE','BG','BW','BR','NB') and {year_vri} - EXTRACT('Year' FROM earliest_nonlogging_dist_date) > 6 and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) <= 10 then 'O-1a/b'
...
```{r}
veg_recent_burned <-data.table(getTableQuery(glue::glue("Select feature_id, species_cd_1, species_cd_2, species_cd_3, species_cd_4, species_cd_5, species_pct_1, species_pct_2, species_pct_3, species_pct_3, species_pct_4, species_pct_5, EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) as tsf, crown_closure FROM veg_comp_lyr_r1_poly{year_vri} where bclcs_level_1 = 'V' AND bclcs_level_2 = 'T' AND earliest_nonlogging_dist_type in ('B','BE','BG','BW','BR','NB') and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) < 11;")))
...
veg_con_pure_lodgepole_jack <-data.table(getTableQuery(glue::glue("Select feature_id, (case 
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 7 then 'S-1'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 = 'SP' AND (bec_zone_code in('CWH', 'CDF', 'MH') OR (bec_zone_code = 'ICH' AND bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') )) then 'D-1/2'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 = 'SP' AND (bec_zone_code not in ('CWH', 'CDF', 'MH') OR (bec_zone_code not in ('ICH') AND bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}') )) then 'C-7'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and COALESCE(proj_height_1,0)  < 4  then 'O-1a/b'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 4 and proj_height_1 < 12 and COALESCE(vri_live_stems_per_ha, 0) + COALESCE(vri_dead_stems_per_ha,0) > 8000  then 'C-4'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 4 and proj_height_1 < 12 and COALESCE(vri_live_stems_per_ha,0) + COALESCE(vri_dead_stems_per_ha,0) < 8000 or (vri_live_stems_per_ha is null and vri_dead_stems_per_ha is null)  then 'C-3'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and crown_closure < 40 and bec_zone_code in ('BG', 'PP', 'IDF', 'MS')  then 'C-7'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and crown_closure < 40 and bec_zone_code in ('CWH', 'MH', 'ICH')  then 'C-5'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and crown_closure < 40 and bec_zone_code not in ('BG', 'PP', 'IDF', 'MS', 'CWH', 'MH', 'ICH')  then 'C-3'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and earliest_nonlogging_dist_type = 'IBM' AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) <= 5 AND stand_percentage_dead > 50 then 'M-3'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and earliest_nonlogging_dist_type = 'IBM' AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) <= 5 AND stand_percentage_dead < 50 AND stand_percentage_dead >= 25 then 'C-2'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and earliest_nonlogging_dist_type = 'IBM' AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) <= 5 AND (stand_percentage_dead < 25 or stand_percentage_dead is null) then 'C-3'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and earliest_nonlogging_dist_type = 'IBM' AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) > 5 AND stand_percentage_dead > 50 then 'C-2'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and earliest_nonlogging_dist_type = 'IBM' AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM earliest_nonlogging_dist_date) > 5 AND (stand_percentage_dead < 50 or stand_percentage_dead is null) then 'C-3'
     when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  >= 7 or harvest_date is null and bclcs_level_5 in ('DE', 'OP') and proj_height_1 >= 12 and (crown_closure >= 40 or crown_closure is null) and (earliest_nonlogging_dist_type not in ('IBM') or earliest_nonlogging_dist_type is null)  then 'C-3'
...
when bclcs_level_5 in ('DE', 'OP') AND EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 10 then 'S-1'                                                           when bclcs_level_5 in ('DE', 'OP') AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and COALESCE(proj_height_1,0)  < 4 then 'O-1a/b'
when bclcs_level_5 in ('DE', 'OP') AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and proj_height_1 >= 4 and proj_height_1 <= 12 and  COALESCE(vri_live_stems_per_ha,0) + COALESCE(vri_dead_stems_per_ha,0) >= 8000  then 'C-4'
when bclcs_level_5 in ('DE', 'OP') AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and proj_height_1 >= 4 and proj_height_1 <= 12 and  COALESCE(vri_live_stems_per_ha,0) + COALESCE(vri_dead_stems_per_ha,0) >= 3000  and  COALESCE(vri_live_stems_per_ha,0) + COALESCE(vri_dead_stems_per_ha,0) < 8000  then 'C-3' 
when bclcs_level_5 in ('DE', 'OP') AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and proj_height_1 >= 4 and proj_height_1 <= 12 and  (COALESCE(vri_live_stems_per_ha,0) + COALESCE(vri_dead_stems_per_ha,0) < 3000  
OR (vri_live_stems_per_ha is null and vri_dead_stems_per_ha is null))  then 'C-7'
when bclcs_level_5 = 'DE' AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and proj_height_1 > 12 and proj_height_1 <=17 then 'C-3'
when bclcs_level_5 = 'OP' AND (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 OR harvest_date is null) and proj_height_1 > 12 and proj_height_1 <=17 then 'C-7'
...
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 6 and (bec_zone_code in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'S-3' 
when EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 6 and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'S-1' 
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and COALESCE(proj_height_1,0) < 4  and (bec_zone_code  in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone  in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'D-1/2' 
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and COALESCE(proj_height_1,0)  < 4  and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'O-1a/b' 
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and proj_height_1 < 12 and crown_closure >= 55 and (bec_zone_code in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) then 'C-3' 
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and proj_height_1 < 12 and crown_closure >= 55 and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) and stand_percentage_dead > 34 then 'C-4'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and proj_height_1 < 12 and crown_closure >= 55 and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}'))) and COALESCE(stand_percentage_dead, 0) <= 34 then 'C-3'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 12 and crown_closure >= 55 and (bec_zone_code  in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone  in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'C-5'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and  proj_height_1 >= 12 and crown_closure >= 55 and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone  not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'C-7'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and (crown_closure >=26 and crown_closure < 55 or crown_closure is null) and (bec_zone_code in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'C-5'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and (crown_closure >=26 and crown_closure < 55 or crown_closure is null) and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'C-7'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and crown_closure < 26 and (bec_zone_code in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'D-1/2'
when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and proj_height_1 >= 4 and crown_closure < 26 and (bec_zone_code not in ('CWH', 'MH', 'CDF') OR (bec_zone_code = 'ICH' and bec_subzone not in ('{glue::glue_collapse(wet,  sep = '\\',\\'')}')))  then 'O-1a/b'
end) as fuel_type  
...
when species_cd_1 = 'SE' and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 10 then 'S-2'
when species_cd_1 = 'SE' and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null) and bclcs_level_5 = 'SP' then 'D-1/2'
when species_cd_1 = 'SE' and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null) and bclcs_level_5 = 'DE' then 'C-2'
when species_cd_1 = 'SE' and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null) and bclcs_level_5 = 'OP' then 'C-3'
when species_cd_1 = 'SS' and EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 6 then 'S-3'
when species_cd_1 = 'SS' and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and bclcs_level_5 = 'SP' then 'D-1/2'
when species_cd_1 = 'SS' and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 6 or harvest_date is null) and bclcs_level_5 in('DE', 'OP') then 'C-5'
when species_cd_1  in ('SB', 'SW', 'SXW') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 10) then 'S-3'
when species_cd_1  in ('SB', 'SW', 'SXW') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null)  and bclcs_level_5 in ('DE', 'OP') then 'C-2'
when species_cd_1  in ('SB', 'SW', 'SXW') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null)  and bclcs_level_5 = 'SP' and bec_zone_code in ('BWBS', 'SWB') then 'C-1'
when species_cd_1  in ('SB', 'SW', 'SXW') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 10 or harvest_date is null)  and bclcs_level_5 = 'SP' and bec_zone_code not in ('BWBS', 'SWB') then 'M-1/2'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  <= 7)  then 'S-2'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 7 or harvest_date is null) and bec_zone_code in ('BWBS', 'SWB') and bclcs_level_5 in ('DE', 'OP')  then 'C-2'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date)  > 7 or harvest_date is null) and bec_zone_code in ('BWBS', 'SWB') and bclcs_level_5 = 'SP'  then 'C-1'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 7 or harvest_date is null) and bec_zone_code not in ('BWBS', 'SWB') and bclcs_level_5  = 'SP' then 'C-7'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 7 or harvest_date is null) and bec_zone_code in ('CWH', 'CDF') and bclcs_level_5  in ('DE', 'OP')  then 'C-5'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 7 or harvest_date is null) and bec_zone_code not in ('BWBS', 'SWB','CWH', 'CDF') and bclcs_level_5 in ('DE', 'OP') and COALESCE (proj_height_1, 0 ) <= 4 then '0-1a/b'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 7 or harvest_date is null) and bec_zone_code not in ('BWBS', 'SWB','CWH', 'CDF') and bclcs_level_5 ='DE' and COALESCE (proj_height_1, 0 ) > 4 then 'C-2'
when species_cd_1  in ('S', 'SX', 'SXL', 'SXS') and (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 7 or harvest_date is null) and bec_zone_code not in ('BWBS', 'SWB','CWH', 'CDF') and bclcs_level_5 ='OP' and COALESCE (proj_height_1, 0 ) > 4 then 'C-3'
end) as fuel_type  
...
veg_con_pure_hw <-data.table(getTableQuery(glue::glue("Select feature_id, (case
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) <= 6) then 'S-3'             when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'DE' and COALESCE(proj_height_1, 0) <= 4 then 'D-1/2' 
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'DE' and COALESCE(proj_height_1, 0) > 4 and proj_height_1 <= 15 then 'C-3'
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'DE' and proj_height_1 >  15 and COALESCE(proj_age_1,0) <= 60 then 'C-3' 
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'DE' and proj_height_1 >  15 and proj_age_1 > 60 and proj_age_1 <= 99 then 'M-1/2' 
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'DE' and proj_height_1 >  15 and proj_age_1 > 99 then 'C-5' 
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'OP' then 'C-5' 
   when (EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) > 6 or harvest_date is null) and bclcs_level_5 = 'SP' then 'D-1/2'
   end)  as fuel_type 
...
```{r}
veg_mixed <-data.table(getTableQuery(glue::glue("Select feature_id, coast_interior_cd, bclcs_level_5, bec_zone_code, bec_subzone, proj_height_1, COALESCE(vri_live_stems_per_ha,0) as vri_live_stems_per_ha, COALESCE(vri_dead_stems_per_ha,0) as vri_dead_stems_per_ha, COALESCE (stand_percentage_dead, 0) as stand_percentage_dead, species_cd_1, species_cd_2, species_cd_3, species_cd_4, species_cd_5,species_cd_6, species_pct_1, species_pct_2, species_pct_3, species_pct_3, species_pct_4, species_pct_5,species_pct_6, EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) as ys_log, EXTRACT('Year' FROM projected_date)- EXTRACT('Year' FROM earliest_nonlogging_dist_date) as ys_dist, earliest_nonlogging_dist_type, proj_age_1, crown_closure FROM veg_comp_lyr_r1_poly{year_vri} where bclcs_level_1 = 'V' AND bclcs_level_2 = 'T' AND species_pct_1 < 80;")))
...
##### Non-Forested
```{r}
non_forested <-data.table(getTableQuery(glue::glue("Select feature_id, coast_interior_cd, bclcs_level_5, bec_zone_code, bec_subzone, proj_height_1, COALESCE(vri_live_stems_per_ha,0) as vri_live_stems_per_ha, COALESCE(vri_dead_stems_per_ha,0) as vri_dead_stems_per_ha, COALESCE (stand_percentage_dead, 0) as stand_percentage_dead, species_cd_1, species_cd_2, species_cd_3, species_cd_4, species_cd_5,species_cd_6, species_pct_1, species_pct_2, species_pct_3, species_pct_3, species_pct_4, species_pct_5,species_pct_6, EXTRACT('Year' FROM projected_date) - EXTRACT('Year' FROM harvest_date) as ys_log, EXTRACT('Year' FROM projected_date)- EXTRACT('Year' FROM earliest_nonlogging_dist_date) as ys_dist, earliest_nonlogging_dist_type, proj_age_1, crown_closure FROM veg_comp_lyr_r1_poly{year_vri} where bclcs_level_1 = 'V' AND bclcs_level_2 = 'T' AND species_pct_1 < 80;")))
```