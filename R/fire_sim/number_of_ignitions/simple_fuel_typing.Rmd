...
lapply(seq(2009, 2023, 1), function(x) {
  ...
  write.csv(out, glue::glue("fueltype_10k_{year_vri}.csv"))
...
fuel_type<-rbindlist(
  lapply(seq(2009, 2023, 1), function(x){
    data<-data.table(read.csv(glue::glue("C:/Users/klochhea/castor/R/fire_sim/number_of_ignitions/fueltype_10k_{x}.csv")))
    data$FIRE_YEAR<-x
    data
}))
write.csv(fuel_type, "fuel_type_10k_2009to2023.csv")
```
