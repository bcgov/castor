...
#Cariboo
  ...
  models.fc4 <- sdmTMB(data = data.fit.fc4 , count ~ 1 + CMI_MIN  + dCMI3yr + avgCMIProv + as.factor(frt) + log(con+1) + log(young+1) + log(dec+1), offset = log(data.fit.fc4$flammable), family = nbinom2(), time = "year", mesh = spde_fc1_loo , spatial = T, spatiotemporal = FALSE, reml=T)
