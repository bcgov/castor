...
m0 <- sdmTMB(data = occ.model.data, count ~ 1 + (1|year) , offset = log(occ.model.data$flammable), family = nbinom2(), time = "year",  mesh = spde, spatial = FALSE, spatiotemporal = FALSE, reml=T)

m1 <- sdmTMB(data = occ.model.data, count ~ 1 + CMI_MIN + (1|year) , offset = log(occ.model.data$flammable), family = nbinom2(), time = "year",  mesh = spde, spatial = F, spatiotemporal = FALSE, reml=T)
...
m5 <- sdmTMB(data = occ.model.data, count ~ 1 + CMI_MIN + dCMI3yr + as.factor(frt) + log(con+1) + log(young+1) + (1|year), offset = log(occ.model.data$flammable), family = nbinom2(), time = "year", mesh = spde, spatial = T, spatiotemporal = FALSE)

m6 <- sdmTMB(data = occ.model.data, count ~ 1 + scale(CMI_MIN) + scale(dCMI3yr)+ scale(log(con+1)), offset = log(occ.model.data$flammable), family = nbinom2_mix(), time = "year", mesh = spde, spatial = T, spatiotemporal = FALSE)
