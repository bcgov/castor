...
climateData<-rbindlist(lapply(seq(2005, 2022, 1), function(x){
  ...
  data_ras_CMI <- terra::rasterize(data_sf, prov.rast, field = "CMI")
    data_ras_CMI_min <- terra::rasterize(data_sf, prov.rast, field = "CMI_MIN")
  data_ras_CMD <- terra::rasterize(data_sf, prov.rast, field = "CMD")
  data_ras_CMI05 <- terra::rasterize(data_sf, prov.rast, field = "CMI05")
 data_ras_CMI06 <- terra::rasterize(data_sf, prov.rast, field = "CMI06")
 data_ras_CMI07 <- terra::rasterize(data_sf, prov.rast, field = "CMI07")
 data_ras_CMI08 <- terra::rasterize(data_sf, prov.rast, field = "CMI08")
  data_ras_CMD_sm <- terra::rasterize(data_sf, prov.rast, field = "CMD_sm")
  data_ras_TEMP_MAX <- terra::rasterize(data_sf, prov.rast, field = "TEMP_MAX")
  data_ras_DD18_sm <- terra::rasterize(data_sf, prov.rast, field = "DD18_sm")
  data_ras_PPT_sm <- terra::rasterize(data_sf, prov.rast, field = "PPT_sm")
...
#Rolling average
climateData<-climateData[, CMI5yr := frollmean(.SD, n=5), by = "pixelid", .SDcols = "CMI"]
climateData<-climateData[, CMI3yr := frollmean(.SD, n=3), by = "pixelid", .SDcols = "CMI"]
climateData<-climateData[, CMI2yr := frollmean(.SD, n=2), by = "pixelid", .SDcols = "CMI"]
