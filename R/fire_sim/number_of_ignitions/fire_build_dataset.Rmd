...
#  data.table(FIRE_YEAR =x, haz= #rast(glue::glue("C:/Users/klochhea/castor/R/fire_sim/num#ber_of_ignitions/hazard_{x-1}_10k.tif"))[])
#}))
...
#FIRE SIZE
data.lightning.size<- ignit_unknown[FIRE_CAUSE=="Lightning" & bclcs_level_1 != 'U', ]
...
pixel.simple_fueltype<-data.table(read.csv( "C:/Users/klochhea/castor/R/fire_sim/number_of_ignitions/fuel_type_5k_2009to2023.csv"))
...
saveRDS(data.lightning.size, "data_lightning_size_5k.rds")
...
saveRDS(data.lightning, "data_lightning_5k.rds")
```
