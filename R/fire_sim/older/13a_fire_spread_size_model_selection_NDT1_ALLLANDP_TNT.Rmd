...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_height_1 + live_stand_volume_125 + bclcs_level_2 + proj_height_1:bclcs_level_2 + dist_infra + roads_km + slope + aspect + wind_atfire + slope:wind_atfire + climate1 + climate2 + mdc_atfire + elevation*wind_atfire + vegtype2*wind_atfire + Tdif_atfire, data = dat1)
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_height_1 + live_stand_volume_125 + bclcs_level_2 + proj_height_1:bclcs_level_2 + dist_infra + roads_km + slope + aspect + wind_atfire + climate1 + climate2 + mdc_atfire + elevation*wind_atfire + vegtype2*wind_atfire + Tdif_atfire, data = dat1)
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_height_1 + live_stand_volume_125 + bclcs_level_2 + proj_height_1:bclcs_level_2  + roads_km + slope + aspect + wind_atfire + climate1 + climate2 + mdc_atfire + elevation*wind_atfire + vegtype2*wind_atfire + Tdif_atfire, data = dat1)
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_height_1 + live_stand_volume_125 + bclcs_level_2 + proj_height_1:bclcs_level_2 + slope + aspect + wind_atfire + climate1 + climate2 + mdc_atfire + elevation*wind_atfire + vegtype2*wind_atfire + Tdif_atfire, data = dat1)
...
model.NDT1.Spread<-lm(LNsize_ha ~ proj_height_1 + live_stand_volume_125 + bclcs_level_2 + proj_height_1:bclcs_level_2 + slope + aspect + wind_atfire + climate1 + climate2 + mdc_atfire + elevation*wind_atfire + vegtype2*wind_atfire + Tdif_atfire, data = NDT1_spread_size)
