...
# some fire ignition locations get lost in the data processing. I checked this and it seems some of them fall outside the BC boundary so when I clip the locations to BC it removes a bunch. Also, when I link my fire locations to the VRI some spots dissapear. Im not sure why this happens though.
...
library(ggpubr)
# volume and height are fairly correlated but age and volume are not
