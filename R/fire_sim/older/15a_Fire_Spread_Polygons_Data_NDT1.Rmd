...
test<-fire_spread_veg_data_df
table(test$vegtype2)
table(test$bclcs_level_2)
test$vegtype2[test$bclcs_level_2=="W"] <- "W"
table(test$vegtype2)
...
NDT1_l_spread_models_treed<-rbind(AIC_lightning_NDT1_spread_treed_summary_VRI2, AIC_lightning_NDT1_spread_treed_summary_topo2)
...
```{r}
write.csv(AIC_lightning_NDT1_spread_treed_summary_infra2, file="D:\\Fire\\fire_data\\raw_data\\NDT1_lightning_spread_models_treed_polygon_infra.csv")
...
model.NDT1<-glm(spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_dam + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + dist_mun:roads_km + dist_mun:bclcs_level_5_2 + dist_dam:bclcs_level_5_2 + dist_nat:roads_km + dist_nat:bclcs_level_5_2 + dist_pow:bclcs_level_5_2 + dist_mine:roads_km + dist_mine:bclcs_level_5_2 + roads_km:bclcs_level_5_2
 + vegtype2 + bclcs_level_2, family = binomial, data = dat1)

AIC(model.NDT1) #60450.24
summary(model.NDT1)

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response") #new levels?
...
model.NDT1<-glm(spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2 + bclcs_level_2, family = binomial, data = dat1)

AIC(model.NDT1) #60733.95 --> much higher AIC< but AUC is similar, and this one is not overfitted.
summary(model.NDT1)
...
model.NDT1<-glm(spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #60731.76 --> much higher AIC< but AUC is similar, and this one is not overfitted.
summary(model.NDT1)
...
#Since water now included in vegtype, can remove bclcs_level_2
model.NDT1<-glm(spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #60730.55 --> much higher AIC< but AUC is similar, and this one is not overfitted.
summary(model.NDT1)
...
model.NDT1<-glm(spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2, family = binomial, data = NDT1_spread)
...
NDT1_spread$resids<-resid(model.NDT1)
...
top_mod_table_NDT1_spread_poly <- data.frame (matrix (ncol = 30, nrow = 0))
...
#New table
#Create a new blank table and get AUC too
top_mod_table_NDT1_spread_poly <- data.frame (matrix (ncol = 70, nrow = 0))
colnames (top_mod_table_NDT1_spread_poly ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_slope", "coef_aspect_cos", "coef_elev", "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_dist_pow",  "coef_dist_mine", "coef_roads_km", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2ROCK", "coef_bclcs_level_5_2SOIL", "coef_bclcs_level_5_2SP", "coef_bclcs_level_5_2UR", "coef_bclcs_level_5_2WATER", "coef_vegtype2OP", "coef_vegtype2RO", "coef_vegtype2S", "coef_vegtype2TB", "coef_vegtype2TC", "coef_vegtype2TM", "coef_bclcs_level_2N", "coef_bclcs_level_2T", "coef_slope:aspect_cos", "coef_slope:elev", "coef_dist_mun:roads_km",
                                                 
"coef_dist_mun:bclcs_level_5_2OP", "dist_mun:bclcs_level_5_2ROCK", "dist_mun:bclcs_level_5_2SOIL", "dist_mun:bclcs_level_5_2SP", "dist_mun:bclcs_level_5_2UR", "dist_mun:bclcs_level_5_2WATER", 

"coef_dist_dam:bclcs_level_5_2OP", "dist_dam:bclcs_level_5_2ROCK", "dist_dam:bclcs_level_5_2SOIL", "dist_dam:bclcs_level_5_2SP", "dist_dam:bclcs_level_5_2UR", "dist_dam:bclcs_level_5_2WATER",

"coef_dist_nat:roads_km",

"coef_dist_nat:bclcs_level_5_2OP", "dist_nat:bclcs_level_5_2ROCK", "dist_nat:bclcs_level_5_2SOIL", "dist_nat:bclcs_level_5_2SP", "dist_nat:bclcs_level_5_2UR", "dist_nat:bclcs_level_5_2WATER",

"coef_dist_pow:bclcs_level_5_2OP", "dist_pow:bclcs_level_5_2ROCK", "dist_pow:bclcs_level_5_2SOIL", "dist_pow:bclcs_level_5_2SP", "dist_pow:bclcs_level_5_2UR", "dist_pow:bclcs_level_5_2WATER",

"coef_dist_mine:roads_km",

"coef_dist_mine:bclcs_level_5_2OP", "dist_mine:bclcs_level_5_2ROCK", "dist_mine:bclcs_level_5_2SOIL", "dist_mine:bclcs_level_5_2SP", "dist_mine:bclcs_level_5_2UR", "dist_mine:bclcs_level_5_2WATER",

"coef_roads_km:bclcs_level_5_2OP", "roads_km:bclcs_level_5_2ROCK", "roads_km:bclcs_level_5_2SOIL", "roads_km:bclcs_level_5_2SP", "roads_km:bclcs_level_5_2UR", "roads_km:bclcs_level_5_2WATER",
...
top_mod_table_NDT1_spread <- data.frame (matrix (ncol = 70, nrow = 0))
...
top_mod_table_NDT1_spread[1,4]<-"spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_dam + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + dist_mun:roads_km + dist_mun:bclcs_level_5_2 + dist_dam:bclcs_level_5_2 + dist_nat:roads_km + dist_nat:bclcs_level_5_2 + dist_pow:bclcs_level_5_2 + dist_mine:roads_km + dist_mine:bclcs_level_5_2 + roads_km:bclcs_level_5_2
 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread[1,5]<- coef(model.NDT1)[1] #Intercept
top_mod_table_NDT1_spread[1,6]<- coef(model.NDT1)[2] #
top_mod_table_NDT1_spread[1,7]<- coef(model.NDT1)[3] #
top_mod_table_NDT1_spread[1,8]<- coef(model.NDT1)[4] #
top_mod_table_NDT1_spread[1,9]<- coef(model.NDT1)[5] #
top_mod_table_NDT1_spread[1,10]<- coef(model.NDT1)[6] #
top_mod_table_NDT1_spread[1,11]<- coef(model.NDT1)[7] 
top_mod_table_NDT1_spread[1,12]<- coef(model.NDT1)[8] #
top_mod_table_NDT1_spread[1,13]<- coef(model.NDT1)[9] #
top_mod_table_NDT1_spread[1,14]<- coef(model.NDT1)[10] #
top_mod_table_NDT1_spread[1,15]<- coef(model.NDT1)[11] #
top_mod_table_NDT1_spread[1,16]<- coef(model.NDT1)[12] #
top_mod_table_NDT1_spread[1,17]<- coef(model.NDT1)[13] #
top_mod_table_NDT1_spread[1,18]<- coef(model.NDT1)[14] #
top_mod_table_NDT1_spread[1,19]<- coef(model.NDT1)[15] #
top_mod_table_NDT1_spread[1,20]<- coef(model.NDT1)[16] # 
top_mod_table_NDT1_spread[1,21]<- coef(model.NDT1)[17] #  
top_mod_table_NDT1_spread[1,22]<- coef(model.NDT1)[18] #
top_mod_table_NDT1_spread[1,23]<- coef(model.NDT1)[19] #
top_mod_table_NDT1_spread[1,24]<- coef(model.NDT1)[20] #
top_mod_table_NDT1_spread[1,25]<- coef(model.NDT1)[21] #
top_mod_table_NDT1_spread[1,26]<- coef(model.NDT1)[22] #
top_mod_table_NDT1_spread[1,27]<- coef(model.NDT1)[23] #
top_mod_table_NDT1_spread[1,28]<- coef(model.NDT1)[24] #
top_mod_table_NDT1_spread[1,29]<- coef(model.NDT1)[25] #

top_mod_table_NDT1_spread[1,30]<- coef(model.NDT1)[26] #
top_mod_table_NDT1_spread[1,31]<- coef(model.NDT1)[27] #
top_mod_table_NDT1_spread[1,32]<- coef(model.NDT1)[28] #
top_mod_table_NDT1_spread[1,33]<- coef(model.NDT1)[29] #
top_mod_table_NDT1_spread[1,34]<- coef(model.NDT1)[30] #
top_mod_table_NDT1_spread[1,35]<- coef(model.NDT1)[31] #
top_mod_table_NDT1_spread[1,36]<- coef(model.NDT1)[32] #
top_mod_table_NDT1_spread[1,37]<- coef(model.NDT1)[33] #
top_mod_table_NDT1_spread[1,38]<- coef(model.NDT1)[34] #
top_mod_table_NDT1_spread[1,39]<- coef(model.NDT1)[35] #
top_mod_table_NDT1_spread[1,40]<- coef(model.NDT1)[36] #

top_mod_table_NDT1_spread[1,41]<- coef(model.NDT1)[37] #
top_mod_table_NDT1_spread[1,42]<- coef(model.NDT1)[38] #
top_mod_table_NDT1_spread[1,43]<- coef(model.NDT1)[39] #
top_mod_table_NDT1_spread[1,44]<- coef(model.NDT1)[40] #
top_mod_table_NDT1_spread[1,45]<- coef(model.NDT1)[41] #
top_mod_table_NDT1_spread[1,46]<- coef(model.NDT1)[42] #
top_mod_table_NDT1_spread[1,47]<- coef(model.NDT1)[43] #
top_mod_table_NDT1_spread[1,48]<- coef(model.NDT1)[44] #
top_mod_table_NDT1_spread[1,49]<- coef(model.NDT1)[45] #
top_mod_table_NDT1_spread[1,50]<- coef(model.NDT1)[46] #

top_mod_table_NDT1_spread[1,51]<- coef(model.NDT1)[47] #
top_mod_table_NDT1_spread[1,52]<- coef(model.NDT1)[48] #
top_mod_table_NDT1_spread[1,53]<- coef(model.NDT1)[49] #
top_mod_table_NDT1_spread[1,54]<- coef(model.NDT1)[50] #
top_mod_table_NDT1_spread[1,55]<- coef(model.NDT1)[51] #
top_mod_table_NDT1_spread[1,56]<- coef(model.NDT1)[52] #
top_mod_table_NDT1_spread[1,57]<- coef(model.NDT1)[53] #
top_mod_table_NDT1_spread[1,58]<- coef(model.NDT1)[54] #
top_mod_table_NDT1_spread[1,59]<- coef(model.NDT1)[55] #
top_mod_table_NDT1_spread[1,60]<- coef(model.NDT1)[56] #

top_mod_table_NDT1_spread[1,61]<- coef(model.NDT1)[57] #
top_mod_table_NDT1_spread[1,62]<- coef(model.NDT1)[58] #
top_mod_table_NDT1_spread[1,63]<- coef(model.NDT1)[59] #
top_mod_table_NDT1_spread[1,64]<- coef(model.NDT1)[60] #
top_mod_table_NDT1_spread[1,65]<- coef(model.NDT1)[61] #
top_mod_table_NDT1_spread[1,66]<- coef(model.NDT1)[62] #
top_mod_table_NDT1_spread[1,67]<- coef(model.NDT1)[63] #
top_mod_table_NDT1_spread[1,68]<- coef(model.NDT1)[64] #
top_mod_table_NDT1_spread[1,69]<- coef(model.NDT1)[65] #
top_mod_table_NDT1_spread[1,70]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly, file="D:\\Fire\\fire_data\\raw_data\\top_mod_spread_NDT1_light_t_ALL_EXTENDED.csv")
```

```{r}
names(top_mod_table_NDT1_spread_poly)
#colMeans(top_mod_table_NDT1_spread_poly[5:30])
#sapply(top_mod_table_NDT1_spread_poly,mean, na.rm = T)
#lapply(top_mod_table_NDT1_spread_poly,mean, na.rm = T)
...
top_mod_table_NDT1_spread_poly_means[1,4]<- "spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_dam + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + dist_mun:roads_km + dist_mun:bclcs_level_5_2 + dist_dam:bclcs_level_5_2 + dist_nat:roads_km + dist_nat:bclcs_level_5_2 + dist_pow:bclcs_level_5_2 + dist_mine:roads_km + dist_mine:bclcs_level_5_2 + roads_km:bclcs_level_5_2 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread_poly_means
```
Save table.

```{r}
write.csv(top_mod_table_NDT1_spread_poly_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT1_spread_poly_means_EXTENDED.csv")
```
...
top_mod_table_NDT1_spread_poly_sd[1,4]<-"spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_dam + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + dist_mun:roads_km + dist_mun:bclcs_level_5_2 + dist_dam:bclcs_level_5_2 + dist_nat:roads_km + dist_nat:bclcs_level_5_2 + dist_pow:bclcs_level_5_2 + dist_mine:roads_km + dist_mine:bclcs_level_5_2 + roads_km:bclcs_level_5_2
 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread_poly_sd
```
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT1_spread_poly_sd_EXTENDED.csv")
```

#Note, the mean AUC is 0.64... the same as the earlier model with much higher AIC, but is much simpler of a model...
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT1_spread <- data.frame (matrix (ncol = 30, nrow = 0))
colnames (top_mod_table_NDT1_spread ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_slope", "coef_aspect_cos", "coef_elev", "coef_dist_mun", "coef_dist_nat", "coef_dist_pow",  "coef_dist_mine", "coef_roads_km", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2ROCK", "coef_bclcs_level_5_2SOIL", "coef_bclcs_level_5_2SP", "coef_bclcs_level_5_2UR", "coef_bclcs_level_5_2WATER", "coef_vegtype2OP", "coef_vegtype2RO", "coef_vegtype2S", "coef_vegtype2TB", "coef_vegtype2TC", "coef_vegtype2TM", "coef_bclcs_level_2N", "coef_bclcs_level_2T", "coef_slope:aspect_cos", "coef_slope:elev", "AUC")
...
top_mod_table_NDT1_spread[1,2]<-"NDT1"
top_mod_table_NDT1_spread[1,3]<-"ALL Treed and not treed"
top_mod_table_NDT1_spread[1,4]<-"spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread[1,5]<- coef(model.NDT1)[1] #Intercept
top_mod_table_NDT1_spread[1,6]<- coef(model.NDT1)[2] #
top_mod_table_NDT1_spread[1,7]<- coef(model.NDT1)[3] #
top_mod_table_NDT1_spread[1,8]<- coef(model.NDT1)[4] #
...
top_mod_table_NDT1_spread[1,28]<- coef(model.NDT1)[24] #
top_mod_table_NDT1_spread[1,29]<- coef(model.NDT1)[25] #
top_mod_table_NDT1_spread[1,30]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly, file="D:\\Fire\\fire_data\\raw_data\\top_mod_spread_NDT1_light_t_ALL_SHORTER.csv")
```
...
top_mod_table_NDT1_spread_poly_means[1,2]<-"NDT1"
top_mod_table_NDT1_spread_poly_means[1,3]<-"ALL Treed and not treed"
top_mod_table_NDT1_spread_poly_means[1,4]<- "spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread_poly_means
```
Save table.

```{r}
write.csv(top_mod_table_NDT1_spread_poly_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT1_spread_poly_means_SHORTER.csv")
```
...
top_mod_table_NDT1_spread_poly_sd[1,2]<-"NDT1"
top_mod_table_NDT1_spread_poly_sd[1,3]<-"ALL Treed and not treed"
top_mod_table_NDT1_spread_poly_sd[1,4]<-"spread ~ slope + aspect_cos + elev + slope:aspect_cos + slope:elev + dist_mun + dist_nat + dist_pow + dist_mine + roads_km + bclcs_level_5_2 + vegtype2 + bclcs_level_2" 
top_mod_table_NDT1_spread_poly_sd
```
...
```{r}
write.csv(top_mod_table_NDT1_spread_poly_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT1_spread_poly_sd_shorter.csv")
```
