...
#vars.oth<-c("proj_height_1", "proj_age_1", "live_stand_volume_125", "vegtype")
...
#the list of all possible model RHSs. 
all.poss.mods <- c(1, vars.clim, twoway.ints, mods.me2, mods.inter2)
all.poss.mods
all.poss.mods[2]
length(all.poss.mods) #20 models with new alterations - this is a reasonable number to cycle through
```
