...
sample_locations2<- ignition_weather_crs1
...
str(sample_locations2)#200292 values
...
st_write(sample_locations_DEM, dsn = "C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\DC_data_DEM_5x_AllMonths_frt.shp", delete_layer=TRUE)

rm(ignition_weather, ignition_weather_crs,pointCoordinates, rasValue2, test, TRASP2, DEM, DEM_aspect, DEM_slope) # remove some files out of memory
gc()
