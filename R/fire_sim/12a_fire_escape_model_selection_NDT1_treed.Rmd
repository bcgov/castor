...
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + slope:elevation + elevation*climate2 + wind_atfire*climate1 + wind_atfire*climate2 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1922.4
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + slope:elevation + elevation*climate2 + wind_atfire*climate1 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1914.6
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*climate1 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1910.7
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1908.1
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1906.6
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1905.8
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + Tdif_atfire*climate1 + Tdif_atfire, family = binomial, data = dat1)

AIC(model.NDT1) #1905.2
...
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + Tdif_atfire*climate1 + Tdif_atfire, family = binomial, data = NDT1_escape_t)
...
NDT1_escape_t$resids<-resid(model.NDT1)
...
top_mod_table_NDT1_light_t[1,8]<- coef(model.NDT1)[4] #coefficient vegtypeTB
top_mod_table_NDT1_light_t[1,9]<- coef(model.NDT1)[5] #coefficient vegtypeTC
top_mod_table_NDT1_light_t[1,10]<- coef(model.NDT1)[6] #coefficient vegtypeTM
top_mod_table_NDT1_light_t[1,11]<- coef(model.NDT1)[7] #live stand volume
top_mod_table_NDT1_light_t[1,12]<- coef(model.NDT1)[8] #coefficient dist_dam
top_mod_table_NDT1_light_t[1,13]<- coef(model.NDT1)[9] #coefficient dist_nat
top_mod_table_NDT1_light_t[1,14]<- coef(model.NDT1)[10] #coefficient bclcs_level_5_2OP
top_mod_table_NDT1_light_t[1,15]<- coef(model.NDT1)[11] #coefficient bclcs_level_5_2SP
top_mod_table_NDT1_light_t[1,16]<- coef(model.NDT1)[12] #coefficient slope
top_mod_table_NDT1_light_t[1,17]<- coef(model.NDT1)[13] #coefficient elevation
top_mod_table_NDT1_light_t[1,18]<- coef(model.NDT1)[14] #coefficient wind_atfire
top_mod_table_NDT1_light_t[1,19]<- coef(model.NDT1)[15] #Tdif_atfire
top_mod_table_NDT1_light_t[1,20]<- coef(model.NDT1)[16] # climate1:vegtype2TB 
top_mod_table_NDT1_light_t[1,21]<- coef(model.NDT1)[17] # climate1:vegtype2TC 
top_mod_table_NDT1_light_t[1,22]<- coef(model.NDT1)[18] #coefficient climate1:vegtype2TM
top_mod_table_NDT1_light_t[1,23]<- coef(model.NDT1)[19] #coefficient climate2:vegtype2TB
top_mod_table_NDT1_light_t[1,24]<- coef(model.NDT1)[20] #coefficient climate2:vegtype2TC
top_mod_table_NDT1_light_t[1,25]<- coef(model.NDT1)[21] #coefficient climate2:vegtype2TM
top_mod_table_NDT1_light_t[1,26]<- coef(model.NDT1)[22] #coefficient climate2:elevation
top_mod_table_NDT1_light_t[1,27]<- coef(model.NDT1)[23] #coefficient climate1:Tdif_atfire 
