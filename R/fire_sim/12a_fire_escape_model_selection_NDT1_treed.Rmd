...
mod.valid <- predict.glm(model.NDT1, newdata=Valid, type="response")
   ...
   mod.auc <- auc(roc_obj)
   mod.auc #0.72 --> good fit!
   
Anova(model.NDT1, type=3)
Anova(model.NDT1, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*climate1 + wind_atfire*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1841.2
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2  + wind_atfire*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1839.3
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1837.5
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1835.7
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1833.9
...
#Remove least significant interaction
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + roads_km + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1831.4
...
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT1) #1829.4
...
NDT1_escape_t<-escape_lightning_t_NDT1 %>% drop_na(climate1, climate2, vegtype2, live_stand_volume_125, dist_dam, dist_nat, bclcs_level_5_2, slope, elevation, wind_atfire)

#Run Model again with this data; but uses all data here
model.NDT1<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2, family = binomial, data = NDT1_escape_t)
...
top_mod_table_NDT1_light_t_ALL <- data.frame (matrix (ncol = 29, nrow = 0))
colnames (top_mod_table_NDT1_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_live_stand_volume_125",  "coef_dist_dam", "coef_dist_nat", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope", "coef_elevation", "coef_wind_atfire",  "coef_climate1:vegtype2TB", "coef_climate1:vegtype2TC", "coef_climate1:vegtype2TM", "coef_climate2:vegtype2TB", "coef_climate2:vegtype2TC", "coef_climate2:vegtype2TM", "coef_elevation*climate2", "coef_wind_atfire:vegtype2TB", "coef_wind_atfire:vegtype2TC", "coef_wind_atfire:vegtype2TM", "AUC")
```
...
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(NDT1_escape_t$escape, p = prop,
                                    list = FALSE,
                                    times = 1)
...
top_mod_table_NDT1_light_t <- data.frame (matrix (ncol = 29, nrow = 0))
...
top_mod_table_NDT1_light_t[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2" 
...
top_mod_table_NDT1_light_t[1,19]<- coef(model.NDT1)[15] # climate1:vegtype2TB 
top_mod_table_NDT1_light_t[1,20]<- coef(model.NDT1)[16] # climate1:vegtype2TC 
top_mod_table_NDT1_light_t[1,21]<- coef(model.NDT1)[17] #coefficient climate1:vegtype2TM
top_mod_table_NDT1_light_t[1,22]<- coef(model.NDT1)[18] #coefficient climate2:vegtype2TB
top_mod_table_NDT1_light_t[1,23]<- coef(model.NDT1)[19] #coefficient climate2:vegtype2TC
top_mod_table_NDT1_light_t[1,24]<- coef(model.NDT1)[20] #coefficient climate2:vegtype2TM
top_mod_table_NDT1_light_t[1,25]<- coef(model.NDT1)[21] #coefficient climate2:elevation
top_mod_table_NDT1_light_t[1,26]<- coef(model.NDT1)[22] #coefficientvegtype2TB:wind_atfire 
top_mod_table_NDT1_light_t[1,27]<- coef(model.NDT1)[23] #coefficient vegtype2TC:wind_atfire 
top_mod_table_NDT1_light_t[1,28]<- coef(model.NDT1)[24] #coefficient vegtype2TM:wind_atfire 
top_mod_table_NDT1_light_t[1,29]<- mod.auc
...
mean(top_mod_table_NDT1_light_t_ALL$AUC) #0.714

# create model table (only do this once) and add the relevant data
top_mod_table_NDT1_light_t_Means <- data.frame (matrix (ncol = 29, nrow = 0))
...
top_mod_table_NDT1_light_t_Means[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2" 
...
top_mod_table_NDT1_light_t_Means[1,19]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TB`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_Means[1,20]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TC`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_Means[1,21]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TM`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_Means[1,22]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TB`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_Means[1,23]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TC`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_Means[1,24]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TM`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_Means[1,25]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_elevation*climate2`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_Means[1,26]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TB`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_Means[1,27]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TC`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_Means[1,28]<- mean(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TM`, na.rm=TRUE) #coefficient climate1*projage
top_mod_table_NDT1_light_t_Means[1,29]<- mean(top_mod_table_NDT1_light_t_ALL$AUC, na.rm=TRUE)
...
```{r}
# create model table (only do this once) and add the relevant data
top_mod_table_NDT1_light_t_SD <- data.frame (matrix (ncol = 29, nrow = 0))
...
top_mod_table_NDT1_light_t_SD[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + climate1:vegtype2 + climate2:vegtype2 + dist_dam + dist_nat + bclcs_level_5_2 + slope + elevation + wind_atfire + elevation*climate2 + wind_atfire*vegtype2" 
...
top_mod_table_NDT1_light_t_SD[1,19]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TB`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_SD[1,20]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TC`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_SD[1,21]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate1:vegtype2TM`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_SD[1,22]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TB`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_SD[1,23]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TC`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_SD[1,24]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_climate2:vegtype2TM`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_SD[1,25]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_elevation*climate2`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_SD[1,26]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TB`, na.rm=TRUE) #
top_mod_table_NDT1_light_t_SD[1,27]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TC`, na.rm=TRUE) 
top_mod_table_NDT1_light_t_SD[1,28]<- sd(top_mod_table_NDT1_light_t_ALL$`coef_wind_atfire:vegtype2TM`, na.rm=TRUE) #coefficient climate1*projage
top_mod_table_NDT1_light_t_SD[1,29]<- sd(top_mod_table_NDT1_light_t_ALL$AUC, na.rm=TRUE)
