...
samp_locations_sf$fire_yr <- as.numeric(as.character(samp_locations_sf$fire_yr))
...
st_write(ignition_weather_crs, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\DC_data_5x_AllMonths.shp", delete_layer=TRUE)
