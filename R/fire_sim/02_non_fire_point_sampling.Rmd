...
fire.ignt.frt2 <- fire.igni.frt.ndt %>%
  select("id", "FIRE_NUMBER", "FIRE_YEAR", "IGNITION_DATE", "FIRE_CAUSE", "FIRE_LABEL", "FIRE_CENTRE", "ZONE", "FIRE_ID", "FIRE_TYPE", "LATITUDE", "LONGITUDE","CURRENT_SIZE","ig_mnth", "Cluster","geometry")
