...
```{r}
sample_locations_DEM_roads_2<-st_read(dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Data_climate_DEM_roads.shp")
...
sample_locations_DEM_roads_wind2_test<-sample_locations_DEM_roads_wind2[-32]
sample_locations_DEM_roads_wind2_test<-sample_locations_DEM_roads_wind2_test[-32]
sample_locations_DEM_roads_wind2_test<-sample_locations_DEM_roads_wind2_test[-34]
sample_locations_DEM_roads_wind2_test<-sample_locations_DEM_roads_wind2_test[-37]
...
sf::st_write(sample_locations_DEM_roads_wind2_test, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Data_clim_DEM_roads_wind.shp", delete_layer=TRUE)
