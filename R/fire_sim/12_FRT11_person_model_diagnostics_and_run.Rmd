...
mod_frt_10a<- glm(fire ~ climate1 + elevatn + FWI_veg + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
Anova(mod_frt_10a, type=3)
mod_frt_10a2<- glm(fire ~ climate1 + FWI_veg + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
mod_frt_10a3<- glm(fire ~elevatn + FWI_veg + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
# althoug elevation seems to be better I would rather keep climate1


mod_frt11b<- glm(fire ~ climate1 + FWI_veg + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
Anova(mod_frt11b, type=3)

mod_frt11c<- glm(fire ~ climate1 + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
Anova(mod_frt11c, type=3)

anova(mod_frt11b, mod_frt11c, test="Chisq")
...
```{r}
mod_frt11<- glm(fire ~ climate1 + log(road_dist_m+1) + log(infr_dist+1), data=dat11, family=binomial(link="logit"))
...
#Model   
mod<-glm(fire ~ climate1 + log(road_dist_m+1) + log(infr_dist+1), data=dat1, family=binomial(link="logit"))
...
top_mod_table_FRT5_person[1,3]<-"fire ~ climate1 + log_road_dist_m + log_infr_dist"
