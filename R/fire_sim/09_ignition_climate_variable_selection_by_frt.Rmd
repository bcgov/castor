...
dist.cut.corr <- dat_person [c (21:28, 36:40)]
corr <- round (cor (dist.cut.corr), 3)
ggcorrplot (corr, type = "lower", lab = TRUE, tl.cex = 10,  lab_size = 3,
            title = "Correlation between maximum temperature and MDC")
...
variables<- c(#"Tmax03",
 ...
 variables1<-c("Tmax04", "Tmax05", "Tmax06", "Tmax07", "Tmax08", "Tmax09","Tmax10", 
               "Tave04","Tave05", "Tave06", "Tave07", "Tave08", "Tave09", "Tave10")
 
variables2<-c("PPT04","PPT05", "PPT06", "PPT07", "PPT08", "PPT09","PPT10",
