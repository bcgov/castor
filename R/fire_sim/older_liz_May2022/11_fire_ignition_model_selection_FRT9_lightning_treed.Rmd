...
```{r}
zones1<-c("9") #Do one zone at a time
...
Save.
```{r}
write.csv(AIC_lightning_t, file="C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\out\\model_results_lightning_treed\\table.glm.FRT_9_ALL.csv")
```
