...
#create new column
dat_lightning$FWI_veg<-paste(dat_lightning$fire, dat_lightning$FWI_veg)
...
dat_person<-dat_person %>%
    mutate(climate1 = case_when(
                                ...
                                frt == "7" ~ mean_Tave05_Tave06_Tave07_Tave08,
                                frt == "9" ~ mean_Tave03_Tave04_Tave05_Tave06_Tave07_Tave08_Tave09, # NDT4
                                frt == "10" ~ mean_Tave07_Tave08_Tave09,
...
dat_person<-dat_person %>%
    mutate(climate2 = case_when(
                                frt == "7" ~ mean_PPT05_PPT06_PPT07_PPT08,
                                frt == "10" ~ mean_PPT07_PPT08_PPT09,
