...
#Checking model fits for FRT 14

```{r}
dat<- dat_lightning_t %>% dplyr::select(fire_yr, ig_mnth, frt, fire, dm_h_bc, climate1, prj_h_1, prj_g_1, l___125,win_spg, win_sum vegtype, bclcs_level_5_2)

dat2<- dat %>% dplyr::filter(frt == 14) %>%
  drop_na(prj_h_1)
