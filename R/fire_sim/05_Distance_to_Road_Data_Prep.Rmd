...
download.file("ftp://ftp.geobc.gov.bc.ca/sections/outgoing/bmgs/DRA_Public/dgtl_road_atlas.gdb.zip",
              destfile = file.path("//Work//caribou//castor//R//fire_sim//data", RdsZip))
...
GDALinfo("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\dist_roads.tif")
...
ignition_weather_crs<-st_read("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\samp_locations_fire_all_15x.shp")
...
st_write(sample_locations_DEM_roads, dsn = "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\DC_data_DEM_roads.shp", delete_layer=TRUE)
