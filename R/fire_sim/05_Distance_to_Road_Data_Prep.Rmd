...
ignition_weather_crs<-st_read("C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\DC_data_DEM_5x_AllMonths_frt.shp")
...
sample_locations_DEM_roads<-sample_locations_DEM_roads %>% select(id:dem_ha_bc, Tmax04:geometry )
