...
mod_frt5<- glm(fire ~ climate1 + log_road_dist + log_infr_dist, data=dat5, family=binomial(link="logit"))
summary(mod_frt5)
Anova(mod_frt5, type=3)
...
colnames (top_mod_table_FRT5_person_All ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate1", "coef_log_road_dist", "coef_log_infr_dist", "AUC")
...
#Model   
mod<-glm(fire ~ climate1 + log_road_dist + log_infr_dist, data=dat1, family=binomial(link="logit"))
...
colnames (top_mod_table_FRT5_person ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate1", "coef_log_road_dist", "coef_log_infr_dist", "AUC")

##Add data for NDT1
top_mod_table_FRT5_person[1,1]<-"person"
top_mod_table_FRT5_person[1,2]<-"FRT5"
top_mod_table_FRT5_person[1,3]<-"fire ~ climate1 + log_road_dist + log_infr_dist"
