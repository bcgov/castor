...
top_mod_table_NDT3_light_t_ALL <- data.frame (matrix (ncol = 27, nrow = 0))
...
#Model   
model.NDT3<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:proj_height_1 + climate1:proj_age_1  + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + dist_pow + slope + aspect + elevation + elevation:climate1, family = binomial, data = dat1) 
...
top_mod_table_NDT3_light_t <- data.frame (matrix (ncol = 27, nrow = 0))
...
top_mod_table_NDT3_light_t[1,4]<-"fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:proj_height_1 + climate1:proj_age_1  + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + dist_pow + slope + aspect + elevation + elevation:climate1" 
...
top_mod_table_NDT3_light_t[1,8]<- coef(model.NDT3)[18] #Interaction climate variables
top_mod_table_NDT3_light_t[1,9]<- coef(model.NDT3)[4] #coefficient vegtypeOP
top_mod_table_NDT3_light_t[1,10]<- coef(model.NDT3)[5] #coefficient vegtypeTB
top_mod_table_NDT3_light_t[1,11]<- coef(model.NDT3)[6] #coefficient vegtypeTC
top_mod_table_NDT3_light_t[1,12]<- coef(model.NDT3)[7] #coefficient vegtypeTM
top_mod_table_NDT3_light_t[1,13]<- coef(model.NDT3)[8] #stand_height
top_mod_table_NDT3_light_t[1,14]<- coef(model.NDT3)[9] #live stand volume
top_mod_table_NDT3_light_t[1,15]<- coef(model.NDT3)[10] #coefficient proj age
top_mod_table_NDT3_light_t[1,16]<- coef(model.NDT3)[11] #coefficient dist_mun
top_mod_table_NDT3_light_t[1,17]<- coef(model.NDT3)[12] #coefficient dist_dam
top_mod_table_NDT3_light_t[1,18]<- coef(model.NDT3)[13] #coefficient dist_nat
top_mod_table_NDT3_light_t[1,19]<- coef(model.NDT3)[14] #coefficient dist_pow
top_mod_table_NDT3_light_t[1,20]<- coef(model.NDT3)[15] #coefficient slope
top_mod_table_NDT3_light_t[1,21]<- coef(model.NDT3)[16] #coefficient aspect
top_mod_table_NDT3_light_t[1,22]<- coef(model.NDT3)[17] #coefficient elevation
top_mod_table_NDT3_light_t[1,23]<- coef(model.NDT3)[19] #coefficient climate1:proj_height_1
top_mod_table_NDT3_light_t[1,24]<- coef(model.NDT3)[20] #coefficient climate1:proj_age_1  
top_mod_table_NDT3_light_t[1,25]<- coef(model.NDT3)[21] #coefficient climate2:proj_height_1
top_mod_table_NDT3_light_t[1,26]<- coef(model.NDT3)[22] #coefficient climate1:elevation
top_mod_table_NDT3_light_t[1,27]<- mod.auc
...
write.csv(table.glm.clim_VRI.NDT3_set_ALL_summary_2, file="D:\\Fire\\fire_data\\raw_data\\table.glm.clim_VRI.NDT3_set_ALL_summary_2.csv")
```
...
mean(top_mod_table_NDT3_light_t_ALL$AUC) #0.748

# create model table (only do this once) and add the relevant data
top_mod_table_NDT3_light_t_Means <- data.frame (matrix (ncol = 27, nrow = 0))
...
top_mod_table_NDT3_light_t_Means[1,4]<-"fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + proj_age_1 + climate1:climate2 + climate1:proj_height_1 + climate1:proj_age_1  + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + dist_pow + slope + aspect + elevation + elevation:climate1" 
...
top_mod_table_NDT3_light_t_Means[1,9]<- mean(top_mod_table_NDT3_light_t_ALL$coef_vegtypeOP, na.rm=TRUE) #coefficient vegtypeOP
top_mod_table_NDT3_light_t_Means[1,10]<- mean(top_mod_table_NDT3_light_t_ALL$coef_vegtypeTB, na.rm=TRUE) #coefficient vegtypeTB
top_mod_table_NDT3_light_t_Means[1,11]<- mean(top_mod_table_NDT3_light_t_ALL$coef_vegtypeTC, na.rm=TRUE) #coefficient vegtypeTC
top_mod_table_NDT3_light_t_Means[1,12]<- mean(top_mod_table_NDT3_light_t_ALL$coef_vegtypeTM, na.rm=TRUE) #coefficient vegtypeTM
top_mod_table_NDT3_light_t_Means[1,13]<- mean(top_mod_table_NDT3_light_t_ALL$coef_stand_height, na.rm=TRUE) #stand_height
top_mod_table_NDT3_light_t_Means[1,14]<- mean(top_mod_table_NDT3_light_t_ALL$coef_live_stand_volume_125, na.rm=TRUE) #live stand volume
top_mod_table_NDT3_light_t_Means[1,15]<- mean(top_mod_table_NDT3_light_t_ALL$coef_stand_age, na.rm=TRUE) #proj age
top_mod_table_NDT3_light_t_Means[1,16]<- mean(top_mod_table_NDT3_light_t_ALL$coef_dist_mun, na.rm=TRUE) #coefficient dist_mun
top_mod_table_NDT3_light_t_Means[1,17]<- mean(top_mod_table_NDT3_light_t_ALL$coef_dist_dam, na.rm=TRUE)#coefficient dist_dam
top_mod_table_NDT3_light_t_Means[1,18]<- mean(top_mod_table_NDT3_light_t_ALL$coef_dist_nat, na.rm=TRUE) #coefficient dist_nat
top_mod_table_NDT3_light_t_Means[1,19]<- mean(top_mod_table_NDT3_light_t_ALL$coef_dist_pow, na.rm=TRUE) #coefficient dist_pow
top_mod_table_NDT3_light_t_Means[1,20]<- mean(top_mod_table_NDT3_light_t_ALL$slope, na.rm=TRUE) #coefficient slope
top_mod_table_NDT3_light_t_Means[1,21]<- mean(top_mod_table_NDT3_light_t_ALL$aspect, na.rm=TRUE) #coefficient aspect
top_mod_table_NDT3_light_t_Means[1,22]<- mean(top_mod_table_NDT3_light_t_ALL$elevation, na.rm=TRUE) #coefficient elevation
top_mod_table_NDT3_light_t_Means[1,23]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_climate1:proj_height_1`, na.rm=TRUE) #coefficient climate1*projheight
top_mod_table_NDT3_light_t_Means[1,24]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_climate1:proj_age_1`, na.rm=TRUE) #coefficient climate1*projage
top_mod_table_NDT3_light_t_Means[1,25]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_climate2:proj_height_1`, na.rm=TRUE) #coefficient climate2*projheight
top_mod_table_NDT3_light_t_Means[1,26]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_climate1:elevation`, na.rm=TRUE) #coefficient climate1:elevation 
top_mod_table_NDT3_light_t_Means[1,27]<- mean(mod.auc, na.rm=TRUE)
