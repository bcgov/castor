...
3. slope + aspect + elevation + slope:elevation + aspect:elevation
...
#Least sig
model.NDT3<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + climate1:climate2 + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate2:vegtype2 + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + aspect + elevation + slope:elevation + aspect:elevation + elevation:climate1 + elevation:climate2, family = binomial, data = dat1)
...
#Least sig
model.NDT3<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + climate1:climate2 + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate2:vegtype2 + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + bclcs_level_5_2 + dist_nat:bclcs_level_5_2 + slope + aspect + elevation + slope:elevation + aspect:elevation  + elevation:climate2, family = binomial, data = dat1)
...
#Least sig
model.NDT3<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + climate1:climate2  + climate1:live_stand_volume_125 + climate2:vegtype2 + climate2:proj_height_1 + dist_mun + dist_dam + dist_nat + bclcs_level_5_2  + slope + aspect + elevation + slope:elevation + aspect:elevation  + elevation:climate2, family = binomial, data = dat1)
...
NDT3_t<-dat_lightning_t_NDT3 %>% drop_na(climate1, climate2, proj_height_1, live_stand_volume_125, dist_mun, dist_dam, vegtype2, slope, aspect, elevation)

#Run Model again with this data; but uses all data here
model.NDT3<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + proj_height_1 + live_stand_volume_125 + climate1:climate2  + climate1:live_stand_volume_125 + climate2:vegtype2 + climate2:proj_height_1 + dist_mun + dist_dam  + bclcs_level_5_2  + slope + aspect + elevation + slope:elevation + aspect:elevation  + elevation:climate2, family = binomial, data = NDT3_t)
...
top_mod_table_NDT3_light_t[1,20]<- coef(model.NDT3)[15] #coefficient aspect
...
top_mod_table_NDT3_light_t[1,28]<- coef(model.NDT3)[24] #coefficient aspect:elevation
...
mean(top_mod_table_NDT3_light_t_ALL$AUC) #0.641
...
top_mod_table_NDT3_light_t_Means[1,20]<- mean(top_mod_table_NDT3_light_t_ALL$coef_aspect, na.rm=TRUE) #coefficient aspect
...
top_mod_table_NDT3_light_t_Means[1,28]<- mean(top_mod_table_NDT3_light_t_ALL$`aspect:elevation`, na.rm=TRUE) #
...
top_mod_table_NDT3_light_t_SD[1,20]<- sd(top_mod_table_NDT3_light_t_ALL$coef_aspect, na.rm=TRUE) #coefficient aspect
...
top_mod_table_NDT3_light_t_SD[1,28]<- sd(top_mod_table_NDT3_light_t_ALL$`aspect:elevation`, na.rm=TRUE) #
