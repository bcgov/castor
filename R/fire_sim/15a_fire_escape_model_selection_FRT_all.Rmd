...
table(is.na(escape_frt10$wind_atfire))
table(is.na(escape_frt10$rd_dst_))
...
#Run model using dat1
model_ft10<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + slope:elevatn + rd_dst_ + wind_atfire + fire_cs, family = binomial, data = escape_frt10)

AIC(model_ft10) #412.9779
Anova(model_ft10, type=3) 

#Remove least significant interaction
model_ft10b<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + rd_dst_ + wind_atfire + fire_cs, family = binomial, data = escape_frt10)

AIC(model_ft10b) #410.9786
Anova(model_ft10b, type=3) 

#Remove least term ~ elevatn
model_ft10c<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + rd_dst_ + wind_atfire, family = binomial, data = escape_frt10)

AIC(model_ft10c) #407.6957
Anova(model_ft10c, type=3) 

#Remove least term ~ elevatn
model_ft10d<-glm(escape10 ~ climate2 + FWI_veg  + slope + elevatn + rd_dst_ + wind_atfire, family = binomial, data = escape_frt10)

AIC(model_ft10d) #406.1593
Anova(model_ft10d, type=3) 


#Remove least term ~ elevatn
model_ft10d<-glm(escape10 ~ climate2 + FWI_veg  + slope + rd_dst_ + wind_atfire, family = binomial, data = escape_frt10)

AIC(model_ft10d) #405.4694
Anova(model_ft10d, type=3) 

#Remove least term ~ elevatn
model_ft10e<-glm(escape10 ~ climate2 + FWI_veg  + slope + rd_dst_, family = binomial, data = escape_frt10)

AIC(model_ft10e) #405.348
Anova(model_ft10e, type=3) 

#Remove least term ~ elevatn
model_ft10f<-glm(escape10 ~ climate2  + slope + rd_dst_, family = binomial, data = escape_frt10)

AIC(model_ft10f) #401.6321
Anova(model_ft10f, type=3) 
...
#######################
#Remove least term ~ slope
model_ft10e<-glm(escape10 ~ climate2  + slope + rd_dst_, family = binomial, data = escape_frt10)

mod.valid <- predict.glm(model_ft10e, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape10"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7253 
...
binnedplot (escape_frt10$slope, 
            escape_frt10$resids,  
            nclass = NULL)

binnedplot (escape_frt10$rd_dst_, 
            escape_frt10$resids,  
            nclass = NULL)
...
#Model   
model.FRT10<-glm(escape10 ~ climate2  + slope + rd_dst_, family = binomial, data = dat1)
...
top_mod_table_FRT10[1,2]<-"escape ~ climate2  + slope + rd_dst_" 
...
summary_top_mod_table_FRT10_ALL$Model_terms<-"escape ~ climate2 + slope + rd_dst" 
...
escape_frt11$FWI_veg[escape_frt11$FWI_veg=="O-1a/b"]<-"C-2"
...
escape_frt12$FWI_veg[escape_frt12$FWI_veg=="C-4"]<-"C-1"
...
table(is.na(escape_frt12$wind_atfire))
table(is.na(escape_frt12$rd_dst_))
table(is.na(escape_frt12$slope))
table(is.na(escape_frt12$fire_cs))
table(is.na(escape_frt12$escape10))

#Run model using dat1
model_ft12<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + wind_atfire + rd_dst_ + infr_ds + fire_cs + slope:elevatn, family = binomial, data = escape_frt12)

AIC(model_ft12) #2506.315
Anova(model_ft12, type=3) 

#Remove least significant interaction
model_ft12b<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt12)


AIC(model_ft12b) #2504.407
Anova(model_ft12b, type=3) 

#Remove least term ~ FWI_veg
model_ft12c<-glm(escape10 ~ climate1 + climate2 + FWI_veg  + slope + elevatn + wind_atfire + rd_dst_ + infr_ds, family = binomial, data = escape_frt12)

AIC(model_ft12c) #2502.295
Anova(model_ft12c, type=3) 

#Remove least term ~ elevatn
model_ft12d<-glm(escape10 ~ climate2 + FWI_veg  + slope + elevatn + wind_atfire + rd_dst_ + infr_ds, family = binomial, data = escape_frt12)

AIC(model_ft12d) #2502.022
anova(model_ft12c,model_ft12d,test="Chisq")
Anova(model_ft12d, type=3) 

#Remove least term ~ wind
model_ft12e<-glm(escape10 ~ climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds, family = binomial, data = escape_frt12)

AIC(model_ft12e) #2503.351
anova(model_ft12d,model_ft12e,test="Chisq")
Anova(model_ft12e, type=3) 
...
mod.valid <- predict.glm(model_ft12e, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape10"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.7308 

hist(escape_frt12$climate2)
hist(escape_frt12$rd_dst_)

table(escape_frt12$escape10) #0 = 948 and 1 = 267 not bad actually.
table(escape_frt12$FWI_veg)
...
binnedplot (escape_frt12$rd_dst_, 
            escape_frt12$resids,  
            nclass = NULL)
...
binnedplot (escape_frt12$infr_ds, 
            escape_frt12$resids,  
            nclass = NULL)
...
#Model   
model.FRT12<-glm(escape10 ~ climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds, family = binomial, data = dat1)
...
top_mod_table_FRT12[1,2]<-"escape ~ climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds" 
...
top_mod_table_FRT12[1,18]<- coef(model.FRT12)[16] #Intercept
...
summary_top_mod_table_FRT12_ALL$Model_terms<-"climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds" 
...
#Run model using dat1
model_ft13<-glm(escape10 ~ climate1 + FWI_veg  + slope + elevatn + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt13)

AIC(model_ft13) #5758.033
Anova(model_ft13, type=3) 

#Remove least significant interaction
model_ft13b<-glm(escape10 ~ climate1 + FWI_veg  + slope + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt13)
...
#######################
#Remove least term ~ slope
model_ft13e<-glm(escape10 ~ climate1 + FWI_veg  + slope + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt13)

hist(escape_frt13$climate1)
hist(escape_frt13$rd_dst_)
...
#Model   
model.FRT13<-glm(escape10 ~ climate1 + FWI_veg  + slope + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = dat1)
...
top_mod_table_FRT13[1,2]<-"escape ~ climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds" 
...
summary_top_mod_table_FRT13_ALL$Model_terms<-"climate2 + FWI_veg  + slope + elevatn + wind_atfire + infr_ds" 
...
table(is.na(escape_frt14$wind_atfire))
...
#Run model using dat1
model_ft14<-glm(escape10 ~ climate1 + climate2 + FWI_veg + elevatn + wind_atfire + rd_dst_ + fire_cs + elevatn:wind_atfire, family = binomial, data = escape_frt14)

AIC(model_ft14) #3737.464
Anova(model_ft14, type=3) 

#Remove least significant interaction
model_ft14b<-glm(escape10 ~ climate1 + climate2 + FWI_veg + elevatn + wind_atfire + rd_dst_ + fire_cs, family = binomial, data = escape_frt14)

AIC(model_ft14b) #3739.792
Anova(model_ft14b, type=3) 

#Remove least significant interaction
model_ft14c<-glm(escape10 ~ climate1 + climate2 + FWI_veg + wind_atfire + rd_dst_ + fire_cs, family = binomial, data = escape_frt14)

AIC(model_ft14c) #3737.912
Anova(model_ft14c, type=3) 

#Remove least significant interaction
model_ft14d<-glm(escape10 ~ climate1 + climate2 + FWI_veg + rd_dst_ + fire_cs, family = binomial, data = escape_frt14)

AIC(model_ft14d) #3736.716
Anova(model_ft14d, type=3) 
...
#######################
#Remove least term ~ slope
model_ft14e<-glm(escape10 ~ climate1 + climate2 + FWI_veg + rd_dst_ + fire_cs, family = binomial, data = escape_frt14)

hist(escape_frt14$climate1)
hist(escape_frt14$climate2)
hist(escape_frt14$rd_dst_)

table(escape_frt14$escape10) #0 = 948 and 1 = 267 not bad actually.
table(escape_frt14$FWI_veg)
...
#Model   
model.FRT14<-glm(escape10 ~ climate1 + FWI_veg  + slope + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = dat1)
...
top_mod_table_FRT14[1,2]<-"escape ~ climate1 + climate2 + FWI_veg + rd_dst + fire_cause" 
...
top_mod_table_FRT14[1,14]<- coef(model.FRT14)[12] #
top_mod_table_FRT14[1,15]<- coef(model.FRT14)[13] #
...
summary_top_mod_table_FRT14_ALL$Model_terms<-"climate1 + climate2 + FWI_veg + rd_dst + fire_cause" 
...
#### FRT 15
```{r}
escape_frt15<- Escape_data_ALL2 %>% filter(Cluster==15)
table(escape_frt15$FWI_veg)
escape_frt15$FWI_veg[escape_frt15$FWI_veg=="S-2"]<-"M-1/2"
...
table(is.na(escape_frt15$wind_atfire))
table(is.na(escape_frt15$rd_dst_))
...
escape_frt15_2<- escape_frt15 %>% filter(!is.na(wind_atfire))

#Run model using dat1
model_ft15<-glm(escape10 ~ climate1 + climate2 + FWI_veg + slope + wind_atfire + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt15_2)

AIC(model_ft15) #926.5801
Anova(model_ft15, type=3) 

#Remove least significant interaction
model_ft15b<-glm(escape10 ~ climate1 + climate2 + FWI_veg + slope + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt15_2)

AIC(model_ft15b) #928.114
...
#######################
#Remove least term ~ slope
model_ft15e<-glm(escape10 ~ climate1 + climate2 + FWI_veg + slope + rd_dst_ + infr_ds + fire_cs, family = binomial, data = escape_frt15_2)

hist(escape_frt15$climate1)
hist(escape_frt15$climate2)
hist(escape_frt15$rd_dst_)
...
#Create a new blank table and get AUC too
top_mod_table_FRT15_ALL <- data.frame (matrix (ncol = 18, nrow = 0))
...
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(escape_frt15$veg_escape, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- escape_frt15[ trainIndex,]
   Valid <- escape_frt15[-trainIndex,]
   
#Model   
model.FRT15<-glm(escape10 ~ climate1 + climate2 + FWI_veg + slope + rd_dst_ + infr_ds + fire_cs, family = binomial, data = dat1)
...
# create model table (only do this once) and add the relevant data
top_mod_table_FRT15 <- data.frame (matrix (ncol = 18, nrow = 0))
...
top_mod_table_FRT15[1,2]<-"escape ~ climate1 + climate2 + FWI_veg + slope + rd_dst_ + infr_ds + fire_cs" 
...
top_mod_table_FRT15[1,7]<- coef(model.FRT15)[5] #coefficient 
top_mod_table_FRT15[1,8]<- coef(model.FRT15)[6] #Intercept
top_mod_table_FRT15[1,9]<- coef(model.FRT15)[7] #
top_mod_table_FRT15[1,10]<- coef(model.FRT15)[8] #
top_mod_table_FRT15[1,11]<- coef(model.FRT15)[9] #coefficient 
top_mod_table_FRT15[1,12]<- coef(model.FRT15)[10] #coefficient 
top_mod_table_FRT15[1,13]<- coef(model.FRT15)[11] #Intercept
top_mod_table_FRT15[1,14]<- coef(model.FRT15)[12] #
top_mod_table_FRT15[1,15]<- coef(model.FRT15)[13] #
top_mod_table_FRT15[1,16]<- coef(model.FRT15)[14] #
top_mod_table_FRT15[1,17]<- coef(model.FRT15)[15] #
top_mod_table_FRT15[1,18]<- mod.auc
...
summary_top_mod_table_FRT15_ALL$Model_terms<-"climate1 + climate2 + FWI_veg + rd_dst + fire_cause" 
