...
hist(as.numeric(Escape_data_ALL$ig_mnth))
...
write.csv(AIC_all_escape_summary_VRI, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\escape_climate_veg_models.csv")
```
...
write.csv(AIC_all_escape_summary_VRI, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\escape_climate1_climate2_veg_models.csv")
```
...
write.csv(AIC_all_escape_summary_VRI, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\escape_infra_road_dist_models.csv")
```
...
write.csv(AIC_all_escape_summary_VRI, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\escape_topo_models.csv")
...
write.csv(AIC_all_escape_summary_VRI, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\escape_temp_precip_wind_models.csv")
...
model_ft5<-glm(escape10 ~ climate1 + FWI_veg + slope + elevatn + win_spg + log_road +log_infra, family = binomial, data = escape_frt5)

AIC(model_ft5) #878.2177
Anova(model_ft5, type=3)

model_ft5b<-glm(escape10 ~ climate1 + FWI_veg + slope + elevatn + log_road +log_infra, family = binomial, data = escape_frt5)

AIC(model_ft5b) #878.2177
Anova(model_ft5b, type=3)

model_ft5c<-glm(escape10 ~ climate1 + FWI_veg + elevatn + log_road +log_infra, family = binomial, data = escape_frt5)

AIC(model_ft5c) #878.2177
Anova(model_ft5c, type=3)

model_ft5d<-glm(escape10 ~ climate1 + FWI_veg + elevatn +log_infra, family = binomial, data = escape_frt5)

AIC(model_ft5d) #878.2177
...
escape_frt5<-escape_frt5 %>% drop_na(elevatn)
...
binnedplot (escape_frt5$log_infra, 
            escape_frt5$resids,  
            nclass = NULL)
...
#Model   
model.FRT5<-glm(escape10 ~ climate1 + FWI_veg + elevatn +log_infra, family = binomial, data = dat1) 
...
top_mod_table_FRT5[1,2]<-"escape ~ climate1 + FWI_veg + elevatn +log_infra" 
...
FRT5_summary_table_mean$Model_terms<-"escape ~ climate1 + FWI_veg + elevatn +log_infra"
...
escape_frt7$FWI_veg[escape_frt7$FWI_veg=="C-7"]<-"D-1/2"
escape_frt7$FWI_veg[escape_frt7$FWI_veg=="M-3"]<-"O-1a/b"
...
cor.test(escape_frt7$climate1, escape_frt7$elevatn)
cor.test(escape_frt7$climate1, escape_frt7$slope)
cor.test(escape_frt7$elevatn, escape_frt7$slope)
cor.test(escape_frt7$road_dist_m, escape_frt7$infr_dist)

escape_frt7$log_road<-log(escape_frt7$road_dist_m+1)
escape_frt7$log_infr<-log(escape_frt7$infr_dist+1)

#Run model using dat1
model_ft7<-glm(escape10 ~ climate1 + FWI_veg + slope + elevatn + log_road + log_infr + win_spg, family = binomial, data = escape_frt7)

AIC(model_ft7) #1048.448
Anova(model_ft7, type=3) 

model_ft7b<-glm(escape10 ~ climate1 + FWI_veg + slope + elevatn + log_road + log_infr, family = binomial, data = escape_frt7)

AIC(model_ft7b) #1046.536
Anova(model_ft7b, type=3) 

model_ft7c<-glm(escape10 ~ climate1 + FWI_veg + slope + log_road + log_infr, family = binomial, data = escape_frt7)

AIC(model_ft7c) #1044.926
Anova(model_ft7c, type=3) 

model_ft7d<-glm(escape10 ~ climate1 + FWI_veg + log_road + log_infr, family = binomial, data = escape_frt7)

AIC(model_ft7d) #1040.529
Anova(model_ft7d, type=3) 

model_ft7e<-glm(escape10 ~ climate1 + FWI_veg + log_infr, family = binomial, data = escape_frt7)

AIC(model_ft7e) #1039.672
Anova(model_ft7e, type=3) 

model_ft7f<-glm(escape10 ~ climate1 + log_infr, family = binomial, data = escape_frt7)

AIC(model_ft7f) #1039.672
...
### TOP MODEL
#######################
model_ft7g<-glm(escape10 ~ climate1 + log_infr, family = binomial, data = escape_frt7)

hist(escape_frt7$climate1)
hist(escape_frt7$log_infr)

table(is.na(escape_frt7$climate1))
table(is.na(escape_frt7$log_infr))
```
...
binnedplot (escape_frt7$log_infr, 
            escape_frt7$resids,  
            nclass = NULL)
...
#Create a new blank table and get AUC too
top_mod_table_FRT7_ALL <- data.frame (matrix (ncol = 6, nrow = 0))
...
#Model   
model.FRT7<-glm(escape10 ~ climate1 + log_infr, family = binomial, data = dat1) 
...
# create model table (only do this once) and add the relevant data
top_mod_table_FRT5 <- data.frame (matrix (ncol = 6, nrow = 0))
colnames (top_mod_table_FRT5 ) <- c ("FRT", "Model_terms", "intercept",
                                         "coef_climate_1",
                                         "coef_log_infra",
                                         "AUC")
...
top_mod_table_FRT5[1,2]<-"escape ~ climate1 + log_infra" 
...
top_mod_table_FRT5[1,6]<- mod.auc
...
summary_top_mod_table_FRT7_ALL$Model_terms<-"escape ~ climate1 + log_infra" 
...
escape_frt9$FWI_veg[escape_frt9$FWI_veg=="M-3"]<-"O-1a/b"
...
table(is.na(escape_frt9$road_dist_m))
table(is.na(escape_frt9$slope))

cor.test(escape_frt9$road_dist_m, escape_frt9$infr_dist)
cor.test(escape_frt9$climate1, escape_frt9$climate2)
cor.test(escape_frt9$climate1, escape_frt9$elevatn) # these are correlated!
cor.test(escape_frt9$elevatn, escape_frt9$slope)
cor.test(escape_frt9$win_sum, escape_frt9$win_spg) # very correlated

escape_frt9$log_road<-log(escape_frt9$road_dist_m+1)
escape_frt9$log_infr<- log(escape_frt9$infr_dist+1)

#Run model using dat1
model_ft9<-glm(escape10 ~ climate1 + FWI_veg  + slope + elevatn + win_sum + log_road, family = binomial, data = escape_frt9)

AIC(model_ft9)  #163
Anova(model_ft9, type=3)

model_ft9b<-glm(escape10 ~ climate1  + slope + elevatn + win_sum + log_road, family = binomial, data = escape_frt9)

AIC(model_ft9b) #153
Anova(model_ft9b, type=3)


model_ft9c<-glm(escape10 ~ climate1  + slope + win_sum + log_road, family = binomial, data = escape_frt9)

AIC(model_ft9c) #151
Anova(model_ft9c, type=3)

model_ft9d<-glm(escape10 ~ climate1  + slope + log_road, family = binomial, data = escape_frt9)

AIC(model_ft9d) #149
Anova(model_ft9d, type=3)

model_ft9e<-glm(escape10 ~ climate1 + log_road, family = binomial, data = escape_frt9)
...
#Model   
model.FRT9<-glm(escape10 ~ climate1 + log_road, family = binomial, data = dat1) 
...
escape_frt11_2<- escape_frt11 %>% filter(FWI_veg!="N")
table(escape_frt11_2$FWI_veg)

table(is.na(escape_frt11_2$climate1))
table(is.na(escape_frt11_2$elevatn))
table(is.na(escape_frt11_2$FWI_veg))
table(is.na(escape_frt11_2$win_sum))
table(is.na(escape_frt11_2$road_dist_m))
table(is.na(escape_frt11_2$slope))

cor.test(escape_frt11_2$road_dist_m, escape_frt11_2$infr_dist)
cor.test(escape_frt11_2$climate1, escape_frt11_2$elevatn) # elevation and climate are correlated 0.71
cor.test(escape_frt11_2$elevatn, escape_frt11_2$slope)
cor.test(escape_frt11_2$elevatn, escape_frt11_2$win_sum)

escape_frt11_2$log_road<-log(escape_frt11_2$road_dist_m+1)
escape_frt11_2$log_infr<- log(escape_frt11_2$infr_dist+1)


#Run model using dat1
model_ft11<-glm(escape10 ~ climate1 + FWI_veg  + slope + elevatn + log_road +log_infr + win_sum, family = binomial, data = escape_frt11_2)

model_ft11b<-glm(escape10 ~ climate1 + FWI_veg  + slope + log_road +log_infr + win_sum, family = binomial, data = escape_frt11_2)

model_ft11c<-glm(escape10 ~ FWI_veg  + slope + elevatn + log_road +log_infr + win_sum, family = binomial, data = escape_frt11_2)

# Phew the best model is the one that includes climate1 and throws out elevation :) Proceed with model_ft11b
...
model_ft11c<-glm(escape10 ~ climate1 + FWI_veg + log_road +log_infr + win_sum, family = binomial, data = escape_frt11_2)

AIC(model_ft11c) #256
Anova(model_ft11c, type=3)

model_ft11d<-glm(escape10 ~ climate1 + FWI_veg + log_road +log_infr, family = binomial, data = escape_frt11_2)

AIC(model_ft11d) #255
Anova(model_ft11d, type=3)

model_ft11e<-glm(escape10 ~ climate1 + log_road +log_infr, family = binomial, data = escape_frt11_2)
...
hist(escape_frt11_2$climate1)
hist(escape_frt11_2$slope)
hist(log(escape_frt11_2$road_dist_m+1))
hist(escape_frt11_2$infr_dist)

table(escape_frt11_2$escape10) #0 = 948 and 1 = 267 not bad actually.
...
escape_frt11_2$resids<-resid(model_ft11e)

binnedplot (escape_frt11_2$climate1, 
            escape_frt11_2$resids,  
            nclass = NULL)

binnedplot (escape_frt11_2$log_road, 
            escape_frt11_2$resids,  
            nclass = NULL)

binnedplot (escape_frt11_2$log_infr, 
            escape_frt11_2$resids,  
            nclass = NULL)

binnedplot (log(escape_frt11$road_dist_m+1), 
            escape_frt11$resids,  
            nclass = NULL)
...
#Create a new blank table and get AUC too
top_mod_table_FRT11_ALL <- data.frame (matrix (ncol = 7, nrow = 0))
...
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(escape_frt11_2$escape10, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- escape_frt11_2[ trainIndex,]
   Valid <- escape_frt11_2[-trainIndex,]
   
#Model   
model.FRT11<-glm(escape10 ~ climate1 + log_road + log_infr, family = binomial, data = dat1)
...
# create model table (only do this once) and add the relevant data
top_mod_table_FRT11 <- data.frame (matrix (ncol = 7, nrow = 0))
...
top_mod_table_FRT11[1,2]<-"escape ~ climate1 + log_road + log_infr" 
...
top_mod_table_FRT11[1,7]<- mod.auc
...
summary_top_mod_table_FRT11_ALL$Model_terms<-"escape ~ climate1 + log_road + log_infr" 
