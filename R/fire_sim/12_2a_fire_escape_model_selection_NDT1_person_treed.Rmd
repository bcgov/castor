...
```{r}
escape_person_t_NDT1<-subset(Escape_data_person_t, Escape_data_person_t$ntrl_ds=="NDT1")
...
#Run model using dat1
model.NDT1.E<-glm(escape ~  + elevation*climate1 + wind_atfire*climate1 + wind_atfire*vegtype2 + Tdif_atfire*climate1  + Tdif_atfire*wind_atfire + , family = binomial, data = dat1)
