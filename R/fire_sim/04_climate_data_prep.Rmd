...
for (i in 1: length(y1)){
  ...
  for (j in 1 : length(Lf)) {
    ...
    x2$MDC_02<-15 # the MDC value for April. This assumes that the ground is saturated at the start of the season. Maybe not true for all locations... may need to think about this a little more.
