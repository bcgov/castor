...
##2022
inputFile = '/C:\\Work\\caribou\\castor\\R\\fire_sim\\tmp\\sampled.points.all.frt.2022.csv' 
outputFile = '/C:\\Work\\caribou\\castor\\R\\fire_sim\\tmp\\output\\samp_points_2022.csv'
...
for (i in 1: length(y1)){
  ...
  x<-eval(as.name(y1[i])) %>% 
    rename(YEAR=ID2) %>%
    dplyr::select(ID1, YEAR,Latitude, Longitude, Tmax02:Tmax11, Tave02:Tave11, PPT02:PPT11, RH02:RH11, CMI02:CMI11,CMD02: CMD11, Tmin02:Tmin11)
