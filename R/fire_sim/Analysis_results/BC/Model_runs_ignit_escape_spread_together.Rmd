...
```{r}
dat<-st_read( "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\BC_all_dat_400m_final_2001.gpkg")
...
frt5$veg_M12 <- ifelse(frt5$FWI_veg == 'M-1/2', 1, frt5$veg_M12) # change S-1 to M-1/2
frt5$veg_C7 <- ifelse(frt5$FWI_veg == 'S-2', 1, frt5$veg_C7)

model_coef_table_lightning<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt5_lightning.csv")
...
model_coef_table_person<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_FRT5_person.csv")
...
model_coef_table_escape<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt5_escape.csv")
...
logit_P_escape<- model_coef_table_escape[[2]] + 
  ...
  model_coef_table_escape[[10]]*log(frt5$dist_infrastructure_m+1)
...
model_coef_table_spread<-read.csv("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\top_mod_table_frt5_spread.csv")
...
frt7$veg_M12 <- ifelse(frt7$FWI_veg == 'C-7', 1, frt7$veg_M1)

model_coef_table_lightning<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt7_lightning.csv")
...
model_coef_table_person<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_FRT7_person.csv")
...
model_coef_table_escape<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt7_escape.csv")
...
logit_P_escape<- model_coef_table_escape[[2]] + 
  ...
  model_coef_table_escape[[4]]*log(frt7$dist_infrastructure_m +1) 
...
model_coef_table_spread<-read.csv("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\top_mod_table_frt7_spread.csv")
...
model_coef_table_lightning<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt9_lightning.csv")
model_coef_table_lightning
# put coefficients into model formula
#logit(p) = b0+b1X1+b2X2+b3X3….+bkXk
logit_P_lightning<- model_coef_table_lightning[[2]] + 
...
model_coef_table_person<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt9_person.csv")
model_coef_table_person
...
model_coef_table_escape<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt9_escape.csv")
...
logit_P_escape<- model_coef_table_escape[[2]] +
  ...
  model_coef_table_escape[[4]]*(log(frt9$dist_roads_m+1))
...
model_coef_table_spread<-read.csv("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\top_mod_table_frt9_spread.csv")
...
model_coef_table_lightning<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_FRT10_lightning.csv")
...
model_coef_table_escape<-read.csv("D:\\Fire\\fire_data\\raw_data\\top_mod_table_frt10_escape.csv")
...
logit_P_escape<- model_coef_table_escape[[2]] + 
  ...
  model_coef_table_escape[[4]]*frt10$climate2_escape +
  model_coef_table_escape[[5]]*log(frt10$dist_roads_m+1) +
  model_coef_table_escape[[6]]*frt10$dist_infrastructure_m 
...
model_coef_table_spread<-read.csv("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\top_mod_table_frt10_spread.csv")
...
#logit(p) = b0+b1X1+b2X2+b3X3….+bkXk
logit_P_escape<- model_coef_table[[2]] +
  model_coef_table[[3]]*frt12$climate1_escape +
  model_coef_table[[4]]*frt12$veg_C2 +
  model_coef_table[[5]]*frt12$veg_C3 +
  ...
  model_coef_table[[15]]*log(frt12$dist_roads_m+1) +
  model_coef_table[[16]]*log(frt12$dist_infrastructure_m+1)
...
logit_P_escape<- model_coef_table[[2]] + 
  ...
  model_coef_table[[14]]*frt13$el +
  model_coef_table[[15]]*frt13$win_sum +
  model_coef_table[[16]]*log(frt13$dist_roads_m+1) +
  model_coef_table[[17]]*log(frt13$dist_infrastructure_m+1) 
...
frt13$veg_C2 <- ifelse(frt13$FWI_veg == 'C-4', 1, frt13$veg_C2)
frt13$veg_C7 <- ifelse(frt13$FWI_veg == 'S-2', 1, frt13$veg_C7)
frt13$veg_M12 <- ifelse(frt13$FWI_veg == 'S-3', 1, frt13$veg_M12)
...
logit_P_spread<- model_coef_table[[2]] + 
  ...
  model_coef_table[[4]]*frt14$climate2_spread +
  model_coef_table[[5]]*frt14$el +
  ...
  model_coef_table[[18]]*log(frt14$dist_roads_m+1) +
  model_coef_table[[19]]*log(frt14$dist_infrastructure_m+1) +
...
# save it!
```{r}
st_write(frt_all2, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\BC_ignit_escape_spread_final_2001.gpkg", delete_layer=TRUE, driver="GPKG")
```
