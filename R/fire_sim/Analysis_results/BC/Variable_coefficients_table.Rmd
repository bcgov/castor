...
```{r}
clim2021<-read.csv("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\BC\\bc_dem_frt_clim_2021.csv")
...
###################################################
clim<-clim %>% select(ID1, ID2, mean_Tave05_Tave06_Tave07_Tave08,
                      meanRH05_RH06_RH07,
                      Tmax05,
                      Tave07,
