...
save the data
```{r}
st_write(frt_all2, "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\fisher_study_area_lighting_ignit_final.gpkg", delete_layer=TRUE, driver="GPKG")
...
writeRaster(z, file=" C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\Lightning_ignition_probability_2021.tif", format="GTiff", overwrite=TRUE)
