...
str(rasValue3)
names(rasValue3)
dim(rasValue3)# 200292 values

#Append new information
 dat2<-cbind(dat_person, rasValue3)
...
```{r}
sf::st_write(dat2, dsn = "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\fisher_study_area_person_dat.gpkg", delete_layer=TRUE)
...
st_write(frt_all, "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\Prob_ignit_person.gpkg", delete_layer=TRUE, driver="GPKG")
```
