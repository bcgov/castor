...
```{r}
sf::st_write(dat2, dsn = "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\fisher_study_area_person_dat.gpkg", delete_layer=TRUE)
...
st_write(frt_all, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Skeena_Omineca_Thompson_Okanagan\\Prob_ignit_person.gpkg", delete_layer=TRUE, driver="GPKG")
```
