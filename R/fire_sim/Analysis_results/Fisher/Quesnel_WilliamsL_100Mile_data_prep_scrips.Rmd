...
# CHANGE VARIABLES FOR LIGHTNING CAUSED AFTER RE_RUN!!!
...
x4_clim_dem_2<- x4_clim_dem %>% dplyr::select(ID1, ID2, Latitude, Longitude, Elevation, Tmax01: PPT12, mean_Tave07_Tave08_Tave09:RH05_RH06_RH07) %>%
  rename(idno=ID1,
         frt=ID2)
