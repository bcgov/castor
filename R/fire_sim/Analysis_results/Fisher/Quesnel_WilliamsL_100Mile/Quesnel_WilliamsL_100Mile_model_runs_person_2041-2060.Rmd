...
st_write(frt_all, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Probability_of_person_Ignition_Quesnell_WilliamsL_100Mile_allFRT_800m_future2050.gpkg", delete_layer=TRUE, driver="GPKG")
```
...
writeRaster(maxint, file=" C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Probability_of_Person_Ignition_Quesnell_WilliamsL_100Mile_allFRT_800m_future2050.tif", format="GTiff", overwrite=TRUE)
```


```{r}
person.ignit<-raster(" C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Probability_of_Person_Ignition_Quesnell_WilliamsL_100Mile_allFRT_800m_future2050.tif")

lightning.ignit<-raster(" C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Probability_of_lightning_Ignition_Quesnell_WilliamsL_100Mile_allFRT_800m_2050.tif")
...
writeRaster(total.ignit, file=" C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\prob_of_lightning_and_person_ignition_2050.tif", format="GTiff", overwrite=TRUE)
