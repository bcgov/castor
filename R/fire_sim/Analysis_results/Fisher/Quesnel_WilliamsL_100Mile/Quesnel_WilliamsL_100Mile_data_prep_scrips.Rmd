...
# 
# 
# st_write(x_frt10, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_frt10.gpkg", delete_layer=TRUE, driver="GPKG")
# 
# st_write(x_frt12, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_frt12.gpkg", delete_layer=TRUE, driver="GPKG")
# 
# st_write(x_frt13, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_frt13.gpkg", delete_layer=TRUE, driver="GPKG")
# 
# st_write(x_frt14, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_frt14.gpkg", delete_layer=TRUE, driver="GPKG")
# 
# st_write(x_frt15, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_frt15.gpkg", delete_layer=TRUE, driver="GPKG")
# 
# 
...
st_write(my.sf.point, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile.gpkg", delete_layer=TRUE, driver="GPKG")
...
```{r}
dat<- st_read("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Quesnel_WilliamsLake_100Mile_buffered_400_joinedVRI2021.gpkg")
...
st_write(fire_all1, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\Fire_data_all_Quesnell_WilliamsL_100Mile_FRT_800m.gpkg", delete_layer=TRUE, driver="GPKG")
```
