...
##################################
# create escape rasters for 2022
##################################
```{r}
...
#     filter(FIRE_TYPE == "Fire") %>%
#     collect()
# ) # I did not end up doing this but I was considering extracting 2021 and 2020 data as well as 2022 data and running the test on all that data together. i was considering doing this because my sample sizes for spread for 2022 are quite low particularly in some frt's.
