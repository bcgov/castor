...
```{r}
fire_ignitions<-st_read("C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Fire_data_all_veg2.gpkg")
...
fire_ignitions<-st_set_geometry(fire.ignt.NDT,NULL) # remove geometry column for dataset
...
```{r}
#Write file
write.csv(dat_lightning, "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\dat_lightning_for_analysis.csv")

#st_write(dat_lightning, dsn = "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\dat_lightning_for_analysis.csv", delete_layer=TRUE)
...
```{r}
write.csv(aic_bec_lightning_summary2, file="C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\climate_AIC_results_lightning_FRT.csv")
```
...
```{r}
#Write file
write.csv(dat_human, "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\dat_human_for_analysis.csv")
...
```{r}
write.csv(aic_bec_person_summary2, file="C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\climate_AIC_results_person_FRT.csv")
