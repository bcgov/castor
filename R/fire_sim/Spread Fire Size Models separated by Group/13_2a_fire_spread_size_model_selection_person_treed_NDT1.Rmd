---
title: "13_2a_fire_spread_size_model_selection_person_treed_NDT1"
author: "Cora Skaien"
date: "06/12/2021"
...
#=================================
#  Script Name: 13_2a_fire_spread_size_model_selection_person_treed_NDT1.R
#  Script Version: 1.0
...
for (h in 1:length(zones1)) {
  dat2<- subset(spread_data_person_t, spread_data_person_t$ntrl_ds=="NDT1")
...
AIC_person_NDT1_spread_treed_climate<-table.glm.climate.simple.spread

AIC_person_NDT1_spread_treed_summary_climate<- AIC_person_NDT1_spread_treed_climate %>%
  group_by(model) %>%
...
AIC_person_NDT1_spread_treed_summary_climate2<- AIC_person_NDT1_spread_treed_summary_climate %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_spread_treed_summary_climate2)
```
...
AIC_person_NDT1_spread_treed_climate_gamma<-table.glm.climate.simple.spread.gamma

AIC_person_NDT1_spread_treed_summary_climate_gamma<- AIC_person_NDT1_spread_treed_climate_gamma %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            sdR2=sd(Model.R2, na.rm=TRUE),
...
AIC_person_NDT1_spread_treed_summary_climate_gamma2<- AIC_person_NDT1_spread_treed_summary_climate_gamma %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_spread_treed_summary_climate_gamma2)
```
...
AIC_person_NDT1_spread_treed_VRI<-table.glm.VRI.simple.spread

AIC_person_NDT1_spread_treed_summary_VRI<- AIC_person_NDT1_spread_treed_VRI %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_person_NDT1_spread_treed_summary_VRI2<- AIC_person_NDT1_spread_treed_summary_VRI %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_spread_treed_summary_VRI2)
```
...
AIC_person_NDT1_spread_treed_topo<-table.glm.topo.simple.spread

AIC_person_NDT1_spread_treed_summary_topo<- AIC_person_NDT1_spread_treed_topo %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_person_NDT1_spread_treed_summary_topo2<- AIC_person_NDT1_spread_treed_summary_topo %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_spread_treed_summary_topo2)
```
...
AIC_person_NDT1_spread_treed_infra<-table.glm.infra.simple.spread

AIC_person_NDT1_spread_treed_summary_infra<- AIC_person_NDT1_spread_treed_infra %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic, na.rm=TRUE),
            meanR2=mean(Model.R2, na.rm=TRUE),
            meanAdjustR2=mean(Adjusted.R2, na.rm=TRUE),
...
AIC_person_NDT1_spread_treed_summary_infra2<- AIC_person_NDT1_spread_treed_summary_infra %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_spread_treed_summary_infra2)
```

Combine together
```{r}
NDT1_l_treed_spread<-rbind(AIC_person_NDT1_spread_treed_summary_climate2, AIC_person_NDT1_spread_treed_summary_infra2, AIC_person_NDT1_spread_treed_summary_topo2, AIC_person_NDT1_spread_treed_summary_VRI2)
...
Save data.
```{r}
write.csv(NDT1_l_treed_spread, file="D:\\Fire\\fire_data\\raw_data\\NDT1_person_models_treed_spread_Nov.csv")
```
...
```{r}
spread_person_t_NDT1<-subset(spread_data_person_t, spread_data_person_t$ntrl_ds=="NDT1") #100 observations

prop<-0.75

#Partition data into training and validation
 trainIndex <- createDataPartition(spread_person_t_NDT1$vegtype2, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- spread_person_t_NDT1[ trainIndex,]
   Valid <- spread_person_t_NDT1[-trainIndex,]
  
#Run model using dat1
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun  + slope + climate1 + climate2 + climate1:climate2 + wind_atfire + climate1:proj_height_1 + climate1:proj_age_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope:wind_atfire + elevation:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT1) #218.4
summary(model.NDT1)$r.squared #0.51
summary(model.NDT1)$adj.r.squared #0.29
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun  + slope + climate1 + climate2 + climate1:climate2 + wind_atfire + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT1) #214.6
summary(model.NDT1)$r.squared #0.51
summary(model.NDT1)$adj.r.squared #0.32
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire  + climate1:live_stand_volume_125 + climate1:elevation  + slope:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT1) #213.1
summary(model.NDT1)$r.squared #0.50
summary(model.NDT1)$adj.r.squared #0.33

predictions <- model.NDT1 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.07
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.05
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire  + climate1:live_stand_volume_125 + slope:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT1) #211.1
summary(model.NDT1)$r.squared #0.50
summary(model.NDT1)$adj.r.squared #0.34
...
#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire  + climate1:live_stand_volume_125 + slope:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT1) #210.2
summary(model.NDT1)$r.squared #0.49
summary(model.NDT1)$adj.r.squared #0.34

predictions <- model.NDT1 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.96
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.69

summary(model.NDT1)
Anova(model.NDT1, type=3)

#Remove least sig
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + vegtype2+ wind_atfire  + climate1:live_stand_volume_125 + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT1) #208.4
summary(model.NDT1)$r.squared #0.49
summary(model.NDT1)$adj.r.squared #0.35

predictions <- model.NDT1 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.07
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.98
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.71

summary(model.NDT1)
Anova(model.NDT1, type=3)

#Missing vegtype2 in non-interaction form
model.NDT1<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + vegtype2+ wind_atfire  + climate1:live_stand_volume_125 + slope:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1)

AIC(model.NDT1) #210.4
summary(model.NDT1)$r.squared #0.49
summary(model.NDT1)$adj.r.squared #0.34
...
AIC(model.NDT1) #210.4
summary(model.NDT1)$r.squared #0.48
summary(model.NDT1)$adj.r.squared #0.33

predictions <- model.NDT1 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.90
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #1.67
...
NDT1_spread_size_t<-spread_person_t_NDT1 %>% drop_na(proj_age_1 , live_stand_volume_125, slope , elevation , climate1 , climate2 , vegtype2, wind_atfire, Tdif_atfire) #87 observations.. be aware of potential over-fitting

#Run Model again with this data; but uses all data here
model.NDT1.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + vegtype2+ wind_atfire  + climate1:live_stand_volume_125 + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)

summary(model.NDT1.Spread)$r.squared #0.24
summary(model.NDT1.Spread)$adj.r.squared #0.09

#Because of small sample size, review and potentially reduce interactions and terms
AIC(model.NDT1.Spread) #305.6

model.NDT1.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + vegtype2+ wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
AIC(model.NDT1.Spread) #304.8
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)
summary(model.NDT1.Spread)$r.squared #0.23
summary(model.NDT1.Spread)$adj.r.squared #0.09

model.NDT1.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
AIC(model.NDT1.Spread) #302.6
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)
summary(model.NDT1.Spread)$r.squared #0.22
summary(model.NDT1.Spread)$adj.r.squared #0.10

model.NDT1.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
AIC(model.NDT1.Spread) #301.8
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)
summary(model.NDT1.Spread)$r.squared #0.20
summary(model.NDT1.Spread)$adj.r.squared #0.10

model.NDT1.Spread<-lm(LNsize_ha ~ live_stand_volume_125  + slope + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
AIC(model.NDT1.Spread) #300.8
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)
summary(model.NDT1.Spread)$r.squared #0.20
summary(model.NDT1.Spread)$adj.r.squared #0.10

model.NDT1.Spread<-lm(LNsize_ha ~ slope + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = NDT1_spread_size_t)

#Anova(model.NDT1.Spread, type=3)
AIC(model.NDT1.Spread) #299.8
Anova(model.NDT1.Spread, type=3, singular.ok = TRUE)

summary(model.NDT1.Spread)$r.squared #0.19
summary(model.NDT1.Spread)$adj.r.squared #0.10
...
#Remove NAs to ensure all same data used so we can compare AICs
NDT1_spread_size_t<-spread_person_t_NDT1 %>% drop_na(proj_age_1 , live_stand_volume_125, slope , elevation , climate1 , climate2, wind_atfire, Tdif_atfire) #87 observations.. be aware of potential over-fitting
...
#Partial Residuals
#LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire
visreg(model.NDT1.Spread, "proj_age_1")
visreg(model.NDT1.Spread, "live_stand_volume_125")

visreg(model.NDT1.Spread, "slope", by="wind_atfire")
visreg(model.NDT1.Spread, "elevation")


visreg(model.NDT1.Spread, "climate1", by="climate2")
visreg(model.NDT1.Spread, "climate2", by="climate1")

visreg(model.NDT1.Spread, "wind_atfire", by="slope")
visreg(model.NDT1.Spread, "wind_atfire", by="Tdif_atfire")
visreg(model.NDT1.Spread, "Tdif_atfire", by="wind_atfire")
...
#Model   
model.NDT1.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire, data = dat1) 
...
top_mod_table_NDT1_person_t[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire" 
top_mod_table_NDT1_person_t[1,5]<- coef(model.NDT1.Spread)[1] #Intercept
top_mod_table_NDT1_person_t[1,6]<- coef(model.NDT1.Spread)[2] #C
top_mod_table_NDT1_person_t[1,7]<- coef(model.NDT1.Spread)[3] #C
top_mod_table_NDT1_person_t[1,8]<- coef(model.NDT1.Spread)[4] #co
top_mod_table_NDT1_person_t[1,9]<- coef(model.NDT1.Spread)[5] #co
top_mod_table_NDT1_person_t[1,10]<- coef(model.NDT1.Spread)[6] #c
top_mod_table_NDT1_person_t[1,11]<- coef(model.NDT1.Spread)[7] #l
top_mod_table_NDT1_person_t[1,12]<- coef(model.NDT1.Spread)[8] #co
top_mod_table_NDT1_person_t[1,13]<- coef(model.NDT1.Spread)[9] #c
top_mod_table_NDT1_person_t[1,14]<- coef(model.NDT1.Spread)[10] #coeff
top_mod_table_NDT1_person_t[1,15]<- coef(model.NDT1.Spread)[11] #co
top_mod_table_NDT1_person_t[1,16]<- coef(model.NDT1.Spread)[12] #coe
top_mod_table_NDT1_person_t[1,17]<- AIC(model.NDT1.Spread)
top_mod_table_NDT1_person_t[1,18]<- summary(model.NDT1.Spread)$r.squared
top_mod_table_NDT1_person_t[1,19]<- R2(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT1_person_t[1,20]<- RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT1_person_t[1,21]<- MAE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT1_person_t[1,22]<- summary(model.NDT1.Spread)$adj.r.squared
...
```{r}
write.csv(top_mod_table_NDT1_person_t_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT1.Spread_firesize_person_t.csv")
```
...
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means<-top_mod_table_NDT1_person_t_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means

top_mod_table_NDT1_model.NDT1.Spreadperson_t_means[1,1]<-"person"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means[1,2]<-"NDT1"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means[1,3]<-"Treed"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means[1,4]<- "LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire" 
top_mod_table_NDT1_model.NDT1.Spreadperson_t_means
```
Save table.

```{r}
write.csv(top_mod_table_NDT1_model.NDT1.Spreadperson_t_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT1.Spread_firesize_person_t_Means.csv")
```

Standard deviation.

```{r}
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd<-top_mod_table_NDT1_person_t_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd

top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd[1,1]<-"person"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd[1,2]<-"NDT1"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd[1,3]<-"Treed"
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125  + slope + elevation + climate1 + climate2 + climate1:climate2 + wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire" 
top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd
```
...
```{r}
write.csv(top_mod_table_NDT1_model.NDT1.Spreadperson_t_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_model.NDT1.Spread_firesize_person_t_SD.csv")
```
