...
2. dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km
3. slope + aspect + elevation + slope:elevation
4. climate1 + vegtype2
...
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + slope:elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:proj_age_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope:wind_atfire + elevation:wind_atfire + vegtype2:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT3) #3464.3
summary(model.NDT3)$r.squared #0.18
summary(model.NDT3)$adj.r.squared #0.14

predictions <- model.NDT3 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.05
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.75
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.25
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + slope:elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:proj_age_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:wind_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT3) #3457.1
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.14

predictions <- model.NDT3 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.73
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.24
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + slope:elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:proj_age_1 + climate1:live_stand_volume_125 + climate1:elevation + climate1:wind_atfire + slope:wind_atfire + Tdif_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT3) #3455.2
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15

predictions <- model.NDT3 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.74
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.25
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:live_stand_volume_125 + climate1:elevation  + slope:wind_atfire + Tdif_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT3) #3450.2
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire + Tdif_atfire + Tdif_atfire:live_stand_volume_125, data = dat1)

AIC(model.NDT3) #3448.7
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + dist_nat:roads_km + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire + Tdif_atfire, data = dat1)

AIC(model.NDT3) #3447.8
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15

predictions <- model.NDT3 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.71
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.23
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire + Tdif_atfire, data = dat1)

AIC(model.NDT3) #3447.2
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + roads_km + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire, data = dat1)

AIC(model.NDT3) #3446.6
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15

predictions <- model.NDT3 %>% predict(Valid)
R2(predictions, Valid$LNsize_ha, na.rm=TRUE) #0.06
RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.72
MAE(predictions, Valid$LNsize_ha, na.rm=TRUE) #2.23
...
#Remove least sig
model.NDT3<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire, data = dat1)

AIC(model.NDT3) #3444.8
summary(model.NDT3)$r.squared #0.17
summary(model.NDT3)$adj.r.squared #0.15
...
NDT3_spread_size_t<-spread_lightning_t_NDT3 %>% drop_na(proj_age_1, live_stand_volume_125 , dist_mun, dist_dam , dist_nat, slope , aspect , climate1, vegtype2, wind_atfire, elevation)

#Run Model again with this data; but uses all data here
model.NDT3.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation  + slope:wind_atfire, data = NDT3_spread_size_t)

AIC(model.NDT3.Spread) #4581.9

#Anova(model.NDT3.Spread, type=3)
Anova(model.NDT3.Spread, type=3, singular.ok = TRUE)

#Compare to without wind_at_fire:slope
model.NDT3.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + dist_mun + dist_dam + dist_nat + slope + aspect + elevation + climate1 + vegtype2 + wind_atfire + climate1:proj_height_1 + climate1:elevation, data = NDT3_spread_size_t)

AIC(model.NDT3.Spread) #4580.5

Anova(model.NDT3.Spread, type=3, singular.ok = TRUE)

#Compare to without wind_at_fire:slope
model.NDT3.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:proj_height_1 + climate1:elevation, data = NDT3_spread_size_t)

AIC(model.NDT3.Spread) #4578.6

Anova(model.NDT3.Spread, type=3, singular.ok = TRUE)

#Compare to without wind_at_fire:slope
model.NDT3.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation, data = NDT3_spread_size_t)

AIC(model.NDT3.Spread) #4576.6
...
#Partial Residuals
#proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation
visreg(model.NDT3.Spread, "proj_age_1")
visreg(model.NDT3.Spread, "live_stand_volume_125")
visreg(model.NDT3.Spread, "proj_height_1")

visreg(model.NDT3.Spread, "dist_mun")
visreg(model.NDT3.Spread, "dist_dam")
visreg(model.NDT3.Spread, "dist_nat")

visreg(model.NDT3.Spread, "aspect")
visreg(model.NDT3.Spread, "elevation", by="climate1")

visreg(model.NDT3.Spread, "climate1", by="elevation")
...
top_mod_table_NDT3_lightning_t_ALL <- data.frame (matrix (ncol = 24, nrow = 0))
colnames (top_mod_table_NDT3_lightning_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_proj_age_1", "coef_live_stand_volume_125", "coef_proj_height_1", "coef_dist_mun", "coef_dist_dam", "coef_dist_nat", "coef_aspect", "coef_elevation", "coef_climate_1", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_elevation:climate1", "AIC", "Model.R2", "Valid.R2", "Valid.RSME", "Valid.MAE", "Adjusted.R2")
...
#Model   
model.NDT3.Spread<-lm(LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation, data = dat1) 

predictions <- model.NDT3.Spread %>% predict(Valid)

# create model table (only do this once) and add the relevant data
top_mod_table_NDT3_lightning_t <- data.frame (matrix (ncol = 24, nrow = 0))
...
top_mod_table_NDT3_lightning_t[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation" 
...
top_mod_table_NDT3_lightning_t[1,19]<- AIC(model.NDT3.Spread)
top_mod_table_NDT3_lightning_t[1,20]<- summary(model.NDT3.Spread)$r.squared
top_mod_table_NDT3_lightning_t[1,21]<- R2(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT3_lightning_t[1,22]<- RMSE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT3_lightning_t[1,23]<- MAE(predictions, Valid$LNsize_ha, na.rm=TRUE)
top_mod_table_NDT3_lightning_t[1,24]<- summary(model.NDT3.Spread)$adj.r.squared
...
top_mod_table_NDT3_model.NDT3.Spreadlightning_t_means[1,4]<- "LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation" 
top_mod_table_NDT3_model.NDT3.Spreadlightning_t_means
```
Save table.
...
top_mod_table_NDT3_model.NDT3.Spreadlightning_t_sd[1,4]<-"LNsize_ha ~ proj_age_1 + live_stand_volume_125 + proj_height_1  + dist_mun + dist_dam + dist_nat  + aspect + elevation + climate1 + vegtype2 + climate1:elevation" 
top_mod_table_NDT3_model.NDT3.Spreadlightning_t_sd
```
