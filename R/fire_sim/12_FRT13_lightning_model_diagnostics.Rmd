...
top_mod_table_FRT12_lightningALL <- data.frame (matrix (ncol = 18, nrow = 0))
colnames (top_mod_table_FRT12_lightningALL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_climate2", "coef_FWI_veg_C-3",  "coef_FWI_veg_C-5",  "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_N", "coef_FWI_veg_O-1a/b", "coef_FWI_veg_S-1", "coef_FWI_veg_S-2",  "coef_FWI_veg_S-3","coef_elevatn", "AUC")
...
top_mod_table_FRT12_lightningL <- data.frame (matrix (ncol = 18, nrow = 0))
colnames (top_mod_table_FRT12_lightningL ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_climate2", "coef_FWI_veg_C-3",  "coef_FWI_veg_C-5",  "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_N", "coef_FWI_veg_O-1a/b", "coef_FWI_veg_S-1", "coef_FWI_veg_S-2",  "coef_FWI_veg_S-3","coef_elevatn", "AUC")

##Add data for NDT1
top_mod_table_FRT12_lightningL[1,1]<-"lightning"
top_mod_table_FRT12_lightningL[1,2]<-"FRT13"
...
top_mod_table_FRT12_lightningL[1,18]<- mod.auc
...
FRT12_summary_table_mean$FRT<-13
FRT12_summary_table_mean$Model_terms<-"fire ~ climate1 + climate2 + FWI_veg + elevatn"
...
```{r}
write.csv(top_mod_table_FRT13_lightning, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT1_light_t_Means.csv")
```
