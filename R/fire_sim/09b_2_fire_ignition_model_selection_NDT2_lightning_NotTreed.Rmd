...
#Repeat process with reduced/combined variables
...
#Run model using dat1
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra + climate1:elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #703.7
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #702.0
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra, family = binomial, data = dat1)

AIC(model.NDT2) #700.3
...
```{r}
#Remove NAs to ensure all same data used so we can compare AIC_nts
NDT2_nt<-dat_lightning_nt_NDT2 %>% drop_na(climate1, climate2, vegtype2, dist_infra, slope, elevation, aspect_cos)

#Run Model again with this data; but uses all data here
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra, family = binomial, data = NDT2_nt)

Anova(model.NDT2, type=3)
#Anova(model.NDT2, type=3, singular.ok = TRUE)

#Remove climate interaction
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra, family = binomial, data = NDT2_nt)
...
#Remove climate2
model.NDT2<-glm(fire_pres ~ climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra, family = binomial, data = NDT2_nt)
...
# Diagnostic plots look good
# climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra
visreg(model.NDT2, "climate1")
...
#Create a new blank table and get AUC too
top_mod_table_NDT2_light_nt_ALL <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_table_NDT2_light_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtype2OP", "coef_vegtype2S", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_slope:elevation", "coef_aspect_cos:elevation", "AUC")
```
...
#Model   
model.NDT2<-glm(fire_pres ~ climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra, family = binomial, data = dat1) 
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT2_light_nt <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_table_NDT2_light_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtype2OP", "coef_vegtype2S", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_slope:elevation", "coef_aspect_cos:elevation", "AUC")

##Add data for NDT2
top_mod_table_NDT2_light_nt[1,1]<-"lightning"
top_mod_table_NDT2_light_nt[1,2]<-"NDT2"
top_mod_table_NDT2_light_nt[1,3]<-"N"
top_mod_table_NDT2_light_nt[1,4]<-"fire_pres ~ climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra" 
top_mod_table_NDT2_light_nt[1,5]<- coef(model.NDT2)[1] #Intercept
top_mod_table_NDT2_light_nt[1,6]<- coef(model.NDT2)[2] #Climate variable 1
top_mod_table_NDT2_light_nt[1,7]<- coef(model.NDT2)[3] #Climate variable 2
top_mod_table_NDT2_light_nt[1,8]<- coef(model.NDT2)[4] #slope
top_mod_table_NDT2_light_nt[1,9]<- coef(model.NDT2)[5] #elevation
top_mod_table_NDT2_light_nt[1,10]<- coef(model.NDT2)[6] #d
top_mod_table_NDT2_light_nt[1,11]<- coef(model.NDT2)[7] #cl
top_mod_table_NDT2_light_nt[1,12]<- coef(model.NDT2)[8] #sl
top_mod_table_NDT2_light_nt[1,13]<- coef(model.NDT2)[9] #sl
top_mod_table_NDT2_light_nt[1,14]<- coef(model.NDT2)[10] #sl
top_mod_table_NDT2_light_nt[1,15]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT2_light_nt_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT2_light_nt_ALL_Jan.csv")
```
...
top_mod_table_NDT2_light_nt_Means<-top_mod_table_NDT2_light_nt_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_table_NDT2_light_nt_Means

top_mod_table_NDT2_light_nt_Means[1,1]<-"lightning"
top_mod_table_NDT2_light_nt_Means[1,2]<-"NDT2"
top_mod_table_NDT2_light_nt_Means[1,3]<-"Not Treed"
top_mod_table_NDT2_light_nt_Means[1,4]<- "fire_pres ~ climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra" 
top_mod_table_NDT2_light_nt_Means
```
...
```{r}
write.csv(top_mod_table_NDT2_light_nt_Means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT2_light_nt_Means_Jan.csv")
```

Standard deviation.

```{r}
top_mod_table_NDT2_light_nt_SD<-top_mod_table_NDT2_light_nt_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT2_light_nt_SD

top_mod_table_NDT2_light_nt_SD[1,1]<-"lightning"
top_mod_table_NDT2_light_nt_SD[1,2]<-"NDT2"
top_mod_table_NDT2_light_nt_SD[1,3]<-"Not Treed"
top_mod_table_NDT2_light_nt_SD[1,4]<-"fire_pres ~ climate1 + vegtype2 + slope + aspect_cos + elevation + slope:elevation + aspect_cos:elevation +  dist_infra" 
top_mod_table_NDT2_light_nt_SD
```
...
```{r}
write.csv(top_mod_table_NDT2_light_nt_SD, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT2_light_nt_SD_Jan.csv")
```
