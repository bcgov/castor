...
2. slope + aspect + elevation + slope:elevation + aspect:elevation
...
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect + elevation + slope:elevation + aspect:elevation +  dist_mun + dist_nat + dist_mine + climate1:elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #681.5
...
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect + elevation + slope:elevation + aspect:elevation +  dist_mun + dist_nat + dist_mine + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #679.5
...
model.NDT2<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + slope + aspect + elevation + slope:elevation + aspect:elevation +  dist_mun + dist_nat + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #677.7
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2  + climate1:climate2 + slope + aspect + elevation + slope:elevation + aspect:elevation +  dist_mun + dist_nat + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT2) #674.2
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2  + climate1:climate2 + slope + aspect + elevation + slope:elevation + aspect:elevation +  dist_mun + dist_nat, family = binomial, data = dat1)

AIC(model.NDT2) #672.8
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2  + climate1:climate2 + slope + aspect + elevation + slope:elevation +  dist_mun + dist_nat, family = binomial, data = dat1)

AIC(model.NDT2) #671.8
...
#Remove least significant
model.NDT2<-glm(fire_pres ~ climate1 + climate2  + climate1:climate2 + slope + elevation + slope:elevation +  dist_mun + dist_nat, family = binomial, data = dat1)

AIC(model.NDT2) #669.8
