...
2. Best model was intercept! Investigate: slope + elevation + aspect + slope:elevation
...
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect + slope:elevation + dist_dam + dist_mine + bclcs_level_5_2 + climate1:elevation + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #103.9
...
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect + slope:elevation + dist_dam + dist_mine + bclcs_level_5_2 + climate1:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #101.9
...
#Begin removing least significant interaction
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect  + dist_dam + dist_mine + bclcs_level_5_2 + climate1:elevation,  family = binomial, data = dat1)
...
#Begin removing least significant interaction
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect  + dist_dam + dist_mine + bclcs_level_5_2,  family = binomial, data = dat1)
...
#Remove least sig
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + dist_dam + dist_mine + bclcs_level_5_2,  family = binomial, data = dat1)
...
#Remove least sig
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + dist_dam + bclcs_level_5_2,  family = binomial, data = dat1)
...
#Remove least sig
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + elevation + dist_dam + bclcs_level_5_2,  family = binomial, data = dat1)
