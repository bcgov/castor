...
AIC(model.NDT5) #105.0 (second subset: 103.7)
...
AIC(model.NDT5) #101.2 (second run: 105.1)
...
#Second run suggests older model better, but remove climate interaction
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2 + elevation + bclcs_level_5_2,  family = binomial, data = dat1)

AIC(model.NDT5) # (second subset: 101.8)
...
#Remove
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + bclcs_level_5_2,  family = binomial, data = dat1)

AIC(model.NDT5) # (second subset: 99.9)
...
NDT5_nt<-dat_lightning_nt_NDT5 %>% drop_na(climate1, climate2, vegtype2, bclcs_level_5_2)

#Run Model again with this data; but uses all data here
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + bclcs_level_5_2, family = binomial, data = NDT5_nt)
...
# climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + bclcs_level_5_2
...
top_mod_table_NDT5_light_nt_ALL <- data.frame (matrix (ncol = 13, nrow = 0))
colnames (top_mod_table_NDT5_light_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtypeS", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_climate1:vegtype2S", "coef_climate2:vegtype2S", "AUC")
```
...
top_mod_table_NDT5_light_nt <- data.frame (matrix (ncol = 13, nrow = 0))
colnames (top_mod_table_NDT5_light_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtypeS", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_climate1:vegtype2S", "coef_climate2:vegtype2S", "AUC")

##Add data for NDT5
top_mod_table_NDT5_light_nt[1,1]<-"lightning"
top_mod_table_NDT5_light_nt[1,2]<-"NDT5"
top_mod_table_NDT5_light_nt[1,3]<-"N"
top_mod_table_NDT5_light_nt[1,4]<-"fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + bclcs_level_5_2" 
top_mod_table_NDT5_light_nt[1,5]<- coef(model.NDT5)[1] #Intercept
top_mod_table_NDT5_light_nt[1,6]<- coef(model.NDT5)[2] #Cl
top_mod_table_NDT5_light_nt[1,7]<- coef(model.NDT5)[3] #c
top_mod_table_NDT5_light_nt[1,8]<- coef(model.NDT5)[4] #v
top_mod_table_NDT5_light_nt[1,9]<- coef(model.NDT5)[5] #coeffici
top_mod_table_NDT5_light_nt[1,10]<- coef(model.NDT5)[6] #coefficient
top_mod_table_NDT5_light_nt[1,11]<- coef(model.NDT5)[7] # 
top_mod_table_NDT5_light_nt[1,12]<- coef(model.NDT5)[8] 
top_mod_table_NDT5_light_nt[1,13]<- mod.auc
...
mean(top_mod_table_NDT5_light_nt_ALL$AUC) #0.75
```

Previous top model had better AUC. Go back.
...
# Diagnostic plots look... ok. Small sample size.
#Partial residuals
#climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + elevation + bclcs_level_5_2
visreg(model.NDT5, "climate1", by="vegtype2", overlay=TRUE)
visreg(model.NDT5, "climate1", by="climate2")

visreg(model.NDT5, "climate2", by="vegtype2", overlay=TRUE)
visreg(model.NDT5, "climate2", by="climate1")

visreg(model.NDT5, "vegtype2", by="climate1")
visreg(model.NDT5, "vegtype2", by="climate2")
...
#Repeat aboce with condensed variables
...
#Run model using dat1
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect_cos + slope:elevation + dist_infra + climate1:elevation + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #114.8
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect_cos + slope:elevation + dist_infra + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #112.8
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect_cos + dist_infra + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #110.8
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect_cos + dist_infra + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #109.1
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + aspect_cos + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #107.1`
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2 + slope + elevation + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #105.2
...
#Remove least significant
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation,  family = binomial, data = dat1)

AIC(model.NDT5) #103.2
...
```{r}
#Remove NAs to ensure all same data used so we can compare AIC_nts
NDT5_nt<-dat_lightning_nt_NDT5 %>% drop_na(climate1, climate2, vegtype2, elevation)

#Run Model again with this data; but uses all data here
model.NDT5<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation, family = binomial, data = NDT5_nt)
...
#Partial residuals
#climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation
visreg(model.NDT5, "climate1", by="vegtype2", overlay=TRUE)
visreg(model.NDT5, "climate2", by="vegtype2", overlay=TRUE)
visreg(model.NDT5, "climate2", by="elevation")

visreg(model.NDT5, "vegtype2", by="climate1")
visreg(model.NDT5, "vegtype2", by="climate2")

visreg(model.NDT5, "elevation", by="climate2")
...
#Create a new blank table and get AUC too
top_mod_table_NDT5_light_nt_ALL <- data.frame (matrix (ncol = 13, nrow = 0))
colnames (top_mod_table_NDT5_light_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtypeS", "coef_elevation", "coef_climate1:vegtype2S", "coef_climate2:vegtype2S", "coef_climate2:elevation", "AUC")
```
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT5_light_nt <- data.frame (matrix (ncol = 13, nrow = 0))
colnames (top_mod_table_NDT5_light_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtypeS", "coef_elevation", "coef_climate1:vegtype2S", "coef_climate2:vegtype2S", "coef_climate2:elevation", "AUC")

##Add data for NDT5
top_mod_table_NDT5_light_nt[1,1]<-"lightning"
top_mod_table_NDT5_light_nt[1,2]<-"NDT5"
top_mod_table_NDT5_light_nt[1,3]<-"N"
top_mod_table_NDT5_light_nt[1,4]<-"fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation" 
top_mod_table_NDT5_light_nt[1,5]<- coef(model.NDT5)[1] #Intercept
top_mod_table_NDT5_light_nt[1,6]<- coef(model.NDT5)[2] #Climate variable 1
top_mod_table_NDT5_light_nt[1,7]<- coef(model.NDT5)[3] #climate2
top_mod_table_NDT5_light_nt[1,8]<- coef(model.NDT5)[4] #vegtype2S
top_mod_table_NDT5_light_nt[1,9]<- coef(model.NDT5)[5] #coefficient elevation
top_mod_table_NDT5_light_nt[1,10]<- coef(model.NDT5)[6] #coefficie
top_mod_table_NDT5_light_nt[1,11]<- coef(model.NDT5)[7] #coeffi
top_mod_table_NDT5_light_nt[1,12]<- coef(model.NDT5)[8] #climate1:climate2
top_mod_table_NDT5_light_nt[1,13]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT5_light_nt_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT5_light_nt_ALL_Jan.csv")
```
...
```{r}
names(top_mod_table_NDT5_light_nt_ALL)
mean(top_mod_table_NDT5_light_nt_ALL$AUC) #0.71

top_mod_table_NDT5_light_nt_Means<-top_mod_table_NDT5_light_nt_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_table_NDT5_light_nt_Means

top_mod_table_NDT5_light_nt_Means[1,1]<-"lightning"
top_mod_table_NDT5_light_nt_Means[1,2]<-"NDT5"
top_mod_table_NDT5_light_nt_Means[1,3]<-"Not treed"
top_mod_table_NDT5_light_nt_Means[1,4]<- "fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation" 
top_mod_table_NDT5_light_nt_Means
```
...
```{r}
write.csv(top_mod_table_NDT5_light_nt_Means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT5_light_nt_Means_Jan.csv")
```

Standard deviation.

```{r}
top_mod_table_NDT5_light_nt_SD<-top_mod_table_NDT5_light_nt_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT5_light_nt_SD

top_mod_table_NDT5_light_nt_SD[1,1]<-"lightning"
top_mod_table_NDT5_light_nt_SD[1,2]<-"NDT5"
top_mod_table_NDT5_light_nt_SD[1,3]<-"Not treed"
top_mod_table_NDT5_light_nt_SD[1,4]<-"fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + climate2:vegtype2  + elevation + climate2:elevation" 
top_mod_table_NDT5_light_nt_SD
```

```{r}
write.csv(top_mod_table_NDT5_light_nt_SD, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT5_light_nt_SD_Jan.csv")
```
