...
dat_lightning_<-read.csv("D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Lightning_data_July.csv")

dat_person_<-read.csv("D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Person_data_July.csv")
```
...
table(dat_lightning$bclcs_level_5, dat_lightning$fire)
