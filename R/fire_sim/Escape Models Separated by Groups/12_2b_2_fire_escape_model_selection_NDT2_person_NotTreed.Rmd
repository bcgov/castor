---
title: "12_2b_2_fire_escape_model_selection_NDT2_person_NotTreed"
author: "Cora Skaien"
date: "19/11/2021"
...
#=================================
#  Script Name: 12_2b_2_fire_escape_model_selection_NDT2_person_NotTreed.R
#  Script Version: 1.0
...
Select NDT: NDT2
- NDT2 has two climate variables; NDTs 2-5 have only 1
...
AIC_person_NDT2_escape_ntreed_climate<-table.glm.climate.simple

AIC_person_NDT2_escape_ntreed_summary_climate<- AIC_person_NDT2_escape_ntreed_climate %>%
  group_by(model) %>%
...
AIC_person_NDT2_escape_ntreed_summary_climate2<- AIC_person_NDT2_escape_ntreed_summary_climate %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT2_escape_ntreed_summary_climate2)
```
...
AIC_person_NDT2_escape_ntreed_ntopo<-table.glm.topo.simple

AIC_person_NDT2_escape_ntreed_summary_ntopo<- AIC_person_NDT2_escape_ntreed_ntopo %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic),
            meanAUC=mean(auc.valid),
            sdAUC=sd(auc.valid),
...
AIC_person_NDT2_escape_ntreed_summary_ntopo2<- AIC_person_NDT2_escape_ntreed_summary_ntopo %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT2_escape_ntreed_summary_ntopo2)
```
...
AIC_person_NDT2_escape_ntreed_infra<-table.glm.infra.simple

AIC_person_NDT2_escape_ntreed_summary_infra<- AIC_person_NDT2_escape_ntreed_infra %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic),
            meanAUC=mean(auc.valid),
            sdAUC=sd(auc.valid),
...
AIC_person_NDT2_escape_ntreed_summary_infra2<- AIC_person_NDT2_escape_ntreed_summary_infra %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT2_escape_ntreed_summary_infra2)
...
```{r}
NDT2_l_models_ntreed<-rbind(AIC_person_NDT2_escape_ntreed_summary_climate2, AIC_person_NDT2_escape_ntreed_summary_ntopo2, AIC_person_NDT2_escape_ntreed_summary_infra2)
NDT2_l_models_ntreed
NDT2_l_models_ntreed$NDT<-"NDT2"

write.csv(NDT2_l_models_ntreed, file="D:\\Fire\\fire_data\\raw_data\\NDT2_person_models_notrees_escape.csv")
```
...
Top Models:
1. climate1 + vegtype2
2. slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + aspect:wind_atfire
3. dist_dam + dist_mine + roads_km
...
```{r}
escape_person_nt_NDT2<-subset(Escape_data_person_nt, Escape_data_person_nt$ntrl_ds=="NDT2") #Only 629 observations - likely cannot use all interactions effectively

#Divide data into training and valid
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(escape_person_nt_NDT2$escape, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- escape_person_nt_NDT2[ trainIndex,]
   Valid <- escape_person_nt_NDT2[-trainIndex,]

#Run model using dat1
#Start without additional interactions
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + aspect:wind_atfire + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 + elevation*climate1 +  wind_atfire*climate1 +  wind_atfire*vegtype2 +  Tdif_atfire*climate1 +  Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT2.E) #318.9
...
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 + elevation*climate1 +  wind_atfire*climate1 +  wind_atfire*vegtype2 +  Tdif_atfire*climate1 +  Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT2.E) #316.9
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 + elevation*climate1 +  wind_atfire*climate1 +  wind_atfire*vegtype2 +  Tdif_atfire*climate1, family = binomial, data = dat1)

AIC(model.NDT2.E) #314.9
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2 +  Tdif_atfire*climate1, family = binomial, data = dat1)

AIC(model.NDT2.E) #313.6
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + slope:wind_atfire + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT2.E) #312.3
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT2.E) #310.4
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire +  wind_atfire*climate1 +  wind_atfire*vegtype2, family = binomial, data = dat1)

AIC(model.NDT2.E) #316.6
...
#Try infrastructure interactions
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2 + roads_km*dist_dam + roads_km*dist_mine + roads_km*bclcs_level_5_2, family = binomial, data = dat1)

AIC(model.NDT2.E) #305.4
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + elevation + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2, family = binomial, data = dat1)

AIC(model.NDT2.E) #303.5
...
#Remove least significant
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2, family = binomial, data = dat1)

AIC(model.NDT2.E) #301.9
...
NDT2_escape_nt<-escape_person_nt_NDT2 %>% drop_na(climate1, vegtype2, slope, aspect, wind_atfire, Tdif_atfire, dist_dam, dist_mine, roads_km, bclcs_level_5_2) #623 observations

#Run Model again with this data; but uses all data here
model.NDT2.E<-glm(escape ~ climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2, family = binomial, data = NDT2_escape_nt)
...
binnedplot (NDT2_escape_nt$live_stand_volume_125, 
...
#Partial Residuals
#climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2
...
visreg(model.NDT2.E, "wind_atfire", by="vegtype2")

visreg(model.NDT2.E, "slope", by="aspect")
visreg(model.NDT2.E, "aspect", by="slope")

# dist_dam + dist_mine + roads_km + bclcs_level_5_2 + roads_km*dist_mine + roads_km*bclcs_level_5_2
visreg(model.NDT2.E, "dist_dam")
visreg(model.NDT2.E, "dist_mine", by="roads_km")
visreg(model.NDT2.E, "bclcs_level_5_2", by="roads_km")

visreg(model.NDT2.E, "roads_km", by="bclcs_level_5_2", overlay=TRUE)
...
top_mod_ntable_NDT2_person_nt_ALL <- data.frame (matrix (ncol = 25, nrow = 0))
colnames (top_mod_ntable_NDT2_person_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtype2OP", "coef_vegtype2S", "coef_slope", "coef_aspect", "coef_wind_atfire", "coef_dist_dam", "coef_dist_mine", "coef_roads_km", "coef_Tdif_atfire", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope:aspect", "coef_climate1:wind_atfire", "coef_vegtype2OP:wind_atfire", "coef_vegtype2S:wind_atfire", "coef_dist_mine:roads_km", "coef_roads_km:bclcs_level_5_2OP", "coef_roads_km:bclcs_level_5_2SP","AUC")

NDT2_escape_nt$escape_land<-paste(NDT2_escape_nt$escape, NDT2_escape_nt$bclcs_level_5_2)
```
...
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(NDT2_escape_nt$escape_land, p = prop,
                                    list = FALSE,
                                    times = 1)
...
top_mod_ntable_NDT2_person_nt <- data.frame (matrix (ncol = 25, nrow = 0))
colnames (top_mod_ntable_NDT2_person_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtype2OP", "coef_vegtype2S", "coef_slope", "coef_aspect", "coef_wind_atfire", "coef_dist_dam", "coef_dist_mine", "coef_roads_km", "coef_Tdif_atfire", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_slope:aspect", "coef_climate1:wind_atfire", "coef_vegtype2OP:wind_atfire", "coef_vegtype2S:wind_atfire", "coef_dist_mine:roads_km", "coef_roads_km:bclcs_level_5_2OP", "coef_roads_km:bclcs_level_5_2SP","AUC")

##Add data for NDT2
top_mod_ntable_NDT2_person_nt[1,1]<-"person"
top_mod_ntable_NDT2_person_nt[1,2]<-"NDT2"
top_mod_ntable_NDT2_person_nt[1,3]<-"N"
top_mod_ntable_NDT2_person_nt[1,4]<-"escape ~ climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2" 
top_mod_ntable_NDT2_person_nt[1,5]<- coef(model.NDT2.E)[1] #Intercept
top_mod_ntable_NDT2_person_nt[1,6]<- coef(model.NDT2.E)[2] #C
top_mod_ntable_NDT2_person_nt[1,7]<- coef(model.NDT2.E)[3] #C
top_mod_ntable_NDT2_person_nt[1,8]<- coef(model.NDT2.E)[4] #co
top_mod_ntable_NDT2_person_nt[1,9]<- coef(model.NDT2.E)[5] #co
top_mod_ntable_NDT2_person_nt[1,10]<- coef(model.NDT2.E)[6] #c
top_mod_ntable_NDT2_person_nt[1,11]<- coef(model.NDT2.E)[7] #l
top_mod_ntable_NDT2_person_nt[1,12]<- coef(model.NDT2.E)[8] #co
top_mod_ntable_NDT2_person_nt[1,13]<- coef(model.NDT2.E)[9] #c
top_mod_ntable_NDT2_person_nt[1,14]<- coef(model.NDT2.E)[10] #coeff
top_mod_ntable_NDT2_person_nt[1,15]<- coef(model.NDT2.E)[11] #coeff
top_mod_ntable_NDT2_person_nt[1,16]<- coef(model.NDT2.E)[12] #coeff
top_mod_ntable_NDT2_person_nt[1,17]<- coef(model.NDT2.E)[13] #coeff
top_mod_ntable_NDT2_person_nt[1,18]<- coef(model.NDT2.E)[14] #coeff
top_mod_ntable_NDT2_person_nt[1,19]<- coef(model.NDT2.E)[15] #coeff
top_mod_ntable_NDT2_person_nt[1,20]<- coef(model.NDT2.E)[16] #coeff
top_mod_ntable_NDT2_person_nt[1,21]<- coef(model.NDT2.E)[17] #coeff
top_mod_ntable_NDT2_person_nt[1,22]<- coef(model.NDT2.E)[18] #coeff
top_mod_ntable_NDT2_person_nt[1,23]<- coef(model.NDT2.E)[19] #coeff
top_mod_ntable_NDT2_person_nt[1,24]<- coef(model.NDT2.E)[20] #coeff
top_mod_ntable_NDT2_person_nt[1,25]<- mod.auc

top_mod_ntable_NDT2_person_nt_ALL<-rbind(top_mod_ntable_NDT2_person_nt_ALL, top_mod_ntable_NDT2_person_nt)
...
Check.
```{r}
head(top_mod_ntable_NDT2_person_nt_ALL)
...
```{r}
write.csv(top_mod_ntable_NDT2_person_nt_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT2_person_nt_ALL.csv")
```
...
```{r}
names(top_mod_ntable_NDT2_person_nt_ALL)

top_mod_ntable_NDT2_escape_person_nt_means<-top_mod_ntable_NDT2_person_nt_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_ntable_NDT2_escape_person_nt_means

top_mod_ntable_NDT2_escape_person_nt_means[1,1]<-"person"
top_mod_ntable_NDT2_escape_person_nt_means[1,2]<-"NDT2"
top_mod_ntable_NDT2_escape_person_nt_means[1,3]<-"Not Treed"
top_mod_ntable_NDT2_escape_person_nt_means[1,4]<- "escape ~ climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2" 
top_mod_ntable_NDT2_escape_person_nt_means
```
Save table.

```{r}
write.csv(top_mod_ntable_NDT2_escape_person_nt_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT2_person_nt_Means.csv")
```

Standard deviation.

```{r}
top_mod_ntable_NDT2_escape_person_nt_sd<-top_mod_ntable_NDT2_person_nt_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_ntable_NDT2_escape_person_nt_sd

top_mod_ntable_NDT2_escape_person_nt_sd[1,1]<-"person"
top_mod_ntable_NDT2_escape_person_nt_sd[1,2]<-"NDT2"
top_mod_ntable_NDT2_escape_person_nt_sd[1,3]<-"Not Treed"
top_mod_ntable_NDT2_escape_person_nt_sd[1,4]<-"escape ~ climate1 + vegtype2 + slope + aspect + wind_atfire + slope:aspect + dist_dam + dist_mine + roads_km + Tdif_atfire + bclcs_level_5_2 +  wind_atfire*climate1 +  wind_atfire*vegtype2  + roads_km*dist_mine + roads_km*bclcs_level_5_2" 
top_mod_ntable_NDT2_escape_person_nt_sd
```
...
```{r}
write.csv(top_mod_ntable_NDT2_escape_person_nt_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT2_person_nt_SD.csv")
```
