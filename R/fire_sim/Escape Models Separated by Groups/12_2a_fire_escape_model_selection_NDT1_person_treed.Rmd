...
table(Escape_data_person_t$ntrl_ds)
...
```{r}
escape_person_t_NDT1<-subset(Escape_data_person_t, Escape_data_person_t$ntrl_ds=="NDT1") #Only 760 observations - likely cannot use all interactions effectively

#Divide data into training and valid
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(escape_person_t_NDT1$escape, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- escape_person_t_NDT1[ trainIndex,]
   Valid <- escape_person_t_NDT1[-trainIndex,]

#Run model using dat1
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km +  elevation*climate1  + elevation*climate2 + wind_atfire*climate1 + wind_atfire*climate2 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*climate2 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + bclcs_level_5_2*dist_dam + bclcs_level_5_2*roads_km + dist_mun*roads_km + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #320.1
...
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km +  elevation*climate1  + elevation*climate2 + wind_atfire*climate1 + wind_atfire*climate2 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + bclcs_level_5_2*dist_dam + bclcs_level_5_2*roads_km + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #316.4
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km +  elevation*climate1  + elevation*climate2 + wind_atfire*climate1 + wind_atfire*climate2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + bclcs_level_5_2*roads_km + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #308.6

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.57 - bad, but better
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km +  elevation*climate1 + wind_atfire*climate2 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + bclcs_level_5_2*roads_km + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #303.6

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.60 - bad, but better
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km + wind_atfire*climate2 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + bclcs_level_5_2*roads_km + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #301.99
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km + wind_atfire*climate2 + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #300.3

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.65 - bad, but better
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #299.3

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.66 - bad, but better
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun + dist_dam*roads_km, family = binomial, data = dat1)

AIC(model.NDT1.E) #297.2
...
#AUC was higher for smaller models, so compare here
model.NDT1.E<-glm(escape ~ climate1 + climate2 + vegtype2 + dist_mun + dist_dam + roads_km + Tdif_atfire*wind_atfire + bclcs_level_5_2*dist_mun, family = binomial, data = dat1)

AIC(model.NDT1.E) #396.7

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.72  better AUC but worse AIC
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#In between model with fewer interactions
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + climate2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + dist_dam + roads_km + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #306.7

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.70 - already better...
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant
model.NDT1.E<-glm(escape ~ climate1 + climate2 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + roads_km + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #305.1

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.69 - already better...
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant
model.NDT1.E<-glm(escape ~ climate1 + proj_height_1 + proj_age_1 + live_stand_volume_125 + slope + elevation + wind_atfire + slope:elevation + dist_mun + roads_km + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #304.4
...
```{r}
##Create variable lists to be used in the model loop.
variables_all_NDT1<-c(climate1 = "climate1", climate2 = "climate2", vegtype2 = "vegtype2", live_stand_volume_125 = "live_stand_volume_125", proj_height_1 = "proj_height_1", proj_age_1 ="proj_age_1", slope = "slope", elevation ="elevation",  dist_dam = "dist_dam", roads_km = "roads_km", bclcs_level_5_2 = "bclcs_level_5_2", wind_atfire = "wind_atfire", Tdif_atfire ="Tdif_atfire")
...
variables_clim_VRI_NDT1<-c(climate1 = "climate1", climate2 = "climate2", vegtype2 = "vegtype2", live_stand_volume_125 = "live_stand_volume_125", proj_height_1 = "proj_height_1", proj_age_1 ="proj_age_1")

#treat slo'pe, aspect and elevation as their own thing. And we have already done this analysis with them.
#slope = "slope", aspect = "aspect", elevation ="elevation").

variables_all_infra_landuse_NDT1<-c(dist_mun = "dist_mun", dist_dam = "dist_dam", roads_km = "roads_km", bclcs_level_5_2 = "bclcs_level_5_2") #I don't think it makes sense to have interactions between the distance elements, but maybe with land use and each distance element?
...
twoway.ints
twoway.ints_dist<-twoway.ints[c(2,3,4,5,6)]
twoway.ints_dist
...
length(mods.me.infra_landuse_NDT1) #16
...
```{r}
escape_person_t_NDT1<-subset(Escape_data_person_t, Escape_data_person_t$ntrl_ds=="NDT1") #Only 760 variables, so may not be able to use all interactions
...
#Run model using dat1
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + elevation*climate1 + wind_atfire*climate1 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + roads_km:dist_mun + roads_km:dist_dam + roads_km:dist_mine, family = binomial, data = dat1)

AIC(model.NDT1.E) #344.9

#Determine AUC of full model
mod.valid <- predict.glm(model.NDT1.E, newdata=Valid, type="response")
   roc_obj <- roc(Valid[,"escape"], mod.valid)
   mod.auc <- auc(roc_obj)
   mod.auc #0.80 --> good fit!
   
Anova(model.NDT1.E, type=3)
Anova(model.NDT1.E, type=3, singular.ok = TRUE)

#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + elevation*climate1 + wind_atfire*climate1 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + roads_km:dist_mun + roads_km:dist_mine, family = binomial, data = dat1)

AIC(model.NDT1.E) #342.9
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + elevation*climate1 + wind_atfire*climate1 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + roads_km:dist_mine, family = binomial, data = dat1)

AIC(model.NDT1.E) #341.1
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*climate1 + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + roads_km:dist_mine, family = binomial, data = dat1)

AIC(model.NDT1.E) #339.5
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire + roads_km:dist_mine, family = binomial, data = dat1)

AIC(model.NDT1.E) #338.2
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + dist_mine + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #337.1
...
#Remove least significant interaction
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + dist_dam + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #335.5
...
#Remove least significant
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire, family = binomial, data = dat1)

AIC(model.NDT1.E) #335.2
...
NDT1_escape_t<-escape_person_t_NDT1 %>% drop_na(climate1, vegtype2, live_stand_volume_125, dist_mun,slope, elevation, wind_atfire, Tdif_atfire, roads_km) #536 observations

#Run Model again with this data; but uses all data here
model.NDT1.E<-glm(escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire, family = binomial, data = NDT1_escape_t)
...
#Partial Residuals
#climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire

visreg(model.NDT1.E, "climate1", by="Tdif_atfire")
visreg(model.NDT1.E, "vegtype2", by="wind_atfire")
visreg(model.NDT1.E, "vegtype2", by="wind_atfire", ylim=c(-10,10))
visreg(model.NDT1.E, "vegtype2", by="wind_atfire", ylim=c(-20,20))
visreg(model.NDT1.E, "live_stand_volume_125")

visreg(model.NDT1.E, "dist_mun")
visreg(model.NDT1.E, "roads_km")

visreg(model.NDT1.E, "slope", by="elevation")
visreg(model.NDT1.E, "elevation", by="slope")

#wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire
visreg(model.NDT1.E, "wind_atfire", by="vegtype2", overlay=TRUE)
visreg(model.NDT1.E, "wind_atfire", by="vegtype2", overlay=TRUE, ylim=c(-30,30))
visreg(model.NDT1.E, "wind_atfire", by="Tdif_atfire")

visreg(model.NDT1.E, "Tdif_atfire", by="climate1")
visreg(model.NDT1.E, "Tdif_atfire", by="wind_atfire")
...
top_mod_table_NDT1_person_t_ALL <- data.frame (matrix (ncol = 23, nrow = 0))
colnames (top_mod_table_NDT1_person_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtypeTB", "coef_vegtypeTC", "coef_vegtypeTM", "coef_live_stand_volume_125", "coef_dist_mun", "coef_roads_km", "coef_slope", "coef_elevation", "coef_wind_atfire", "coef_Tdif_atfire", "coef_slope:elevation", "coef_vegtype2TB:wind_atfire", "coef_vegtype2TC:wind_atfire", "coef_vegtype2TM:wind_atfire", "coef_climate1:Tdif_atfire", "coef_wind_atfire:Tdif_atfire", "AUC")
```
...
top_mod_table_NDT1_person_t <- data.frame (matrix (ncol = 23, nrow = 0))
...
top_mod_table_NDT1_person_t[1,4]<-"escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire" 
top_mod_table_NDT1_person_t[1,5]<- coef(model.NDT1.E)[1] #Intercept
top_mod_table_NDT1_person_t[1,6]<- coef(model.NDT1.E)[2] #C
top_mod_table_NDT1_person_t[1,7]<- coef(model.NDT1.E)[3] #C
top_mod_table_NDT1_person_t[1,8]<- coef(model.NDT1.E)[4] #co
top_mod_table_NDT1_person_t[1,9]<- coef(model.NDT1.E)[5] #co
top_mod_table_NDT1_person_t[1,10]<- coef(model.NDT1.E)[6] #c
top_mod_table_NDT1_person_t[1,11]<- coef(model.NDT1.E)[7] #l
top_mod_table_NDT1_person_t[1,12]<- coef(model.NDT1.E)[8] #co
top_mod_table_NDT1_person_t[1,13]<- coef(model.NDT1.E)[9] #c
top_mod_table_NDT1_person_t[1,14]<- coef(model.NDT1.E)[10] #coeff
top_mod_table_NDT1_person_t[1,15]<- coef(model.NDT1.E)[11] #co
top_mod_table_NDT1_person_t[1,16]<- coef(model.NDT1.E)[12] #coe
top_mod_table_NDT1_person_t[1,17]<- coef(model.NDT1.E)[13] #co
top_mod_table_NDT1_person_t[1,18]<- coef(model.NDT1.E)[14] #co
top_mod_table_NDT1_person_t[1,19]<- coef(model.NDT1.E)[15] #
top_mod_table_NDT1_person_t[1,20]<- coef(model.NDT1.E)[16] # cl
top_mod_table_NDT1_person_t[1,21]<- coef(model.NDT1.E)[17] # c
top_mod_table_NDT1_person_t[1,22]<- coef(model.NDT1.E)[18] #coefficien
top_mod_table_NDT1_person_t[1,23]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT1_person_t_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT1_person_t_ALL.csv")
```
...
top_mod_table_NDT1_escape_person_t_means<-top_mod_table_NDT1_person_t_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
top_mod_table_NDT1_escape_person_t_means

top_mod_table_NDT1_escape_person_t_means[1,1]<-"person"
top_mod_table_NDT1_escape_person_t_means[1,2]<-"NDT1"
top_mod_table_NDT1_escape_person_t_means[1,3]<-"Treed"
top_mod_table_NDT1_escape_person_t_means[1,4]<- "escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire" 
top_mod_table_NDT1_escape_person_t_means
```
Save table.

```{r}
write.csv(top_mod_table_NDT1_escape_person_t_means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT1_person_t_Means.csv")
```

Standard deviation.

```{r}
top_mod_table_NDT1_escape_person_t_sd<-top_mod_table_NDT1_person_t_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT1_escape_person_t_sd

top_mod_table_NDT1_escape_person_t_sd[1,1]<-"person"
top_mod_table_NDT1_escape_person_t_sd[1,2]<-"NDT1"
top_mod_table_NDT1_escape_person_t_sd[1,3]<-"Treed"
top_mod_table_NDT1_escape_person_t_sd[1,4]<-"escape ~ climate1 + vegtype2 + live_stand_volume_125 + dist_mun + roads_km + slope + elevation + wind_atfire + Tdif_atfire + slope:elevation + wind_atfire*vegtype2 + Tdif_atfire*climate1 + Tdif_atfire*wind_atfire" 
top_mod_table_NDT1_escape_person_t_sd
```
...
```{r}
write.csv(top_mod_table_NDT1_escape_person_t_sd, file="D:\\Fire\\fire_data\\raw_data\\top_mod_escape_NDT1_person_t_SD.csv")
```
