---
title: "09_2a_2_fire_ignition_model_selection_NDT1_person_NotTreed"
author: "Cora Skaien"
date: "10/11/2021"
...
AIC_person_NDT1_fire_pres_NotTreed_climate<-table.glm.climate.simple

AIC_person_NDT1_fire_pres_NotTreed_summary_climate<- AIC_person_NDT1_fire_pres_NotTreed_climate %>%
  group_by(model) %>%
...
AIC_person_NDT1_fire_pres_NotTreed_summary_climate2<- AIC_person_NDT1_fire_pres_NotTreed_summary_climate %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_fire_pres_NotTreed_summary_climate2)
```
...
AIC_person_NDT1_fire_pres_NotTreed_topo<-table.glm.topo.simple

AIC_person_NDT1_fire_pres_NotTreed_summary_topo<- AIC_person_NDT1_fire_pres_NotTreed_topo %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic),
            meanAUC=mean(auc.valid),
            sdAUC=sd(auc.valid),
...
AIC_person_NDT1_fire_pres_NotTreed_summary_topo2<- AIC_person_NDT1_fire_pres_NotTreed_summary_topo %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_fire_pres_NotTreed_summary_topo2)
```
If redid when fixed aspect, save here.

```{r}
write.csv(AIC_person_NDT1_fire_pres_NotTreed_summary_topo2, file="D:\\Fire\\fire_data\\raw_data\\NDT1_person_models_NotTreed_ignition_TOPO_REDO.csv")
```
...
AIC_person_NDT1_fire_pres_NotTreed_infra<-table.glm.infra.simple

AIC_person_NDT1_fire_pres_NotTreed_summary_infra<- AIC_person_NDT1_fire_pres_NotTreed_infra %>%
  group_by(model) %>%
  summarise(meanAIC=mean(aic),
            meanAUC=mean(auc.valid),
            sdAUC=sd(auc.valid),
...
AIC_person_NDT1_fire_pres_NotTreed_summary_infra2<- AIC_person_NDT1_fire_pres_NotTreed_summary_infra %>%
  mutate(deltaAIC=meanAIC-min(meanAIC))

head(AIC_person_NDT1_fire_pres_NotTreed_summary_infra2)
...
```{r}
NDT1_l_models_NotTreed<-rbind(AIC_person_NDT1_fire_pres_NotTreed_summary_climate2, AIC_person_NDT1_fire_pres_NotTreed_summary_topo2, AIC_person_NDT1_fire_pres_NotTreed_summary_infra2)
...
prop<-0.75
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(ignition_person_nt_NDT1$fire_pres, p = prop,
                                    list = FALSE,
                                    times = 1)
...
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1 + elevation:climate2 + bclcs_level_5_2:roads_km, family = binomial, data = dat1)
...
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1 + elevation:climate2, family = binomial, data = dat1)
...
#Remove least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1, family = binomial, data = dat1)
...
#Remove least significant interaction
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2  + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1, family = binomial, data = dat1)
...
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + climate1:climate2  + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1, family = binomial, data = dat1)
...
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + climate1:climate2  + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1, family = binomial, data = NDT1_ignition_nt) 
...
top_mod_table_NDT1_person_t[1,4]<-"fire_pres ~ climate1 + climate2 + climate1:climate2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1" 
...
top_mod_table_NDT1_ignite_person_NT_means[1,4]<- "fire_pres ~ climate1 + climate2 + climate1:climate2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1" 
top_mod_table_NDT1_ignite_person_NT_means
```
Save table.
...
top_mod_table_NDT1_ignite_person_NT_sd[1,4]<-"fire_pres ~ climate1 + climate2 + climate1:climate2 + slope + aspect_cos + elevation + dist_mun + dist_dam + dist_pow + roads_km + dist_mun:roads_km + bclcs_level_5_2 + elevation:climate1" 
top_mod_table_NDT1_ignite_person_NT_sd
```
...
#Run model using dat1
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + dist_infra:roads_km + elevation:climate1 + elevation:climate2, family = binomial, data = dat1)
...
#Remove least significant
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + dist_infra:roads_km + elevation:climate1 , family = binomial, data = dat1)
...
#Remove least significant
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + elevation:climate1 , family = binomial, data = dat1)
...
#Remove least significant
model.NDT1<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + elevation:climate1 , family = binomial, data = dat1)
...
#Remove least significant
model.NDT1<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + elevation:climate1 , family = binomial, data = dat1)
...
#Run Model again with this data; but uses all data here
model.NDT1<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_infra + roads_km + elevation:climate1, family = binomial, data = NDT1_ignition_nt) 
...
model.NDT1<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope +  elevation + dist_infra + roads_km + elevation:climate1, family = binomial, data = NDT1_ignition_nt) 
...
#Model   
model.NDT1<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope +  elevation + dist_infra + roads_km + elevation:climate1, family = binomial, data = dat1) 
...
top_mod_table_NDT1_person_t[1,2]<-"NDT1"
top_mod_table_NDT1_person_t[1,3]<-"N"
top_mod_table_NDT1_person_t[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope +  elevation + dist_infra + roads_km + elevation:climate1" 
top_mod_table_NDT1_person_t[1,5]<- coef(model.NDT1)[1] #Intercept
top_mod_table_NDT1_person_t[1,6]<- coef(model.NDT1)[2] #Climate variable 1
top_mod_table_NDT1_person_t[1,7]<- coef(model.NDT1)[3] #Climate variable 2
top_mod_table_NDT1_person_t[1,8]<- coef(model.NDT1)[4] #
...
top_mod_table_NDT1_ignite_person_NT_means[1,2]<-"NDT1"
top_mod_table_NDT1_ignite_person_NT_means[1,3]<-"Not Treed"
top_mod_table_NDT1_ignite_person_NT_means[1,4]<- "fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope +  elevation + dist_infra + roads_km + elevation:climate1" 
top_mod_table_NDT1_ignite_person_NT_means
```
Save table.
...
top_mod_table_NDT1_ignite_person_NT_sd[1,2]<-"NDT1"
top_mod_table_NDT1_ignite_person_NT_sd[1,3]<-"Not Treed"
top_mod_table_NDT1_ignite_person_NT_sd[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope +  elevation + dist_infra + roads_km + elevation:climate1" 
top_mod_table_NDT1_ignite_person_NT_sd
```
