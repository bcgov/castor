...
#### VEGETATION DATA #### 
2002 to 2021 are the only years that VRI data exists, there is no earlier data. I have located a 2020 data file, but it has some too but not all columns for VRI info.
