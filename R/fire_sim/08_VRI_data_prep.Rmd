...
ignition_pres_abs4<- ignition_pres_abs3 %>% drop_na(bclcs_level_4) # this drops from 176706 to 176666  locations so I think its ok to remove the NA's
...
```{r}
st_write(ignition_pres_abs4, dsn = "C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\Fire_data_all_with_veg.shp", delete_layer=TRUE)
