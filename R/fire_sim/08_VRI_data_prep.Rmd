...
```{r}
file.list1<-list.files("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\QGIS_analysis\\For_analysis_2022_10_25", pattern="fire_veg", all.files=FALSE, full.names=FALSE)
y1<-gsub(".gpkg","",file.list1)
the_dir <- "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\QGIS_analysis\\For_analysis_2022_10_25"
...
```{r}
ignit2002<-st_read("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\ignit_all_2012.shp")
