...
dat12$
  FWI_veg[dat12$FWI_veg=="C-1"]<-"C-3" # C_1 and C-3 are apparently similar in spread rates so will change C-1 to C-3
...
mod_frt_12a<- glm(fire ~ climate1 + elevatn + FWI_veg + road_dist_m + infr_dist, data=dat12, family=binomial(link="logit"))
Anova(mod_frt_12a, type=3)

mod_frt12b<- glm(fire ~ climate1 + elevatn + FWI_veg + road_dist_m, data=dat12, family=binomial(link="logit"))
anova(mod_frt_12a,mod_frt12b, test="Chisq") 

mod_frt12c<- glm(fire ~ climate1 + elevatn + FWI_veg + infr_dist, data=dat12, family=binomial(link="logit"))
anova(mod_frt_12a,mod_frt12c, test="Chisq") 

mod_frt_12d<- glm(fire ~ climate1 + FWI_veg + road_dist_m + infr_dist, data=dat12, family=binomial(link="logit"))
...
top_mod_table_FRT5_person_All <- data.frame (matrix (ncol = 18, nrow = 0))
colnames (top_mod_table_FRT5_person_All ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_elevatn", "coef_log_road_dist", "coef_log_inf_dist", "coef_FWI_veg_C-3", "coef_FWI_veg_C-5", "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_M-3", "coef_FWI_veg_N","coef_FWI_veg_O-1a/b", "coef_FWI_veg_S-1",  "AUC")
...
top_mod_table_FRT5_person <- data.frame (matrix (ncol = 18, nrow = 0))
colnames (top_mod_table_FRT5_person ) <- c ("CAUSE", "FRT",  "Model_terms", "intercept", "coef_climate_1", "coef_elevatn", "coef_log_road_dist", "coef_log_inf_dist", "coef_FWI_veg_C-3", "coef_FWI_veg_C-5", "coef_FWI_veg_C-7", "coef_FWI_veg_D-1/2", "coef_FWI_veg_M-1/2", "coef_FWI_veg_M-3", "coef_FWI_veg_N","coef_FWI_veg_O-1a/b", "coef_FWI_veg_S-1",  "AUC")
...
top_mod_table_FRT5_person[1,18]<- mod.auc
