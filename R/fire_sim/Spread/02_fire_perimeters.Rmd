...
st_write(all_points, dsn="C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\spread\\all_sample_points.gpkg")
...
```{r}
sf::st_write(dat2, dsn = "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\spread\\Spread_dem_clim_rds_infr.gpkg", delete_layer=TRUE)
...
sf::st_write(dat4, dsn = "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\spread\\Spread_dem_clim_rds_infr_wind.gpkg", delete_layer=TRUE)
```
