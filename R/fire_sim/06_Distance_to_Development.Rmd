...
```{r}
dist_rail<- raster("C:\\Work\\caribou\\clus\\R\\fire_sim\\data\\dist_rail.tif")
dist_power<- raster("C:\\Work\\caribou\\clus\\R\\fire_sim\\data\\dist_power.tif")
dist_oil<- raster("C:\\Work\\caribou\\clus\\R\\fire_sim\\data\\dist_oil.tif")
dist_mines<- raster("C:\\Work\\caribou\\clus\\R\\fire_sim\\data\\dist_mines.tif")
dist_urban<- raster("C:\\Work\\caribou\\clus\\R\\fire_sim\\data\\dist_urban.tif")
...
```{r}
sample_locations_DEM_roads<-sf::st_read( "C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\Data_clim_DEM_roads_wind_frt.shp")
...
sample_locations_DEM_roads_infra <- sample_locations_DEM_roads_infra %>% 
  select(id:road_dist_m, geometry:dist_urban_m)
...
sample_locations_DEM_roads_infra<- sample_locations_DEM_roads_infra %>%
  dplyr::rename(fire_yr=FIRE_YEAR,
         fire_no=FIRE_NUMBER,
         fire_cs=FIRE_CAUSE,
...
sf::st_write(sample_locations_DEM_roads_infra, dsn = "C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\Data_clim_DEM_roads_infra.shp", delete_layer=TRUE)
