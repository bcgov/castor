...
```{r}
sample_locations_DEM_roads<-sf::st_read( "C:\\Work\\caribou\\clus\\R\\fire_sim\\tmp\\DC_data_DEM_roads.shp")
...
sf::st_write(sample_locations_DEM_roads_infra, dsn = "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\tmp\\Data_clim_DEM_roads_infra.gpkg", delete_layer=TRUE)
