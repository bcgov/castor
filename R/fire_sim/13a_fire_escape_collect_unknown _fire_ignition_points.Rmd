...
st_write(unknown_clipped, dsn = "C:\\Work\\caribou\\castor\\R\\fire_sim\\tmp\\ignt.unknown.frt_rasts_wind.gpkg", delete_layer=TRUE)
...
st_write(unknown_veg_query, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\unknown_veg_query.gpkg")
...
```{r}
file.list1<-list.files("C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data", pattern="Unknown_ignit", all.files=FALSE, full.names=FALSE)
y1<-gsub(".gpkg","",file.list1)
the_dir <- "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data"
...
unknown_ignition_weather2<- st_read( "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\tmp\\unknown_ignition.shp")
...
st_write(fire_all1, "C:\\Work\\caribou\\castor_data\\Fire\\Fire_sim_data\\data\\unknown_ignition_weather_veg.gpkg", overwrite=TRUE)
