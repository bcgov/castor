...
st_write(fire_all1, "C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\unknown_ignition_weather_veg.gpkg")
...
unknown_ignition_weather_veg4<-unknown %>%
  rename(fire_no = FIRE_NU,
    fire_yr=FIRE_YE,
       ...
       infr_ds = dst_nf_, 
       rd_dst_ = dst_rb_) %>%
       dplyr::select(fire_no, fire_yr, IGNITIO, fire_cs, FIRE_LA, ZONE, FIRE_ID, fir_typ, LATITUD, LONGITU, size_ha, ig_mnth, Cluster, idno, slope, aspect, elevatn, Tmax02:MDC_11, infr_ds, rd_dst_, win_sum, win_spg, inventory_standard_cd:FWI_veg)


fire_escapes3 <- fire_escapes2  %>% dplyr::select(fire_no, fire_yr, IGNITIO, fire_cs, FIRE_LA, ZONE, FIRE_ID, fir_typ, LATITUD, LONGITU, size_ha, ig_mnth, Cluster, idno, slope, aspect, elevatn, Tmax02:MDC_11, infr_ds, rd_dst_, win_sum, win_spg, inventory_standard_cd:live_stand_volume_175, yearHarvest:FWI_veg)
