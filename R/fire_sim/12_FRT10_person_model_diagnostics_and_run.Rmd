...
mod_frt10b<- glm(fire ~ climate1 + dm_h_bc + fwveg + road_dist_m, data=dat10, family=binomial(link="logit"))
anova(mod_frt_10a,mod_frt10b, test="Chisq") # removing infrastructure is fine
Anova(mod_frt10b, type=3)

mod_frt10c<-glm(fire ~ climate1 + fwveg + road_dist_m, data=dat10, family=binomial(link="logit"))
