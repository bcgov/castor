...
##Partial Residuals
visreg(mod_frt10c, scale="response") # nicer plots than the ones below!
...
probabilities <- predict(mod_frt10c, type = "response")
...
plot(mod_frt10c, which = 4, id.n = 3)
...
```{r}
mod_frt10<- glm(fire ~ climate1 + road_dist_m + FWI_veg, data=dat10, family=binomial(link="logit"))
...
top_mod_table_FRT5_person[1,3]<-"fire ~ climate1 + road_dist + FWI_veg"
