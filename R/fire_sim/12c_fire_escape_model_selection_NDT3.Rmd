...
*Interactions to include: climate1:elevation + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire
...
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2 + live_stand_volume_125:proj_height_1 + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_dam:bclcs_level_5_2 + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + slope:elevation + aspect:wind_atfire + climate1:elevation + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire, family = binomial, data = dat1)

AIC(model.NDT3) #2837.1
...
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_dam:bclcs_level_5_2 + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + slope:elevation + aspect:wind_atfire + climate1:elevation + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire, family = binomial, data = dat1)

AIC(model.NDT3) #2835.9
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_dam:bclcs_level_5_2 + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + slope:elevation + aspect:wind_atfire + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire, family = binomial, data = dat1)

AIC(model.NDT3) #2833.9
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_dam:bclcs_level_5_2 + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + aspect:wind_atfire + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire, family = binomial, data = dat1)

AIC(model.NDT3) #2831.9
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + aspect:wind_atfire + climate1:wind_atfire + climate2:elevation + climate2:wind_atfire, family = binomial, data = dat1)

AIC(model.NDT3) #2829.3
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + aspect:wind_atfire + climate1:wind_atfire + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2827.8
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire + aspect:wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2826.3
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + dist_mine + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2825.3
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun  + roads_km + bclcs_level_5_2 + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2823.3
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + slope + aspect + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2820.6
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km  + aspect + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2819.7
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1 + climate2:vegtype2  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2819.4
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #2817.8
...
#Remove least significant
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2  + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT3) #3215.07 BAD!
...
NDT3_escape_t<-escape_lightning_t_NDT3 %>% drop_na(climate1, climate2, vegtype2, live_stand_volume_125, proj_height_1, proj_age_1, dist_dam, dist_mun, roads_km, elevation, wind_atfire)

#Run Model again with this data; but uses all data here
model.NDT3<-glm(escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation, family = binomial, data = NDT3_escape_t)
...
NDT3_escape_t$resids<-resid(model.NDT3)
...
top_mod_table_NDT3_light_t_ALL <- data.frame (matrix (ncol = 22, nrow = 0))
colnames (top_mod_table_NDT3_light_t_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_climate_2", "coef_vegtype2TB", "coef_vegtype2TC", "coef_vegtype2TM", "coef_live_stand_volume_125", "coef_proj_height_1", "coef_proj_age_1", "coef_dist_dam", "coef_dist_mun", "coef_roads_km", "coef_elevation", "coef_wind_atfire", "coef_dist_dam:roads_km", "coef_dist_mun:roads_km", "coef_climate2:elevation", "AUC")
```
...
top_mod_table_NDT3_light_t <- data.frame (matrix (ncol = 22, nrow = 0))
...
top_mod_table_NDT3_light_t[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation" 
...
top_mod_table_NDT3_light_t[1,8]<- coef(model.NDT3)[4] #coefficient vegtype2TB 
top_mod_table_NDT3_light_t[1,9]<- coef(model.NDT3)[5] #coefficient vegtype2TC
top_mod_table_NDT3_light_t[1,10]<- coef(model.NDT3)[6] #coefficient vegtype2TM
top_mod_table_NDT3_light_t[1,11]<- coef(model.NDT3)[7] #coefficient live_stand_volume_125
top_mod_table_NDT3_light_t[1,12]<- coef(model.NDT3)[8] #coefficient proj_height_1
top_mod_table_NDT3_light_t[1,13]<- coef(model.NDT3)[9] #coefficient proj_age_1 
top_mod_table_NDT3_light_t[1,14]<- coef(model.NDT3)[10] #coefficient dist_dam 
top_mod_table_NDT3_light_t[1,15]<- coef(model.NDT3)[11] #coefficient dist_mun 
top_mod_table_NDT3_light_t[1,16]<- coef(model.NDT3)[12] #coefficient roads_km
top_mod_table_NDT3_light_t[1,17]<- coef(model.NDT3)[13] #coefficient elevation
top_mod_table_NDT3_light_t[1,18]<- coef(model.NDT3)[14] #coefficient  wind_atfire 
top_mod_table_NDT3_light_t[1,19]<- coef(model.NDT3)[15] #coefficient  dist_dam:roads_km
top_mod_table_NDT3_light_t[1,20]<- coef(model.NDT3)[16] #coefficient  dist_mun:roads_km
top_mod_table_NDT3_light_t[1,21]<- coef(model.NDT3)[17] #coefficient climate2:elevation
top_mod_table_NDT3_light_t[1,22]<- mod.auc
...
mean(top_mod_table_NDT3_light_t_ALL$AUC) # 0.74

# create model table (only do this once) and add the relevant data
top_mod_table_NDT3_light_t_Means <- data.frame (matrix (ncol = 22, nrow = 0))
...
top_mod_table_NDT3_light_t_Means[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation" 
...
top_mod_table_NDT3_light_t_Means[1,17]<- mean(top_mod_table_NDT3_light_t_ALL$coef_elevation, na.rm=TRUE) #
top_mod_table_NDT3_light_t_Means[1,18]<- mean(top_mod_table_NDT3_light_t_ALL$coef_wind_atfire, na.rm=TRUE) #
top_mod_table_NDT3_light_t_Means[1,19]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_dist_dam:roads_km`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_Means[1,20]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_dist_mun:roads_km`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_Means[1,21]<- mean(top_mod_table_NDT3_light_t_ALL$`coef_climate2:elevation`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_Means[1,22]<- mean(top_mod_table_NDT3_light_t_ALL$AUC, na.rm=TRUE)
...
```{r}
# create model table (only do this once) and add the relevant data
top_mod_table_NDT3_light_t_SD <- data.frame (matrix (ncol = 22, nrow = 0))
...
top_mod_table_NDT3_light_t_SD[1,4]<-"escape ~ climate1 + climate2 + vegtype2 + live_stand_volume_125 + proj_height_1 + proj_age_1  + dist_dam + dist_mun + roads_km + dist_dam:roads_km + dist_mun:roads_km + elevation + wind_atfire  + climate2:elevation" 
...
top_mod_table_NDT3_light_t_SD[1,17]<- sd(top_mod_table_NDT3_light_t_ALL$coef_elevation, na.rm=TRUE) #
top_mod_table_NDT3_light_t_SD[1,18]<- sd(top_mod_table_NDT3_light_t_ALL$coef_wind_atfire, na.rm=TRUE) #
top_mod_table_NDT3_light_t_SD[1,19]<- sd(top_mod_table_NDT3_light_t_ALL$`coef_dist_dam:roads_km`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_SD[1,20]<- sd(top_mod_table_NDT3_light_t_ALL$`coef_dist_mun:roads_km`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_SD[1,21]<- sd(top_mod_table_NDT3_light_t_ALL$`coef_climate2:elevation`, na.rm=TRUE) #
top_mod_table_NDT3_light_t_SD[1,22]<- sd(top_mod_table_NDT3_light_t_ALL$AUC, na.rm=TRUE)
