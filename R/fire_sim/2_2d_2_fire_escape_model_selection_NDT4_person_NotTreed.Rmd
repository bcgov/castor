...
```{r}
escape_person_nt_NDT4<-subset(Escape_data_person_nt, Escape_data_person_nt$ntrl_ds=="NDT4") #Only 124 observations - likely cannot use all interactions effectively
...
model.NDT4.E<-glm(escape ~ climate1 + climate2 + slope + aspect + elevation + aspect:elevation + dist_mun, family = binomial, data = dat1)

AIC(model.NDT4.E) #81.8
...
model.NDT4.E<-glm(escape ~ climate1 + climate2 + slope + aspect + elevation + aspect:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #80.0
...
#Remove least significant
model.NDT4.E<-glm(escape ~ climate1 + climate2 + aspect + elevation + aspect:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #78.9
...
#Go back
model.NDT4.E<-glm(escape ~ climate1 + climate2 + slope + aspect + elevation + aspect:elevation + dist_mun + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #81.5
...
#Add
model.NDT4.E<-glm(escape ~ climate1 + climate2 + slope + aspect + elevation + aspect:elevation + dist_mun + climate1:elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #82.9
...
#
model.NDT4.E<-glm(escape ~ climate1 + climate2 + slope + aspect + elevation + aspect:elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #64.8
...
#
model.NDT4.E<-glm(escape ~ climate1  + slope + aspect + elevation + aspect:elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #63.2
...
#
model.NDT4.E<-glm(escape ~ climate1 + slope + aspect + elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4.E) #62.6
...
NDT4_escape_nt<-escape_person_nt_NDT4 %>% drop_na(climate1, dist_mun,slope, aspect, elevation, Tdif_atfire, bclcs_level_5_2) #122 observations

#Run Model again with this data; but uses all data here
model.NDT4.E<-glm(escape ~ climate1 + slope + aspect + elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation, family = binomial, data = NDT4_escape_nt)
...
visreg(model.NDT4.E, "elevation")
visreg(model.NDT4.E, "aspect")

visreg(model.NDT4.E, "bclcs_level_5_2", ylim = c(-50,50))
...
top_mod_ntable_NDT4_person_nt_ALL <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_ntable_NDT4_person_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_slope", "coef_aspect", "coef_elevation", "coef_dist_mun", "coef_Tdif_atfire", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_climate1:elevation", "AUC")
...
top_mod_ntable_NDT4_person_nt <- data.frame (matrix (ncol = 15, nrow = 0))
colnames (top_mod_ntable_NDT4_person_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_slope", "coef_aspect", "coef_elevation", "coef_dist_mun", "coef_Tdif_atfire", "coef_bclcs_level_5_2OP", "coef_bclcs_level_5_2SP", "coef_climate1:elevation", "AUC")

##Add data for NDT4
top_mod_ntable_NDT4_person_nt[1,1]<-"person"
top_mod_ntable_NDT4_person_nt[1,2]<-"NDT4"
top_mod_ntable_NDT4_person_nt[1,3]<-"N"
top_mod_ntable_NDT4_person_nt[1,4]<-"escape ~ climate1 + slope + aspect + elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation" 
...
top_mod_ntable_NDT4_person_nt[1,15]<- mod.auc
...
top_mod_ntable_NDT4_escape_person_nt_means[1,4]<- "escape ~ climate1 + slope + aspect + elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation" 
top_mod_ntable_NDT4_escape_person_nt_means
```
Save table.
...
top_mod_ntable_NDT4_escape_person_nt_sd[1,4]<-"escape ~ climate1 + slope + aspect + elevation + dist_mun + Tdif_atfire + bclcs_level_5_2 + climate1:elevation" 
top_mod_ntable_NDT4_escape_person_nt_sd
```
