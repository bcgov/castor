...
NDT4_nt<-dat_lightning_nt_NDT4 %>% drop_na(climate1, vegtype2, slope, elevation, aspect_cos, dist_mun, dist_pow, dist_mine, bclcs_level_5_2)

#Run Model again with this data; but uses all data here
model.NDT4<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_pow + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + climate1:elevation, family = binomial, data = NDT4_nt)
...
#Residual Plot
#climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_pow + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + climate1:elevation
...
visreg(model.NDT4, "dist_mun", by="bclcs_level_5_2", overlay=TRUE)
visreg(model.NDT4, "dist_mine", by="bclcs_level_5_2", overlay=TRUE)
...
top_mod_table_NDT4_light_nt <- data.frame (matrix (ncol = 24, nrow = 0))
...
top_mod_table_NDT4_light_nt[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_pow + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + climate1:elevation" 
...
top_mod_table_NDT4_light_nt[1,7]<- coef(model.NDT4)[3] #
top_mod_table_NDT4_light_nt[1,8]<- coef(model.NDT4)[4] #
top_mod_table_NDT4_light_nt[1,9]<- coef(model.NDT4)[5] #
top_mod_table_NDT4_light_nt[1,10]<- coef(model.NDT4)[6] #
top_mod_table_NDT4_light_nt[1,11]<- coef(model.NDT4)[7] #
top_mod_table_NDT4_light_nt[1,12]<- coef(model.NDT4)[8] 
top_mod_table_NDT4_light_nt[1,13]<- coef(model.NDT4)[9] #
top_mod_table_NDT4_light_nt[1,14]<- coef(model.NDT4)[10] #
top_mod_table_NDT4_light_nt[1,15]<- coef(model.NDT4)[11] 
top_mod_table_NDT4_light_nt[1,16]<- coef(model.NDT4)[12] 
top_mod_table_NDT4_light_nt[1,17]<- coef(model.NDT4)[13] #
top_mod_table_NDT4_light_nt[1,18]<- coef(model.NDT4)[14] #
top_mod_table_NDT4_light_nt[1,19]<- coef(model.NDT4)[15] #
top_mod_table_NDT4_light_nt[1,20]<- coef(model.NDT4)[16] #
top_mod_table_NDT4_light_nt[1,21]<- coef(model.NDT4)[17] #
top_mod_table_NDT4_light_nt[1,22]<- coef(model.NDT4)[18] 
top_mod_table_NDT4_light_nt[1,23]<- coef(model.NDT4)[19] #
top_mod_table_NDT4_light_nt[1,24]<- mod.auc
...
mean(top_mod_table_NDT4_light_nt_ALL$AUC) #0.64

top_mod_table_NDT4_light_nt_Means<-top_mod_table_NDT4_light_nt_ALL %>% summarise_each(funs( mean( .,na.rm = TRUE)))
...
top_mod_table_NDT4_light_nt_Means[1,3]<-"Not treed"
top_mod_table_NDT4_light_nt_Means[1,4]<- "fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_pow + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + climate1:elevation" 
top_mod_table_NDT4_light_nt_Means
```
...
```{r}
top_mod_table_NDT4_light_nt_SD<-top_mod_table_NDT4_light_nt_ALL %>% summarise_each(funs( sd( .,na.rm = TRUE)))
top_mod_table_NDT4_light_nt_SD

top_mod_table_NDT4_light_nt_SD[1,1]<-"lightning"
top_mod_table_NDT4_light_nt_SD[1,2]<-"NDT4"
top_mod_table_NDT4_light_nt_SD[1,3]<-"Not treed"
top_mod_table_NDT4_light_nt_SD[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + dist_mun + dist_pow + dist_mine + bclcs_level_5_2 + dist_mun:bclcs_level_5_2 + dist_mine:bclcs_level_5_2 + climate1:elevation" 
top_mod_table_NDT4_light_nt_SD
```
...
#Redo above with condensed variables
...
#Run model using dat1
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra +  climate1:elevation + climate2:elevation, family = binomial, data = dat1)

AIC(model.NDT4) #1607.0
...
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:climate2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra +  climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4) #1605.3
...
#Remove least significant
model.NDT4<-glm(fire_pres ~ climate1 + climate2 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra +  climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4) #1603.8
...
#Remove least significant
model.NDT4<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra +  climate1:elevation, family = binomial, data = dat1)

AIC(model.NDT4) #1601.9
...
```{r}
#Remove NAs to ensure all same data used so we can compare AICs
NDT4_nt<-dat_lightning_nt_NDT4 %>% drop_na(climate1, vegtype2, slope, elevation, aspect_cos, dist_infra)

#Run Model again with this data; but uses all data here
model.NDT4<-glm(fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra + climate1:elevation, family = binomial, data = NDT4_nt)
...
#Residual Plot
#climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra + climate1:elevation
visreg(model.NDT4, "climate1", by="vegtype2", overlay=TRUE)
visreg(model.NDT4, "climate1", by="elevation")
...
#Create a new blank table and get AUC too
top_mod_table_NDT4_light_nt_ALL <- data.frame (matrix (ncol = 17, nrow = 0))
colnames (top_mod_table_NDT4_light_nt_ALL ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtypeOP", "coef_vegtypeS", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_climate1:vegtype2OP", "coef_climate1:vegtype2S", "coef_slope:elevation", "coef_climate1:elevation", "AUC")
```
...
# create model table (only do this once) and add the relevant data
top_mod_table_NDT4_light_nt <- data.frame (matrix (ncol = 17, nrow = 0))
colnames (top_mod_table_NDT4_light_nt ) <- c ("CAUSE", "NDT", "TREED", "Model_terms", "intercept", "coef_climate_1", "coef_vegtypeOP", "coef_vegtypeS", "coef_slope", "coef_aspect_cos", "coef_elevation", "coef_dist_infra", "coef_climate1:vegtype2OP", "coef_climate1:vegtype2S", "coef_slope:elevation", "coef_climate1:elevation", "AUC")

##Add data for NDT4
top_mod_table_NDT4_light_nt[1,1]<-"lightning"
top_mod_table_NDT4_light_nt[1,2]<-"NDT4"
top_mod_table_NDT4_light_nt[1,3]<-"N"
top_mod_table_NDT4_light_nt[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra + climate1:elevation" 
top_mod_table_NDT4_light_nt[1,5]<- coef(model.NDT4)[1] #Intercept
top_mod_table_NDT4_light_nt[1,6]<- coef(model.NDT4)[2] #Climate variable 1
top_mod_table_NDT4_light_nt[1,7]<- coef(model.NDT4)[3] #
top_mod_table_NDT4_light_nt[1,8]<- coef(model.NDT4)[4] #
...
top_mod_table_NDT4_light_nt[1,15]<- coef(model.NDT4)[11] 
top_mod_table_NDT4_light_nt[1,16]<- coef(model.NDT4)[12] 
top_mod_table_NDT4_light_nt[1,17]<- mod.auc
...
```{r}
write.csv(top_mod_table_NDT4_light_nt_ALL, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_nt_ALL_Jan.csv")
```
...
```{r}
names(top_mod_table_NDT4_light_nt_ALL)
mean(top_mod_table_NDT4_light_nt_ALL$AUC) #0.61
...
top_mod_table_NDT4_light_nt_Means[1,2]<-"NDT4"
top_mod_table_NDT4_light_nt_Means[1,3]<-"Not treed"
top_mod_table_NDT4_light_nt_Means[1,4]<- "fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra + climate1:elevation" 
top_mod_table_NDT4_light_nt_Means
```
...
```{r}
write.csv(top_mod_table_NDT4_light_nt_Means, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_nt_Means_Jan.csv")
```
...
top_mod_table_NDT4_light_nt_SD[1,2]<-"NDT4"
top_mod_table_NDT4_light_nt_SD[1,3]<-"Not treed"
top_mod_table_NDT4_light_nt_SD[1,4]<-"fire_pres ~ climate1 + vegtype2 + climate1:vegtype2 + slope + aspect_cos + elevation + slope:elevation + dist_infra + climate1:elevation" 
top_mod_table_NDT4_light_nt_SD
```

```{r}
write.csv(top_mod_table_NDT4_light_nt_SD, file="D:\\Fire\\fire_data\\raw_data\\top_mod_table_NDT4_light_nt_SD_Jan.csv")
```
