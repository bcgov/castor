...
table(fire_veg_DEM_climate_2$bclcs_level_2) #Remove ones designated as water. This will be done in the next step.

```

Save datafile to clus database. This needs to be done via OsGeo4 command line.


```{r}

st_write(fire_veg_DEM_climate_2, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Escape_data.shp", delete_layer=TRUE)
