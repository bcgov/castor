...
```{r}
#Save to postgre
#ogr2ogr -f PostgreSQL PG:"host=DC052586 user= dbname=clus password= port=5432" D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Data.spread.shp -overwrite -a_srs EPSG:3005 -progress --config PG_USE_COPY YES -nlt PROMOTE_TO_MULTI

#ogr2ogr -f "PostgreSQL" PG:"host=localhost user=postgres dbname=postgres password=postgres port=5432" D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Data.spread.shp -overwrite -a_srs EPSG:3005 -progress --config PG_USE_COPY YES -nlt PROMOTE_TO_MULTI
```
...
(SELECT feature_id, bclcs_level_2, bclcs_level_3, bclcs_level_4, bclcs_level_5,
  ...
  fire.roads_km, fire.win_sum, fire.win_spr, fire.dist_mun, fire.dist_dam,
  fire.dist_nat, fire.dist_pow, fire.dist_mine, fire.dist_any,
  ...
  spread, id, slope, aspect, elev, roads_km, win.sum, win_spr, 
  # subzone, ntrl_ds, 
   dist_mun, dist_dam, dist_nat, dist_pow, dist_mine, dist_any 
   from Data_spread where FIRE_YEAR = '2002') as fire where st_contains
