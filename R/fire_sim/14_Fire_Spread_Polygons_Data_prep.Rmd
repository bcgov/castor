...
```{r}
keep(spread_150_DEM_roads_wind, spread_150_DEM_roads_wind_sf, spread_150_DEM_roads_wind_sf_2, spread_500_DEM, spread_150_DEM_roads_wind_sf_2_df, sure = TRUE) # setting sure to TRUE removes variables not in the list
...
spread_150_DEM_roads_wind_sf_2<-select(spread_150_DEM_roads_wind_sf, 'id2','FIRE_NO', 'FIRE_YEAR', 'FIRE_CAUSE','SIZE_HA', 'FIRE_DATE', 'OBJECTID', 'AREA_SQM', 'spread', 'id', 'slope_ha_bc', 'aspect_ha_bc', 'dem_ha_bc', 'roads_km', 'wind_summer_clipped_224', 'wind_spring_raster_224', 'geometry')

str(spread_150_DEM_roads_wind_sf_2)

spread_150_DEM_roads_wind_sf_2b<-st_cast(spread_150_DEM_roads_wind_sf_2, "POINT")
spread_150_DEM_roads_wind_sf_2c<-st_make_valid(spread_150_DEM_roads_wind_sf_2b)
str(spread_150_DEM_roads_wind_sf_2c)


spread_150_DEM_roads_wind_sf_2c_<-cbind(spread_150_DEM_roads_wind_sf_2c, st_coordinates(spread_150_DEM_roads_wind_sf_2c))
head(spread_150_DEM_roads_wind_sf_2c_)


spread_150_DEM_roads_wind_sf_2d<-data.frame((spread_150_DEM_roads_wind_sf_2c_))
str(spread_150_DEM_roads_wind_sf_2d)

spread_150_DEM_roads_wind_sf_2d_ = subset(spread_150_DEM_roads_wind_sf_2d, select = -c(geometry) )
head(spread_150_DEM_roads_wind_sf_2d_)

spread_150_DEM_roads_wind_sf_2e<-st_as_sf(spread_150_DEM_roads_wind_sf_2d_, coords = c("X", "Y"))
str(spread_150_DEM_roads_wind_sf_2e)
st_crs(spread_150_DEM_roads_wind_sf_2e)

spread_150_DEM_roads_wind_sf_2e_<- spread_150_DEM_roads_wind_sf_2e %>% st_set_crs(3005)
st_crs(spread_150_DEM_roads_wind_sf_2e_)
head(spread_150_DEM_roads_wind_sf_2e_)
str(spread_150_DEM_roads_wind_sf_2e_)


sf::st_write(spread_150_DEM_roads_wind_sf_2e_, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind.shp", delete_layer=TRUE)

sf::st_write(spread_150_DEM_roads_wind_sf_2e, "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind_.shp", delete_layer=TRUE, layer_options = "GEOMETRY=AS_WKT")

sf::st_write(spread_150_DEM_roads_wind_sf_2e, dsn= "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind_.shp", delete_layer=TRUE, layer_options = "GEOMETRY=AS_XY")


#Save as dataframe as well
spread_150_DEM_roads_wind_sf_2_df<-data.frame((spread_150_DEM_roads_wind_sf_2))

write.csv(spread_150_DEM_roads_wind_sf_2_df, "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind_df.csv")

write.csv(spread_150_DEM_roads_wind_sf_2d, "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind_df_.csv")

spread_150_DEM_roads_wind_sf_2f<-read.csv("D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\spread_150_DEM_roads_wind_sf_.csv")
head(spread_150_DEM_roads_wind_sf_2f)

spread_150_DEM_roads_wind_sf_2f$geometry<-paste(spread_150_DEM_roads_wind_sf_2f$geometry, "," , spread_150_DEM_roads_wind_sf_2f$X)

spread_150_DEM_roads_wind_sf_2g<-st_as_sf(spread_150_DEM_roads_wind_sf_2f, sf_column_name = "geometry", wkt="geometry")
...
Note: TBD if this file will be able to be saved after processing either. May need to do this step in QGIS as well. If do in R, use below code. Otherwise, in QGIS, use the Field Calculator, and the min(A,B,C...) function.
...
```{r}
sf::st_write(spread_locations_distances, dsn = "D:\\Fire\\fire_data\\raw_data\\ClimateBC_Data\\Spread_DEM_roads_wind_infra.shp", delete_layer=TRUE)
```
