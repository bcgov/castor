---
title: "11_fire_ignition_model_selection_FRT10_lightning_treed"
author: "Cora Skaien"
date: "16/09/2021"
...
# note FRT 10 had Tave08 as the climate variable
```{r}
...
variables_all<-c(climate1 = "climate1", prj_h_1 = "prj_h_1", prj_g_1 = "prj_g_1", l___125 = "l___125", elevatn ="elevatn", vegtype = "vegtype") 

variables_all_c1<-c(climate1 = "climate1", prj_h_1 = "prj_h_1", prj_g_1 = "prj_g_1", l___125 = "l___125", elevatn ="elevatn", vegtype = "vegtype") 
...
```{r}
zones1<-c("10") #Do one zone at a time
...
FRT10_l_models_treed$FRT<-"FRT10"

write.csv(FRT10_l_models_treed, file="C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\data\\Ignition_lightning_treed_model_results\\FRT10_lightning_models_treed.csv")
```
...
Save.
```{r}
write.csv(AIC_lightning_t, file="C:\\Work\\caribou\\clus_data\\Fire\\Fire_sim_data\\out\\table.glm.FRT_10_ALL.csv")
```
