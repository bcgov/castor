...
#Overview
This file continues from huckleberry&buffaloberry_data_processing_Jan2022. Here, we explore how silviculture practices influence the abundance of buffaloberry berries.

#Load Data In
```{r}
cutblock_plots_openings_Buff_ALL_df<-read.csv(file="C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Buff_ALL_df_March2022.csv")
...
cutblock_plots_openings_Buff_ALL_df<-subset(cutblock_plots_openings_Buff_ALL_df, cutblock_plots_openings_Buff_ALL_df$Species.Pr!="0") #145 plants
...
table(cutblock_plots_openings_Buff_ALL_df$DN1_DIS_CD) #135 logged
```
...
table(cutblock_plots_openings_Buff_ALL_df$PREP_BU)    #103 not burned, 200 burned; MANY NAs
...
table(cutblock_plots_openings_Buff_ALL_df$PREP1_TECH) #156 burned
table(cutblock_plots_openings_Buff_ALL_df$PREP2_TECH) #67 burned
table(cutblock_plots_openings_Buff_ALL_df$PREP_TECH_2) #122 Bu Bu (so burned both times); so 200 burned seemed realistic
...
table(cutblock_plots_openings_Buff_ALL_df$PREP_ME, cutblock_plots_openings_Buff_ALL_df$Mechanical) #14 more yeses for one, and 10 different moreyeses for other...
table(cutblock_plots_openings_Buff_ALL_df$PREP_ME) #180 yes
table(cutblock_plots_openings_Buff_ALL_df$Mechanical) #184 yes
...
table(cutblock_plots_openings_Buff_ALL_df$Mechanical2) #914 yeses, combining infor from both
...
table(cutblock_plots_openings_Buff_ALL_df$Manual) #142 yeses
...
table(cutblock_plots_openings_Buff_ALL_df$Manual2) #145 yeses, combining info from both
...
table(cutblock_plots_openings_Buff_ALL_df$Brush2) #140 yeses, combining info from both
```
...
table(cutblock_plots_openings_Buff_ALL_df$Chem2) #40 yeses, combining info from both
...
table(cutblock_plots_openings_Buff_ALL_df$Planted2) #387 yeses, combining info from both; 31 nos
```
...
```{r}
table(cutblock_plots_openings_Buff_ALL_df$PREP_BU) #262 no, 161 yes
table(cutblock_plots_openings_Buff_ALL_df$PREP_ME) #243 no, 180 yes
table(cutblock_plots_openings_Buff_ALL_df$PREP_MA) #404 no, 19 yes

#With refined data
table(cutblock_plots_openings_Buff_ALL_df$Burned) #242 no, 176 yes
table(cutblock_plots_openings_Buff_ALL_df$Mechanical2) #224 no, 194 yes
table(cutblock_plots_openings_Buff_ALL_df$Manual2) #273 no, 145 yes # But thuis may include brushing now?

#Compare above with data
table(cutblock_plots_openings_Buff_ALL_df$Species.Pr) #423 present; ignores BEC plots because only presences there
table(cutblock_plots_openings_Buff_ALL_df$Species.Pr, cutblock_plots_openings_Buff_ALL_df$PREP_BU) 
table(cutblock_plots_openings_Buff_ALL_df$Species.Pr, cutblock_plots_openings_Buff_ALL_df$DN1_SILSYS_GP) #Only 475 datapoints accounted for here. CCRES = Clearcut with reserves; CLEAR = clearcut
...
cutblock_plots_openings_Buff_ALL_df$CutBlock_O[is.na(cutblock_plots_openings_Buff_ALL_df$CutBlock_O)]<-1
table(cutblock_plots_openings_Buff_ALL_df$CutBlock_O) #604 - fixed!
...
cutblock_plots_openings_Buff_ALL_df<-subset(cutblock_plots_openings_Buff_ALL_df, cutblock_plots_openings_Buff_ALL_df$origin=="1") #Drops down to 406
```
...
```{r}
table(cutblock_plots_openings_Buff_ALL_df$Fruit.Pres) #All 406 cases report if fruits or not
...
cutblock_plots_openings_Buff_ALL_df_FruitNotNA<-subset(cutblock_plots_openings_Buff_ALL_df, cutblock_plots_openings_Buff_ALL_df$Fruit.AbunTEST!="NA") #240
table(cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Fruit.Pres) # 112 absences, 210 presences.
```
...
```{r}
cutblock_plots_openings_Buff_ALL_df_FruitNotNA$planted_density_TOT #This indicates planting density of the up to 5 species planted. Probably more accurate than creating a proxy. But note, not all have this info, so will lose more data again.
```
...
```{r}
cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Species.Co #Only a handful of NAs, actually not too bad
cor(cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Species.Co, cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Fruit.AbunTEST, use = "complete.obs") #0.22
...
cor(cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Species.He, cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Fruit.AbunTEST, use = "complete.obs") #0.26 - this correlation is stronger
...
```{r}
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA, aes (x = origin.age, y = Canopy.Cov, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA, aes (x = Canopy.Cov, y = Fruit.AbunTEST, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
Chem2
```{r}
cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Chem2 #A few NAs... why?
cutblock_plots_openings_Buff_ALL_df_FruitNotNA_chem<-subset(cutblock_plots_openings_Buff_ALL_df_FruitNotNA, cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Chem2!="NA")

ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA_chem, aes (x = Canopy.Cov, y = Fruit.AbunTEST, colour = factor(Chem2))) +
  geom_point () +
  geom_smooth (se=F) +
...
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA_chem, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Chem2))) +
  geom_point () +
  geom_smooth (se=F) +
...
Brush2
```{r}
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA_chem, aes (x = Canopy.Cov, y = Fruit.AbunTEST, colour = factor(Brush2))) +
  geom_point () +
  geom_smooth (se=F) +
...
ggplot (cutblock_plots_openings_Buff_ALL_df_FruitNotNA_chem, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Brush2))) +
  geom_point () +
  geom_smooth (se=F) +
...
##ALL BELOW MODELS NEED UPDATING: MARCH 17, 2022 ###
...
cutblock_plots_openings_Buff_ALL_df_FruitNotNA$PREP_ME<-as.factor(cutblock_plots_openings_Buff_ALL_df_FruitNotNA$PREP_ME)
...
#Model Series 2:
DN1_SILSYS_GP + PREP_ME + Burned + Brush2 + Chem2 + G_BGC_ZONE + OPEN_GRSAR + PLANTED + Canopy.Cov + START_SEASON + heatload + PREP_ME*Canopy.Cov + START_SEASON*Canopy.Cov + Chem2*Canopy.Cov + Species.He
...
```{r}
#Best model
model.new.1 <- lm (Fruit.AbunTEST ~ DN1_SILSYS_GP + PREP_ME + Burned + Chem2 + G_BGC_ZONE + TimeSinceCutblock + START_SEASON + heatload + PREP_ME*TimeSinceCutblock + Species.He, data=cutblock_plots_openings_Buff_ALL_df_FruitNotNA)
...
```{r}
model.new.2 <- lm (Fruit.AbunTEST ~ DN1_SILSYS_GP + PREP_ME + Burned + Brush2 + Chem2 + G_BGC_ZONE + OPEN_GRSAR + PLANTED + Canopy.Cov + START_SEASON + heatload + PREP_ME*Canopy.Cov + START_SEASON*Canopy.Cov + Chem2*Canopy.Cov + Species.He,
data=cutblock_plots_openings_Buff_ALL_df_FruitNotNA)
...
```{r}
#Best model
model.new.2 <- lm (Fruit.AbunTEST ~ + PREP_ME + Burned + Brush2 + G_BGC_ZONE  + Canopy.Cov + START_SEASON + heatload + Species.He,
data=cutblock_plots_openings_Buff_ALL_df_FruitNotNA)
...
#Explore partial residuals with current model
# PREP_ME + Burned + Brush2 + G_BGC_ZONE  + Canopy.Cov + START_SEASON + heatload + Species.He
library(visreg)
...
```{r}
write.csv(cutblock_plots_openings_Buff_ALL_df_FruitNotNA, file="c:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Buff_ALL_df_FruitNotNA_March16.csv")
```
...
```{r}
model.new.2b <- gam (Fruit.AbunTEST ~ DN1_SILSYS_GP + PREP_ME + Burned + Brush2 + Chem2 + G_BGC_ZONE + s(OPEN_GRSAR) + s(Canopy.Cov, by=PLANTED) + s(Canopy.Cov, by=PREP_ME) + s(Canopy.Cov, by=Chem2) + s(Canopy.Cov, by=START_SEASON) + s(heatload) + s(Species.He) + s(Canopy.Cov, by=Brush2),
data=cutblock_plots_openings_Buff_ALL_df_FruitNotNA, method="REML")
...
```{r}
model.new.2b_2 <- gam (Fruit.AbunTEST ~ DN1_SILSYS_GP + PREP_ME + Burned + Brush2 + Chem2 + G_BGC_ZONE + s(OPEN_GRSAR) + s(Canopy.Cov, by=PLANTED) + s(Canopy.Cov, by=PREP_ME) + s(Canopy.Cov, by=Chem2) + s(Canopy.Cov, by=START_SEASON) + s(Canopy.Cov, by=Brush2),
data=cutblock_plots_openings_Buff_ALL_df_FruitNotNA, method="REML")
