...
```{r}
table(cutblock_plots_openings_Buff_ALL_df$PREP_BU) #113 no, 22 yes
table(cutblock_plots_openings_Buff_ALL_df$PREP_ME) #98 no, 37 yes
table(cutblock_plots_openings_Buff_ALL_df$PREP_MA) #133 no, 2 yes

#With refined data
table(cutblock_plots_openings_Buff_ALL_df$Burned) #113 no, 22 yes
table(cutblock_plots_openings_Buff_ALL_df$Mechanical2) #97 no, 38 yes
table(cutblock_plots_openings_Buff_ALL_df$Manual2) #95 no, 40 yes # But thuis may include brushing now?
...
```{r}
table(cutblock_plots_openings_Buff_ALL_df$Fruit.Pres) #All 134 cases report berries 0/1
...
cutblock_plots_openings_Buff_ALL_df_FruitNotNA<-subset(cutblock_plots_openings_Buff_ALL_df, cutblock_plots_openings_Buff_ALL_df$Fruit.AbunTEST!="NA") #119
table(cutblock_plots_openings_Buff_ALL_df_FruitNotNA$Fruit.Pres) # 19 absences, 100 presences.
```
