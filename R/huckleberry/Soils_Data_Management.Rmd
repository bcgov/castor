...
Bring in the data for soils.
```{r}
cutblock_plots_openings_soils<- st_read ( dsn = "D:\\Hucklberry\\Clayton_openings_soils.shp", stringsAsFactors = T) #986 observations
str(cutblock_plots_openings)

Huck_Laura_Berries_soils<-st_read ( dsn = "D:\\Hucklberry\\Laura_openings_soils.shp", stringsAsFactors = T)
head(Huck_Laura_Berries) #42 datapoints

cutblock_plots_openings_mowatBuff_soils<- st_read ( dsn = "D:\\Hucklberry\\Mackenzie_openings_soils.shp", stringsAsFactors = T)
...
```{r}
Clayton_cutblock_plots_openings_df_soils<-full_join(cutblock_plots_openings_df, cutblock_plots_openings_soils_df) #If join this way, end up with 1783 observations

Laura_cutblock_plots_openings_df_soils<-full_join(Huck_Laura_Berries_df, Huck_Laura_Berries_soils_df) # end up with 84 observations

Mackenzie_cutblock_plots_openings_df_soils<-full_join(cutblock_plots_openings_mowatBuff_df, cutblock_plots_openings_mowatBuff_soils_df) #End up with 101 observations
