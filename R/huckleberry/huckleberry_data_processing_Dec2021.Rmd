...
names(cutblock_plots_openings_df_Huck) # Key names: Species.Cover, HARVEST_YE == CutBlock_Year
...
cutblock_plots_openings_df_Huck[setdiff(names(cutblock_plots_openings_BECHuck_df), names(cutblock_plots_openings_df_Huck))] <- NA
cutblock_plots_openings_BECHuck_df[setdiff(names(cutblock_plots_openings_df_Huck), names(cutblock_plots_openings_BECHuck_df))] <- NA

cutblock_plots_openings_Huck_ALL_df<-rbind(cutblock_plots_openings_df_Huck, cutblock_plots_openings_BECHuck_df)
...
names(cutblock_plots_openings_df_Buff)
...
2. Other elements huckleberry: cutblock_plots_openings_df_Huck (although if use above, NA remove will likely get same result- *should* at least)
