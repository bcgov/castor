...
table(cutblock_plots_openings_Huck_ALL_df2$Species.Present2) #133 absences and 467 present
...
hist(cutblock_plots_openings_Huck_ALL_df2b$ASPECT)
...
plot(cutblock_plots_openings_Huck_ALL_df2b$ASPECT ~ cutblock_plots_openings_Huck_ALL_df2b$aspect_30m_SRTM)
...
cutblock_plots_openings_Huck_ALL_df2b$SAI_cb<-(sin(cutblock_plots_openings_Huck_ALL_df2b$ASPECT + 225) *(cutblock_plots_openings_Huck_ALL_df2b$SLOPE/58.9)) #SAI (Slope to aspect Index) of cutblock data slope and aspect
...
plot(DEM)
crs(DEM)
crs(cutblock_plots_openings_Huck_ALL_df2b) #Same! Excellent.

pointCoordinates<-data.frame(cutblock_plots_openings_Huck_ALL_df2b$coords.x1, cutblock_plots_openings_Huck_ALL_df2b$coords.x2)
...
#Append
cutblock_plots_openings_Huck_ALL_df2c<-cbind(cutblock_plots_openings_Huck_ALL_df2b, ELEVATION)
head(cutblock_plots_openings_Huck_ALL_df2c)
```

```{r}
hist(cutblock_plots_openings_Huck_ALL_df2c$ELEVATION)
```
...
```{r}
cutblock_plots_openings_Huck_ALL_df2c$PLANTED<-as.factor(cutblock_plots_openings_Huck_ALL_df2c$PLANTED)
```
...
model.new.1 <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PAS_total + PH2 + MODIS_LC + PLANTED +AREAHA + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df2c,
               family = binomial (link = "logit"))
...
names(cutblock_plots_openings_Huck_ALL_df2c)
cutblock_plots_openings_Huck_ALL_df2c$VFSAND
...
```{r}
#Add BEC zones
table(cutblock_plots_openings_Huck_ALL_df2c$G_BGC_ZONE)
...
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = slope_30m_SRTM, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope",
...
cutblock_plots_openings_Huck_ALL_df2c$slope_30m_SRTM_tr<- -((cutblock_plots_openings_Huck_ALL_df2c$slope_30m_SRTM/4)-5)^2+23

ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = slope_30m_SRTM_tr, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope Transformed",
...
```
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = PH2, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "pH",
...
cutblock_plots_openings_Huck_ALL_df2c$PH2_tr<- -((cutblock_plots_openings_Huck_ALL_df2c$PH2)-4)^2+25

ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = PH2_tr, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "pH transformed",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = Tave_wt, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Average winter Temp",
...
cutblock_plots_openings_Huck_ALL_df2c$Tave_wt_tr<- -((cutblock_plots_openings_Huck_ALL_df2c$Tave_wt)+7)^2+7

ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = Tave_wt_tr, y = Species.Cover)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
...
cutblock_plots_openings_Huck_ALL_df2c_ng<-as.data.frame((cutblock_plots_openings_Huck_ALL_df2c))
model.data<- cutblock_plots_openings_Huck_ALL_df2c_ng %>% dplyr::select(Species.Present2, variables.huck)
...
names(cutblock_plots_openings_Huck_ALL_df2c)
head(cutblock_plots_openings_Huck_ALL_df2c$DST_STR_DT)
table(cutblock_plots_openings_Huck_ALL_df2c$DST_STR_DT)

cutblock_plots_openings_Huck_ALL_df2c$DST_Start_year<-stri_sub(cutblock_plots_openings_Huck_ALL_df2c$DST_STR_DT,3,4)
cutblock_plots_openings_Huck_ALL_df2c$DST_Start_year
cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month<-stri_sub(cutblock_plots_openings_Huck_ALL_df2c$DST_STR_DT,5,6)
head(cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month)
cutblock_plots_openings_Huck_ALL_df2c$DST_End_year<-stri_sub(cutblock_plots_openings_Huck_ALL_df2c$DST_END_DT,3,4)
cutblock_plots_openings_Huck_ALL_df2c$DST_End_year
cutblock_plots_openings_Huck_ALL_df2c$DST_End_month<-stri_sub(cutblock_plots_openings_Huck_ALL_df2c$DST_END_DT,5,6)

#Make all numeric
cutblock_plots_openings_Huck_ALL_df2c$DST_Start_year.num<-as.numeric((cutblock_plots_openings_Huck_ALL_df2c$DST_Start_year))
cutblock_plots_openings_Huck_ALL_df2c$DST_End_year.num<- as.numeric(cutblock_plots_openings_Huck_ALL_df2c$DST_End_year)

cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month.num<-as.numeric((cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month))
cutblock_plots_openings_Huck_ALL_df2c$DST_End_month.num<- as.numeric(cutblock_plots_openings_Huck_ALL_df2c$DST_End_month)

#Determine length in years
cutblock_plots_openings_Huck_ALL_df2c$DST_year_length<- cutblock_plots_openings_Huck_ALL_df2c$DST_End_year.num - cutblock_plots_openings_Huck_ALL_df2c$DST_Start_year.num
table(cutblock_plots_openings_Huck_ALL_df2c$DST_year_length) #Can see that treatment took a long time in some.

#Only look at start month, assuming this is when harvesting and scarification ocurred.
table(cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month)
str(cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month)
cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month<-as.factor(cutblock_plots_openings_Huck_ALL_df2c$DST_Start_month)

#Turn into seasonal months
cutblock_plots_openings_Huck_ALL_df2c$DIST_SEASON<-0
cutblock_plots_openings_Huck_ALL_df2c<-cutblock_plots_openings_Huck_ALL_df2c %>%
    mutate(DIST_SEASON = case_when(DST_Start_month == "01" ~ "Winter",
                                  ...
                                  TRUE ~ "NA"))
table(cutblock_plots_openings_Huck_ALL_df2c$DIST_SEASON) # Determine if want different cutoffs for snow months.

```


```{r}
cutblock_plots_openings_Huck_ALL_df2c$PAS_total<-cutblock_plots_openings_Huck_ALL_df2c$PAS_wt + cutblock_plots_openings_Huck_ALL_df2c$PAS_sm + cutblock_plots_openings_Huck_ALL_df2c$PAS_sp + cutblock_plots_openings_Huck_ALL_df2c$PAS_at
...
cutblock_plots_openings_Huck_ALL_df2c$Fire_Occ<-as.factor(cutblock_plots_openings_Huck_ALL_df2c$Fire_Occ)
cutblock_plots_openings_Huck_ALL_df2c$MODIS_LC<-as.factor(cutblock_plots_openings_Huck_ALL_df2c$MODIS_LC)
head(cutblock_plots_openings_Huck_ALL_df2c$Fire_Occ)
...
```{r}
ggscatter(cutblock_plots_openings_Huck_ALL_df2c, x = "LandsatCC_2010_Fixed", y = "origin.age", 
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = DIST_SEASON , y = Species.Cover)) +
  geom_boxplot () +
  labs (x = "Season",
        y = "Huckleberry Cover")
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(slope_30m_SRTM, as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(LandsatCC_2010_Fixed , as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(PAS_total, as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(PH2, as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(ELEVATION, as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(Tave_wt , as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = Fire_Occ , y = Species.Cover)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = PREP_ME_ , y = Species.Cover)) +
  geom_boxplot () +
  labs (x = "No Mechanical TR (0), Mechanical TR (1)",
        y = "Huckleberry Cover")
```
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2c, aes (x = PREP_BU_ , y = Species.Cover)) +
  geom_boxplot () +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2c, aes(origin.age , as.numeric(Species.Present))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
#Ensure as factor
cutblock_plots_openings_Huck_ALL_df2c_ng$Fruit.Present2<-as.factor(cutblock_plots_openings_Huck_ALL_df2c_ng$Fruit.Present)
str(cutblock_plots_openings_Huck_ALL_df2c_ng$Fruit.Present)
str(cutblock_plots_openings_Huck_ALL_df2c_ng$Fruit.Present2)

#Subset the data once into training and validation set
model.data2<- cutblock_plots_openings_Huck_ALL_df2c_ng %>% dplyr::select(Fruit.Present2, variables.huck)
...
```{r}
table(cutblock_plots_openings_Huck_ALL_df2c$Fruit.Present)
str(cutblock_plots_openings_Huck_ALL_df2c$Fruit.Present)
