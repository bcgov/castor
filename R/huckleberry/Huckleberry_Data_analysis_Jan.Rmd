...
cutblock_plots_openings_Huck_ALL_df[216]
n[220]

cutblock_plots_openings_Huck_ALL_df2<-cutblock_plots_openings_Huck_ALL_df[-220]
cutblock_plots_openings_Huck_ALL_df2<-cutblock_plots_openings_Huck_ALL_df2[-216]

write_csv(cutblock_plots_openings_Huck_ALL_df2, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_Jan24.csv")
```
...
plot(cutblock_plots_openings_Huck_ALL_df$SLOPE ~ cutblock_plots_openings_Huck_ALL_df$slope_30m_SRTM) #Quite different. Perhaps use point values and use DEM to get slope and aspect? Or use the cutblock data because it likely takes the average for the cutblock which is probably more representative.
...
```{r}
#Species Present or Absent Huckleberry
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_*PREP_ME_ +  PAS_total + PH2 + MODIS_LC + PLANTED +AREA_SQM + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#Remove least significant
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#Remove least significant
model.new.1 <- glm (Species.Pr2 ~ LandsatCC_ + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
names(cutblock_plots_openings_Huck_ALL_df)
cutblock_plots_openings_Huck_ALL_df$VFSAND

model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + TimeSinceC +TimeSinceF + TCLAY + VFSAND,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))

#Change to origin age
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#SAI_cb + LandsatCC_ + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP
visreg(model.new.1, "SAI_cb")
visreg(model.new.1, "LandsatCC_")
...
```{r}
#Add BEC zones
table(cutblock_plots_openings_Huck_ALL_df$G_BGC_ZONE)

model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
## Add Start_Season
```{r}
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREA_SQM + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREA_SQM + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
Get Partial residuals for above model: SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREA_SQM + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE
```{r}
visreg(model.new.1, "SAI_cb")
...
```{r}
#Remove least significant (whether planted or not)
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREA_SQM + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#Remove last sig
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREA_SQM + ELEVATION + VFSAND + G_BGC_ZONE + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
```{r}
model.new.1k <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1l <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.1m <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#Remove sand
model.new.1n <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = slope_30m_SRTM, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope",
...
cutblock_plots_openings_Huck_ALL_df$slope_30m_SRTM_tr<- -((cutblock_plots_openings_Huck_ALL_df$slope_30m_SRTM/4)-5)^2+23

ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = slope_30m_SRTM_tr, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope Transformed",
...
```{r}
model.new.1r <- glm (Species.Pr2 ~ slope_30m_SRTM_tr + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
cutblock_plots_openings_Huck_ALL_df$PH2_tr<- -((cutblock_plots_openings_Huck_ALL_df$PH2)-4)^2+25

ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = PH2_tr, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "pH transformed",
...
```{r}
model.new.1s <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2_tr + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = Tave_wt, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Average winter Temp",
...
cutblock_plots_openings_Huck_ALL_df$Tave_wt_tr<- -((cutblock_plots_openings_Huck_ALL_df$Tave_wt)+7)^2+7

ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = Tave_wt_tr, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
...
```{r}
model.new.1t <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt_tr,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
#Create variables
variables.huck<-c(slope_30m_SRTM = "slope_30m_SRTM", LandsatCC_ = "LandsatCC_", PREP_BU_ = "PREP_BU_" , PREP_ME_ = "PREP_ME_",  PAS_total = "PAS_total", PH2 = "PH2", ELEVATION = "ELEVATION", Tave_wt = "Tave_wt")

variables.huck<-c("slope_30m_SRTM", "LandsatCC_", "PREP_BU_", "PREP_ME_",  "PAS_total", "PH2", "ELEVATION", "Tave_wt")
...
cutblock_plots_openings_Huck_ALL_df_ng<-as.data.frame((cutblock_plots_openings_Huck_ALL_df))
model.data<- cutblock_plots_openings_Huck_ALL_df_ng %>% dplyr::select(Species.Pr2, variables.huck)
...
```{r}
cutblock_plots_openings_Huck_ALL_df$PAS_total<-cutblock_plots_openings_Huck_ALL_df$PAS_wt + cutblock_plots_openings_Huck_ALL_df$PAS_sm + cutblock_plots_openings_Huck_ALL_df$PAS_sp + cutblock_plots_openings_Huck_ALL_df$PAS_at

variables.huck<-c("slope_30m_SRTM", "aspect_30m_SRTM", "LandsatCC_",  "PAS_total", "PH2", "ELEVATION", "Tave_wt", "TSAND", "MODIS_LC", "Fire_Occ", "PLANTED", "PREP_BU_", "PREP_ME_", "DIST_SEASON", "origin.age", "DN1_SILSYS_GP")

cutblock_plots_openings_Huck_ALL_df$Fire_Occ<-as.factor(cutblock_plots_openings_Huck_ALL_df$Fire_Occ)
cutblock_plots_openings_Huck_ALL_df$MODIS_LC<-as.factor(cutblock_plots_openings_Huck_ALL_df$MODIS_LC)
head(cutblock_plots_openings_Huck_ALL_df$Fire_Occ)
...
```{r}
model.new.2 <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.2b <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.2c <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_ + PREP_BU_,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
model.new.2d <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_ + PLANTED,
               data=cutblock_plots_openings_Huck_ALL_df,
               family = binomial (link = "logit"))
...
```{r}
ggscatter(cutblock_plots_openings_Huck_ALL_df, x = "LandsatCC_", y = "origin.age", 
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = DIST_SEASON , y = Species.Co)) +
  geom_boxplot () +
  labs (x = "Season",
        y = "Huckleberry Cover")
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(slope_30m_SRTM, as.numeric(Species.Pr))) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(LandsatCC_ , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(PAS_total, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(PH2, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(ELEVATION, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(Tave_wt , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df, aes (x = Fire_Occ , y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df, aes(origin.age , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
model.new.2e <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_ + PAS_total +
...
```{r}
head(cutblock_plots_openings_Huck_ALL_df)
table(cutblock_plots_openings_Huck_ALL_df$Date)

#Select month that data was collected
library(stringi)
cutblock_plots_openings_Huck_ALL_df$Date_month<-stri_sub(cutblock_plots_openings_Huck_ALL_df$Date,6,7)
table(cutblock_plots_openings_Huck_ALL_df$Date_month) # Most August, then September, then July, then some in June.
#hist(cutblock_plots_openings_Huck_ALL_df$Date_month)
