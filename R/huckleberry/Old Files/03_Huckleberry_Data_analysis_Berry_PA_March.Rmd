...
#Before subsetting, ensure that locations without fruits given 0 abundance
...
Look at lat-long.
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Latitude.x
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Latitude.y
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Latitude #Blank

cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Longitude.x
```
...
```{r}
write.csv(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, file="C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_March.csv")
...
cor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$TimeSinceCutblock, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Canopy_Cov) #0.50
```
...
Mounding
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_chem, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Mounding))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover and Brushing",
        x = "Canopy Cover",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_chem, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Mounding))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time and Brushing",
        x = "Time Since Cutblock",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Fruit.AbunTEST>0) #n=197
```
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Fruit.AbunTEST
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Canopy_Cov
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$G_BGC_ZONE) 

#Combine MS and SBS as one category due to small sample size
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$G_BGC_ZONE<-revalue(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$G_BGC_ZONE, c("MS"="Other", "SBS"="Other","ESSF"="ESSF","ICH"="ICH"))
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$G_BGC_ZONE) 

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Canopy Cover",
        x = "Canopy Cover (%)",
...
#Remove BEC
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Canopy Cover",
        x = "Canopy Cover (%)",
...
Compare to origin age.
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Time Since Cutblock",
        x = "Time Since Logging",
...
#By BEC
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST,colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Time Since Cutblock",
        x = "Time Since Logging",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$vri_age #some NAs

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = vri_age, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by VRI Age",
        x = "VRI age",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = vri_age, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by VRI Age",
        x = "VRI age",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
#Look at Growing Degree Days
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$DD5_at_0

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = DD5_at_0, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Growing Degree Days",
        x = "Growing Degree Days > 5",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$heatload

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = heatload, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Heatload",
        x = "Heatload",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Species.Co 
cor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Species.Co, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Fruit.AbunTEST, use = "complete.obs") #0.12

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Species.Co, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Species Cover",
        x = "Species Cover (%)",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Species.Co, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Species Cover",
        x = "Species Cover (%)",
...
By Species Height.
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Species.He 
cor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Species.He, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Fruit.AbunTEST, use = "complete.obs") #0.21 - this correlation is stronger

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Species.He, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Species Height",
        x = "Species Height (cm)",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Species.He, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Species Height",
        x = "Species Height (cm)",
...
# We see not much influence of planting density on berry production here
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = planted_density_TOT, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Planting Density",
        x = "Planting Density (trees/ha)",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = planted_density_TOT, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Planting Density",
        x = "Planting Density (trees/ha)",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Fruit.Cove
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$Burned 

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Burned, y = Fruit.AbunTEST)) +
  geom_boxplot () +
  labs (x = "Not Burned (0), Burned(1)",
        y = "Huckleberry Fruit Cover")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(Burned))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(Burned))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Burned))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(PREP_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(PLANTED))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(PLANTED))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(PLANTED))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(DN1_SILSYS_GP))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(DN1_SILSYS_GP))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(DN1_SILSYS_GP))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Canopy_Cov, colour = factor(Qa))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(Qa))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Qa))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s2<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$START_SEASON!="NA")

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s2, aes (x = origin.age, y = Canopy_Cov, colour = factor(START_SEASON))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Canopy Cover by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s2, aes (x = origin.age, y = Fruit.AbunTEST, colour = factor(START_SEASON))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time Since Cutblock/Logging",
        x = "Time Since Logging",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s2, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(START_SEASON))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover",
        x = "Canopy Cover",
...
AREA_SQM
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = AREA_SQM, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Area of Cutblock",
        x = "Area of Cutblock",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = AREA_SQM, y = Fruit.AbunTEST, colour = factor(G_BGC_ZONE))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Area of Cutblock",
        x = "Area of Cutblock",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Chem2))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover and Chemical Application",
        x = "Canopy Cover",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Chem2))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time and Chemical Application",
        x = "Time Since Cutblock",
...
Brush2
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Brush2))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover and Brushing",
        x = "Canopy Cover",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Brush2))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time and Brushing",
        x = "Time Since Cutblock",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(Mounding))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Canopy Cover and Brushing",
        x = "Canopy Cover",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = TimeSinceCutblock, y = Fruit.AbunTEST, colour = factor(Mounding))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Berry Abundance by Time and Brushing",
        x = "Time Since Cutblock",
...
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$TSAND

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = TSAND, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Berry Abundance in Cutblocks by % Sand",
        x = "% Sand",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Tave_wt_0, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Average Winter Temperature Season Prior",
        x = "Average Winter Temp",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Tave_wt_1, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Average Winter Temperature Season Prior",
        x = "Average Winter Temp",
...
Spring Temperature.
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Tave_sp_0, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Average Spring Temperature Season Prior",
        x = "Average Spring Temp",
...
Summer Temperature.
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = Tave_sm_0, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Average Summer Temperature Season Prior",
        x = "Average Summer Temp",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = PAS_total, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Precipitation as Snow",
        x = "Precipitation as snow (mm)",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$PH2

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = PH2, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by pH",
        x = "Soil PH",
...
```{r}
plot(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_30m_, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_ha_bc) #Not the same... but positively correlated


ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = slope_30m_, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Slope",
        x = "Slope",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = slope_ha_bc, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Slope",
        x = "Slope",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = aspect_30m, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Coverby Apsect",
        x = "Aspect",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = aspect_ha_bc, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Aspect",
        x = "Aspect",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = cos_aspect, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Aspect",
        x = "cos(Aspect)",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = dem_ha_bc, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by Elevation",
        x = "Elevation (m)",
...
```{r}
names(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s)
hist(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_ha_bc)
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SLOPE<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_ha_bc)
max(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SLOPE) 
hist(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$aspect_ha_bc)

cor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SLOPE, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_30m_) #0.70
plot(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SLOPE ~ cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_30m_) #Quite different. Perhaps use point values and use DEM to get slope and aspect? Or use the cutblock data because it likely takes the average for the cutblock which is probably more representative.
plot(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$aspect_ha_bc ~ cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$aspect_30m)


cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_cb<-(sin(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$aspect_ha_bc + 225) *(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SLOPE/58.9)) #SAI (Slope to aspect Index) of cutblock data slope and aspect
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_rec<-(sin(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$aspect_30m + 225) *(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$slope_30m_/45)) #SAI of slope and aspect from Clayton's data

hist(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_cb)
hist(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_rec)
plot(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_cb ~ cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s$SAI_rec) # The result is COMPLETELY different, depending on which values are used. No correlation what so ever.
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = SAI_cb, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by SAI",
        x = "SAI_cb",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA_No0s, aes (x = SAI_rec, y = Fruit.AbunTEST)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by SAI",
        x = "SAI_rec",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, aes (x = heatload, y = Species.He)) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Berry Abundance by Canopy Cover",
        x = "Heatload",
...
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$PLANTED) #23 not, 299 yes
...
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$PREP_ME) # 197 not, 125 yes

cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Burned<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Burned)
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Burned) #182 not burned, 140 burned
...
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Manual2[is.na(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Manual2)]<-0
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Manual2) #209 not, 113 yes
...
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Chem2[is.na(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Chem2)]<-0
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Chem2)#290 not, 32 yes. Highly uneven.
...
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Brush2[is.na(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Brush2)]<-0
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Brush2) #213 not brushed, 109 brushed.

cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding)
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding[is.na(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding)]<-0
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$Mounding) #uneven. 274 not mounded, 48 mounded.


```

#Model Series 1:
DN1_SILSYS_GP + PREP_ME + Burned + Manual2 + Chem2 + G_BGC_ZONE + OPEN_GRSAR + PLANTED + TimeSinceCutblock + START_SEASON + heatload + PREP_ME*TimeSinceCutblock + START_SEASON*TimeSinceCutblock + Chem2*TimeSinceCutblock + Species.He

#Model Series 2:
DN1_SILSYS_GP + PREP_ME + Burned + Manual2 + Chem2 + G_BGC_ZONE + OPEN_GRSAR + PLANTED + Canopy_Cov + START_SEASON + heatload + PREP_ME*Canopy_Cov + START_SEASON*Canopy_Cov + Chem2*Canopy_cov + Species.He

#REML will not work to use AIC - actually might be ok to use AIC. If use -2log likelihood comparison, then need to remove REML as well. Scale it between 0 and 1, want it to be high.
Look in output for -2Log Likelihood (not restricted though)

#Notes
1. Going to remove planted or not because very few not planted, and this is not generally an option for companies
2. Smoothing curves selected are based on raw data plots
3. Going to remove MS and SBS BEC zones because sample size too small
4. Details on whetehr clearcut or not only go back 30 years, so remove from analysis
5. Combine non-snow harvest seasons together
6. Not much variation by BEC, so remove BEC from variables
7. Add site index or growing season rainfall
8. From Garth: The Huck model could include: crown closure, plant height, spring GDD (April-June), July temp range (these from the Holden paper). Not sure how functional either of these variables is-test with our data? Probably better just to use heatload. Need a moisture variable too but what?
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$G_BGC_ZONE!="MS")

cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb, cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb$G_BGC_ZONE!="SBS")
#Drops from N=322 to N=304

#Revalue seasons
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb$START_SEASON)
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb$START_SEASONb<-revalue(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb$START_SEASON, c("Spring"="No Snow", "Fall"="No Snow", "Summer"="No Snow", "Winter"="Winter"))
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb$START_SEASONb)

```


```{r}
model.new.1c <- gam (Fruit.AbunTEST ~ PREP_ME + Burned + Manual2 + Chem2 + s(OPEN_GRSAR) + Mounding + s(TimeSinceCutblock, by=PREP_ME) + s(TimeSinceCutblock, by=Chem2) + s(TimeSinceCutblock, by=Mounding) + START_SEASONb + s(heatload) + s(Species.He),
data=cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, method="REML", family=ziP()) 

gam.check(model.new.1c)
anova(model.new.1c)
anova.gam(model.new.1c)
summary(model.new.1c) #Deviance explained 99.7% - seems overfitted though
AIC(model.new.1c) #8958.886

#Some other checks
range(predict(model.new.1c,type="response")[model.new.1c$y==0]) # 0 to 202... is that bad? It seems bad?
plot(predict(model.new.1c,type="response"),residuals(model.new.1c))
plot(predict(model.new.1c,type="response"),model.new.1c$y);abline(0,1,col=2)
plot(model.new.1c$linear.predictors,model.new.1c$y)
qq.gam(model.new.1c,rep=20,level=1)

getViz(model.new.1c)
plot(model.new.1c)

#So many flat lines, remove splines
model.new.1c <- gam (Fruit.AbunTEST ~ PREP_ME + Burned + Manual2 + Chem2 + G_BGC_ZONE + s(OPEN_GRSAR, k=4) + Mounding + s(TimeSinceCutblock, by=PREP_ME, k=3) + s(TimeSinceCutblock, by=Chem2, k=3) + s(TimeSinceCutblock, by=Mounding, k=3) + START_SEASONb + s(heatload) + Species.He,
data=cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb, method="REML", family=ziP()) 

gam.check(model.new.1c)
anova(model.new.1c)
anova.gam(model.new.1c)
summary(model.new.1c) #Deviance explained 99.5% - seems overfitted though
AIC(model.new.1c) #13740.59
...
#Remove fit for chemical, leave as fixed effect; some other changes to  etc
model.new.1c <- gam (Fruit.AbunTEST ~ PREP_ME + Burned + Manual2 + Chem2 + G_BGC_ZONE + s(OPEN_GRSAR, k=4) + Mounding + s(TimeSinceCutblock, by=PREP_ME, k=3) + s(TimeSinceCutblock, by=Mounding, k=3) + START_SEASONb + s(heatload, k=5) + Species.He,
data=cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNAb, method="REML", family=ziP()) 
...
anova.gam(model.new.1c)
summary(model.new.1c) #Deviance explained 99.5% - seems overfitted though
AIC(model.new.1c) #15317.64

#Some other checks
range(predict(model.new.1c,type="response")[model.new.1c$y==0]) # 0 to 756... is that bad? It seems bad.
plot(predict(model.new.1c,type="response"),residuals(model.new.1c))
plot(predict(model.new.1c,type="response"),model.new.1c$y);abline(0,1,col=2)
plot(model.new.1c$linear.predictors,model.new.1c$y)
qq.gam(model.new.1c,rep=20,level=1)
...
getViz(model.new.1c)
plot(model.new.1c)
plot(model.new.1c, select=1)
plot(model.new.1c, select=2)
plot(model.new.1c, select=3)
plot(model.new.1c, select=4)
plot(model.new.1c, select=5) 
plot(model.new.1c, select=6)
plot(model.new.1c, select=7)

library(visreg)
visreg(model.new.1c, "Chem2")
visreg(model.new.1c, "PREP_ME")
visreg(model.new.1c, "Burned")
visreg(model.new.1c, "Manual2")
visreg(model.new.1c, "G_BGC_ZONE")
visreg(model.new.1c, "START_SEASONb")
visreg(model.new.1c, "Species.He")
visreg(model.new.1c, "heatload")

visreg(model.new.1c, "TimeSinceCutblock", by= "PREP_ME")
visreg(model.new.1c, "TimeSinceCutblock", by= "Mounding")
visreg(model.new.1c, "TimeSinceCutblock")
...
##Old models prior to usinf ziP (zero-inflated Poisson)
