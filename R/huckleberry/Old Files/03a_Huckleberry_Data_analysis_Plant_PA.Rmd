...
1. Percent cover huckleberry: cutblock_plots_openings_Huck_ALL_df_2022_b23b (and subset Huck)
2. Other elements huckleberry: cutblock_plots_openings_Huck_ALL_df_2022_b2 (although if use above, NA remove will likely get same result- *should* at least)
...
#Numbers below represent once species absences removed...
...
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$DN1_DIS_CD) #492 logged
```
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Pr2 <- as.factor (cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Pr)
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Pr)

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, fill = origin)) + 
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = origin, y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = origin, y = origin.age)) +
  geom_boxplot () +
...
```{r}
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$CutBlock_O) #97 indicated not to have been in cutblocks despite RESULTS Openings data. Possible they were logged after. Remove these.

cutblock_plots_openings_Huck_ALL_df_2022_b2<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2, cutblock_plots_openings_Huck_ALL_df_2022_b2$CutBlock_O=="1")
```
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, y = AREA_SQM)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, y = origin.age)) +
  geom_boxplot () +
  labs (x = "No Huckleberry (0) and Huckleberry Detected (1) Stands",
        y = "Stand Age")
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU)

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, fill = PREP_BU_)) + 
  geom_bar (position = "fill") +
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Co<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Co)

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_BU_, y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_BU_, y = origin.age)) +
  geom_boxplot () +
  labs (x = "Not Burned (0), Burned(1)",
        y = "Stand Age")
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_ME_<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_ME)

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, fill = PREP_ME_)) + 
  geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_ME_, y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_ME_, y = origin.age)) +
  geom_boxplot () +
  labs (x = "No Mechanical TR (0), Mechanical TR (1)",
        y = "Stand Age")
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_ME<-paste(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_, cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_ME_)
str(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_ME)
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_ME<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU_ME)

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = TimeSinceC, y = Species.Co, colour = factor(PREP_BU_ME))) +
  geom_point () +
  geom_smooth (se=F) +
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2_PA<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b2, cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Pr=="1")

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = TimeSinceC, y = Species.Co, colour = factor(PREP_BU_ME))) +
  geom_point () +
  geom_smooth (se=F) +
  labs (title = "Huckleberry Cover Across stand Ages",
        x = "Stand Age (years)",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, fill = DN1_SILSYS_GP)) + 
  geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = DN1_SILSYS_GP, y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = DN1_SILSYS_GP, y = origin.age)) +
  geom_boxplot () +
  labs (x = "Clearcut Technique",
        y = "Stand Age")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Species.Pr2, fill = PREP1_TECH_GP)) + 
  geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b23, aes (x = Fruit.Pres, fill = PREP1_TECH_GP)) + 
geom_bar (position = "fill") +
  scale_fill_discrete (name = "Site Prep technique")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP1_TECH_GP, y = Species.Co)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP1_TECH_GP, y = Fruit.Abund)) +
  geom_boxplot () +
  labs (x = "Prep Technique",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP1_TECH_GP, y = origin.age)) +
  geom_boxplot () +
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$AREA_SQM
```

#Check pattern by origin.age

```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = origin.age, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = TimeSinceC, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
...
1. cutblock_plots_openings_Huck_ALL_df_2022_b2
2. cutblock_plots_openings_Huck_ALL_df_2022_b2

Save

```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b22[68]
cutblock_plots_openings_Huck_ALL_df_2022_b22<-cutblock_plots_openings_Huck_ALL_df_2022_b22[-68]

write_csv(cutblock_plots_openings_Huck_ALL_df_2022_b22, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_b2_Jan25.csv")
```
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = TSAND, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "% Sand",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = Tave_wt, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = PAS_total, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PH2, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Soil PH",
...
```{r}
plot(cutblock_plots_openings_Huck_ALL_df_2022_b2$slope_30m_, cutblock_plots_openings_Huck_ALL_df_2022_b2$slope_ha_bc) #Not the same...

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = slope_30m_, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = slope_ha_bc, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Slope",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = aspect_30m, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Aspect",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = aspect_ha_bc, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Aspect",
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = LandsatCC_, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "Canopy Cover (%)",
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = SAI_cb, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_PA, aes (x = SAI_rec, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover by SAI",
        x = "SAI_rec",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$MODIS_LC<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$MODIS_LC)
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$MODIS_LC)

cutblock_plots_openings_Huck_ALL_df_2022_b2$PLANTED<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PLANTED)

cutblock_plots_openings_Huck_ALL_df_2022_b2$DN1_DIS_CD<-as.factor(as.character(cutblock_plots_openings_Huck_ALL_df_2022_b2$DN1_DIS_CD))

cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_MA<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_MA)
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_ME<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_ME)
cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$PREP_BU)

cutblock_plots_openings_Huck_ALL_df_2022_b2$BRUSH_MA<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$BRUSH_MA)
...
model.new.1 <- glm (Species.Pr2 ~ DN1_DIS_CD + DN1_SILSYS_GP + PREP_MA + PREP_ME * PREP_BU + BRUSH_MA + BRUSH_CM + G_BGC_ZONE + PLANTED + origin + origin.age + TimeSinceF + TimeSinceC + AREA_SQM + PAS_total + Tave_wt_dec + Tave_sp_dec + Tave_sm_dec + PPT_sp_dec + PPT_sm_dec + TSAND + PH2 + MODIS_LC + CMI_sp_dec + CMI_sm_dec + CMI_at_dec + SAI_cb + dem_ha_bc,
               data=cutblock_plots_openings_Huck_ALL_df_2022_b2,
...
```{r}
write.csv(cutblock_plots_openings_Huck_ALL_df_2022_b2, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_b2_Jan.csv")
```
...
# Creating training and testing datasets so that I can get a measure of how well the model actually predicts the data e.g. AUG
  trainIndex <- createDataPartition(cutblock_plots_openings_Huck_ALL_df_2022_b2$Species.Pr2, p = prop,
                                    list = FALSE,
                                    times = 1)
  
   dat1 <- cutblock_plots_openings_Huck_ALL_df_2022_b2[ trainIndex,]
   Valid <- cutblock_plots_openings_Huck_ALL_df_2022_b2[-trainIndex,]
...
names(cutblock_plots_openings_Huck_ALL_df_2022_b2)
head(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_STR_DT)
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_STR_DT)

cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_year<-stri_sub(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_STR_DT,3,4)
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_year
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month<-stri_sub(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_STR_DT,5,6)
head(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month)
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_year<-stri_sub(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_END_DT,3,4)
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_year
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_month<-stri_sub(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_END_DT,5,6)

#Make all numeric
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_year.num<-as.numeric((cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_year))
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_year.num<- as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_year)

cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month.num<-as.numeric((cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month))
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_month.num<- as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_month)

#Determine length in years
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_year_length<- cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_End_year.num - cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_year.num
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_year_length) #Can see that treatment took a long time in some.

#Only look at start month, assuming this is when harvesting and scarification ocurred.
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month)
str(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month)
cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2$DST_Start_month)

#Turn into seasonal months
cutblock_plots_openings_Huck_ALL_df_2022_b2$DIST_SEASON<-0
cutblock_plots_openings_Huck_ALL_df_2022_b2<-cutblock_plots_openings_Huck_ALL_df_2022_b2 %>%
    mutate(DIST_SEASON = case_when(DST_Start_month == "01" ~ "Winter",
                                  ...
                                  TRUE ~ "NA"))
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$DIST_SEASON) # Determine if want different cutoffs for snow months.
...
#Ensure as factor
cutblock_plots_openings_Huck_ALL_df_2022_b2_ng$Fruit.Pres2<-as.factor(cutblock_plots_openings_Huck_ALL_df_2022_b2_ng$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df_2022_b2_ng$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df_2022_b2_ng$Fruit.Pres2)

#Subset the data once into training and validation set
model.data2<- cutblock_plots_openings_Huck_ALL_df_2022_b2_ng %>% dplyr::select(Fruit.Pres2, variables.huck)
...
```{r}
table(cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres)
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = TSAND, y = Species.Co)) +
  geom_point () +
  geom_smooth () +
  labs (title = "Huckleberry Percent Cover in Cutblocks of Different Ages",
        x = "% Sand",
...
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres2 <- as.factor (cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres)
cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres2
cutblock_plots_openings_Huck_ALL_df_2022_b23 <-  subset(cutblock_plots_openings_Huck_ALL_df_2022_b2, cutblock_plots_openings_Huck_ALL_df_2022_b2$Fruit.Pres2!="NA")
cutblock_plots_openings_Huck_ALL_df_2022_b23$Fruit.Pres2

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b23, aes (x = Fruit.Pres, fill = origin)) + 
geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = origin, y = Fruit.Abund)) +
  geom_boxplot () +
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b23, aes (x = Fruit.Pres, fill = PREP_BU_)) + 
geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_BU_, y = Fruit.Abund)) +
  geom_boxplot () +
  labs (x = "Not Burned (0), Burned(1)",
        y = "Huckleberry Fruit Abundance")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = PREP_ME_, y = Fruit.Abund)) +
  geom_boxplot () +
  labs (x = "No Mechanical TR (0), Mechanical TR (1)",
        y = "Huckleberry Fruit Abundance")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b23, aes (x = Fruit.Pres, fill = DN1_SILSYS_GP)) + 
geom_bar (position = "fill") +
  scale_fill_discrete (name = "Clearcut Technique")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = DN1_SILSYS_GP, y = Fruit.Abund)) +
  geom_boxplot () +
  labs (x = "Clearcut Technique",
        y = "Huckleberry Fruit Abundance")
