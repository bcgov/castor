...
```{r}
cutblock_plots_openings_mowatBuff<- st_read ( dsn = "C:\\cora\\Hucklberry\\Mackenzie_Points_Buff_OPENINGS.shp", stringsAsFactors = T)

head(cutblock_plots_openings_mowatBuff)
names(cutblock_plots_openings_mowatBuff) #68 observations
...
#head(cutblock_plots_openings_mowatBuff2) #65 datapoints within cutblocks
table(cutblock_plots_openings_mowatBuff$Clear_Cut) #14 not in cutblocks, 54 yes
...
```{r}
cutblock_plots_openings_mowatBuff$LONG2<-round(cutblock_plots_openings_mowatBuff$LONGITUDE, digits=4)
cutblock_plots_openings_mowatBuff$ID2<-paste(cutblock_plots_openings_mowatBuff$Study_Area, cutblock_plots_openings_mowatBuff$LONG2)
...
cutblock_plots_openings_mowatBuff2<-left_join(cutblock_plots_openings_mowatBuff_df, Mowat_Buff_Climate, by="ID2") #Coming in with climate data being ALL NAs...
head(cutblock_plots_openings_mowatBuff2)
cutblock_plots_openings_mowatBuff2$Tave_at_0
...
head(cutblock_plots_openings_mowatBuff_FIRE) #29
str(cutblock_plots_openings_mowatBuff_FIRE)
...
cutblock_plots_openings_mowatBuff_FIRE_df$LONGITUDE2<-round(cutblock_plots_openings_mowatBuff_FIRE_df$LONGITUDE, digits=4)
cutblock_plots_openings_mowatBuff_FIRE_df$LONGITUDE2

cutblock_plots_openings_mowatBuff_FIRE_df$ID2<-paste(cutblock_plots_openings_mowatBuff_FIRE_df$Study_Area, cutblock_plots_openings_mowatBuff_FIRE_df$LONGITUDE2)
...
table(cutblock_plots_openings_mowatBuff_FIRE_df$ID2, cutblock_plots_openings_mowatBuff_FIRE_df$FIRE_YEAR)
...
# Commerce -114.485356
cutblock_plots_openings_mowatBuff_FIRE_df[10,]
cutblock_plots_openings_mowatBuff_FIRE_df[9,]
...
table(cutblock_plots_openings_mowatBuff2$ID2) #
table(cutblock_plots_openings_mowatBuff_FIRE_df$ID2) #N

#When joining, we should get 68 observations
cutblock_plots_openings_mowatBuff3<-full_join(cutblock_plots_openings_mowatBuff2, cutblock_plots_openings_mowatBuff_FIRE_df, by="ID2") # 68 observations
names(cutblock_plots_openings_mowatBuff3) #Notice many repeat variables because .x and .y here, likely naming was different from shape files and how saved
...
cutblock_plots_openings_mowatBuff3$Date.x
cutblock_plots_openings_mowatBuff3$Year<-c(2020)
cutblock_plots_openings_mowatBuff3$Year
...
library(stringi)
cutblock_plots_openings_mowatBuff3$Cutblock_Year<-stri_sub(cutblock_plots_openings_mowatBuff3$DST_STR_DT.x,1,4)
...
Add heatload.
```{r}
cutblock_plots_openings_mowatBuff3$heatload <- heatload (aspect = cutblock_plots_openings_mowatBuff3$aspect_ha_bc_3005, slope = cutblock_plots_openings_mowatBuff3$slope_ha_bc_3005, latitude = cutblock_plots_openings_mowatBuff3$LATITUDE.x, equation = 3)
...
Save new file.
```{r}
write.csv(cutblock_plots_openings_mowatBuff3, file = "C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate_March23.csv")
```

If need to load back in data.
#Modified to remove the .y repeats, and the .x naming
```{r}
cutblock_plots_openings_mowatBuff3<-read.csv(file = "C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate_March23b.csv")
...
str(cutblock_plots_openings_Buff_ALL_df2) #191 observations, 490 variables

cutblock_plots_openings_mowatBuff3<-read.csv(file = "C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate_March23b.csv")
head(cutblock_plots_openings_mowatBuff3)
str(cutblock_plots_openings_mowatBuff3) #68 observations of 474 variables
```
...
cutblock_plots_openings_mowatBuff3$Canopy_C_1
...
cutblock_plots_openings_mowatBuff3$Latitude
cutblock_plots_openings_Buff_ALL_df2$Latitude
...
#Combine
str(cutblock_plots_openings_Buff_ALL_df2b) #191 observations, 610 variables
str(cutblock_plots_openings_mowatBuff3b) #68 observations, 610 variables

cutblock_plots_openings_Buff_ALL_df2b$DATASET<-c(1)
cutblock_plots_openings_mowatBuff3b$DATASET<-c(2)

cutblock_plots_openings_Buff_ALL_df<-smartbind(cutblock_plots_openings_Buff_ALL_df2b, cutblock_plots_openings_mowatBuff3b)
cutblock_plots_openings_Buff_ALL_df<-rbind(cutblock_plots_openings_Buff_ALL_df2b, cutblock_plots_openings_mowatBuff3b)

str(cutblock_plots_openings_Buff_ALL_df) #259 observations, 611 variables
...
cutblock_plots_openings_Buff_ALL_df$Latitude #Not plotting because coordinates not same name

cutblock_plots_openings_Buff_ALL_df$Latitude
cutblock_plots_openings_Buff_ALL_df$LATITUDE

cutblock_plots_openings_Buff_ALL_df$Lat<-ifelse(is.na(cutblock_plots_openings_Buff_ALL_df$Latitude), cutblock_plots_openings_Buff_ALL_df$LATITUDE, cutblock_plots_openings_Buff_ALL_df$Latitude)

cutblock_plots_openings_Buff_ALL_df$Lat

cutblock_plots_openings_Buff_ALL_df$Long<-ifelse(is.na(cutblock_plots_openings_Buff_ALL_df$Latitude), cutblock_plots_openings_Buff_ALL_df$LONGITUDE, cutblock_plots_openings_Buff_ALL_df$Longitude)
...
```{r}
cutblock_plots_openings_Buff_ALL_df$Fruit.Abun
cutblock_plots_openings_Buff_ALL_df$Fruit.Pres
cutblock_plots_openings_Buff_ALL_df$TCLAY
cutblock_plots_openings_Buff_ALL_df$Tave_at_0
```
...
write.csv(cutblock_plots_openings_Buff_ALL_df, file="C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Buff_ALL_df_March2022c.csv")
```
...
cutblock_plots_openings_Buff_ALL_df_b22_a<-cutblock_plots_openings_Buff_ALL_df_b2[688]
cutblock_plots_openings_Buff_ALL_df_b22_b<-cutblock_plots_openings_Buff_ALL_df_b2[692:694]
cutblock_plots_openings_Buff_ALL_df_b22_c<-cutblock_plots_openings_Buff_ALL_df_b2[701:702]
...
cutblock_plots_openings_Buff_ALL_df_b22b<-subset(cutblock_plots_openings_Buff_ALL_df_b22b, cutblock_plots_openings_Buff_ALL_df_b22b$silv_method_code!="WALK") #Down to 1283
```
...
cutblock_plots_openings_Buff_ALL_df_b2$CutBlock_O

cutblock_plots_openings_Buff_ALL_df_b2$CutBlock_O[is.na(cutblock_plots_openings_Buff_ALL_df_b2$CutBlock_O)]<-1
table(cutblock_plots_openings_Buff_ALL_df_b2$CutBlock_O) #259 - fixed!
head(cutblock_plots_openings_Buff_ALL_df_b2)
