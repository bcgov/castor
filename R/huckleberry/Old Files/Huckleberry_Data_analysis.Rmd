...
#Load Data In
```{r}
cutblock_plots_openings_HuckBuff_ALL_df<-st_read(dsn="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_HuckBuff_ALL_df3b.csv")
```

#Subset the huckleberry data
```{r}
table(cutblock_plots_openings_HuckBuff_ALL_df3b$Species)
cutblock_plots_openings_Huck_ALL_df<-subset(cutblock_plots_openings_HuckBuff_ALL_df3b, cutblock_plots_openings_HuckBuff_ALL_df3b$Species=="Vaccinium_membranaceum")
...
table(cutblock_plots_openings_Huck_ALL_df$Species.Pr, cutblock_plots_openings_Huck_ALL_df$PREP_TECH_2_GP) #Definitely a smaller sample size; must be a lot of NAs --> only 383 datapoints accounted for here if eliminate NAs; BU = burn; ME = mechanical
...
cutblock_plots_openings_Huck_ALL_df$Species.Pr
cutblock_plots_openings_Huck_ALL_df2 <-  subset(cutblock_plots_openings_Huck_ALL_df, cutblock_plots_openings_Huck_ALL_df$Species.Pr2!="NA")
table(cutblock_plots_openings_Huck_ALL_df2$Species.Pr2) #135 absences and 2141 present

ggplot (cutblock_plots_openings_Huck_ALL_df2, aes (x = Species.Pr2, fill = origin)) + 
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, y = AREAHA)) +
  geom_boxplot () +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2, aes (x = Species.Pr2, y = origin.age)) +
  geom_boxplot () +
  labs (x = "No Huckleberry (0) and Huckleberry Detected (1) Stands",
        y = "Stand Age")
...
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, y = origin.age)) +
  geom_boxplot () +
  labs (x = "No Huckleberry (0) and Huckleberry Detected (1) Stands",
        y = "Stand Age")
...
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, fill = PREP_BU_)) + 
  geom_bar (position = "fill") +
...
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, fill = PREP_ME_)) + 
  geom_bar (position = "fill") +
...
ggplot (cutblock_plots_openings_Huck_ALL_df3, aes (x = Fruit.Pres, fill = PREP_ME_)) + 
geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, fill = DN1_SILSYS_GP)) + 
  geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, fill = PREP_TECH_2_GP)) + 
  geom_bar (position = "fill") +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df3, aes (x = Fruit.Pres, fill = PREP_TECH_2_GP)) + 
geom_bar (position = "fill") +
  scale_fill_discrete (name = "Site Prep Technique")
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df2b, aes (x = Species.Pr2, fill = PREP1_TECH_GP)) + 
  geom_bar (position = "fill") +
  scale_fill_discrete (name = "Site Prep Technique") 
...
table(cutblock_plots_openings_Huck_ALL_df4$Species.Pr) #dataset down to 53 absences and 231 presences. Getting pretty slim.
...
```{r}
model1 <- glm (Species.Pr2 ~ PREP1_TECH_GP + DN1_SILSYS_GP + origin*origin.age,
...
model1b <- glm (Species.Pr2 ~ PREP_TECH_2_GP + DN1_SILSYS_GP + origin*origin.age,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
Anova(model1b, type=3) #Nothing

#Remove interaction
model2 <- glm (Species.Pr2 ~ PREP1_TECH_GP + DN1_SILSYS_GP + origin + origin.age,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model2b <- glm (Species.Pr2 ~ PREP_TECH_2_GP + DN1_SILSYS_GP + origin + origin.age,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model3 <- glm (Species.Pr2 ~ PREP1_TECH_GP + DN1_SILSYS_GP + TimeSinceCut,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model3b <- glm (Species.Pr2 ~ PREP_TECH_2_GP + DN1_SILSYS_GP + TimeSinceCut,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model4 <- glm (Species.Pr2 ~ PREP_BU_ + PREP_ME_ + DN1_SILSYS_GP + TimeSinceCut,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
model.1 <- glm (Species.Pr2 ~ PREP_TECH_2_GP,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.1b <- glm (Species.Pr2 ~ PREP_TECH_2_GP,
...
#
model.2 <- glm (Species.Pr2 ~ PREP1_TECH_GP,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.3 <- glm (Species.Pr2 ~ DN1_SILSYS_GP,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.4 <- glm (Species.Pr2 ~ TimeSinceCut,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.5 <- glm (Species.Pr2 ~ origin*origin.age,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.6 <- glm (Species.Pr2 ~ origin,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.7 <- glm (Species.Pr2 ~ PLANTED,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.8 <- glm (Species.Pr2 ~ PREP_BU_ + PREP_ME_,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.9 <- glm (Species.Pr2 ~ Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.10 <- glm (Species.Pr2 ~ PAS_total,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.12 <- glm (Species.Pr2 ~ slope_30m_SRTM,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.14 <- glm (Species.Pr2 ~ LandsatCC_2010_Fixed,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.13 <- glm (Species.Pr2 ~ MODIS_LC,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(SAI_cb, as.numeric(Species.Pr))) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(SAI_rec, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PAS_total + PH2 + MODIS_LC + PLANTED +AREAHA + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove least significant
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove least significant
model.new.1 <- glm (Species.Pr2 ~ LandsatCC_2010_Fixed + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_ + PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + TimeSinceCut +TimeSinceFire + TCLAY + VFSAND,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))

#Change to origin age
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
## Add Start_Season
```{r}
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREAHA + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
#Remove least significant (whether planted or not)
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREAHA + ELEVATION + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove last sig
model.new.1 <- glm (Species.Pr2 ~ SAI_cb + PREP_BU_* PREP_ME_ +  PAS_total + PH2  +AREAHA + ELEVATION + VFSAND + G_BGC_ZONE + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
model.new.1k <- glm (Species.Pr2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1l <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1m <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION + TSAND + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove sand
model.new.1n <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1o <- glm (Species.Pr2 ~ slope_30m_SRTM + origin.age + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove CC and age
model.new.1p <- glm (Species.Pr2 ~ slope_30m_SRTM + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.1q <- glm (Species.Pr2 ~ slope_30m_SRTM  +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
model.new.1r <- glm (Species.Pr2 ~ slope_30m_SRTM_tr + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
model.new.1s <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2_tr + ELEVATION  + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
model.new.1t <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PAS_total + PH2 + ELEVATION  + Tave_wt_tr,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.data<- cutblock_plots_openings_Huck_ALL_df2b_ng %>% dplyr::select(Species.Pr2, variables.huck)
trainIndex_huck <- createDataPartition(model.data$Species.Pr2, p = prop,
                                    list = FALSE,
                                    times = 1)
...
big.mod <- function(mods.in, df.train, df.test, dep.var="Species.Pr2") {
...
```{r}
model.new.2 <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.2b <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.2c <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_ + PREP_BU_,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.new.2d <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + Tave_wt + Fire_Occ + DIST_SEASON + origin.age + PREP_ME_ + PLANTED,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(slope_30m_SRTM, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(LandsatCC_2010_Fixed , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(PAS_total, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(PH2, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(ELEVATION, as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(Tave_wt , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
```{r}
ggplot(cutblock_plots_openings_Huck_ALL_df2b, aes(origin.age , as.numeric(Species.Pr))) +
  geom_smooth(method="glm", formula=y~x,
              method.args=list(family="binomial"),
              alpha=0.3, size=1) +
  geom_point(position=position_jitter(height=0.03, width=0)) +
...
model.new.2e <- glm (Species.Pr2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total +
...
#Ensure as factor
cutblock_plots_openings_Huck_ALL_df2b_ng$Fruit.Pres2<-as.factor(cutblock_plots_openings_Huck_ALL_df2b_ng$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df2b_ng$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df2b_ng$Fruit.Pres2)

#Subset the data once into training and validation set
model.data2<- cutblock_plots_openings_Huck_ALL_df2b_ng %>% dplyr::select(Fruit.Pres2, variables.huck)
...
```{r}
model.fruitPA.1 <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.fruitPA.1b <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + G_BGC_ZONE,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.fruitPA.1c <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + PLANTED,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
model.fruitPA.1c <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + PREP_BU_,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
Anova(model.fruitPA.1c, type=3)
summary(model.fruitPA.1c)
...
model.fruitPA.1c <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + PREP_ME_,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
Anova(model.fruitPA.1c, type=3)
summary(model.fruitPA.1c)
...
model.fruitPA.1c <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + TSAND,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
Anova(model.fruitPA.1c, type=3)
summary(model.fruitPA.1c)
...
model.fruitPA.1c <- glm (Fruit.Pres2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PAS_total + PH2 + ELEVATION + MODIS_LC + ELEVATION + MODIS_LC + origin.age + Fire_Occ + Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
Anova(model.fruitPA.1c, type=3)
summary(model.fruitPA.1c)
...
```{r}
table(cutblock_plots_openings_Huck_ALL_df2b$Fruit.Pres)
str(cutblock_plots_openings_Huck_ALL_df2b$Fruit.Pres)

model.new.F1 <- glm (Fruit.Pres ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + TCLAY + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove least sig
model.new.F1 <- glm (Fruit.Pres ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + G_BGC_ZONE + START_SEASON +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
```{r}
#Remove least sig
model.new.F1 <- glm (Fruit.Pres ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP + START_SEASON +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove least sig
model.new.F1 <- glm (Fruit.Pres ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP  +Tave_wt,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
...
#Remove least sig
model.new.F1 <- glm (Fruit.Pres ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_* PREP_ME_ +  PAS_total + PH2 + PLANTED +AREAHA + ELEVATION + origin.age + VFSAND + DN1_SILSYS_GP,
               data=cutblock_plots_openings_Huck_ALL_df2b,
               family = binomial (link = "logit"))
