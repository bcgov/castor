...
#Buff_Laura_burn<-st_read ( dsn = "C:\\cora\\Hucklberry\\Laura_OPENINGS_PA_FirePoints.shp", stringsAsFactors = T)

Buff_Laura_burn_df<-st_drop_geometry(Buff_Laura_burn)
```

```{r}
Buff_Laura_burn_df$TimeSinceFire<-(Buff_Laura_burn_df$Year - Buff_Laura_burn_df$FIRE_YEAR)
