...
```{r}
cutblock_plots_openings<- st_read ( dsn = "C:\\cora\\Hucklberry\\Clayton_OPENINIGS_Plots2.shp", stringsAsFactors = T) #986 observations
...
Huck_Laura_Plant<-st_read ( dsn = "C:\\cora\\Hucklberry\\Laura_OPENINGS_PerCov.shp", stringsAsFactors = T)
head(Huck_Laura_Plant) #17 data points
crs(Huck_Laura_Plant) #Will need to convert to 3005, or 9001, to use rasters

#Data for abundance
Huck_Laura_Berries<-st_read ( dsn = "C:\\cora\\Hucklberry\\Laura_OPENINGS_All.shp", stringsAsFactors = T)
...
names(cutblock_plots_openings_Huck_ALL_df_2022_b2) #ID4 = 646; 650:652, 659:660
cutblock_plots_openings_Huck_ALL_df_2022_b22<-cutblock_plots_openings_Huck_ALL_df_2022_b2[646,650,651,652,659,660]

cutblock_plots_openings_Huck_ALL_df_2022_b22_a<-cutblock_plots_openings_Huck_ALL_df_2022_b2[646]
cutblock_plots_openings_Huck_ALL_df_2022_b22_b<-cutblock_plots_openings_Huck_ALL_df_2022_b2[650:652]
cutblock_plots_openings_Huck_ALL_df_2022_b22_c<-cutblock_plots_openings_Huck_ALL_df_2022_b2[659:660]
...
head(cutblock_plots_openings_Huck_ALL_df_2022_b22)
...
cutblock_plots_openings_Huck_ALL_df_2022_b22b2<-cutblock_plots_openings_Huck_ALL_df_2022_b22b2[-26]
cutblock_plots_openings_Huck_ALL_df_2022_b22b2<-cutblock_plots_openings_Huck_ALL_df_2022_b22b2[-21]
cutblock_plots_openings_Huck_ALL_df_2022_b22b2<-cutblock_plots_openings_Huck_ALL_df_2022_b22b2[-20]
...
table(cutblock_plots_openings_Huck_ALL_df_2022_b_atu$MechAboveG) #75 abive ground, 562 not
```
...
Save data.
```{r}
write.csv(cutblock_plots_openings_Huck_ALL_df_2022_b2, file="C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_b2.csv")
...
st_write(cutblock_plots_openings_Buff_ALL_df, dsn="C:\\cora\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\Mowat_Buff_Openings_duplicates_removed_DEM_df2b.csv")
```
############################ PREP COMPLETE ####################
