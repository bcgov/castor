...
table(cutblock_plots_openings_Buff_ALL_df_b$OPENING_ID) #Mostly 1, some more, but some points were in more than one opening.
...
cutblock_plots_openings_Buff_ALL_df_b22_a<-cutblock_plots_openings_Buff_ALL_df_b2[716]
cutblock_plots_openings_Buff_ALL_df_b22_b<-cutblock_plots_openings_Buff_ALL_df_b2[720:722]
cutblock_plots_openings_Buff_ALL_df_b22_c<-cutblock_plots_openings_Buff_ALL_df_b2[729:730]
...
cutblock_plots_openings_Buff_ALL_df_b22b<-subset(cutblock_plots_openings_Buff_ALL_df_b22b, cutblock_plots_openings_Buff_ALL_df_b22b$silv_method_code!="WALK") #Down to 4726
```
...
table(cutblock_plots_openings_Buff_ALL_df_b22b$Brushing_ALL) #484 had brushing
...
#Chemical
cutblock_plots_openings_Buff_ALL_df_b22b$Chemical<-ifelse(cutblock_plots_openings_Buff_ALL_df_b22b$silv_technique_code=="CA",1,
                                                               (ifelse(cutblock_plots_openings_Buff_ALL_df_b22b$silv_technique_code=="CG",1,0)))
...
table(cutblock_plots_openings_Buff_ALL_df_b22b$Burned_ALL) #Still 302, so same as Burned
