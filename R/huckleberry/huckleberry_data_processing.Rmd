...
table(cutblock_plots$PREP1_2_TECH)# 516; get two additional one, but names messed up
```
...
```{r}
cutblock_plots$PREP_BU <- ifelse ((cutblock_plots$PREP1_TECH == "BU" | cutblock_plots$PREP2_TECH == "BU"), 1, 0)
table(cutblock_plots$PREP_BU) #There should be a LOT more data here
table(cutblock_plots$PREP1_TECH)
table(cutblock_plots$PREP1_TECH, cutblock_plots$PREP_BU)
cutblock_plots$PREP_BU # A lot of NAs: turn to 0s
cutblock_plots$PREP_BU[is.na(cutblock_plots$PREP_BU)]<-0
table(cutblock_plots$PREP_BU) #This looks better, but keep in mind that some that had no info may have had treatments not listed
...
```{r}
cutblock_plots$PREP_ME <- ifelse ((cutblock_plots$PREP1_TECH == "ME" | cutblock_plots$PREP2_TECH == "ME"), 1, 0)
table(cutblock_plots$PREP_ME) #There should be a LOT more data here
table(cutblock_plots$PREP1_TECH)
table(cutblock_plots$PREP1_TECH, cutblock_plots$PREP_ME)
cutblock_plots$PREP_ME # A lot of NAs: turn to 0s
cutblock_plots$PREP_ME[is.na(cutblock_plots$PREP_ME)]<-0
table(cutblock_plots$PREP_ME) #This looks better, MEt keep in mind that some that had no info may have had treatments not listed
```
