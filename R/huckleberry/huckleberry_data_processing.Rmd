...
model.new.1 <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + MODIS_LC + PLANTED +AREAHA + ELEVATION,
...
model.new.1b <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + MODIS_LC + PLANTED +ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
#Remove landtype
model.new.1c <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + PLANTED + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
#Remove planting
model.new.1d <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1e <- glm (Species.Present2 ~ SLOPE + ASPECT + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1f <- glm (Species.Present2 ~ slope_30m_SRTM + aspect_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1g <- glm (Species.Present2 ~ SAI_rec+ LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1h <- glm (Species.Present2 ~ LandsatCC_2010_Fixed + PREP_BU_*PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
#Remove interaction
model.new.1i <- glm (Species.Present2 ~ LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
# Add SAI_cb back in
model.new.1j <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
```{r}
model.new.1k <- glm (Species.Present2 ~ SAI_cb + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION + TSAND,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1l <- glm (Species.Present2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION + TSAND,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1m <- glm (Species.Present2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION + TSAND + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
#Remove sand
model.new.1n <- glm (Species.Present2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1o <- glm (Species.Present2 ~ slope_30m_SRTM + origin.age + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
#Remove CC and age
model.new.1p <- glm (Species.Present2 ~ slope_30m_SRTM + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
model.new.1q <- glm (Species.Present2 ~ slope_30m_SRTM  +  PPT_wt + PH2 + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
```{r}
model.new.1r <- glm (Species.Present2 ~ slope_30m_SRTM_tr + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
```{r}
model.new.1s <- glm (Species.Present2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2_tr + ELEVATION  + Tave_wt,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
...
```{r}
model.new.1t <- glm (Species.Present2 ~ slope_30m_SRTM + LandsatCC_2010_Fixed + PREP_BU_+PREP_ME_ +  PPT_wt + PH2 + ELEVATION  + Tave_wt_tr,
               data=huckle_data_logged2c,
               family = binomial (link = "logit"))
