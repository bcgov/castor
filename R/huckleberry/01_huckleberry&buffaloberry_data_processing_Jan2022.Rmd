...
```{r}
cutblock_plots_openings_HuckBuff_ALL_df3b<-read.csv(file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_HuckBuff_ALL_df3b.csv")
head(cutblock_plots_openings_HuckBuff_ALL_df3b)
```
...
```{r}
#Berry data
cutblock_plots_openings_Laura_Huck_Berries$Cutblock_Year<-stri_sub(cutblock_plots_openings_Laura_Huck_Berries$DST_STR_DT,1,4)
...
#percent Cover data
cutblock_plots_openings_Laura_Huck_Plant$Cutblock_Year<-stri_sub(cutblock_plots_openings_Laura_Huck_Plant$DST_STR_DT,1,4)
...
```{r}
cutblock_plots_openings_Laura_Huck_Plant<-read.csv(file = "D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Laura_Huck_Plant.csv")
head(cutblock_plots_openings_Laura_Huck_Plant)

cutblock_plots_openings_Laura_Huck_Berries<-read.csv(file = "D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Laura_Huck_Berries.csv")
head(cutblock_plots_openings_Laura_Huck_Berries)
```
...
cutblock_plots_openings_mowatBuff3<-full_join(cutblock_plots_openings_mowatBuff2, cutblock_plots_openings_mowatBuff_FIRE_df) #59 observations
...
Save new file.
```{r}
write.csv(cutblock_plots_openings_mowatBuff3, file = "D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate.csv")
```

If need to load back in data.
```{r}
cutblock_plots_openings_mowatBuff3<-read.csv(file = "D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate.csv")
```
...
```{r}
write.csv(cutblock_plots_openings_Buff_ALL_df2, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Buff_ALL_df2.csv")
```
...
cutblock_plots_openings_Laura_Huck_Berries<-rename(cutblock_plots_openings_Laura_Huck_Berries,
                   c("Species.Co"="Species_Co",
                     "HARVEST_YE"="Cutblock_Year",
                     "Species.He" = "Plant_Heig",
...
cutblock_plots_openings_Huck_ALL_df_2022$Canopy_Cov
cutblock_plots_openings_Huck_ALL_df_2022$Canopy_Cov<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022$Canopy_Cov)
...
#two fire year columns
plot(cutblock_plots_openings_Huck_ALL_df_2022$Fire_Year, cutblock_plots_openings_Huck_ALL_df_2022$FIRE_YEAR)
cutblock_plots_openings_Huck_ALL_df_2022<-cutblock_plots_openings_Huck_ALL_df_2022[-517]

write.csv(cutblock_plots_openings_Huck_ALL_df_2022, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022b.csv")
```
...
write.csv(cutblock_plots_openings_Huck_ALL_df2_PresenceOnly, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df2_PresenceOnly.csv")
...
```{r}
cutblock_plots_openings_Huck_ALL_df2_PresenceOnly<-read.csv( file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df2_PresenceOnly.csv")
head(cutblock_plots_openings_Huck_ALL_df2_PresenceOnly)

cutblock_plots_openings_Huck_ALL_df_2022<-read.csv( file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022.csv")
head(cutblock_plots_openings_Huck_ALL_df_2022)
...
silv_dt<- read.csv(file="D:\\Hucklberry\\Dave_Files\\silv_dt_b.csv")
head(silv_dt)

atu_subset<- read.csv(file="D:\\Hucklberry\\Dave_Files\\atu_subset_b.csv")
head(atu_subset)

msyt_sub<- read.csv(file="D:\\Hucklberry\\Dave_Files\\msyt_sub_b.csv")
head(msyt_sub)
...
Bind using smartbind.
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b<-smartbind(cutblock_plots_openings_Huck_ALL_df_2022, silv_dt)
...
cutblock_plots_openings_Huck_ALL_df_2022_b<-smartbind(cutblock_plots_openings_Huck_ALL_df_2022_b, atu_subset)
gc()
cutblock_plots_openings_Huck_ALL_df_2022_b<-smartbind(cutblock_plots_openings_Huck_ALL_df_2022_b, msyt_sub) # recursive gc invocation
...
Inspect data.
```{r}
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_base_code)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_technique_code)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_method_code)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_objective_code_1)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_objective_code_2)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_objective_code_3)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$silv_fund_srce_code)

table(cutblock_plots_openings_Huck_ALL_df_2022_b$plan_silv_technique_code)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$plan_silv_method_code)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$planted_species1)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$planted_species2)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$planted_species3)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$natural_species1)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$natural_species2)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$natural_species3)

table(cutblock_plots_openings_Huck_ALL_df_2022_b$op_cat)
table(cutblock_plots_openings_Huck_ALL_df_2022_b$op_stat)

cutblock_plots_openings_Huck_ALL_df_2022_b$treatment_amount<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b$treatment_amount)
cutblock_plots_openings_Huck_ALL_df_2022_b$vri_age.<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b$vri_age)
cutblock_plots_openings_Huck_ALL_df_2022_b$rslt_age.<-as.numeric(cutblock_plots_openings_Huck_ALL_df_2022_b$rslt_age)

hist(cutblock_plots_openings_Huck_ALL_df_2022_b$treatment_amount)
hist(cutblock_plots_openings_Huck_ALL_df_2022_b$planted_density1)
hist(cutblock_plots_openings_Huck_ALL_df_2022_b$vri_age)
hist(cutblock_plots_openings_Huck_ALL_df_2022_b$rslt_age)
```

Also check because some opening IDs may have been for buffaloberry, and thus nothave a species associated with it anymore.

```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b$Species

cutblock_plots_openings_Huck_ALL_df_2022_c<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b, cutblock_plots_openings_Huck_ALL_df_2022_b$Species.x!="NA") #Note, we get down to 600 datapoints, wherein we had 642 data points prior to adding Dave's info.
...
Save data.
```{r}
write.csv(cutblock_plots_openings_Huck_ALL_df_2022_b, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_b.csv")

write.csv(cutblock_plots_openings_Huck_ALL_df_2022_c, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022_c.csv")
```

Can also make into presence only plots again:
```{r}
cutblock_plots_openings_Huck_ALL_df_2022_b_PresenceOnly<-subset(cutblock_plots_openings_Huck_ALL_df_2022_b, cutblock_plots_openings_Huck_ALL_df_2022_b$Species.Pr=="1")
```
...
```{r}
cutblock_plots_openings_Buff_ALL_df2<-read.csv(file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Buff_ALL_df2.csv")
...
cutblock_plots_openings_mowatBuff3$Species_Co #Buff Species Percent cover

#"Buff_Fruit" "Buff_Fru_1" "Buff_Fru_2" "count_of_B" "count_of_1" "Buff_Fru_3" "USED"
cutblock_plots_openings_mowatBuff3$Buffalob_1 #Buff_Fruit_Present
cutblock_plots_openings_mowatBuff3$Buffalob_2 # Buff_Fruit_Stage
cutblock_plots_openings_mowatBuff3$Buffalob_4 # Buff_Fruiting_Plant_Cover_percent
cutblock_plots_openings_mowatBuff3$Buffalob_5 
cutblock_plots_openings_mowatBuff3$Fruit_Coun
cutblock_plots_openings_mowatBuff3$Fruit_Cove
cutblock_plots_openings_mowatBuff3$Fruit_Pres
...
#mowat
cutblock_plots_openings_mowatBuff32<-rename(cutblock_plots_openings_mowatBuff3,
...
head(cutblock_plots_openings_mowatBuff32)
table(cutblock_plots_openings_mowatBuff32$WILDFIRE_Y) #I am unsure how to assess these values... there are 58 values of 0 and one value of 109??
table(cutblock_plots_openings_mowatBuff32$HARVEST_YE) #Are these number of years since? Cross check with RESULTS data
table(cutblock_plots_openings_mowatBuff32$HARVEST_YE, cutblock_plots_openings_mowatBuff32$HARVESTYR) #Do not make sense...


cutblock_plots_openings_mowatBuff32$TimeSinceCut<-(2021-cutblock_plots_openings_mowatBuff32$HARVESTYR)

table(cutblock_plots_openings_mowatBuff32$TimeSinceCut)
...
```{r}
# fill in non-overlapping columns with NAs
cutblock_plots_openings_Huck_ALL_df_Buff[setdiff(names(cutblock_plots_openings_mowatBuff32), names(cutblock_plots_openings_Huck_ALL_df_Buff))] <- NA
cutblock_plots_openings_mowatBuff32[setdiff(names(cutblock_plots_openings_Huck_ALL_df_Buff), names(cutblock_plots_openings_mowatBuff32))] <- NA

#Combine
cutblock_plots_openings_Buff_ALL_df<-rbind(cutblock_plots_openings_Huck_ALL_df_Buff, cutblock_plots_openings_mowatBuff32)
