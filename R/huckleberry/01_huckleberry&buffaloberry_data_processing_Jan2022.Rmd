...
```{r}
cutblock_plots_openings_mowatBuff2<-read.csv(file = "D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\MowatMac_Buff_Openings_DEM_Soil_Climate.csv")
```
...
table(cutblock_plots_openings_Buff_ALL_df$CutBlock_O)#Suggests 49 not
table(cutblock_plots_openings_Huck_ALL_df$CutBlock_O) #Suggests 99 not
...
cutblock_plots_openings_Huck_ALL_df_2022<-cutblock_plots_openings_Huck_ALL_df_2022[-518]

write.csv(cutblock_plots_openings_Huck_ALL_df_2022, file="D:\\Hucklberry\\Grizzly Bear stuff\\berries\\data\\cutblock_plots_openings_Huck_ALL_df_2022.csv")
```
...
silv_dt<- read.csv(file="D:\\Hucklberry\\Dave_Files\\silv_dt.csv")
head(silv_dt)

atu_subset<- read.csv(file="D:\\Hucklberry\\Dave_Files\\atu_subset.csv")
head(atu_subset)

msyt_sub<- read.csv(file="D:\\Hucklberry\\Dave_Files\\msyt_sub.csv")
head(msyt_sub)
