...
cutblock_plots_openings_Huck_Laura_Plant<-left_join(Huck_Laura_Plant_df2, huck_Laura_plantcover_climate, by="ID1")
...
I tried searching Environment Canada by GPS coordiantes and turned up nothing.
...
Huck_Laura_Berries_df2$ID1<-paste(Huck_Laura_Berries_df2$Site_ID, Huck_Laura_Berries_df2$Year)
  
cutblock_plots_openings_Laura_Huck<-left_join(Huck_Laura_Berries_df2, Huck_Laura_climate_data, by="ID1")
...
```{r}
cutblock_plots_openings_mowatBuff<- st_read ( dsn = "D:\\Hucklberry\\Mackenzie_Points_Buff.shp", stringsAsFactors = T)
...
head(rasValue2) #
str(rasValue2) #79 values
str(cutblock_plots_openings_mowatBuff2)#79 values
