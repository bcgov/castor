...
table(cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$bec_zone) #144 ESSF, 45 ICH, 3 MS and 10 SBS... MS and SBS scarce. Somehow have a ton of NAS; We have 202 accounted for from 322 observations??
cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA$bec_zone #Need to acquire full BEC data

ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, aes (x = Canopy_Cov, y = Fruit.AbunTEST, colour = factor(bec_zone))) +
  geom_point () +
  geom_smooth (se=F) +
...
```{r}
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2_FruitNotNA, aes (x = origin.age, y = Canopy_Cov, colour = factor(bec_zone))) +
  geom_point () +
  geom_smooth (se=F) +
...
ggplot (cutblock_plots_openings_Huck_ALL_df_2022_b2, aes (x = Burned, y = Fruit.Cove)) +
  geom_boxplot () +
