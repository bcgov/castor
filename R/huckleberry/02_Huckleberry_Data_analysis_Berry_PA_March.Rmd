...
8. From GarthL The Huck model could include: crown closure, plant height, spring GDD (April-June), July temp range (these from the Holden paper). Not sure how functional either of these variables is-test with our data? Probably better just to use heatload. Need a moisture variable too but what?
