...
Questions I have:
  ...
  2. Check for information on burning - is it in the data? For natural fires, yes.
  3. Data also for buffaloberry? Yes.
  4. What other elements for grizzly bear model do we already have? Forest service road and human disturbance elements?
  5. Do we have information on cutblock treatment in the data? Check. RESULTS file on bc gov page may have info on treatments and silviculture. This likely needs to be added.
  6. Cutblock size info? I have coordinates and I may be able to match these to online databases.  https://catalogue.data.gov.bc.ca/dataset/harvested-areas-of-bc-consolidated-cutblocks-
  7. Phenology and distribution and abundance? And energetics!
  8. In the data, what is MODIS_LC (SEE METADATA- CATEGORICAL!)? Is PH2 the soil pH (YES)?
  9. What is the projection for the coordinates provided in the productivity data file? UTM 10? ESPG 3005?
  10. ifelse statement to determine if fire after logging or not.
  11. If extent BC, how to create a raster for soil pH across the province to be able to include it in the predictive model. Or even over a smaller area. May need to create 2 models, one with and one without?
  12. I notice in Proctor et al. 2017 Figure 6a that the modelled huckleberry occurrence (logistic regression reasult >0.48) differed for total occurrence, and occurrence useful for grizzly bears. Should we incorporate this idea for this mode? I will need to look into the details again more closely as to how they did this portion. We likely do not have the needed data on grizzly bears? I believe this was based on GPS of collared bears. I think we just need to see how forestry practices impact huckleberries.
...
The researchers created occurrence models for both fruiting shrub species using multivariate logistic regression (P/A) and occurrence records from 1779 vegetation plots (20 x 20 m) conducted within the study area, using climate, soil, topographic and fire variables. Data was separated into training (85%) and validation (15%) datasets. 
