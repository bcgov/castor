...
knitr::kable (data.table(number = c(seq(1:6)),
                         name = c("Annual Harvest","Decadal Harvest", "Harvest Blocking","Roading", "No Harvest Zone", "Forest Cover Constraint"), 
                         interval = c("Annual", "Decadal", "Decadal", "Decadal", "Decadal", "Annual"), 
                         block = c("No", "No", "Yes", "Yes","No","No"),
                         road = c("No", "No","No", "Yes","No", "No"),
                         constraint = c("None","None","None","None","No Harvest","Forest Cover")),
