...
Here we describe a preliminary analysis of the potential impacts to annual timber harvest volume of applying additional constraints to forest harvest activity in caribou critical habitat (as defined by government of British Columbia caribou biologists). We use a standard spatial forest harvest/timber supply model to test how additional constraints on forest harvest in caribou critical habitat influences annual timber volume harvested (m^3^) compared to a 'business-as-usual' (BAU) scenario. The BAU scenario applies existing, legal forest harvest constraints, as is typically done in timber supply reviews. Alternative scenarios (i.e., additional constraints) to the BAU included:
- no harvest in caribou critical habitat areas
- no harvest in high and low elevation critical habitat types, but 15% harvest (equivalent to 35% disturbance area) in matrix critical habitat
...
The results of these analyses should be considered preliminary and subject to change. The parameters in the forest harvest/timber supply models used in this analysis were standardized across forest harvest units, but model outputs may be different if the models are parameterized differently to better fit local conditions. The annual timber volume outputs from these models should therefore be used with caution, as they may have a low degree of precision. We also note that our BAU scenarios were not necessarily equivalent to the 'base-case' models used in previous timber supply reviews for a TSA or TFL, and thus may not be exactly comparable.    
