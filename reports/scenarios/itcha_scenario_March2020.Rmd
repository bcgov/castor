...
NEED TO EXPLAIN THIS MORE; HOW WE DEALT WITH DISTURBANCE (18% early seral) is nto teh 35% way; in that case use no harvest
...
18% rule of harvest in scenarios
...
#               filter (scenario == "itchas_eccc_a3_r30") %>%
...
table.volume = data.table (
  scenario = c ("BAU", "BAU", "BC Herd Plan", "ECCC Recovery Strategy", "BC Herd Plan", "ECCC Recovery Strategy", "BAU",
                "BC Herd Plan", "ECCC Recovery Strategy", "BC Herd Plan", "ECCC Recovery Strategy"),
  adjacency = c (0, 1.5, 1.5, 1.5, 1.5, 1.5, 3, 3, 3, 3, 3),
  recovery = c (0, 0, 40, 40, 30, 30, 0, 40, 40, 30, 30),
  annual_volume = c (3460143, 3460473, 3295942, 3035029, 3325450, 3061603, 3519953, 3394338, 3138134, 3425914, 3163968),
  diff_annual_volume = c (0, 0, 164531, 425444, 135023, 398870, 0, 125615, 381819, 94039, 355985),
  perc_diff_tot_volume = c ("0", "0", "-5%", "-12%", "-4%", "-12%", "0", "-4%", "-11%", "-3%", "-10%")
)
kable (table.volume,
