...
ggplot (data.dist.ques, aes (x = timeperiod, y = dist500_per, color = scenario, linetype = scenario)) +
  ...
  labs (title = "Figure 3. Proportion of Area Disturbed, by Critical Habitat Type 
in the Quesnel TSA Under the Different Scenarios with a 3m Adjacency and 
40 Year Recovery Age.", 
        x = "Future Year", 
        y = "Percent Disturbed",
...
ggplot (data.dist.wl, aes (x = timeperiod, y = dist500_per, color = scenario, linetype = scenario)) +
  geom_line (position = position_dodge (width = 1)) + 
  facet_grid (. ~critical_hab) +
  labs (title = "Figure 4. Proportion of Area Disturbed, by Critical Habitat Type 
in the Williams Lake TSA Under the Different Scenarios with a 3m Adjacency and 
40 Year Recovery Age.", 
        x = "Future Year", 
        y = "Percent Disturbed",
        caption = "BAU = business-as-usual scenario; 
...
ECCC most contrainint, quite a bit more than BC
recovery time improves a bit; likely more improvements with active road recvoery or focus on eraly seral forest
why more harvest with higehr adjaceny? harvestign higher volume stands beucase model needs to wait unti later?



displacement effect  need to priortize prior to planning; efefcts fof addign additonal protections not addtivie, but multiplicative, non-linear


matrix habtait is where ditsurbanc managment is goign to be the challenge
