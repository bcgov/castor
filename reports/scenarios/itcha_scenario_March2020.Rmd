...
The BC herd plan and ECCC scenarios reduced the amount of disturbance in caribou critical habitat comarped to the BAU scenarios. 
...
```{r, FIG 3, disturbance scenario compare, echo = F, error = F, eval = T, include = T, message = F, warning = F}
...
ggplot (data.dist.ques, aes (x = timeperiod, y = dist500_per, color = scenario)) +
...
BC = British Columbia") + 
  scale_color_discrete (name = "Scenario", labels = c("BAU, 3m, 40 years", "BC Herd Plan, 3m, 40 years",  "ECCC, 3m, 40 years",
