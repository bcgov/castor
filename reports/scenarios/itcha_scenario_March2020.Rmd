...
The BAU scenario had the highest annual timber harvest, but lowest indicators of caribou habitat and survival. A no harvest scenario in all critical caribou habitat had a 14% (approximately 500,000m^3^) impact on timber harvest. Otherwise, the ECCC scenarios had the largest impact on timber harvest, regardless of adjacency height and habitat recovery time. The ECCC scenarios resulted in a 10% (approximately 350,000m^3^) to 12% (approximately 400,000m^3^) reduction in annual harvested volume compared to BAU scenarios. The BC herd plan scenarios resulted in a 3% (approximately 100,000m^3^) to 5% (approximately 160,000m^3^) reduction in annual harvested volume compared to BAU scenarios. Decreasing habitat recovery time from 40 years to 30 years resulted in a 1% (approximately 30,000m^3^) improvement in timber supply across scenarios. A 3m adjacency constraint increased the annual amount of volume harvest in the scenarios compared to a 1.5m adjacency constraint. In the BAU scenarios, the annual timber harvest decreased by 2% (approximately 60,000m^3^) with the 3m adjacency constraint compared to a 1.5 m constraint. In the ECCC and BC sceanrios, the annual timber harvest decreased by 3% (approximately 100,000m^3^) with the 3m adjacency constraint compared to a 1.5 m constraint.

The no harvest, BC herd plan and ECCC scenarios all had teh desired efefct of reducing the amount of disturbance adn early forest in cariobu critical habitat. AS expected, the BC herd plan scenarios allowed for some disturabnce and early seral forest in LEWR critcal habtiat, but less than in the BAU scenario, adn the ECCC scenarios resulted in a decrease in disturabnce and early seral forest in Matrix habitat compared to the BC herd plan scenarios.

The scenarios provide a basis for evaluating the trade-off between forest harvest and caribou habitat recovery and conservation. They need to be evaluated within the context of model parameters, such as habitat recovery rates and forest harvest priority. Our results also show the significant effect of caribou habitat recovery on forest harvest rates. We show that reducing the time period of habtiat recovery from 40 years to 30 years can reduce the impact to forest harvest. However, more improtantly, while critical habitat disturbance thresholds may be a useful heuristic for conserving caribou, applying these constraints in the Itcha-Ilgachuz herd would result in no harvest there, unless active habitat recovery were to occur. In the absence of disturbance recovery, we show that forest harvest can occur if disturbances are recovered. Our results show that a more detailed discussion on the teh efefcts of roads adn early seral forest on cariobu popaultions, adn the definition of recovered caribou habitat is needed to create more realistic and optimistic CLUS model scenarios and caribou recovery plans.
