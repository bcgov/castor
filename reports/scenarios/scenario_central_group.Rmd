...
# data.harvest <- read.csv (here ("reports/scenarios/data", "harvest_central_group_20200528.csv"))
...
#### Disturbance in Burnt Pine Critical Habitat Within TFL48




```{r, FIG 3, TFL48 Burtn PIne disturbance scenario compare, echo = F, error = F, eval = T, include = T, message = F, warning = F}
data.dist <- read.csv (here ("reports/scenarios/data", "disturbance_central_group_20200528.csv"))
# # scenarios: cg_bau_a3_rNA, cg_partner_agreement_a3_r40
# # compartments: TFL48, Dawson_Creek_TSA
...
in TFL 48 Under the Different Habitat Management Scenarios.", 
  ...
  scale_color_discrete (name = "Scenario", labels = c("BAU", "No Harvest")) +
  scale_linetype_discrete (name = "Scenario", labels = c("BAU", "No Harvest")) +
...
<<<<<<< HEAD
#### Disturbance in Kennedy Siding Critical Habitat Within TFL48
...
data.dist.ks <- data.dist %>%
                  filter (scenario == "cg_bau_a3_rNA" | scenario == "cg_partner_agreement_a3_r40") %>%
                    filter (critical_hab == "Kennedy_Siding HESR" | critical_hab == "Kennedy_Siding HEWR" |
                            critical_hab == "Kennedy_Siding HEWSR" | critical_hab == "Kennedy_Siding Matrix")
...
#### Disturbance in Klinse-Za Critical Habitat Within TFL48
...
#### Disturbance in Qunitette Critical Habitat Within TFL48
...
```{r, FIG 3, TFL48 Burtn PIne disturbance scenario compare, echo = F, error = F, eval = T, include = T, message = F, warning = F}
>>>>>>> 4c8e90adfe288741dd8cd5369abeba620fa7a053
data.dist <- read.csv (here ("reports/scenarios/data", "disturbance_central_group_20200528.csv"))
# # scenarios: cg_bau_a3_rNA, cg_partner_agreement_a3_r40
# # compartments: TFL48, Dawson_Creek_TSA
...
data.dist.q <- data.dist %>%
                  filter (scenario == "cg_bau_a3_rNA" | scenario == "cg_partner_agreement_a3_r40") %>%
                    filter (critical_hab == "Quintette HESR" | critical_hab == "Quintette HEWR" |
                            critical_hab == "Quintette HEWSR" | critical_hab == "Quintette Matrix")
...
```{r, FIG 7, TFL48 displaced disturbance scenario compare, echo = F, error = F, eval = T, include = T, message = F, warning = F}
data.dist <- read.csv (here ("reports/scenarios/data", "disturbance_central_group_20200528.csv"))
# # scenarios: cg_bau_a3_rNA, cg_partner_agreement_a3_r40
# # compartments: TFL48, Dawson_Creek_TSA
...
ggplot (data.dist.tfl48.disp, aes (x = timeperiod, y = dist500_per, color = scenario, linetype = scenario)) +
  geom_line (position = position_dodge (width = 1)) + 
  facet_grid (. ~critical_hab) +
  labs (title = "Figure 7. Proportion of Area Disturbed in Graham and Hart Ranges Critical Habitat 
in TFL 48 Under the Different Habitat Management Scenarios.", 
        x = "Future Year", 
        y = "Percent Disturbed",
        caption = "BAU = business-as-usual scenario") + 
...
=======
[11]    Moberly HESR          Moberly HEWR          Moberly HEWSR        
[16] Moberly Matrix        Quintette HESR        Quintette HEWR        Quintette HEWSR       Quintette Matrix 
   ...
   Graham HESR          
 [6] Graham HEWSR          Graham Matrix         Hart_Ranges HEWSR    
