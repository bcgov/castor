...
table.glm.summary <- read.csv ("data/table_glm_summary_fire.csv")
...
The maximum VIF from the simple GLM covariate model was <1.01, indicating these covariates were not correlated.
