...
The maximum VIF from the simple GLM covariate model (i.e., including distance to cutblock 1 to 4, 5 to 9 and over 10 years old) was <4.1, indicating covaraites were not highly correlated. The AIC*~w~* of the model without fucntional response covaraites was 1.00, indicating a lack of functional response in caribou selection for cutblcoks. In addition, the AUC of the simpler model (AUC = 0.679) was slightly better than the functional response model (AUC = 0.668). 
...
The maximum VIF from the simple GLM covariate model (i.e., including distance to cutblock 1 to 4, over 5 years old) was <1.8, indicating covariates were not highly correlated. The AIC*~w~* of the model without functional response covariates was 1.00, indicating a lack of fucntional response in caribou selection for cutblcoks. In addition, the AUC of theis simpler model (AUC = 0.690) was slightly better than the functional response model (AUC = 0.675). 

##### Summer
The correlation plot indicated that distance to cutblocks 10 to 29 years old and 30 or over years old were highly correlated ($\rho$ = 0.80) and distance to cutblocks 5 to 9 years old and 10 to 29 years old were highly correlated ($\rho$ = 0.87) therefore, I grouped these three age categories together (i.e., distance to cutblocks greater than 5 years old).

![](plots/plot_dist_cut_corr_du_7_s.png)

The maximum VIF from the simple GLM covariate model (i.e., including distance to cutblock 1 to 4, over 5 years old) was <1.6, indicating covariates were not highly correlated. The AIC*~w~* of the model without functional response covariates was 1.00, indicating a lack of functional response in caribou selection for cutblocks. In addition, the AUC of the simpler model (AUC = 0.694) was better than the functional response model (AUC = 0.678).
