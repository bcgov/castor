...
The maximum VIF from the simple GLM covariate model was <1.6, indicating covariates were not highly correlated. 

The top-ranked model included covariates of distance to cutblock for each cutblock age class, but no functional response,and had an AIC*~w~* of 1.00. In addition, the top model had the highest AUC (AUC = 0.665).
...
The maximum VIF from the simple GLM covariate model was <1.7, indicating covariates were not highly correalted.
...
#### DU7
##### Early Winter
The correlation plot indicated that distance to cutblocks 10 to 29 years old and 30 or over years old were highly correlated ($\rho$ = 0.81), therefore, I grouped these two age categories together (i.e., disatnce to cutblcoks greater than 10 years old).

![](plots/plot_dist_cut_corr_du_7_ew.png)

The maximum VIF from the simple GLM covariate model (i.e., including distance to cutblock 1 to 4, 5 to 9 and over 10 years old) was <4.1, indicating covaraites were not highly correalted. The AIC*~w~* of the model without fucntional response covaraites was 1.00, indicating a lack of fucntional response in caribou selection for cutblcoks. In addition, the AUC of the simpler model (AUC = 0.679) was slightly better than the functional response model (AUC = 0.668). 

##### Late Winter
The correlation plot indicated that distance to cutblocks 10 to 29 years old and 30 or over years old were highly correlated ($\rho$ = 0.82) and distance to cutblocks 5 to 9 years old and 10 to 29 years old were highly correlated ($\rho$ = 0.71) therefore, I grouped these three age categories together (i.e., distance to cutblcoks greater than 5 years old).

![](plots/plot_dist_cut_corr_du_7_lw.png)

The maximum VIF from the simple GLM covariate model (i.e., including distance to cutblock 1 to 4, over 5 years old) was <1.8, indicating covariates were not highly correlated. The AIC*~w~* of the model without fucntional response covariates was 1.00, indicating a lack of fucntional response in caribou selection for cutblcoks. In addition, the AUC of the simpler model (AUC = 0.690) was slightly better than the functional response model (AUC = 0.675). 

##### Summer
The correlation plot indicated that distance to cutblocks 10 to 29 years old and 30 or over years old were highly correlated ($\rho$ = 0.80) and distance to cutblocks 5 to 9 years old and 10 to 29 years old were highly correlated ($\rho$ = 0.87) therefore, I grouped these three age categories together (i.e., distance to cutblcoks greater than 5 years old).
