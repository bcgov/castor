...
- highest vif value was 3.56
  ...
  - Human disturbance features top-ranked model included slope, disatnce to lake, and soil type and had an AIC weight (AIC*~w~*) of 0.511. The second ranked model included all covariates (elevation, slope, disatnce to lake, disatnce to watercourse, soil type) and had an AIC weight (AIC*~w~*) of 0.489 ; thus all covariates borught into next model. coefficent values of covairaets  for these two models were nearly ideantical, tehrefore ratehr than take average of each model, kept model with all covaraites for next 
