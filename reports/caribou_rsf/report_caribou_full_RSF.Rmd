...
- model with endruing features (slope, distance_to_lake, distance_to_watercourse, soil_parent_material_name, ) and natural disturbance features (beetle adn fire)
  - model failed to converge
