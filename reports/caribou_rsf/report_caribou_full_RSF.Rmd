...
- correlations
  - annual and winter ppt as snow higly correalted ($\rho$ = 0.96); kept winter PAS
  - mean annual temp adn witner temp close to being correalted ($\rho$ = 0.69); removed annual temp

![](plots/corr_all_du6_ew.png)

- vif value for winter temperates was 10.86; removed form analysis, all VIFs <4.26
...
## Conclusions
In DU6 , early winter, 
- cosnsitent with Demards: selected treed bogs and fens; avoid decisuous adn upland types; avoid  lienar features and select early seral/imamture forest
