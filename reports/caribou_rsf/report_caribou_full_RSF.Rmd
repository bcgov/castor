...
- first fit terrain, vegetation, climate, huamn disturbnce, natural disturbnce specific-models, most fit all comibnatiosn fo models, for vegetation, many combinations, used minimum five covaiates  
...
- correlations
  ...
  - VRI basal area correlated with crown closure ($\rho$ = 0.67), live volume ($\rho$ = 0.67) and 
    height ($\rho$ = 0.69)
  - kept basal area, becuase seemed to represent many features (height, volume and crown closure),       bryoid cover, herb cover, stand age, and shrub crown closure
  
- used wetland cover classes instead of VRI cover classes for DU6 because of precedent (Demars)

![](plots/corr_veg_du6_ew.png)

-  vif values were less than 1.83
