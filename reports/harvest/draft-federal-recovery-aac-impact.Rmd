...
setnames(thlb, c("V1", "V2", "V3", "V4"), c("compartment", "total_thlb", "crit_habitat_thlb", "newly_added_crit_habitat_thlb"))
...
knitr::kable(last,format.args = list(big.mark = ","))%>%
  ...
  add_header_above(c(" ", "Total Volume Harvested (m3, over 100 years)" = 2, "AAC Impact" = 2, "THLB Impact" = 4))
```
