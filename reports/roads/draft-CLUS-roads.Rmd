...
Roads are an important consequence from land use operations that impact future economic opportunities and wildlife habitat. Assuming an annual harvest of 200 000 ha with 3 % of the harvest area in roads, a road right of way of 20 m, then roughly 3 000 km of roads get built per year. This equates to travelling a round trip between Vancouver, BC and Fort Nelson, BC. How are these roads planned and designed? 
