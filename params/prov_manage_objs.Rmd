...
```{r}
data.dir<-"<location of downloaded forest harvest restrictions>" # e.g. data.dir<-"C:\\Downloads"
...
###
lu.dt1<-lu.dt[!(beo=="Multiple" & is.na(rt_dt)),]
lu.mult<-lu.dt[beo=="Multiple" & is.na(rt_dt),]
lu.mult<-lu.mult[order(gis_ch_dt)]
