...
--Remove those timber makrs that have distrbance start dates > 2016	
...
left join (select opening_id, timber_mrk, dstrbncstr, dstrbncndd from ftn_results_2012_16) as a
