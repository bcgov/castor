...
DELETE FROM vdyp vdyp WHERE feature_id IN (SELECT feature_id FROM vdyp_err WHERE code = 'E '); 
...
CASE 
WHEN UPPER(species_cd_1) IN ('D','DG','DM','DR','E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'D'
WHEN UPPER(species_cd_1) IN ('E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'E'
WHEN UPPER(species_cd_1) IN ('A','AC','ACB','ACT','AD','AT','AX') THEN 'Ac'
WHEN UPPER(species_cd_1) IN ('B','BA','BB','BC','BG','BL','BM','BP') THEN 'B'
WHEN UPPER(species_cd_1) IN ('C','CW') THEN 'C'
WHEN UPPER(species_cd_1) IN ('Y','YC') THEN 'Yc'
WHEN UPPER(species_cd_1) IN ('F','FD','FDC','FDI') THEN 'F'
WHEN UPPER(species_cd_1) IN ('H','HM','HW','HX','HXM') THEN 'H'
WHEN UPPER(species_cd_1) IN ('L','LA','LD','LS','LT','LW') THEN 'L'
WHEN UPPER(species_cd_1) IN ('M','MB','ME','MN','MR','MS','MV') THEN 'Mb'
WHEN UPPER(species_cd_1) IN ('G','GP','GR','J','JD','JH','JR','K','KC','OA','OB','OC','OD','OE','OF','OG','OH','OI','Q','QE','QG','QW','R','RA','T','TW','U','UA','UP',
'V','VB','VP','VS','VV','VW','W','WA','WB','WD','WP','WS','WT','X','XC','XH','YP','Z','ZC','ZH') THEN 'O'
WHEN UPPER(species_cd_1) IN ('P','PA','PF','PJ','PL','PLC','PLI','PM','PR','PS','PW','PX','PXJ','PY') THEN 'P'
WHEN UPPER(species_cd_1) IN ('SB') THEN 'Sb'
WHEN UPPER(species_cd_1) IN ('S','SA','SE','SN','SS','SW','SX','SXB','SXE','SXL','SXS','SXW','SXX') THEN 'S'
END  ;

Update vdyp_vri2018 set species_cd_2 =
CASE 
WHEN UPPER(species_cd_2) IN ('D','DG','DM','DR','E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'D'
WHEN UPPER(species_cd_2) IN ('E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'E'
WHEN UPPER(species_cd_2) IN ('A','AC','ACB','ACT','AD','AT','AX') THEN 'Ac'
WHEN UPPER(species_cd_2) IN ('B','BA','BB','BC','BG','BL','BM','BP') THEN 'B'
WHEN UPPER(species_cd_2) IN ('C','CW') THEN 'C'
WHEN UPPER(species_cd_2) IN ('Y','YC') THEN 'Yc'
WHEN UPPER(species_cd_2) IN ('F','FD','FDC','FDI') THEN 'F'
WHEN UPPER(species_cd_2) IN ('H','HM','HW','HX','HXM') THEN 'H'
WHEN UPPER(species_cd_2) IN ('L','LA','LD','LS','LT','LW') THEN 'L'
WHEN UPPER(species_cd_2) IN ('M','MB','ME','MN','MR','MS','MV') THEN 'Mb'
WHEN UPPER(species_cd_2) IN ('G','GP','GR','J','JD','JH','JR','K','KC','OA','OB','OC','OD','OE','OF','OG','OH','OI','Q','QE','QG','QW','R','RA','T','TW','U','UA','UP',
'V','VB','VP','VS','VV','VW','W','WA','WB','WD','WP','WS','WT','X','XC','XH','YP','Z','ZC','ZH') THEN 'O'
WHEN UPPER(species_cd_2) IN ('P','PA','PF','PJ','PL','PLC','PLI','PM','PR','PS','PW','PX','PXJ','PY') THEN 'P'
WHEN UPPER(species_cd_2) IN ('SB') THEN 'Sb'
WHEN UPPER(species_cd_2) IN ('S','SA','SE','SN','SS','SW','SX','SXB','SXE','SXL','SXS','SXW','SXX') THEN 'S'
END  ;

Update vdyp_vri2018 set species_cd_3 =
CASE 
WHEN UPPER(species_cd_3) IN ('D','DG','DM','DR','E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'D'
WHEN UPPER(species_cd_3) IN ('E','EA','EB','EE','EP','ES','EW','EX','EXP','EXW') THEN 'E'
WHEN UPPER(species_cd_3) IN ('A','AC','ACB','ACT','AD','AT','AX') THEN 'Ac'
WHEN UPPER(species_cd_3) IN ('B','BA','BB','BC','BG','BL','BM','BP') THEN 'B'
WHEN UPPER(species_cd_3) IN ('C','CW') THEN 'C'
WHEN UPPER(species_cd_3) IN ('Y','YC') THEN 'Yc'
WHEN UPPER(species_cd_3) IN ('F','FD','FDC','FDI') THEN 'F'
WHEN UPPER(species_cd_3) IN ('H','HM','HW','HX','HXM') THEN 'H'
WHEN UPPER(species_cd_3) IN ('L','LA','LD','LS','LT','LW') THEN 'L'
WHEN UPPER(species_cd_3) IN ('M','MB','ME','MN','MR','MS','MV') THEN 'Mb'
WHEN UPPER(species_cd_3) IN ('G','GP','GR','J','JD','JH','JR','K','KC','OA','OB','OC','OD','OE','OF','OG','OH','OI','Q','QE','QG','QW','R','RA','T','TW','U','UA','UP',
'V','VB','VP','VS','VV','VW','W','WA','WB','WD','WP','WS','WT','X','XC','XH','YP','Z','ZC','ZH') THEN 'O'
WHEN UPPER(species_cd_3) IN ('P','PA','PF','PJ','PL','PLC','PLI','PM','PR','PS','PW','PX','PXJ','PY') THEN 'P'
WHEN UPPER(species_cd_3) IN ('SB') THEN 'Sb'
WHEN UPPER(species_cd_3) IN ('S','SA','SE','SN','SS','SW','SX','SXB','SXE','SXL','SXS','SXW','SXX') THEN 'S'
END  ;

/* Group species that are the same*/
select * from vdyp_vri2018 where species_cd_1 = species_cd_3  limit 100;
Update vdyp_vri2018 set species_pct_1 = CASE
WHEN species_cd_1 = species_cd_2 THEN (species_pct_1 + species_pct_2)
WHEN species_cd_1 = species_cd_3 THEN (species_pct_1 + species_pct_3)
END;
...
Update vdyp_vri2018 set species_pct_2 = CASE
WHEN species_cd_2 = species_cd_3 THEN (species_pct_2 + species_pct_3)
END;
...
SELECT * FROM vdyp_vri2018 LIMIT 2345;
