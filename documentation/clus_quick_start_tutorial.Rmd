...
Here you will see a stack of green boxes with a title on teh left side and plus sign non the right side.
...
- currently we upload to a postgres on a VM server; 
  -  define the area of interest name that (aoiName); this sets the name of the schema where tables get uploaded to postgres
