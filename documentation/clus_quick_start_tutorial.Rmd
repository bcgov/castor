...
# Alter table designatedlands rename to designatedlands_2018;
GRANT ALL ON TABLE archive.designatedlands_caribou TO postgres;
GRANT ALL ON TABLE archive.designatedlands_caribou TO clus_project;
GRANT ALL ON TABLE archive.designatedlands_caribou TO tmuhly;
