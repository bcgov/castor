...
DBI::dbWriteTable (conn, c("zone", "zone_test"), # commit tables to pg
                   ...
                   row.names = FALSE, 
                   overwrite = TRUE) 
dbExecute(conn, "Alter Table zone.zone_test add column denom VARCHAR")
