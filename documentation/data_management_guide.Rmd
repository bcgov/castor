...
new_data <- data.table (computer = 'DC052586',  
                        ...
                        type = 'raster',
                        script = 'clus\\R\\Params\\uwr_cond_harvest.Rmd', 
...
new_data2 <- data.table (computer = 'DC052586', 
                        ...
                        last_updated = '2021', 
                        next_update = '2025', 
                        where_used = 'grizzlysurvivalCLUS')
new_data3 <- data.table (computer = 'DC052586', 
                        database = 'clus', 
                        schema = 'vat', 
                        table_name = 'gbpu ', 
...
new_data <- data.table (computer = 'DC052586', 
                        ...
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'clus\\R\\Params\\raster_data.Rmd' 
                        )
new_data1 <- data.table (computer = 'DC052586', 
                        database = 'clus', 
                        schema = 'rast', 
                        ...
                        type = 'raster',
                        script = 'clus\\R\\Params\\raster_data.Rmd', 
                        source = 'Forest Analysis and Inventory Branch, Iaian Mcdougall', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'forestryCLUS' 
                        )
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data1))
...
new_data <- data.table (computer = 'DC052586', 
                        ...
                        type = 'raster', 
                        script = 'clus\\R\\Params\\caribou_southern_mtn_pop_model.Rmd', 
                        source = 'critical habitat as of June 2020; from Nicola Dodd; MoE.', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'smcaribouAbundanceCLUS'
                        )
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'clus',
                        schema = 'vat', 
...
new_data <- data.table (computer = 'DC052586', # e.g., 206.12.91.188 or DC052586 
                        ...
                        script = 'clus\\R\\Params\\caribou_management_areas.Rmd', # name and location of script to produce the data
...
# Chilcotin roads
new_data <- data.table (computer = 'DG401102', database = 'clus', schema = 'public', 
                        table_name = 'Cariboo_Consolidated_Roads', type = 'line', 
                        script = 'clus\\R\\Params\\road_rasterize.Rmd', 
                        source = 'Carole Mahood, Cariboo region GIS Analyst', public = 'No', 
                        last_updated = '2022', next_update = '2023', where_used = 'dataLoaderCLUS')
pgdbs_data_list_new <- merge (pgdbs_data_list, new_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
# raster
new_data <- data.table (computer = 'DG401102', database = 'clus', schema = 'rast', 
...
#Create new row for table
new_data <- data.table (computer = 'DG401102', database = 'clus', schema = 'comaprison_nass', 
                        ...
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data2 <- data.table (computer = 'DG401102', database = 'clus', schema = 'comaprison_nass', 
                        table_name = 'nass_supply_blocks',  type = 'polygon', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA area, with supply blocks.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data3 <- data.table (computer = 'DG401102', database = 'clus', schema = 'comaprison_nass', 
                        table_name = 'rast_supply_blocks',  type = 'raster', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA supply blocks.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data4 <- data.table (computer = 'DG401102', database = 'clus', schema = 'comaprison_nass', 
                        table_name = 'rast_tsa',  type = 'raster', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA area.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data5 <- data.table (computer = 'DG401102', database = 'clus', schema = 'comaprison_nass', 
...
new_data <- data.table (computer = 'DG401102', database = 'clus', schema = 'public', 
                        ...
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data2 <- data.table (computer = 'DG401102', database = 'clus', schema = 'rast', 
                        table_name = 'central_grp_aoi',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; area of interest for central grp tech working group',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data3 <- data.table (computer = 'DG401102', database = 'clus', schema = 'vat', 
                        table_name = 'central_grp_aoi',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; area of interest for central grp tech working group',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')

new_data4 <- data.table (computer = 'DG401102', database = 'clus', schema = 'public', 
                        ...
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data5 <- data.table (computer = 'DG401102', database = 'clus', schema = 'rast', 
                        table_name = 'central_grp_habitat_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data6 <- data.table (computer = 'DG401102', database = 'clus', schema = 'vat', 
                        table_name = 'central_grp_habitat_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data7 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'central_grp_habitat_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')

new_data8 <- data.table (computer = 'DG401102', database = 'clus', schema = 'public', 
                        ...
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data9 <- data.table (computer = 'DG401102', database = 'clus', schema = 'rast', 
                        table_name = 'central_grp_deferral_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data10 <- data.table (computer = 'DG401102', database = 'clus', schema = 'vat', 
                        table_name = 'central_grp_deferral_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data11 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'central_grp_deferral_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')

new_data12 <- data.table (computer = 'DG401102', database = 'clus', schema = 'public', 
                        ...
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data13 <- data.table (computer = 'DG401102', database = 'clus', schema = 'rast', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data14 <- data.table (computer = 'DG401102', database = 'clus', schema = 'vat', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
new_data15 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataLoaderCLUS')
...
dbExecute (conn, 
           "DROP TABLE rast.clus_herd_poly;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'clus_herd_poly' AND computer = 'DG401102';")
dbExecute (conn, 
...
dbExecute (conn, 
           "DROP TABLE public.directory_clus_data;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'directory_clus_data' AND computer = 'DG401102';")
dbExecute (conn, 
...
new_data1 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'zone_whitebark_bc_core_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
new_data3 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'zone_whitebark_eccc_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
new_data4 <- data.table (computer = 'DG401102', database = 'clus', schema = 'vat', 
...
new_data6 <- data.table (computer = 'DG401102', database = 'clus', schema = 'zone', 
                        table_name = 'zone_whitebark_potential_range', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
new_data <- data.table (computer = 'DG401102', database = 'clus',
...
new_data1 <- data.table (computer = 'DG401102', database = 'clus',
                        schema = 'rast', table_name = 'central_grp_restore_aoi', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Megan Watters, caribou recovery prorgam', # description of data source
                        public = 'No', last_updated = '2022',  next_update = 'As needed',  
                        where_used = 'R/scenarios/central_group' )
new_data2 <- data.table (computer = 'DG401102', database = 'clus',
