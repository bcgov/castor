---
title: " Data Management Guidelines for the Forest and Land Use Simulator"
author: "Tyler Muhly"
date: "02/11/2020"
...
Like any quantitative model, the forest and land use simulator (CASTOR) has a specific framework for how it uses datasets in the modeling platform. For details on this framework, see the *Castor quick start tutorial* (https://github.com/bcgov/castor/blob/main/documentation/castor_quick_start_tutorial.md) documentation. Here we describe how to document those datasets that are developed and used within the CASTOR model. 

### The Data Tracking Table
Spatial and aspatial data and parameters used in Castor are stored in [PostgreSQL databases](https://www.postgresql.org/). We uploaded a data tracking table called 'pgdbs_data_list' to a Castor PostgreSQL database that describes each 'table' (i.e., dataset) in each PostgreSQL database used by the Castor model or Castor web applications. This tracking table is intended to help Castor users understand the origin, status and appropriate end-use of datasets in the Castor model.  
...
new_data <- data.table (computer = 'test', # e.g., 206.12.91.188 or DG401102 
                        database = 'test', # Castor
...
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set where_used = 'deprecated' where table_name = 'test';") # This example will set a dataset to 'deprecated'; do this when deleting a dataset from the db
...
Changes to the tracking table can be documented in the code chunk below. We can use this, and the orignal .csv (archived in *spatialfiles2.bcgov/archive/FOR/VIC/HTS/ANA/PROJECTS/CASTOR/Data/pgdbs_data_list.csv*) to recreate the table in the event we lose the PostgreSQL database table.
...
reve_data <- data.table (computer = 'DC052586', 
                         ...
                         type = 'polygon', 
                         script = 'castor\\R\\Params\\caribou_management_areas.Rmd', 
                         source = 'Bevan Ernst, FLNRORD', 
                         public = 'No', 
                         last_updated = '2020', 
                         next_update = 'as needed', 
                         where_used = 'dataCastor' 
                         )
pgdbs_data_list <- getTableQuery ("SELECT * from public.pgdbs_data_list;")
...
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
reve_raster_data <- data.table (computer = 'DC052586', database = 'castor', schema = 'rast', table_name = 'zond_cond_reve_area', type = 'raster', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new2 <- merge (pgdbs_data_list, reve_raster_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new2, 
                  row.names = FALSE, overwrite = TRUE)
reve_data2 <- data.table (computer = 'DC052586', database = 'castor', schema = 'public', table_name = 'zone_reve_vat', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
reve_data3 <- data.table (computer = 'DC052586', database = 'castor', schema = 'zone', table_name = 'zone_reve_area', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
...
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
du9_raster_data <- data.table (computer = 'DC052586', database = 'castor', schema = 'rast', table_name = 'zone_du9_scenarios', type = 'raster', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new2 <- merge (pgdbs_data_list, du9_raster_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new2, 
                  row.names = FALSE, overwrite = TRUE)
du9_data2 <- data.table (computer = 'DC052586', database = 'castor', schema = 'public', table_name = 'zone_du9_scenarios_vat', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
du9_data3 <- data.table (computer = 'DC052586', database = 'castor', schema = 'zone', table_name = 'zone_du9_scenarios', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
...
gh_raster_data <- data.table (computer = 'DC052586', database = 'castor', schema = 'rast', table_name = 'rast.zone_gh_scenarios', type = 'raster', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD; du9 scenario for groundhog only', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new2 <- merge (pgdbs_data_list, gh_raster_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new2, 
                  row.names = FALSE, overwrite = TRUE)

gh_data2 <- data.table (computer = 'DC052586', database = 'castor', schema = 'public', table_name = 'zone_gh_scenarios_vat', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
gh_data3 <- data.table (computer = 'DC052586', database = 'castor', schema = 'zone', table_name = 'zone_gh_scenarios', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Bevan Ernst, FLNRORD', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
...
raster_data <- data.table (computer = 'DC052586', database = 'castor', schema = 'rast', table_name = 'central_grp_proposed_luo_feb2021', type = 'raster', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Russ Laroche; Draft Partnership Land Use Orders', public = 'No', last_updated = '2021', next_update = 'as needed', where_used = 'dataCastor')
...
data2 <- data.table (computer = 'DC052586', database = 'castor', schema = 'public', table_name = 'scenario_central_grp_proposed_luo_feb2021_vat', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Russ Laroche; Draft Partnership Land Use Orders', public = 'No', last_updated = '2021', next_update = 'as needed', where_used = 'dataCastor')
data3 <- data.table (computer = 'DC052586', database = 'castor', schema = 'zone', table_name = 'zone_scenario_central_grp_proposed_luo_feb2021', type = 'table', script = 'castor\\R\\Params\\caribou_management_areas.Rmd', source = 'Russ Laroche; Draft Partnership Land Use Orders', public = 'No', last_updated = '2020', next_update = 'as needed', where_used = 'dataCastor')
...
new_data <- data.table (computer = 'DC052586', 
                        ...
                        last_updated = '2021',
                        next_update = 'as needed', 
                        where_used = 'dataCastor; for TSAs where these herds overlap' 
                        )
# merge tables
...
new_data1 <- data.table (computer = 'DC052586', 
                        ...
                        type = 'table', 
                        script = 'castor\\R\\Params\\study_area_boundaries.Rmd', 
...
new_data6 <- data.table (computer = 'DC052586', 
                        ...
                        type = 'raster', 
                        script = 'castor\\R\\Params\\fsj_management_areas.Rmd', 
                        source = 'Iaian Mcdougall, data compiled to complete timber impact assessment of multiple management areas in Fort St. John TSA, as requested by Shane Ford; these data delineate the core habitat areas for the Pink Mtn caribou herd.', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
...
new_data3 <- data.table (computer = 'DC052586', 
                        ...
                        type = 'raster', 
                        script = 'castor\\R\\Params\\proposed_old_growth_deferal_areas.Rmd', 
                        source = 'Adrian Walton, data compiled for old growth area deferal recommendations. This defines the location of proposed old growth deferral as old growth in BEC zones with <10% old forest (recommendation 6.3a).', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor',  
                        schema = 'public', 
                        table_name = 'uwr_20210621', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'https://catalogue.data.gov.bc.ca/dataset/ungulate-winter-range-approved', 
                        public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'dataCastor' 
...
new_data <- data.table (computer = 'DC052586',  
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'zone_uwr_2021', 
                        type = 'raster',
                        script = 'castor\\R\\Params\\uwr_cond_harvest.Rmd', 
                        source = 'unglate winter ranges: https://catalogue.data.gov.bc.ca/dataset/ungulate-winter-range-approved', 
                        public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'dataCastor' 
...
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data1))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor',  
                        schema = 'public', 
                        table_name = 'wha_20210621', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'https://catalogue.data.gov.bc.ca/dataset/wildlife-habitat-areas-approved', 
                        public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'dataCastor' 
...
new_data <- data.table (computer = 'DC052586',  
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'zone_wha_2021', 
                        type = 'raster',
                        script = 'castor\\R\\Params\\uwr_cond_harvest.Rmd', 
                        source = 'wildlife habitat areas: https://www.env.gov.bc.ca/cgi-bin/apps/faw/wharesult.cgi?search=show_approved', 
                        public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'dataCastor' 
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'gbpu_bc_polygon', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'DataBC: https://catalogue.data.gov.bc.ca/dataset/caa22f7a-87df-4f31-89e0-d5295ec5c725',                         public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2025', 
                        where_used = 'grizzly_bear_population_units.Rmd')
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'gbpu_2021 ', 
                        type = 'raster', 
                        script = 'grizzly_bear_population_units.Rmd', 
                        source = 'DataBC: https://catalogue.data.gov.bc.ca/dataset/caa22f7a-87df-4f31-89e0-d5295ec5c725',                         public = 'Yes', 
                        last_updated = '2021', 
                        next_update = '2025', 
                        where_used = 'survivalgrizzlyCastor')
new_data3 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'vat', 
                        table_name = 'gbpu ', 
...
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
new_data <- data.table (computer = 'DC052586', 
                        ...
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Forest Analysis and Inventory Branch, Iaian Mcdougall', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'castor\\R\\Params\\raster_data.Rmd' 
                        )
new_data1 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'thlb_2020', 
                        type = 'raster',
                        script = 'castor\\R\\Params\\raster_data.Rmd', 
                        source = 'Forest Analysis and Inventory Branch, Iaian Mcdougall', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = '2022', 
                        where_used = 'forestryCastor' 
                        )
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data1))
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'smc_herd_habitat', 
                        type = 'raster', 
                        script = 'castor\\R\\Params\\caribou_southern_mtn_pop_model.Rmd', 
                        source = 'critical habitat as of June 2020; from Nicola Dodd; MoE.', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'smcpopCastor'
                        )
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor',
                        schema = 'vat', 
                        table_name = 'smc_coeffs', 
                        type = 'table', 
                        script = 'castor\\R\\Params\\caribou_southern_mtn_pop_model.Rmd', 
                        source = 'critical habitat as of June 2020; from Nicola Dodd; MoE.', 
                        public = 'No', 
...
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2))
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
dbDisconnect(conn)

# Update cutlbocks table names
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list SET table_name = 'cns_cut_bl_polygon2018' WHERE table_name = 'cns_cut_bl_poly';")
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list SET table_name = 'cns_cut_bl_polygon' WHERE table_name = 'cutblocks2020';")
dbDisconnect(conn)
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'study_area_chilcotin', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'combination of TSA and caribou critical habitat boundaries in Williams Lake and Quesnel TSAs', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'dataCastor' 
...
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'study_area_chilcotin',
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'castor\\R\\Params\\study_area_boundaries.Rmd', #
                        source = 'castor\\R\\Params\\thlb', 
                        public = 'Yes', #
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'dataCastor' 
...
new_data3 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'vat', # caribou, public, vat, zone or rast
                        table_name = 'study_area_chilcotin',
                        type = 'table', # polygon, point, line, raster or table
                        script = 'castor\\R\\Params\\study_area_boundaries.Rmd', #
                        source = 'castor\\R\\Params\\thlb', 
                        public = 'Yes', #
                        last_updated = '2021', 
...
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data2, new_data3))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public',
                        table_name = 'eccc_industrial_sites_all', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Environment Canada; location of cutblocks, wells, wind farms and mines compiled from various sources.', 
                        public = 'Yes', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'dataCastor' 
...
new_data3 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public',
                        table_name = 'eccc_industrial_centroids', 
                        type = 'point', 
                        script = 'ogr2ogr', 
                        source = 'Environment Canada; location of cutblocks, wells, wind farms and mines compiled from various sources.', 
                        public = 'Yes', 
...
# Chilcotin Scenario 2
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'chilcotin_scen2', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Chilcotin planning: Genevieve Lachance, Carolyn Shores',
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'dataCastor' 
...
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'zone_chilcotin_scenario2', 
                        type = 'raster', 
                        script = 'castor\\R\\Params\\caribou_management_areas.Rmd', 
                        source = 'Chilcotin planning: Genevieve Lachance, Carolyn Shores',
                        public = 'No', 
...
# CHILCOTIN AREA-OF-INTEREST
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'chilcoltin_area_to_model', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
                        where_used = 'dataCastor' 
...
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'chilcotin_aoi_v2', 
                        type = 'raster', 
                        script = 'study_area_boundaries.Rmd', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
                        last_updated = '2021', 
                        next_update = 'as needed', 
...
#version 2 of area of interest
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'chilcotin_area_of_interest_habitat', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
...
#version 3 of area of interest
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'chilcotin_area_of_interest_habitat_v3', 
                        type = 'polygon', 
                        script = 'ogr2ogr', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
...
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data1, new_data2))
dbDisconnect(conn)

# Chilcotin proposed WHA
new_data <- data.table (computer = 'DC052586', # e.g., 206.12.91.188 or DC052586 
                        database = 'castor', # castor
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'chilcotin_proposed_wha', # add year adn month if relevant
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'castor\\R\\Params\\caribou_management_areas.Rmd', # name and location of script to produce the data
                        source = 'Chilcotin planning: Genevieve Lachance', # description of data source
                        public = 'No', # Yes, if can be shared with public, otherwise No
                        last_updated = '2022', # year when data added
                        next_update = 'as needed', # year when data should ideally be updated
                        where_used = 'dataCastor' 
                        )
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'rast', 
                        table_name = 'zone_chilcotin_proposed_wha', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'castor\\R\\Params\\caribou_management_areas.Rmd', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
...
# Chilcotin supply blocks
new_data <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'public', 
                        table_name = 'chilcotin_aoi_supply_blocks', 
                        type = 'polygon', 
                        script = 'study_area_boundaries.Rmd', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
...
new_data2 <- data.table (computer = 'DC052586', 
                        database = 'castor', 
                        schema = 'vat', 
                        table_name = 'chilcotin_supply_blocks_vat', 
                        type = 'table', 
                        script = 'study_area_boundaries.Rmd', 
                        source = 'Chilcotin planning: Genevieve Lachance', 
                        public = 'No', 
...
new_data <- data.table (computer = 'DC052586', 
                        ...
                        type = 'raster', 
                        script = 'castor\\R\\Params\\raster_data.Rmd', 
                        source = 'permanent disturabances form cumulative effects; no roads', 
                        public = 'No', 
                        last_updated = '2022', 
                        next_update = '2023', 
                        where_used = 'dataCastor'
...
# Update Kyle's computer name
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set computer = 'DG401102' where computer = 'DC052586';")

# Chilcotin roads
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'Cariboo_Consolidated_Roads', type = 'line', 
                        script = 'castor\\R\\Params\\road_rasterize.Rmd', 
                        source = 'Carole Mahood, Cariboo region GIS Analyst', public = 'No', 
                        last_updated = '2022', next_update = '2023', where_used = 'dataCastor')
pgdbs_data_list_new <- merge (pgdbs_data_list, new_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
# raster
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'rds_cariboo_2022', type = 'line', 
                        script = 'castor\\R\\Params\\road_rasterize.Rmd', 
                        source = 'Carole Mahood, Cariboo region GIS Analyst', public = 'No', 
                        last_updated = '2022', next_update = '2023', where_used = 'dataCastor')
...
#Create new row for table
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'zone_constraints_nass',  type = 'table', 
                        script = 'NA', 
                        source = 'Zone constraint table for the Nass model comparison project. Is a copy of the constraints table from the main zone shema.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'nass_supply_blocks',  type = 'polygon', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA area, with supply blocks.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_supply_blocks',  type = 'raster', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA supply blocks.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data4 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_tsa',  type = 'raster', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA area.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data5 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'vat_supply_blocks',  type = 'table', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA supply blocks VAT.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
# merge tables
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3, new_data4, new_data5))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'vat_tsa',  type = 'table', 
                        script = 'study_area_boundaries.Rmd', source = 'Nass TSA VAT.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data))
# re-upload data to postgres
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'zone_beo',  type = 'table', 
                        script = 'nass_Params.Rmd', source = 'Nass TSA biodiversity emphasis options zone constraints table.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'zone_uwr',  type = 'table', 
                        script = 'nass_Params.Rmd', source = 'Nass TSA ungulate winter range constraints table.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_beo',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Nass TSA beo raster; NOT Multiplied by productive forest.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data4 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_beo_pro',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Nass TSA beo raster multiplied by productive forest.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data5 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_uwr',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Nass TSA UWR raster multiplied by productive forest.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3, new_data4, new_data5))
# re-upload data to postgres
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_thlb_nass ',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Net THLB for Nass.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_beo_lrmp ',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'LRMP BEO zones.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_beo_lrmp_prod ',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'LRMP BEO zones, productive forest only.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'zone_beo_lrmp',  type = 'table', 
                        script = 'nass_Params.Rmd', source = 'LRMP BEO zones constraint table.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_irm ',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Integrated Resource Management zone.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'rast_zone_irm_lu ',  type = 'raster', 
                        script = 'nass_Params.Rmd', source = 'Integrated Resource Management zones x landscape units.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'comaprison_nass', 
                        table_name = 'zone_irm_lu',  type = 'table', 
                        script = 'nass_Params.Rmd', source = 'Integrated Resource Management zones x landscape units constraint table.', 
                        public = 'Yes', last_updated = '2022', next_update = 'as needed', where_used = 'dataCastor')
...
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'central_grp_aoi_072022',  type = 'polygon', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; area of interest for central grp tech working group',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'central_grp_aoi',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; area of interest for central grp tech working group',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'central_grp_aoi',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; area of interest for central grp tech working group',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')

new_data4 <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'central_grp_habitat_072022',  type = 'polygon', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data5 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'central_grp_habitat_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data6 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'central_grp_habitat_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data7 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'central_grp_habitat_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; habitat for central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')

new_data8 <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'central_grp_deferral_072022',  type = 'polygon', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data9 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'central_grp_deferral_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data10 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'central_grp_deferral_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data11 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'central_grp_deferral_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; deferral areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')

new_data12 <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'polygon', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data13 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data14 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data15 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'central_grp_partner_areas_072022',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'Megan Watters; partnership agreement areas central grp tech working group',
                        public = 'No', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
...
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3,
                                     new_data4, new_data5, new_data6, new_data7, 
                                     new_data8, new_data9, new_data10, new_data11,
                                     new_data12, new_data13, new_data14, new_data15))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
# Updated caribou herd boundary data (Tweedsmuir seems to be the only noticeable significantly different area)

new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'public', 
                        table_name = 'bc_caribou_herd_boundary_v20220725',  type = 'polygon', 
                        script = 'caribou_management_areas.Rmd', source = 'https://catalogue.data.gov.bc.ca/dataset/caribou-herd-locations-for-bc/resource/c1dd82ef-4a97-4036-8926-3ad80124a0bf',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'caribou_herd_20220725',  type = 'raster', 
                        script = 'caribou_management_areas.Rmd', source = 'https://catalogue.data.gov.bc.ca/dataset/caribou-herd-locations-for-bc/resource/c1dd82ef-4a97-4036-8926-3ad80124a0bf',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'caribou_herd_20220725',  type = 'table', 
                        script = 'caribou_management_areas.Rmd', source = 'https://catalogue.data.gov.bc.ca/dataset/caribou-herd-locations-for-bc/resource/c1dd82ef-4a97-4036-8926-3ad80124a0bf',
                        public = 'Yes', last_updated = 'July 2022', 
                        next_update = 'as needed', where_used = 'dataCastor')
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
...
# some data clean-up
dbExecute (conn, 
           "SELECT * INTO archive.bc_carib_poly_20090904 FROM public.bc_carib_poly_20090904;")
dbExecute (conn, 
           "DROP TABLE public.bc_carib_poly_20090904;") 
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set where_used = 'archive' where table_name = 'bc_carib_poly_20090904';") 
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set next_update = 'Not applicable' where table_name = 'bc_carib_poly_20090904';") 
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set schema = 'archive' where table_name = 'bc_carib_poly_20090904' AND computer = 'DG401102';") 
dbExecute (conn, 
           "SELECT * INTO archive.bc_caribou_core_matrix_habitat_v20190904_1 FROM public.bc_caribou_core_matrix_habitat_v20190904_1;")
dbExecute (conn, 
           "DROP TABLE public.bc_caribou_core_matrix_habitat_v20190904_1;") 
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set where_used = 'archive' where table_name = 'bc_caribou_core_matrix_habitat_v20190904_1';") 
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set next_update = 'Not applicable' where table_name = 'bc_caribou_core_matrix_habitat_v20190904_1';") 
dbExecute (conn, 
           "DROP TABLE public.boreal_caribou_zone_2019_vat;") 
dbExecute (conn, 
           "DROP TABLE zone.boreal_caribou_zone_2019;") 
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'boreal_caribou_zones_2019_vat';")
dbExecute (conn, 
           "DROP TABLE public.boreal_caribou_zones_2019;") 
dbExecute (conn, 
           "DROP TABLE rast.boreal_caribou_zone_2019;") 
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'boreal_caribou_zones_2019';")
dbExecute (conn, 
           "DROP TABLE rast.bc_gen_crithab;") 
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'bc_gen_crithab';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'beetle_1_to_5';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'beetle_6_to_9';")
dbExecute (conn, 
           "DROP TABLE rast.brfn_areas_fsj;")
dbExecute (conn, 
           "DROP TABLE zone.brfn_areas_fsj;") 		   
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'brfn_areas_fsj';")
dbExecute (conn, 
           "DROP TABLE public.brfnprotectionrestorationmay2021;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'BRFNProtectionRestorationMay2021';")
dbExecute (conn, 
           "DROP TABLE public.caribou_boreal_study_area;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'caribou_boreal_study_area';")
dbExecute (conn, 
           "DROP TABLE rast.caribou_herd;")
dbExecute (conn, 
           "DROP TABLE public.caribou_herd;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'caribou_herd';")
dbExecute (conn, 
           "DROP TABLE public.caribou_herd_25;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'caribou_herd_25';")
dbExecute (conn, 
           "DROP TABLE vat.caribou_herd_vat;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'caribou_herd_vat';")
dbExecute (conn, 
           "DROP TABLE public.caribou_sm_forest_area;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'caribou_sm_forest_area' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.cb_sum;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'cb_sum' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.clim_plot_data;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'clim_plot_data' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.clim_plot_data_bec;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'clim_plot_data_bec' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.clime_bec;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'clime_bec' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE rast.castor_herd_poly;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'castor_herd_poly' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.corepolys_pinkmnt_diss;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'corepolys_pinkmnt_diss' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.criticalhabitat;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'criticalhabitat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE vat.criticalhabitat_gen_bc_vat;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'criticalhabitat_gen_bc_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set schema = 'vat' where table_name = 'criticalhabitat_barkerville_vat' OR table_name = 'criticalhabitat_bc_vat' OR table_name = 'criticalhabitat_burnt_pine_vat' OR table_name = 'criticalhabitat_central_rockies_vat' OR table_name = 'criticalhabitat_central_selkirks_vat' OR table_name = 'criticalhabitat_charlotte_alplands_vat' OR table_name = 'criticalhabitat_columbia_north_vat' OR table_name = 'criticalhabitat_columbia_south_vat' OR table_name = 'criticalhabitat_frisby_boulder_vat' OR table_name = 'criticalhabitat_graham_vat' OR table_name = 'criticalhabitat_groundhog_vat' OR table_name = 'criticalhabitat_hart_ranges_vat' OR table_name = 'criticalhabitat_itcha_ilgachuz_vat' OR table_name = 'criticalhabitat_itchas_vat' OR table_name = 'criticalhabitat_kennedy_siding_vat' OR table_name = 'criticalhabitat_moberly_vat' OR table_name = 'criticalhabitat_monashee_vat' OR table_name = 'criticalhabitat_narraway_vat' OR table_name = 'criticalhabitat_narrow_lake_vat' OR table_name = 'criticalhabitat_north_cariboo_vat' OR table_name = 'criticalhabitat_purcell_central_vat' OR table_name = 'criticalhabitat_purcells_south_vat' OR table_name = 'criticalhabitat_quintette_vat' OR table_name = 'criticalhabitat_rainbows_vat' OR table_name = 'criticalhabitat_redrock_prairie_creek_vat' OR table_name = 'criticalhabitat_south_selkirks_vat' OR table_name = 'criticalhabitat_telkwa_vat' OR table_name = 'criticalhabitat_wells_gray_north_vat' OR table_name = 'criticalhabitat_wells_gray_south_vat';") 
dbExecute (conn, 
           "DROP TABLE rast.dem_sq;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dem_sq' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.designated_herd_bounds;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'designated_herd_bounds' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.designated_herd_bounds2;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'designated_herd_bounds2' AND computer = 'DG401102';")
dbExecute (conn, 
           "DROP TABLE public.designated_herd_bounds3;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'designated_herd_bounds3' AND computer = 'DG401102';")
dbExecute (conn, 
           "UPDATE public.pgdbs_data_list set schema = 'vat' where table_name = 'designatedland_vat';")
dbExecute (conn, 
           "DROP TABLE public.directory_castor_data;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'directory_castor_data' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_agriculture' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_crds_paved' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_crds_resource' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_1_4' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_10_29' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_10o' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_30o' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_5_9' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_cutblock_5o' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_mines' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_pipelines' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_waterbodies' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'dt_watercourses' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'eastnessx1000' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'eastnessx1000' AND computer = 'DG401102';")
dbExecute (conn,  "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_1_to_5' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_6_to_25' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_gt_25' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_not_pine_15' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_old_25' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_pine_15' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.fire_sum;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_sum' AND computer = 'DG401102';")
dbExecute (conn,  "DROP TABLE public.fire_sum_crithab;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fire_sum_crithab' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.fn_aoi;")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fn_aoi' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE zone.fn_aoi_caribou;")
dbExecute (conn, "DROP TABLE rast.fn_aoi_caribou;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fn_aoi_caribou' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE zone.fn_aoi_fsj_tsa;")
dbExecute (conn, "DROP TABLE rast.fn_aoi_fsj_tsa;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fn_aoi_fsj_tsa' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.fn_aoi_fsj_tsa_vat;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fn_aoi_fsj_tsa_vat' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.fsj_old_vri_diss;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'fsj_old_vri_diss' AND computer = 'DG401102';")
dbExecute (conn, "SELECT * INTO archive.gcbp_carib_polygon FROM public.gcbp_carib_polygon;")
dbExecute (conn, "DROP TABLE public.gcbp_carib_polygon;") 
dbExecute (conn, "UPDATE public.pgdbs_data_list set where_used = 'archive' where table_name = 'gcbp_carib_polygon' AND computer = 'DG401102';") 
dbExecute (conn, "UPDATE public.pgdbs_data_list set schema = 'archive' where table_name = 'gcbp_carib_polygon' AND computer = 'DG401102';")  		
dbExecute (conn, "DROP TABLE public.gcbp_thlb_sum;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'gcbp_thlb_sum' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.gcbp_thlb_sum2;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'gcbp_thlb_sum2' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE rast.graham_caribou_core_habitat;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'graham_caribou_core_habitat' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE rast.graham_caribou_old;")
dbExecute (conn, "DROP TABLE zone.graham_caribou_old;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'graham_caribou_old' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.graham_core_20200623;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'graham_core_20200623' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE zone.graham_core_caribou_habitat;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'graham_core_caribou_habitat' AND computer = 'DG401102';")
dbExecute (conn, "DROP TABLE public.graham_core_caribou_habitat_vat;")
dbExecute (conn, "DELETE FROM public.pgdbs_data_list WHERE table_name = 'graham_core_caribou_habitat_vat' AND computer = 'DG401102';")

#Create new row for table
new_data <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'zone_whitebark_bc_core_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
                        where_used = 'R/scenarios/white_bark'
                        )
new_data1 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'zone_whitebark_bc_core_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
new_data2 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'zone_whitebark_eccc_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
                        where_used = 'R/scenarios/white_bark'
                        )
new_data3 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'zone_whitebark_eccc_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
new_data4 <- data.table (computer = 'DG401102', database = 'castor', schema = 'vat', 
                        table_name = 'whitebark_eccc_habitat', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
                        where_used = 'R/scenarios/white_bark'
...
new_data5 <- data.table (computer = 'DG401102', database = 'castor', schema = 'rast', 
                        table_name = 'zone_whitebark_potential_range', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
                        where_used = 'R/scenarios/white_bark'
                        )
new_data6 <- data.table (computer = 'DG401102', database = 'castor', schema = 'zone', 
                        table_name = 'zone_whitebark_potential_range', 
                        type = 'raster', script = 'R/Params/whitebark.Rmd', 
                        source = 'Francis Iredale, Species at Risk Recovery Branch, LWRS', 
                        public = 'No', last_updated = '2022', next_update = 'As needed', 
...
# central group restoration aoi
new_data <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'central_grp_restoration_aoi_112022', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Megan Watters, caribou recovery prorgam', # description of data source
                        public = 'No', last_updated = '2022',  next_update = 'As needed',  
                        where_used = 'R/scenarios/central_group' )
new_data1 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'central_grp_restore_aoi', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Megan Watters, caribou recovery prorgam', # description of data source
                        public = 'No', last_updated = '2022',  next_update = 'As needed',  
                        where_used = 'R/scenarios/central_group' )
new_data2 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'central_grp_restore_aoi', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Megan Watters, caribou recovery prorgam', # description of data source
                        public = 'No', last_updated = '2022',  next_update = 'As needed',  
                        where_used = 'R/scenarios/central_group' )
...
## Revelstoke Complex Scenarios Feb. 2023
new_data <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'revelstoke_tier1_feb2023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data2 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'revelstoke_tier2_feb2023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data3 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'revelstoke_tier3_feb2023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data4 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'revelstoke_tier4_feb2023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data5 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'zone_revelstoke_tier1_caribou', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data6 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'zone_revelstoke_tier2_caribou', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data7 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'zone_revelstoke_tier3_caribou', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data8 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'zone_revelstoke_tier4_caribou', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data9 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'revelstoke_tier1_caribou', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data10 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'revelstoke_tier2_caribou', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data11 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'revelstoke_tier3_caribou', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data12 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'revelstoke_tier4_caribou', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data13 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'zone', table_name = 'revelstoke_tiers_caribou', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Bevan Enrst, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
...
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3, new_data4,
                                     new_data5, new_data6, new_data7, new_data8, new_data9,
                                     new_data10, new_data11, new_data12, new_data13))
...
# DELETE SOME DATA
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'archive' AND table_name = 'northern_group_scenario_20210305' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'archive' AND table_name = 'zone_du7_scenario_20210305' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'archive' AND table_name = 'zone_du7_scenarios_20210305_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'comaprison_nass' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'pink_mtn_caribou_old ' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'pink_mtn_caribou_old' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'pink_mtn_caribou_habitat_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'pink_mtn_habitat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'pink_mtn_caribou_habitat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_bec_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_management_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_noharvest_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_smz_calving_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_smz_highelev_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'whitesail_smz_movecorr_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_barkerville_groundhog_zones_20210303' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_barkerville_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_burnt_pine_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_central_rockies_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_central_selkirks_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_charlotte_alplands_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_columbia_north_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_columbia_south_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_frisby_boulder_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_graham_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_groundhog_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_hart_ranges_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_itcha_ilgachuz_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_kennedy_siding_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_moberly_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_monashee_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_narraway_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_narrow_lake_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_north_cariboo_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_purcell_central_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_purcells_south_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_quintette_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_rainbows_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_redrock_prairie_creek_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_south_selkirks_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_telkwa_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_wells_gray_north_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_cond_nh_crit_wells_gray_south_crithab' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'zone_du7_scenario_20210330' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_bec_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_management_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_noharvest_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_smz_calving_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_smz_highelev_20210527' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'zone' AND table_name = 'whitesail_smz_movecorr_2021052' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_bec_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_management_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_noharvest_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_smz_highelev_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_smz_movecorr_vat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_bec' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_manage' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_no_harvest' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_smz_calving' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_smz_he' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'public' AND table_name = 'whitesail_wha_may2021_smz_move' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'map' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'mat' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'pas' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'pas_wt' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'ppt_sm' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'tave_sm' AND computer = 'DG401102';")
dbExecute (conn, 
           "DELETE FROM public.pgdbs_data_list WHERE schema = 'rast' AND table_name = 'tave_wt' AND computer = 'DG401102';")

# Central group zones March 2023
new_data <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'central_group_chra_032023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data2 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'public', table_name = 'central_group_chma_032023', 
                        type = 'polygon', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data3 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'central_group_chra_032023 ', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data4 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'rast', table_name = 'central_group_chma_032023', 
                        type = 'raster', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data5 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'central_group_chra_032023', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data6 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'vat', table_name = 'central_group_chma_032023', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
new_data7 <- data.table (computer = 'DG401102', database = 'castor',
                        schema = 'zone', table_name = 'central_grp_chma_chra_032023', 
                        type = 'table', script = 'R/Params/caribou_management_areas.Rmd',
                        source = 'Magan Watters, caribou recovery program', # description of data source
                        public = 'No', last_updated = '2023',  next_update = 'As needed',  
                        where_used = 'R/scenarios/revelstoke_complex' )
...
new_data <- data.table (computer = 'DG401102', 
                        database = 'Castor', 
                        schema = 'public',
                        table_name = 'integrated_roads_2021', 
                        type = 'line', 
                        script = 'Params\\delivered_wood_costs.Rmd', 
                        source = 'Cumulative Effects program roads - line', 
                        public = 'No', 
                        last_updated = '2023', 
                        next_update = 'As needed', 
                        where_used = 'delivered wood costs; any roading' 
                        )
new_data2 <- data.table (computer = 'DG401102', 
                        database = 'Castor', 
                        schema = 'rast',
                        table_name = 'ce_road_2021', 
                        type = 'raster', 
                        script = 'Params\\delivered_wood_costs.Rmd', 
                        source = 'Cumulative Effects program roads; rasterzied to 1 ha', 
                        public = 'No', 
                        last_updated = '2023', 
                        next_update = 'As needed', 
                        where_used = 'delivered wood costs; any roading' 
...
new_data <- data.table (computer = 'DG401102', 
                        database = 'Castor',  
                        schema = 'public', 
                        table_name = 'ecas_cycle_time_harvest_system_points', 
                        type = 'point', 
                        script = 'Params\\delivered_wood_costs.Rmd', 
                        source = 'ECAS Source: G:\\!Transfr\\Stone_queries; RESULTS Source: https://catalogue.data.gov.bc.ca/dataset/results-openings-svw', 
                        public = 'public', 
                        last_updated = '2023', 
                        next_update = '2024', 
                        where_used = 'delivered wood costs model') 
pgdbs_data_list_new <- merge (pgdbs_data_list, new_data, all = T)
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
...
new_data <- data.table (computer = 'DG401102', 
                        database = 'Castor',  
                        schema = 'public', 
                        table_name = 'regional_districts_2023', 
                        type = 'polygon', 
                        script = 'Params\\delivered_wood_costs.Rmd', 
                        source = 'https://catalogue.data.gov.bc.ca/dataset/d1aff64e-dbfe-45a6-af97-582b7f6418b9', 
                        public = 'public', 
                        last_updated = '2023', 
                        next_update = '2028', 
                        where_used = 'delivered wood costs model') 
...
new_data <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier1_june2023', # add year and month if relevant
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
                        where_used = 'R/scenarios/revelstoke_complex')
new_data1 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier2_june2023', # add year and month if relevant
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data2 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier3_june2023', # add year and month if relevant
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data3 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier1_moose_june2023', 
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data4 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier2_moose_june2023', 
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data5 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'public', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tier3_moose_june2023', 
                        type = 'polygon', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data6 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier1_caribou_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data7 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier2_caribou_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data8 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier3_caribou_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data9 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier1_caribou_moose_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data10 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier2_caribou_moose_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
new_data11 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = 'rast', # caribou, public, vat, zone or rast
                        table_name = 'zone_revelstoke_tier3_caribou_moose_june2023', 
                        type = 'raster', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
                        where_used = 'R/scenarios/revelstoke_complex')
new_data12 <- data.table (computer = 'DG401102', database = 'Castor',
                        schema = ' zone', # caribou, public, vat, zone or rast
                        table_name = 'revelstoke_tiers_caribou_june2023', 
                        type = 'table', # polygon, point, line, raster or table
                        script = 'R/Params/caribou_management_areas.Rmd', 
                        source = 'Bevan Ernst, Caribou Recovery Program', 
                        public = 'No',  last_updated = '2023',  next_update = 'As Needed', 
...
pgdbs_data_list_new <- Reduce (function(dtf1, dtf2) merge (dtf1, dtf2, all = TRUE), 
                               list (pgdbs_data_list, new_data, new_data2, new_data3, new_data4, 
                                     new_data5, new_data6, new_data7, new_data8, new_data9, 
                                     new_data10, new_data11, new_data12))
# re-upload data to postgres
DBI::dbWriteTable(conn, c("public", "pgdbs_data_list"), 
                  value = pgdbs_data_list_new, 
                  row.names = FALSE, overwrite = TRUE)
