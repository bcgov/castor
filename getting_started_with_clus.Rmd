...
You can periodically calculate growing stock as part of the using forestry simulation by listing the growingStockCLUS module. You only need to set the periodLength paramter, and the forestry CLUS module will call the growingStockCLUS at that interval and cauclate teh amount of volume availabe to be harvested.
