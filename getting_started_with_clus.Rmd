...
Database parameters are indicated as part of the downloaderCLUS module. This helps keeps the forestryCLUS module consistent with the data produced using the downloaderCLUS. You need to specify the PostgreSQL database name (dbName), and the location fo the SQLite database that was created by the downloaderCLUS module (useCLUSdb).  
...
The database and study area paramters are defined via the dataLoaderCLUS module, and include  
