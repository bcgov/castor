...
Also, within the "dataLoaderCLUS" module you set the patchSizeDist parameter, which establishes the size of blocks and the frequency of each block size by each natural disturbance type (ndt). 
