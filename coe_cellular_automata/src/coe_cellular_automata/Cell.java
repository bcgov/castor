...
public class Cell {
	...
	* @param lc 
	*/
	public Cell (Grid landscape, int id, int age, ArrayList<LinkedHashMap<String, Double>> yld, ArrayList<LinkedHashMap<String, Double>> yld_trans, int lc){
		this.id = id;
		this.age = age;
		this.yield = yld;
		this.yield_trans = yld_trans;
		this.landCoverList.add(lc);
